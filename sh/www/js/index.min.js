...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
!function(){!function(e){var t=global.performance||Date,r=0,n=t.now(),a=require,i=function(){r+=t.now()-n,require=a;try{return a.apply(this,arguments)}finally{require=i,n=t.now()}};require=i;try{e()}finally{require=a,r+=t.now()-n,r/=1e3,global.__require_stats__||(global.__require_stats__={}),global.__require_stats__["/home/vadzim/v/work/nerojs/src/app.js"]=r}}(function(){"use strict";function e(e,a){var i=t(a,{uid:null}),u=new o;return n(function(){return u.url=e.localModem&&e.localModem+a}),u.on("resume",function(){return u.send({what:"init",id:i.uid})}),u.on("message",function(e){return i.assign((e.partial?r.applyDiff:r.assignDiff)(i.valueOf(),e.data))}),{data:i.getReadOnly(),send:function(e){u.send({partial:!1,data:e})},update:function(e){u.send({partial:!0,data:e})},"delete":function(){u.close()}}}var t=require("JSONlocal"),r=require("localUtils"),n=require("ra"),a=require("lodash"),i=require("uid"),u=require("httpClient"),c=require("events").EventEmitter||require("events"),l=1e3,o=function(e){this.active=!1,this.closed=!1,this._ws=null,this._first=!0,this.url=e};$traceurRuntime.createClass(o,{get url(){return this._url},set url(e){this._url=e,this._createHandle()},_clearHandle:function(){this._ws&&(this._ws.onclose=null,this._ws.close(),this._ws=null,this.active=!1)},_createHandle:function(){var e=this;this._clearHandle(),this._url&&(this._ws=new WebSocket(this._url),this._ws.onclose=function(){e._ws=null,e.active=!1,e.emit("pause"),e.closed||setTimeout(function(){return e._createHandle()},l)},this._ws.onerror=function(t){e.emit("error",t)},this._ws.onopen=function(){e.active=!0,e._first&&(e._first=!1,e.emit("open")),e.emit("resume")},this._ws.onmessage=function(t){var r;try{r=JSON.parse(t.data)}catch(n){return e.emit("error",n)}e.emit("message",r)})},send:function(e){if(!this._ws||!this.active||this.closed)throw new Error("socket is not open: "+url);this._ws.send(JSON.stringify(e))},"delete":function(){this.close()},close:function(){this.closed=!0,this._clearHandle(),this.emit("close")},ask:function(e){var t=i();return this.send({id:t,question:e}),this.get(e.id).then(function(e){if(e.error)throw new Error(e.error);return e.answer})},get:function(e,t){var r=this;if("string"==typeof e||"number"==typeof e){var n=e;e=function(e){return e.id==n}}else if("function"!=typeof e){var i=e;e=function(){return a.every(i,function(e,t){return msk[t]==e})}}return new Promise(function(n,a){var i,u;i=function(e){r.removeListener("close",i),r.removeListener("message",u),null!=e?n(e):a(new Error("timeout"))},u=function(t){e(t)&&i(t)},null!=t&&setTimeout(i,t),r.on("close",i),r.on("message",u)})}},{},c),module.exports=function(c){var l,s={activePlace:"",language:"ru",iconSize:40,house:{main:null},devices:{uid:null},places:{uid:null,main:null}},f=t(c,s),b=function(e){var t=f.language||"ru";return[t,"ru","en"].filter(function(t){return e.hasOwnProperty(t)}).map(function(t){return e[t]})[0]},d=n.clean((l={},Object.defineProperty(l,"pageWidth",{value:2,configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(l,"pageHeight",{value:3,configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(l,"pageStarting",{value:!1,configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(l,"dialog",{value:"",configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(l,"history",{value:[],configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(l,"go",{value:function(e){e&&f.activePlace!=e&&(d.history.push(f.activePlace),f.activePlace=e)},configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(l,"back",{value:function(){for(;d.history.length;){var e=d.history.pop();if(d.getPlace(e))return f.activePlace=e}f.activePlace=d.main},configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(l,"windowSize",{value:{$:require("windowSize").getReadOnly(),width:null,height:null,ppmm:null,layout:null,window:null},configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(l,"modemLocations",{get:function(){return u.get("/modem_locations")},configurable:!0,enumerable:!0}),Object.defineProperty(l,"localModem",{get:function(){return d.modemLocations?d.modemLocations[0].url.replace(/^http/,"ws"):""},configurable:!0,enumerable:!0}),Object.defineProperty(l,"loggedin",{value:!0,configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(l,"login",{value:function(){},configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(l,"devices",{get:function(){return e(d,"/devices")},configurable:!0,enumerable:!0}),Object.defineProperty(l,"places",{get:function(){return e(d,"/places")},configurable:!0,enumerable:!0}),Object.defineProperty(l,"commands",{get:function(){return d.localModem&&new o(d.localModem+"/commands")},configurable:!0,enumerable:!0}),Object.defineProperty(l,"main",{get:function(){var e=r.valueOf(d.places.data);return e&&r.valueOf(e.main)},configurable:!0,enumerable:!0}),Object.defineProperty(l,"getPlace",{value:function(e){return d.places.data.get(e)},configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(l,"getDevice",{value:function(e){return d.devices.data.get(e)},configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(l,"activePlace",{get:function(){return f.activePlace||d.main},configurable:!0,enumerable:!0}),Object.defineProperty(l,"activeDevice",{get:function(){return d.getPlace(d.activePlace).device},configurable:!0,enumerable:!0}),Object.defineProperty(l,"checkIfTimeToGoBack",{get:function(){r.valueOf(d.places.data),d.getPlace(d.activePlace)||d.back()},configurable:!0,enumerable:!0}),Object.defineProperty(l,"caption",{get:function(){var e="";return d.activePlace!=d.main&&(e=b(d.getPlace(d.activePlace))),e||d.message("favorites")},configurable:!0,enumerable:!0}),Object.defineProperty(l,"placeType",{get:function(){var e=d.getPlace(d.activePlace);return e||(e=d.getPlace(d.main)),"content"==e.type&&e.group?"group":"content"==e.type?"place":"device"},configurable:!0,enumerable:!0}),Object.defineProperty(l,"deviceIds",{value:n.Getter(function(){var e=r.valueOf(d.devices.data);return a.keys(e).filter(function(t){var r=e[t];return r&&r.type}).sort()},r.arrayEqual),configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(l,"getFreeGroup",{value:function(){for(var e=a.reduce(r.valueOf(d.devices.data),function(e,t){return t.group&&(e[t.group]=!0),e},[]),t=2;1022>=t;++t)if(!e[t])return t;return null},configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(l,"placeIds",{value:n.Getter(function(){var e=r.valueOf(d.places.data);return a.keys(e).filter(function(t){var r=e[t];return r&&r.type}).sort()},r.arrayEqual),configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(l,"onDevices",{get:function(){var e=r.valueOf(d.devices.data);e&&e.uid&&(f.devices=e)},configurable:!0,enumerable:!0}),Object.defineProperty(l,"onPlaces",{get:function(){var e=r.valueOf(d.places.data);e&&e.uid&&(f.places=e)},configurable:!0,enumerable:!0}),Object.defineProperty(l,"initialLoading",{get:function(){return!f.places.uid||!f.devices.uid},configurable:!0,enumerable:!0}),Object.defineProperty(l,"initialized",{get:function(){return!d.initialLoading&&!!r.valueOf(f.places.main)},configurable:!0,enumerable:!0}),Object.defineProperty(l,"setDatabase",{value:function(e,t){f.devices=e,d.devices.send(e),f.places=t,d.places.send(t)},configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(l,"reset",{value:function(){d.setDatabase({uid:i()},{uid:i()})},configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(l,"setTemplate",{value:function(e){function t(e,n){if(e.content){var a={},u=0;e.content.forEach(function(e){return a[t(e,i())]={index:u++}}),e.content=a,e.type="place"}return r[n]=e,n}e=a.cloneDeep(e);var r={uid:i()},n=t(e,i()),u={uid:i(),main:n};d.setDatabase(r,u)},configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(l,"templates",{get:function(){return $traceurRuntime.initGeneratorFunction(function e(){var t,r,n,a;return $traceurRuntime.createGeneratorInstance(function(e){for(;;)switch(e.state){case 0:e.pushTry(11,null),e.state=14;break;case 14:t=u.get,r=t.call(u,"/templates"),e.state=6;break;case 6:return e.state=2,r;case 2:n=e.sent,e.state=4;break;case 4:e.returnValue=n,e.state=-2;break;case 8:e.popTry(),e.state=-2;break;case 11:e.popTry(),a=e.storedException,e.state=9;break;case 9:e.returnValue=a,e.state=-2;break;default:return e.end()}},e,this)}).call(this)},configurable:!0,enumerable:!0}),Object.defineProperty(l,"allMessages",{get:function(){return $traceurRuntime.initGeneratorFunction(function e(){var t,r,n;return $traceurRuntime.createGeneratorInstance(function(e){for(;;)switch(e.state){case 0:t=u.get,r=t.call(u,"/messages"),e.state=6;break;case 6:return e.state=2,r;case 2:n=e.sent,e.state=4;break;case 4:e.returnValue=n,e.state=-2;break;default:return e.end()}},e,this)}).call(this)},configurable:!0,enumerable:!0}),Object.defineProperty(l,"messages",{get:function(){var e=d.allMessages;if(null!=e){var t={},r=f.language||"ru";return a.forOwn(e,function(e,n){return t[n]=e.hasOwnProperty(r)?e[r]:n}),t}},configurable:!0,enumerable:!0}),Object.defineProperty(l,"message",{value:function(e){var t=d.messages&&d.messages[e];return null==t&&(t=e),t},configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(l,"createDevice",{value:function(e){var t=r.valueOf(d.getPlace(e));if(!t.device){var n=i();return co.go($traceurRuntime.initGeneratorFunction(function a(){var t,i;return $traceurRuntime.createGeneratorInstance(function(a){for(;;)switch(a.state){case 0:return a.state=2,d.devices.update((t={},Object.defineProperty(t,n,{value:{model:"Nero II 8421",state:0,comfort_1:.8,comfort_2:.2},configurable:!0,enumerable:!0,writable:!0}),t));case 2:a.maybeThrow(),a.state=4;break;case 4:return a.state=6,r.waitFor(function(){return d.getDevice(n)});case 6:a.maybeThrow(),a.state=8;break;case 8:return a.state=10,d.places.update((i={},Object.defineProperty(i,e,{value:{device:n},configurable:!0,enumerable:!0,writable:!0}),i));case 10:a.maybeThrow(),a.state=12;break;case 12:return a.state=14,r.waitFor(function(){return d.getPlace(e).device});case 14:a.maybeThrow(),a.state=-2;break;default:return a.end()}},a,this)}))}return r.promiseSucceeded},configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(l,"addItem",{value:function(e,t){var r,n,a,u=i();return d.places.update((a={},Object.defineProperty(a,e,{value:(n={},Object.defineProperty(n,"content",{value:(r={},Object.defineProperty(r,u,{value:{index:Object.keys(d.getPlace(e).content||{}).length},configurable:!0,enumerable:!0,writable:!0}),r),configurable:!0,enumerable:!0,writable:!0}),n),configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(a,u,{value:t,configurable:!0,enumerable:!0,writable:!0}),a))},configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(l,"addPlace",{value:function(e){return d.addItem(e,{type:"content",ru:"Помещение",en:"Room"})},configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(l,"addDevice",{value:function(e){return d.addItem(e,{type:"single",ru:"Устройство",en:"Device"})},configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(l,"purgeItem",{value:function(e){var t;return d.places.update(a.reduce(r.valueOf(d.places.data),function(t,r,n){var a,i;return r&&r.content&&r.content[e]&&(t[n]=(i={},Object.defineProperty(i,"content",{value:(a={},Object.defineProperty(a,e,{value:null,configurable:!0,enumerable:!0,writable:!0}),a),configurable:!0,enumerable:!0,writable:!0}),i)),t},(t={},Object.defineProperty(t,e,{value:null,configurable:!0,enumerable:!0,writable:!0}),t)))},configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(l,"renameItem",{value:function(e,t){var r,n=a.reduce(d.getPlace(e),function(e,t,r){return 2==r.length&&(e[r]=null),e},{});return n[s.language||"ru"]=t,d.places.update((r={},Object.defineProperty(r,e,{value:n,configurable:!0,enumerable:!0,writable:!0}),r))},configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(l,"command",{value:function(e,t){return d.commands?d.commands.ask({device:e,command:t}):Promise.reject("commands interface is not ready")},configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(l,"iconCommand",{value:function(e,t,n){return console.log(e,t,n),e=r.valueOf(e),("content"==e.type?"Short"==n:"Long"==n)?d.go(t):(("Short"==n||"Long"==n)&&(n="Comfort_1"),e.device?d.command(e.device,n):Promise.reject(new Error("device not configured")))},configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(l,"imgProps",{get:function(){return{onerror:function(){this.classList.add("error")},onload:function(){this.classList.remove("error")}}},configurable:!0,enumerable:!0}),l)).setName("app");return{app:d,local:f}}})}();
//# sourceMappingURL=out.js.map
