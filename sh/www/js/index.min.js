...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
!function(){!function(t){var e=global.performance||Date,r=0,n=e.now(),i=require,o=function(){r+=e.now()-n,require=i;try{return i.apply(this,arguments)}finally{require=o,n=e.now()}};require=o;try{t()}finally{require=i,r+=e.now()-n,r/=1e3,global.__require_stats__||(global.__require_stats__={}),global.__require_stats__["/home/vadzim/v/work/nerojs/src/co.js"]=r}}(function(){"use strict";function t(t){return{done:!0,iteratorFailed:!0,value:t}}function e(e,r){try{return e.next(r)}catch(n){return t(n)}}function r(e,r){if(!e["throw"])return t(r);try{return e["throw"](r)}catch(n){return t(n)}}function n(e){if(e["return"])try{e["return"]()}catch(n){return t(n)}else if(e["throw"]){var i=new _,o=r(e,i);if(o.done&&o.iteratorFailed){if(o.value!=i)return o}else h(new Error("thread has eaten EKill"))}return c}function i(t){if(t&&t.done&&t.iteratorFailed)throw t.value;return t}function o(t){if(t){var e=n(t);e.done&&e.iteratorFailed&&h(e.value)}}var s=require("later"),u=require("events").EventEmitter,a=module.exports=exports=new u,l=null;exports.currentThread=null,exports.global=null;exports.go=function(t){for(var e=[],r=1;r<arguments.length;r++)e[r-1]=arguments[r];if("function"==typeof t&&(t=t.apply(null,e)),!t.next){var n=t;t={next:function(){var t={value:n,done:!n};return n=null,t}}}return new w(t)},exports.gocall=function(t,e){for(var r=[],n=2;n<arguments.length;n++)r[n-2]=arguments[n];return new w(t.apply(e,r))},exports.func=function(t){return arguments.length>=2&&(t=Array.prototype.reduceRight.call(arguments,function(t,e){return e(t)})),function(){return new w(t.apply(this,arguments))}},exports.cb=function(t){return function(){for(var e=[],r=0;r<arguments.length;r++)e[r]=arguments[r];var n=this;return new Promise(function(r,i){var o;return(o=t).call.apply(o,$traceurRuntime.spread([n],e,[function(t,e){null!=t?i(t):r(e)}]))})}},exports.catchThreads=function(t,e){var r=l;l=e;try{return t()}finally{l=r}},exports.receive=function(t,e){return new Promise(function(r,n){function i(){if(l){clearTimeout(s);for(var e in l)t.removeListener(e,l[e]);h.close(),l=null}}function o(t,e){i(),r({event:t,data:e})}var s,u,l=Object.create(null),h=a.defer(function(){i(),n()}),c=function(r){if(e.hasOwnProperty(r)){var n=e[r];if(null==n)return 0;"timeout"==r?s=setTimeout(function(){return o("timeout",null)},n):t.addListener(r,l[r]=function(t){("function"!=typeof n||n(t))&&o(r,t)})}};t:for(var f in e)switch(u=c(f)){case 0:continue t}})},exports.wait=function(t){return{then:t}},exports.sleep=function(t){return{then:function(e){var r=setTimeout(e,t);return{kill:function(){clearTimout(r)}}}}},exports["yield"]=exports.sleep(1),exports.requestAnimationFrame={then:function(t){if("function"==typeof cancelAnimationFrame){{requestAnimationFrame(t)}return{kill:function(){cancelAnimationFrame(timer)}}}return exports.sleep(1).then(t)}};var h=function(t){return setTimeout(function(){throw t},1)},c={done:!0},f={enumerable:!1},_=function(){var t=void 0!==arguments[0]?arguments[0]:"kill";$traceurRuntime.superConstructor(d).call(this,t)},d=_;$traceurRuntime.createClass(_,{},{},Error),exports.EKill=_;var p=function(e){try{return e()}catch(r){return{next:function(){return t(r)}}}},v=function(t){return t instanceof m?t:(this._iterator=t,this._deferred=null,void(this._result=null))},m=v;$traceurRuntime.createClass(v,{defer:function(t){var e=this;if("function"!=typeof t)throw new Error("type error: only functions can be deferred");return this._deferred||(this._deferred=[]),this._deferred.push(t),{close:function(){if(e._deferred)for(var r=e._deferred.length-1;r>=0;--r)if(e._deferred[r]==t)return void e._deferred.splice(r,1)}}},save:function(t){this._result?t.iteratorFailed&&(this._result.iteratorFailed&&h(this._result.value),this._result=t):this._result=t},call:function(t,r){var n=m._iterator;m._iterator=this;try{t:for(;;){var i=t(this._iterator,r);if(!i.done)return i;if(this._iterator=null,!this._deferred)return i;for(this.save(i);this._deferred.length;){var o=p(this._deferred.pop());if(null!=o&&"function"==typeof o.next){this._iterator=o,r=void 0,t=e;continue t}}return i=this._result,this._result=null,i}}finally{m._iterator=n}},next:function(t){return i(this.call(e,t))},"throw":function(t){return i(this.call(r,t))},"return":function(){if(this._iterator){var t=m._iterator;m._iterator=this;try{var e=n(this._iterator);if(this._iterator=null,!this.deferred)return void i(e);for(this.save(e);this._deferred.length;){var r=p(this._deferred.pop());null!=r&&"function"==typeof r.next&&this.save(n(r))}e=this._result,this._result=null,i(e)}finally{m._iterator=t}}}},{}),v._iterator=null,exports.defer=function(t){if(!v._iterator)throw new Error("defer: not in a co-thread");return v._iterator.defer(t)};var w=function(t){var e=this;if(this._attachedToStack=!0,this._iterator=new v(t),this._stopCount=0,this._stack=[],this._global={},this._current=null,this.$name={toString:function(){return"<Thread>"}},this._newStep(),this._start=function(){e._start&&e._step&&e._step.next&&(e._stopCount>0?e._step.resume=e._start:(e._start=null,e._step.next()))},this._promise=new Promise(function(t,r){e._resolve=t,e._reject=r}),!this._resolve)throw new Error("assertion failure: wrong implementation of Promise");s.then(this._start),l&&l(this),exports.emit("start",this)};$traceurRuntime.createClass(w,{linkName:function(t){var e=void 0!==arguments[1]?arguments[1]:":thread";return t.$name&&(t=t.$name),this.$name.toString=function(){return""+t+e},this},waitForInput:function(){if(this._checkFinished(),this._stopCount>0)throw new Error("thread is paused");return this._start&&this._start(),this},_attachPromise:function(t){return t.kill=this.kill.bind(this),t},then:function(t,e){return this._attachedToStack=!1,this._attachPromise(this._promise.then(t,e))},"catch":function(t){return this._attachedToStack=!1,this._attachPromise(this._promise["catch"](t))},isFinished:function(){return!this._step},isPaused:function(){return this._stopCount>0},"throw":function(t){if(this==exports.currentThread)throw t;this._checkFinished(),this._newStep(),this._stopCount>0?this._step.resume=this._step.fail.bind(this._step,t):this._step.fail(t)},attachToStack:function(){this._attachedToStack=!0},kill:function(t){var e=void 0!==arguments[1]?arguments[1]:!0;if(!this.isFinished()){if(this._reject(t),e){o(this._iterator);for(var r=this._stack,n=r.length-1;n>=0;--n)o(r[n])}if(this._current)try{this._current.kill(t,e)}catch(i){h(i)}if(this._done(),this==exports.currentThread)throw new _}},pause:function(){this._checkFinished(),++this._stopCount},resume:function(){if(0==this._stopCount)throw new Error("thread not paused");0==--this._stopCount&&this._step&&this._step.resume&&(s.then(this._step.resume),this._step.resume=null)},_tick:function(t,n,i){if(t===this._step){if(this._stopCount>0)return void(t.resume=this._tick.bind(this,t,n,i));for(;;){this._current=null;var o=exports.currentThread;exports.currentThread=this,global.currentThreadData=exports.global=this._global;var s=this._iterator.call(n,i);if(exports.currentThread=o,global.currentThreadData=exports.global=o&&o._global,s.done){if(this.isFinished())return;if(this._iterator=this._stack.pop()){n=s.iteratorFailed?r:e,i=s.value;continue}var u=s.iteratorFailed?this._reject:this._resolve;this._done(),s.iteratorFailed&&this._attachedToStack&&h(s.value),u(s.value)}else if(s.value)if(s.value.then){var a=s.value.then(t.next,t.fail);a&&a.kill&&(this._current=a)}else{if(s.value.next){this._stack.push(this._iterator),this._iterator=new v(s.value),n=e,i=void 0;continue}if(!("onload"in s.value&&!s.value.onload&&"onerror"in s.value)||s.value.onerror)throw new Error("thread type error");s.value.onload=t.next,s.value.onerror=t.fail}else exports["yield"].then(t.next);break}}},_done:function(){this._step=null,this._iterator=null,this._stack=null,this._resolve=null,this._reject=null,this._current=null},_newStep:function(){var t=this._step={resume:null};t.next=this._tick.bind(this,t,e),t.fail=this._tick.bind(this,t,r);var n=this.$name;t.next.$name={toString:function(){return n+":next"}},t.fail.$name={toString:function(){return n+":fail"}}},_onPromise:function(t,e){this._resolve=t,this._reject=e,this.resume()},_checkFinished:function(){if(this.isFinished())throw new Error("thread is already finished")}},{}),exports.Thread=w,Object.keys(w.prototype).forEach(function(t){return t.match(/^_/)&&Object.defineProperty(w.prototype,t,f)}),exports.currentThread=new w({next:function(){return{value:{then:function(){}}}}}).waitForInput(),exports.global=exports.currentThread._global})}();
//# sourceMappingURL=out.js.map
