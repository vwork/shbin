...
},{}],"/home/vadzim/v/work/nerojs/src/httpClient.js":[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
!function(){!function(e){var t=global.performance||Date,r=0,n=t.now(),a=require,o=function(){r+=t.now()-n,require=a;try{return a.apply(this,arguments)}finally{require=o,n=t.now()}};require=o;try{e()}finally{require=a,r+=t.now()-n,r/=1e3,global.__require_stats__||(global.__require_stats__={}),global.__require_stats__["/home/vadzim/v/work/nerojs/src/webpage.js"]=r}}(function(){"use strict";function e(e){e.target&&"external"==e.target.getAttribute("rel")||e.target instanceof HTMLInputElement||e.preventDefault()}function t(e){setTimeout(function(){throw e},0)}function r(e,r){var n=Date.now(),a=!0,o=!1,i=void 0;try{for(var c=void 0,l=Array.prototype.slice.call(r.changedTouches)[$traceurRuntime.toProperty(Symbol.iterator)]();!(a=(c=l.next()).done);a=!0){var s=c.value,d=s.identifier,m=w[d],f={target:s.target,x:s.screenX,y:s.screenY,time:n,last:!0};if(m&&(m.abandoned=!1,"touchstart"==e||"touchend"==e||"touchcancel"==e)){delete w[d];try{!m.handler.next(f).done&&m.handler["return"]&&m.handler["return"]()}catch(y){t(y)}m=null}if(f.last=!1,"touchstart"==e&&(m=w[d]={abandoned:!1,handler:u(f)},f=void 0),m){var h=!1;try{h=!m.handler.next(f).done}catch(y){t(y)}h||delete w[d]}}}catch(v){o=!0,i=v}finally{try{a||null==l["return"]||l["return"]()}finally{if(o)throw i}}}function n(e){return e.x}function a(e){return e.y}function o(e,t,r){return 0==t||r[t].x>=r[t-1].x}function i(e,t,r){return 0==t||r[t].x<=r[t-1].x}function u(e){var t,r,u,c,s,d,m;return $traceurRuntime.createGeneratorInstance(function(l){for(;;)switch(l.state){case 0:t=[e],r={x:0,y:0,min:{x:e.x,y:e.y},max:{x:e.x,y:e.y}},c="",s=!1,l.state=14;break;case 14:return l.state=2,null;case 2:m=l.sent,l.state=4;break;case 4:u=m,l.state=6;break;case 6:l.state=m?10:-2;break;case 10:t.push(u),r.min.x>u.x&&(r.min.x=u.x),r.min.y>u.y&&(r.min.y=u.y),r.max.x<u.x&&(r.max.x=u.x),r.max.y<u.y&&(r.max.y=u.y),r.x=r.max.x-r.min.x,r.y=r.max.y-r.min.y,d=Math.max(r.x,r.y),s=!1,u.time-e.time<q&&d>L&&(s=d>_,r.x>r.y&&t.map(n).every(o)?c="right":r.x>r.y&&t.map(n).every(i)?c="left":r.x<r.y&&t.map(a).every(o)?c="down":r.x<r.y&&t.map(a).every(i)?c="up":(c="",s=!1)),l.state=11;break;case 11:l.state=u.last?-2:14;break;default:return l.end()}},l,this)}function c(e){var t=document.createElement("script");return t.appendChild(document.createTextNode(e)),t}{var l=$traceurRuntime.initGeneratorFunction(u),s=global.performance||global.Date;s.now()}require("browser-nexttick"),require("platform"),global.lu=require("localUtils"),global.ra=require("ra"),global.co=require("co"),global.lodash=require("lodash"),require("colors");var d=(require("uid"),require("httpClient"),!0),m=!1,f=void 0;try{for(var y=function(){var t=h.value;document.body.addEventListener(t,e),document.body.addEventListener(t,function(e){return r(t,e)})},h=void 0,v=["touchstart","touchmove","touchend","touchcancel"][$traceurRuntime.toProperty(Symbol.iterator)]();!(d=(h=v.next()).done);d=!0)y()}catch(p){m=!0,f=p}finally{try{d||null==v["return"]||v["return"]()}finally{if(m)throw f}}var x={mousedown:"touchstart",mousemove:"touchmove",mouseup:"touchend"},g=function(e){var t=x[e];document.body.addEventListener(e,function(e){return r(t,{changedTouches:{identifier:"mouse",target:e.target,screenX:e.screenX,screenY:e.screenY}})})};for(var b in x)g(b);var w=Object.create(null);setInterval(function(){var e=!0,t=!1,r=void 0;try{for(var n=void 0,a=Object.keys(w)[$traceurRuntime.toProperty(Symbol.iterator)]();!(e=(n=a.next()).done);e=!0){var o=n.value,i=w[o];i.abandoned?(i.handler["return"]&&i.handler["return"](),delete w[o]):i.abandoned=!0}}catch(u){t=!0,r=u}finally{try{e||null==a["return"]||a["return"]()}finally{if(t)throw r}}},5e3);var q=350,_=96/2.54*.5,L=96/2.54*.15;global.LOG=function(e){console.log.apply(console,arguments),global._ALERT&&global._ALERT(e);var t=new XMLHttpRequest;return t.open("POST","/log?"+encodeURIComponent(e)),t.onerror=lodash.noop,t.send(),e},window.addEventListener("error",function E(e){if(!e.message.match(404)&&!E.processing){E.processing=!0;try{LOG(e.message.red+" at "+e.lineno+":"+e.colno+" in "+e.filename)}finally{E.processing=!1}}});var k=window.onerror;window.onerror=function(e,t,r,n,a){var o;if(a&&LOG("stack: "+a.stack),k)try{window.onerror=k,o=k.apply(this,arguments)}finally{k=window.onerror}return o},global.CS=lu["new"](require("components"),global.CS),co.go($traceurRuntime.initGeneratorFunction(function R(){var e,t,r,n,a;return $traceurRuntime.createGeneratorInstance(function(o){for(;;)switch(o.state){case 0:e=cacheUrlResource("./main.html"),o.state=6;break;case 6:return o.state=2,e;case 2:e=o.sent,o.state=4;break;case 4:for(t=document.createDocumentFragment(),r=document.createElement("div"),r.innerHTML=e,r=r.children[0],n=[],a=0;a<r.childNodes.length;++a)n.push(r.childNodes[a]);n.forEach(function(e){return r.removeChild(e)}),n.forEach(function(e){e instanceof HTMLScriptElement&&(e=c(e.innerHTML)),t.appendChild(e)}),document.body.appendChild(t),o.state=-2;break;default:return o.end()}},R,this)})),window.addEventListener("message",function(e){e&&e.data&&"urlResourceUpdated"==e.data.what&&window.setTimeout(function(){return window.location.reload()},1e3)},!1)})}();
//# sourceMappingURL=out.js.map
