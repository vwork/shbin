...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
!function(){!function(e){var t=global.performance||Date,n=0,r=t.now(),o=require,a=function(){n+=t.now()-r,require=o;try{return o.apply(this,arguments)}finally{require=a,r=t.now()}};require=a;try{e()}finally{require=o,n+=t.now()-r,n/=1e3,global.__require_stats__||(global.__require_stats__={}),global.__require_stats__["/home/vadzim/v/work/nerojs/src/httpClient.js"]=n}}(function(){"use strict";var e=(require("lodash"),require("localUtils"),{get:function(t,n){return e.xhr({method:"GET",url:t,encoding:n})},post:function(t,n,r){return e.xhr({method:"POST",url:t,data:n,encoding:r})},xhr:function(e){var t=e,n=t.method,r=t.url,o=t.encoding,a=t.data,u=new XMLHttpRequest;u.responseType="binary"==o?"arraybuffer":"text";var i=new Promise(function(e,t){var o=function(e){"string"==typeof e&&(e=new Error(e),e.method=n,e.url=r),global._ALERT&&global._ALERT("try "+e+r),t(e)};u.ontimeout=function(){return o("TIMEOUT")},u.onerror=function(e){return o(e||"ERROR")},u.onreadystatechange=function(){u.readyState==u.DONE&&0==u.status&&u.ontimeout()},u.onload=function(){if(u.status>=200&&u.status<=299)return e(null==u.response?null:u.response);if(401==u.status){var t=require("url").parse(r);if(t.host){t=t.protocol+"//"+t.host+"/dummy."+Math.random()+".js";var n=document.createElement("script");n.src=t,document.body.appendChild(n),setTimeout(function(){return document.body.removeChild(n)},1e3)}}o(u.status+" "+u.statusText)}});switch(o){case"immutable":i=i.then(function(e){return Immutable.fromJS(JSON.parse(e))});break;case"binary":i=i.then(function(e){return new Uint8Array(e)});break;case"text":break;default:i=i.then(function(e){var t=o;if(!t){var n=u.getResponseHeader("content-type")||"";n.match(/^application\/json/)&&(t="json")}switch(t){case"json":return JSON.parse(e)}return e})}return u.open(n||"GET",r),u.withCredentials=!0,u.send(a),u.then=i.then.bind(i),u.catch=i.catch.bind(i),u},url:function(e,t){return t&&Object.keys(t).forEach(function(n,r){return e=e+(r>0?"&":"?")+encodeURIComponent(n)+"="+encodeURIComponent(t[n])}),e}});module.exports=e})}();
//# sourceMappingURL=out.js.map
