...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
!function(){!function(r){var e=global.performance||Date,t=0,o=e.now(),l=require,i=function(){t+=e.now()-o,require=l;try{return l.apply(this,arguments)}finally{require=i,o=e.now()}};require=i;try{r()}finally{require=l,t+=e.now()-o,t/=1e3,global.__require_stats__||(global.__require_stats__={}),global.__require_stats__["/home/vadzim/v/work/nerojs/src/platform.js"]=t}}(function(){"use strict";if(Object.defineProperty(Object.prototype,"_LOG_",{value:function(){return console.log(this),this},configurable:!0}),require("colors"),global.EventEmitter=require("events").EventEmitter,"function"==typeof Symbol&&Symbol.iterator){var r=null;try{r=eval.call(null,"(function*(){}().constructor.prototype)")}catch(e){}r&&!r[Symbol.iterator]&&(r[Symbol.iterator]=function(){return this})}global.lodash=require("lodash"),global.UID=require("uid"),global.co=require("co"),global.ra=require("ra"),global.lu=require("localUtils"),global.httpClient=require("httpClient")})}();
//# sourceMappingURL=out.js.map
