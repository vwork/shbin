...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
!function(){!function(t){var e=global.performance||Date,r=0,n=e.now(),i=require,a=function(){r+=e.now()-n,require=i;try{return i.apply(this,arguments)}finally{require=a,n=e.now()}};require=a;try{t()}finally{require=i,r+=e.now()-n,r/=1e3,global.__require_stats__||(global.__require_stats__={}),global.__require_stats__["/home/vadzim/v/work/nerojs/src/co.js"]=r}}(function(){"use strict";function t(t){return{done:!0,iteratorFailed:!0,value:t}}function e(e,r){try{return e.next(r)}catch(n){return t(n)}}function r(e,r){if(!e["throw"])return t(r);try{return e["throw"](r)}catch(n){return t(n)}}function n(e){if(e["return"])try{e["return"]()}catch(n){return t(n)}else if(e["throw"]){var i=new _,a=r(e,i);if(a.done&&a.iteratorFailed){if(a.value!=i)return a}else f(new Error("thread has eaten EKill"))}return d}function i(t){if(t&&t.done&&t.iteratorFailed)throw t.value;return t}function a(t){if(t){var e=n(t);e.done&&e.iteratorFailed&&f(e.value)}}function s(t){function i(t){(null==u||t.iteratorFailed)&&(u&&u.iteratorFailed&&f(u.value),u=t)}var a,u,l,c,h,d;return $traceurRuntime.createGeneratorInstance(function(o){for(;;)switch(o.state){case 0:a=[],u=null,l=e,c=null,o.state=55;break;case 55:o.pushTry(null,49),o.state=51;break;case 51:o.state=31;break;case 31:h=void 0,l=e,o.state=32;break;case 32:o.state=null!=c?10:17;break;case 10:o.pushTry(8,null),o.state=11;break;case 11:return o.state=5,c.value;case 5:h=o.sent,o.state=7;break;case 7:o.popTry(),o.state=13;break;case 8:o.popTry(),o.maybeUncatchable(),d=o.storedException,o.state=14;break;case 14:h=d,l=r,o.state=13;break;case 17:h=void 0,o.state=13;break;case 13:s.deferred=deferred,c=l(t,h),s.deferred=null,o.state=34;break;case 34:o.state=c.done?27:51;break;case 27:i(c),c=void 0,o.state=36;break;case 36:o.state=a.length?23:25;break;case 23:t=m(a.shift()),o.state=24;break;case 24:o.state=null!=t&&"function"==typeof t.next?51:36;break;case 25:t=null,o.state=49,o.finallyFallThrough=-2;break;case 49:o.popTry(),o.state=53;break;case 53:for(t&&i(n(t));a.length;)t=m(a.shift()),null!=t&&"function"==typeof t.next&&(c=e(t,void 0),c.done||(c=n(t)),i(c));o.state=47;break;case 47:o.state=u?44:43;break;case 44:o.state=u.iteratorFailed?42:40;break;case 42:throw u.value;case 40:o.returnValue=u.value,o.state=-2;break;case 43:o.state=o.finallyFallThrough;break;default:return o.end()}},o,this)}var o=$traceurRuntime.initGeneratorFunction(s),u=require("later"),l=require("events").EventEmitter,c=module.exports=exports=new l,h=null;exports.currentThread=null,exports.global=null;exports.go=function(t){for(var e=[],r=1;r<arguments.length;r++)e[r-1]=arguments[r];if("function"==typeof t&&(t=t.apply(null,e)),!t.next){var n=t;t={next:function(){var t={value:n,done:!n};return n=null,t}}}return new b(t)},exports.gocall=function(t,e){for(var r=[],n=2;n<arguments.length;n++)r[n-2]=arguments[n];return new b(t.apply(e,r))},exports.func=function(t){return arguments.length>=2&&(t=Array.prototype.reduceRight.call(arguments,function(t,e){return e(t)})),function(){return new b(t.apply(this,arguments))}},exports.cb=function(t){return function(){for(var e=[],r=0;r<arguments.length;r++)e[r]=arguments[r];var n=this;return new Promise(function(r,i){var a;return(a=t).call.apply(a,$traceurRuntime.spread([n],e,[function(t,e){null!=t?i(t):r(e)}]))})}},exports.catchThreads=function(t,e){var r=h;h=e;try{return t()}finally{h=r}},exports.receive=function(t,e){return new Promise(function(r,n){function i(){if(u){clearTimeout(s);for(var e in u)t.removeListener(e,u[e]);l.close(),u=null}}function a(t,e){i(),r({event:t,data:e})}var s,o,u=Object.create(null),l=c.defer(function(){i(),n()}),h=function(r){if(e.hasOwnProperty(r)){var n=e[r];if(null==n)return 0;"timeout"==r?s=setTimeout(function(){return a("timeout",null)},n):t.addListener(r,u[r]=function(t){("function"!=typeof n||n(t))&&a(r,t)})}};t:for(var f in e)switch(o=h(f)){case 0:continue t}})},exports.wait=function(t){return{then:t}},exports.sleep=function(t){return{then:function(e){var r=setTimeout(e,t);return{kill:function(){clearTimout(r)}}}}},exports["yield"]=exports.sleep(1),exports.requestAnimationFrame={then:function(t){if("function"==typeof cancelAnimationFrame){{requestAnimationFrame(t)}return{kill:function(){cancelAnimationFrame(timer)}}}return exports.sleep(1).then(t)}};var f=function(t){return setTimeout(function(){throw t},1)},d={done:!0},_=function(){var t=void 0!==arguments[0]?arguments[0]:"kill";$traceurRuntime.superConstructor(p).call(this,t)},p=_;$traceurRuntime.createClass(_,{},{},Error),exports.EKill=_;var v={enumerable:!1},m=function(e){try{return e()}catch(r){return{next:function(){return t(r)}}}},w=function(t){return t instanceof k?t:(this._iterator=t,this._deferred=null,void(this._result=null))},k=w;$traceurRuntime.createClass(w,{defer:function(t){var e=this;if("function"!=typeof t)throw new Error("type error: only functions can be deferred");return this._deferred||(this._deferred=[]),this._deferred.push(t),{close:function(){if(e._deferred)for(var r=e._deferred.length-1;r>=0;--r)if(e._deferred[r]==t)return void e._deferred.splice(r,1)}}},save:function(t){this._result?t.iteratorFailed&&(this._result.iteratorFailed&&f(this._result.value),this._result=t):this._result=t},call:function(t,r){var n=k._iterator;k._iterator=this;try{t:for(;;){var i=t(this._iterator,r);if(!i.done)return i;if(this._iterator=null,!this._deferred)return i;for(this.save(i);this._deferred.length;){var a=m(this._deferred.pop());if(null!=a&&"function"==typeof a.next){this._iterator=a,r=void 0,t=e;continue t}}return i=this._result,this._result=null,i}}finally{k._iterator=n}},next:function(t){return i(this.call(e,t))},"throw":function(t){return i(this.call(r,t))},"return":function(){if(this._iterator){var t=k._iterator;k._iterator=this;try{var r=n(this._iterator);if(this._iterator=null,!this.deferred)return void i(r);for(this.save(r);this._deferred.length;){var a=m(this._deferred.pop());if(null!=a&&"function"==typeof a.next){var s=e(a);s.done||(s=n(a)),this.save(s)}}r=this._result,this._result=null,i(r)}finally{k._iterator=t}}}},{}),w._iterator=null,exports.defer=function(t){if(!w._iterator)throw new Error("defer: not in a co-thread");return w._iterator.defer(t)},exports._defer=function(t){if("function"!=typeof t)throw new Error("type error: only functions can be deferred");var e=s.deferred;if(e)throw new Error("defer: not in a co-thread");return e.push(t),{close:function(){if(e)for(var r=e.length-1;r>=0;--r)if(e[r]==t)return void e.splice(r,1)}}};var b=function(t){var e=this;if(this._attachedToStack=!0,this._iterator=new w(t),this._stopCount=0,this._stack=[],this._global={},this._current=null,this.$name={toString:function(){return"<Thread>"}},this._newStep(),this._start=function(){e._start&&e._step&&e._step.next&&(e._stopCount>0?e._step.resume=e._start:(e._start=null,e._step.next()))},this._promise=new Promise(function(t,r){e._resolve=t,e._reject=r}),!this._resolve)throw new Error("assertion failure: wrong implementation of Promise");u.then(this._start),h&&h(this),exports.emit("start",this)};$traceurRuntime.createClass(b,{linkName:function(t){var e=void 0!==arguments[1]?arguments[1]:":thread";return t.$name&&(t=t.$name),this.$name.toString=function(){return""+t+e},this},waitForInput:function(){if(this._checkFinished(),this._stopCount>0)throw new Error("thread is paused");return this._start&&this._start(),this},_attachPromise:function(t){return t.kill=this.kill.bind(this),t},then:function(t,e){return this._attachedToStack=!1,this._attachPromise(this._promise.then(t,e))},"catch":function(t){return this._attachedToStack=!1,this._attachPromise(this._promise["catch"](t))},isFinished:function(){return!this._step},isPaused:function(){return this._stopCount>0},"throw":function(t){if(this==exports.currentThread)throw t;this._checkFinished(),this._newStep(),this._stopCount>0?this._step.resume=this._step.fail.bind(this._step,t):this._step.fail(t)},attachToStack:function(){this._attachedToStack=!0},kill:function(t){var e=void 0!==arguments[1]?arguments[1]:!0;if(!this.isFinished()){if(this._reject(t),e){a(this._iterator);for(var r=this._stack,n=r.length-1;n>=0;--n)a(r[n])}if(this._current)try{this._current.kill(t,e)}catch(i){f(i)}if(this._done(),this==exports.currentThread)throw new _}},pause:function(){this._checkFinished(),++this._stopCount},resume:function(){if(0==this._stopCount)throw new Error("thread not paused");0==--this._stopCount&&this._step&&this._step.resume&&(u.then(this._step.resume),this._step.resume=null)},_tick:function(t,n,i){if(t===this._step){if(this._stopCount>0)return void(t.resume=this._tick.bind(this,t,n,i));for(;;){this._current=null;var a=exports.currentThread;exports.currentThread=this,global.currentThreadData=exports.global=this._global;var s=this._iterator.call(n,i);if(exports.currentThread=a,global.currentThreadData=exports.global=a&&a._global,s.done){if(this.isFinished())return;if(this._iterator=this._stack.pop()){n=s.iteratorFailed?r:e,i=s.value;continue}var o=s.iteratorFailed?this._reject:this._resolve;this._done(),s.iteratorFailed&&this._attachedToStack&&f(s.value),o(s.value)}else if(s.value)if(s.value.then){var u=s.value.then(t.next,t.fail);u&&u.kill&&(this._current=u)}else{if(s.value.next){this._stack.push(this._iterator),this._iterator=new w(s.value),n=e,i=void 0;continue}if(!("onload"in s.value&&!s.value.onload&&"onerror"in s.value)||s.value.onerror)throw new Error("thread type error");s.value.onload=t.next,s.value.onerror=t.fail}else exports["yield"].then(t.next);break}}},_done:function(){this._step=null,this._iterator=null,this._stack=null,this._resolve=null,this._reject=null,this._current=null},_newStep:function(){var t=this._step={resume:null};t.next=this._tick.bind(this,t,e),t.fail=this._tick.bind(this,t,r);var n=this.$name;t.next.$name={toString:function(){return n+":next"}},t.fail.$name={toString:function(){return n+":fail"}}},_onPromise:function(t,e){this._resolve=t,this._reject=e,this.resume()},_checkFinished:function(){if(this.isFinished())throw new Error("thread is already finished")}},{}),exports.Thread=b,Object.keys(b.prototype).forEach(function(t){return t.match(/^_/)&&Object.defineProperty(b.prototype,t,v)}),exports.currentThread=new b({next:function(){return{value:{then:function(){}}}}}).waitForInput(),exports.global=exports.currentThread._global})}();
//# sourceMappingURL=out.js.map
