...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
!function(){!function(e){var t=global.performance||Date,n=0,r=t.now(),a=require,i=function(){n+=t.now()-r,require=a;try{return a.apply(this,arguments)}finally{require=i,r=t.now()}};require=i;try{e()}finally{require=a,n+=t.now()-r,n/=1e3,global.__require_stats__||(global.__require_stats__={}),global.__require_stats__["/home/vadzim/v/work/nerojs/src/app.js"]=n}}(function(){"use strict";function e(e,t){var n=new b;return a(function(){return n.url=e.localModem&&e.localModem+t}),n.active=a.on(n,["pause","resume"],function(){return n.connected}),n}function t(t,a){var i=n(a,{uid:null}),c=e(t,a),o=function(){return c.send({what:"init",id:i.uid})};return r.on(c,{resume:o,message:function(e){return e.error?console.log("wsJSONclient: error from server:",e.error):e.partial&&e.previous!=i.uid?o():void(e.hasOwnProperty("data")?i.assign((e.partial?r.applyDiff:r.assignDiff)(i.valueOf(),e.data)):console.log("unknown message from server",e))},error:function(){t.onCredentials()}}),{data:i.getReadOnly(),active:c.active,send:function(e){c.send({what:"save",partial:!1,data:e})},update:function(e){c.send({what:"save",partial:!0,data:e})},"delete":function(){c.close()}}}var n=require("JSONlocal"),r=require("localUtils"),a=require("ra"),i=require("lodash"),c=require("uid"),o=require("httpClient"),u=require("events").EventEmitter||require("events"),s=require("deviceActions"),l=(require("http-status"),require("WebSocketToJSON")),f=require("PingPongJSON"),d=1e3,b=function(e){$traceurRuntime.superConstructor(g).call(this),this.connected=!1,this.closed=!1,this._ws=null,this._sheduledCreating=null,this._first=!0,this._lastClose=-(1/0),this.url=e,this.user=void 0,this.key=void 0},g=b;$traceurRuntime.createClass(b,{get url(){return this._url},set url(e){this._url=e,this._createHandle()},_setConnected:function(e){e=!!e,this.connected!=e&&(this.connected=e,this.emit("changed",e))},_clearHandle:function(){this._ws&&(this._ws.onclose=null,this._ws.close(),this._ws=null,this._setConnected(!1)),this._sheduledCreating&&(clearTimeout(this._sheduledCreating),this._sheduledCreating=null)},_ensureHandle:function(){this._ws||this._createHandle()},_createHandle:function(){var e=this;this._clearHandle(),this._url&&(this._ws=f(l(new WebSocket(this._url))),this._ws.onclose=function(){if(e._ws=null,e._setConnected(!1),e.emit("pause"),!e.closed){var t=e._lastClose;e._lastClose=Date.now(),e._sheduledCreating=setTimeout(function(){e._createHandle()},Math.max(0,d-(e._lastClose-t)))}},this._ws.onerror=function(t){e.emit("error",t)},this._ws.onopen=function(){e._setConnected(!0),e._first&&(e._first=!1,e.emit("open")),e.emit("resume")},this._ws.onmessage=function(t){e.emit("message",t)})},reinit:function(){this._ws&&this._ws.close()},send:function(e){if(this._ensureHandle(),!this._ws||!this.connected||this.closed)throw new Error("socket is not open");this._ws.send(e)},"delete":function(){this.close()},close:function(){this.closed=!0,this._clearHandle(),this.emit("close")},ask:function(e){var t=c();return this.send({id:t,question:e}),this.get(e.id).then(function(e){if(e.error)throw new Error(e.error);return e.answer})},get:function(e,t){var n=this;if("string"==typeof e||"number"==typeof e){var a=e;e=function(e){return e.id==a}}else if("function"!=typeof e){var c=e;e=function(){return i.every(c,function(e,t){return msk[t]==e})}}return new Promise(function(a,i){var c,o;c=function(e){r.off(n,{close:c,message:o}),null!=e?a(e):i(new Error("timeout"))},o=function(t){e(t)&&c(t)},null!=t&&setTimeout(c,t),r.on(n,{close:c,message:o})})}},{},u),module.exports=function(u){var l={activePlace:"",language:"ru",iconSize:40,labels:!0},f=n(u,l),d=a.clean({getMessage:function(e){var t=f.language||"ru";return[t,"ru","en","by"].filter(function(t){return e.hasOwnProperty(t)}).map(function(t){return e[t]})[0]},pageWidth:2,pageHeight:3,pageStarting:!1,dialog:"",history:[],loggedin:!1,onCredentials:function(){d.loggedin=!1},go:function(e){e&&f.activePlace!=e&&(d.history.push(f.activePlace),f.activePlace=e)},back:function(){for(;d.history.length;){var e=d.history.pop();if(d.getPlace(e))return f.activePlace=e}f.activePlace=d.main},windowSize:{$:require("windowSize").getReadOnly(),width:null,height:null,ppmm:null,layout:null,window:null},get modemLocations(){return o.get("/modem_locations")},get localModem(){return d.modemLocations?d.modemLocations[0].url.replace(/^http(?=s?\:\/\/)/,"ws"):""},doLogin:a.Getter($traceurRuntime.initGeneratorFunction(function b(){var e,t;return $traceurRuntime.createGeneratorInstance(function(n){for(;;)switch(n.state){case 0:n.state=3;break;case 3:n.state=d.loggedin||!d.modemLocations?1:2;break;case 1:n.state=-2;break;case 2:e=document.createElement("script"),e.src=d.modemLocations[0].url+"/login?"+c(),document.body.appendChild(e),n.state=28;break;case 28:n.pushTry(16,17),n.state=19;break;case 19:return n.state=5,e;case 5:n.maybeThrow(),n.state=7;break;case 7:n.popTry(),n.state=17,n.finallyFallThrough=21;break;case 16:n.popTry(),n.maybeUncatchable(),t=n.storedException,n.state=14;break;case 14:console.log("error while trying to login",t),n.state=15;break;case 15:return n.state=9,co.sleep(300);case 9:n.maybeThrow(),n.state=17,n.finallyFallThrough=0;break;case 17:n.popTry(),n.state=26;break;case 26:document.body.removeChild(e),n.state=24;break;case 21:a.detach(function(){return d.loggedin=!0}),n.state=0;break;case 24:n.state=n.finallyFallThrough;break;default:return n.end()}},b,this)})),login:function(){},get devices(){return t(d,"/devices")},get places(){return t(d,"/places")},get commands(){return e(d,"/commands")},get connectedToServer(){return!0&&d.devices.active.valueOf()&&d.places.active.valueOf()&&d.commands.active.valueOf()},get main(){var e=r.valueOf(d.places.data);return e&&r.valueOf(e.main)},getPlace:function(e){return d.places.data.get(e)},getDevice:function(e){return d.devices.data.get(e)},get activePlace(){return f.activePlace||d.main},get activeDevice(){return d.getPlace(d.activePlace).device},get checkIfTimeToGoBack(){r.valueOf(d.places.data),d.getPlace(d.activePlace)||d.back()},get caption(){return d.getMessage(d.getPlace(d.activePlace))||d.message("favorites")},get placeType(){var e=d.getPlace(d.activePlace);return e||(e=d.getPlace(d.main)),"content"==e.type&&e.group?"group":"content"==e.type?"place":"device"},deviceIds:a.Getter(function(){var e=r.valueOf(d.devices.data);return i.keys(e).filter(function(t){var n=e[t];return n&&n.type}).sort()},r.arrayEqual),getFreeGroup:function(){for(var e=i.reduce(r.valueOf(d.devices.data),function(e,t){return t.group&&(e[t.group]=!0),e},[]),t=2;1022>=t;++t)if(!e[t])return t;return null},placeIds:a.Getter(function(){var e=r.valueOf(d.places.data);return i.keys(e).filter(function(t){var n=e[t];return n&&n.type}).sort()},r.arrayEqual),get initialLoading(){return!d.places.data.valueOf().uid||!d.devices.data.valueOf().uid},get initialized(){return!d.initialLoading&&!!d.places.data.valueOf().main},setDatabase:function(e,t){d.devices.send(e),d.places.send(t)},reset:function(){d.history.length=0,d.setDatabase({uid:c()},{uid:c()})},setTemplate:function(e){function t(e,t){return Object.keys(e).forEach(function(n){return"image"!=n&&"content"!=n&&"type"!=n&&(t[n]=e[n])}),t}function n(e,r){if(e.content){var i={};a[r]=t(e,{type:"content",content:i});var o=0;e.content.forEach(function(e){return i[n(e,c())]={index:o++}})}else a[r]=t(e,{type:"single"});return r}console.log(e);var r={uid:c()},a={uid:c()};a.main=n(e,c()),d.setDatabase(r,a)},get templates(){return $traceurRuntime.initGeneratorFunction(function e(){var t,n,r,a;return $traceurRuntime.createGeneratorInstance(function(e){for(;;)switch(e.state){case 0:e.pushTry(11,null),e.state=14;break;case 14:t=o.get,n=t.call(o,"/templates"),e.state=6;break;case 6:return e.state=2,n;case 2:r=e.sent,e.state=4;break;case 4:e.returnValue=r,e.state=-2;break;case 8:e.popTry(),e.state=-2;break;case 11:e.popTry(),e.maybeUncatchable(),a=e.storedException,e.state=9;break;case 9:e.returnValue=a,e.state=-2;break;default:return e.end()}},e,this)}).call(this)},get allMessages(){return $traceurRuntime.initGeneratorFunction(function e(){var t,n,r;return $traceurRuntime.createGeneratorInstance(function(e){for(;;)switch(e.state){case 0:t=o.get,n=t.call(o,"/messages"),e.state=6;break;case 6:return e.state=2,n;case 2:r=e.sent,e.state=4;break;case 4:e.returnValue=r,e.state=-2;break;default:return e.end()}},e,this)}).call(this)},get messages(){var e=d.allMessages;if(null!=e){var t={},n=f.language||"ru";return i.forOwn(e,function(e,r){return t[r]=e.hasOwnProperty(n)?e[n]:r}),t}},message:function(e){var t=d.messages&&d.messages[e];return null==t&&(t=e),t},notification:function(){},createDevice:function(e){var t=r.valueOf(d.getPlace(e));if(!t.device){var n=c();return co.go($traceurRuntime.initGeneratorFunction(function a(){var t,i;return $traceurRuntime.createGeneratorInstance(function(a){for(;;)switch(a.state){case 0:return a.state=2,d.devices.update((t={},Object.defineProperty(t,n,{value:{model:"Nero II 8421",state:0,comfort_1:.8,comfort_2:.2},configurable:!0,enumerable:!0,writable:!0}),t));case 2:a.maybeThrow(),a.state=4;break;case 4:return a.state=6,r.waitFor(function(){return d.getDevice(n)});case 6:a.maybeThrow(),a.state=8;break;case 8:return a.state=10,d.places.update((i={},Object.defineProperty(i,e,{value:{device:n},configurable:!0,enumerable:!0,writable:!0}),i));case 10:a.maybeThrow(),a.state=12;break;case 12:return a.state=14,r.waitFor(function(){return d.getPlace(e).device});case 14:a.maybeThrow(),a.state=-2;break;default:return a.end()}},a,this)}))}return r.promiseSucceeded},saveDevice:function(e,t){{var n;c()}return d.devices.update((n={},Object.defineProperty(n,e,{value:r.makeDiff(d.getDevice(e),t),configurable:!0,enumerable:!0,writable:!0}),n))},savePlace:function(e,t){{var n;c()}return d.places.update((n={},Object.defineProperty(n,e,{value:r.makeDiff(d.getPlace(e),t),configurable:!0,enumerable:!0,writable:!0}),n))},newIndex:function(e){return Object.keys(d.getPlace(e).content||[]).length+1},linkItem:function(e,t){var n,r;if(e==t)throw new Error("cannot link place to itself");return d.places.update((r={},Object.defineProperty(r,e,{value:{content:(n={},Object.defineProperty(n,t,{value:{index:d.newIndex(e)},configurable:!0,enumerable:!0,writable:!0}),n)},configurable:!0,enumerable:!0,writable:!0}),r))},linkToFavourites:function(e){return d.linkItem(d.main,e)},linkActiveToFavourites:function(){return d.linkToFavourites(d.activePlace)},addItem:function(e,t){var n,r,a=c();return d.places.update((r={},Object.defineProperty(r,e,{value:{content:(n={},Object.defineProperty(n,a,{value:{index:d.newIndex(e)},configurable:!0,enumerable:!0,writable:!0}),n)},configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(r,a,{value:t,configurable:!0,enumerable:!0,writable:!0}),r))},addPlace:function(e){return d.addItem(e,{type:"content",ru:"Помещение",en:"Room"})},addDevice:function(e){return d.addItem(e,{type:"single",ru:"Устройство",en:"Device"})},deleteItem:function(e,t){var n,r;return d.places.update((r={},Object.defineProperty(r,e,{value:{content:(n={},Object.defineProperty(n,t,{value:null,configurable:!0,enumerable:!0,writable:!0}),n)},configurable:!0,enumerable:!0,writable:!0}),r))},purgeItem:function(e){var t,n;return Promise.all([d.places.update(i.reduce(r.valueOf(d.places.data),function(t,n,r){var a;return n&&n.content&&n.content[e]&&(t[r]={content:(a={},Object.defineProperty(a,e,{value:null,configurable:!0,enumerable:!0,writable:!0}),a)}),t},(t={},Object.defineProperty(t,e,{value:null,configurable:!0,enumerable:!0,writable:!0}),t))),d.devices.update((n={},Object.defineProperty(n,d.getPlace(e).device,{value:null,configurable:!0,enumerable:!0,writable:!0}),n))])},renameItem:function(e,t){var n,r=i.reduce(d.getPlace(e),function(e,t,n){return 2==n.length&&(e[n]=null),e},{});return r[l.language||"ru"]=t,d.places.update((n={},Object.defineProperty(n,e,{value:r,configurable:!0,enumerable:!0,writable:!0}),n))},command:function(e,t){s.getNewState(d.getDevice(e),t);return d.commands.ask({device:e,command:t})},iconCommand:function(e,t,n){return console.log(e,t,n),e=r.valueOf(e),("content"==e.type?"Short"==n:"Long"==n)?d.go(t):(("Short"==n||"Long"==n)&&(n="Comfort_1"),e.device?d.command(e.device,n):Promise.reject(new Error("device not configured")))},get imgProps(){return{onerror:function(){this.classList.add("error")},onload:function(){this.classList.remove("error")}}}}).setName("app");return{app:d,local:f}}})}();
//# sourceMappingURL=out.js.map
