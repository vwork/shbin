...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
"use strict";function _defineProperty(e,t,n){return Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0})}function toNode(e,t){e:for(;;){if(e=e&&"function"==typeof e.valueOf?e.valueOf():e,Array.isArray(e)){if(0==e.length)return null;if(1==e.length){e=e[0];continue e}t||(t=document.createDocumentFragment()),e.forEach(function(e){return toNode(e,t)}),e=t}else"string"==typeof e&&(e=document.createTextNode(e)),t&&(t.appendChild(e),e=t);return e}}function fcalc(e,t){"function"!=typeof e?t(e):!function(){var n=!0;ra(!1,regeneratorRuntime.mark(function r(){var a;return regeneratorRuntime.wrap(function(r){for(;;)switch(r.prev=r.next){case 0:if(!n){r.next=4;break}n=!1,r.next=6;break;case 4:return r.next=6,co.requestAnimationFrame;case 6:if(a=e(),!(a&&a.next&&a["throw"])){r.next=11;break}return r.next=10,a;case 10:a=r.sent;case 11:t(a);case 12:case"end":return r.stop()}},r,this)}))}()}function fcalcX(e,t){"function"!=typeof e?t(e):!function(){var n=!0;ra(!0,regeneratorRuntime.mark(function r(){var a;return regeneratorRuntime.wrap(function(r){for(;;)switch(r.prev=r.next){case 0:if(!n){r.next=4;break}n=!1,r.next=6;break;case 4:return r.next=6,co.requestAnimationFrame;case 6:if(a=e(),!(a&&a.next&&a["throw"])){r.next=11;break}return r.next=10,a;case 10:a=r.sent;case 11:t(a);case 12:case"end":return r.stop()}},r,this)}))}()}function getControl(e){var t=e,n=-(1/0);if(e instanceof DocumentFragment)for(var r=0,a=e.childNodes.length;a>r;++r){var o=e.childNodes.item(r),i=void 0;if(i=o instanceof HTMLScriptElement?0:o instanceof HTMLTemplateElement?0:o instanceof Text?o.data?o.data.trim()?1/0:20:10:"NOSCRIPT"==o.tagName?0:1/0,i==1/0)return o;i>n&&(n=i,t=o)}return t}function ShortSwipeRecognizer(){Hammer.AttrRecognizer.apply(this,arguments)}function directionStr(e){return e==Hammer.DIRECTION_DOWN?"down":e==Hammer.DIRECTION_UP?"up":e==Hammer.DIRECTION_LEFT?"left":e==Hammer.DIRECTION_RIGHT?"right":""}function onMoveEvent(e,t,n,r){var a=getHammer(n);e=e.toLowerCase();var o=n["DIRECTION_"+e]|=Hammer["DIRECTION_"+t.toUpperCase()];a.get(""+e).set({direction:o}),a.on(""+e+t.toLowerCase(),r)}function onMouseEvent(e,t,n){(t=getControl(t))&&t.addEventListener("mouse"+e.toLowerCase(),n)}function onTouchEvent(e,t,n){(t=getControl(t))&&t.addEventListener("touch"+e.toLowerCase(),n)}function checkDOMControl(e){for(var t=[e.ownerDocument&&e.ownerDocument.documentElement,document.documentElement,e.ownerDocument&&e.ownerDocument.body,document.body].filter(Boolean),n=e;n;){if(t.indexOf(n)>=0)return void ra.forceCalculations();n=n.parentNode}}function toAttrString(e){return Array.isArray(e)?e.map(toAttrString).join(" "):""+e}function appendContent(e,t){t||(t=document.createDocumentFragment());var n=!0,r=!1,a=void 0;try{for(var o,i=e[Symbol.iterator]();!(n=(o=i.next()).done);n=!0){var c=o.value;if("function"==typeof c){var s=document.createElement("span");CS.content(s,c),t.appendChild(s)}else if(c instanceof Node)t.appendChild(c);else if(null!=c&&"string"!=typeof c&&c[Symbol.iterator]){var u=!0,l=!1,d=void 0;try{for(var m,f=c[Symbol.iterator]();!(u=(m=f.next()).done);u=!0){var p=m.value;appendContent(p,t)}}catch(v){l=!0,d=v}finally{try{!u&&f["return"]&&f["return"]()}finally{if(l)throw d}}}else t.appendChild(document.createTextNode(c))}}catch(v){r=!0,a=v}finally{try{!n&&i["return"]&&i["return"]()}finally{if(r)throw a}}return t}var co=require("co"),ra=require("ra"),lodash=require("lodash"),Hammer=require("hammerjs");Hammer.inherit(ShortSwipeRecognizer,Hammer.AttrRecognizer,{defaults:{event:"shortswipe",threshold:10,velocity:.1,direction:Hammer.DIRECTION_HORIZONTAL|Hammer.DIRECTION_VERTICAL,pointers:1,maxtime:300},getTouchAction:function(){return Hammer.Pan.prototype.getTouchAction.call(this)},attrTest:function(e){var t=this.options.direction,n=void 0;return t&(Hammer.DIRECTION_HORIZONTAL|Hammer.DIRECTION_VERTICAL)?n=e.maxVelocity:t&Hammer.DIRECTION_HORIZONTAL?n=e.maxVelocityX:t&Hammer.DIRECTION_VERTICAL&&(n=e.maxVelocityY),this._super.attrTest.call(this,e)&&e.deltaTime<=this.options.maxtime&&t&e.direction&&e.distance>this.options.threshold&&Math.abs(n)>this.options.velocity&&e.eventType&Hammer.INPUT_END},emit:function(e){var t=directionStr(e.direction);t&&this.manager.emit(this.options.event+t,e),this.manager.emit(this.options.event,e)}}),Hammer.defaults.preset=[[ShortSwipeRecognizer,{direction:Hammer.DIRECTION_HORIZONTAL}],[Hammer.Pan,{direction:Hammer.DIRECTION_HORIZONTAL},["shortswipe"]],[Hammer.Tap],[Hammer.Tap,{event:"doubletap",taps:2},["tap"]],[Hammer.Press]];for(var updateInput=function(e,t){var n=e.session;if(t.maxVelocity=n.maxVelocity=Math.max(Math.abs(n.maxVelocity||0),Math.abs(t.velocity)),t.maxVelocityX=n.maxVelocityX=Math.max(Math.abs(n.maxVelocityX||0),Math.abs(t.velocityX)),t.maxVelocityY=n.maxVelocityY=Math.max(Math.abs(n.maxVelocityY||0),Math.abs(t.velocityY)),n.inputCount=(n.inputCount||0)+1,!n.directions){var r;n.directions=(r={},_defineProperty(r,Hammer.DIRECTION_LEFT,0),_defineProperty(r,Hammer.DIRECTION_RIGHT,0),_defineProperty(r,Hammer.DIRECTION_HORIZONTAL,0),_defineProperty(r,Hammer.DIRECTION_UP,0),_defineProperty(r,Hammer.DIRECTION_DOWN,0),_defineProperty(r,Hammer.DIRECTION_VERTICAL,0),r),n.directionsCount=0}if(t.directions={},t.direction){++n.directionsCount;for(var a in n.directions)Object.prototype.hasOwnProperty.call(n.directions,a)&&a&t.direction&&++n.directions[a]}for(var a in n.directions)Object.prototype.hasOwnProperty.call(n.directions,a)&&(t.directions[a]=n.directions[a]/n.directionsCount)},getHammer=function(e){var t=e._hammer;return null==t&&(t=e._hammer=Hammer(e),t.on("hammer.input",function(e){return updateInput(t,e)})),t},onSwipeEvent=onMoveEvent.bind(null,"shortswipe"),onPanEvent=onMoveEvent.bind(null,"pan"),CS=module.exports={onClick:function(e,t){(e=getControl(e))&&e.addEventListener("click",t)},onTouch:function(e,t){(e=getControl(e))&&(e.addEventListener("touchstart",t),e.addEventListener("mousedown",t))},onTap:function(e,t){getHammer(e).on("tap",t)},onPress:function(e,t){getHammer(e).on("press",t)},onSwipeUp:onSwipeEvent.bind(null,"Up"),onSwipeDown:onSwipeEvent.bind(null,"Down"),onSwipeLeft:onSwipeEvent.bind(null,"Left"),onSwipeRight:onSwipeEvent.bind(null,"Right"),onPanUp:onPanEvent.bind(null,"Up"),onPanDown:onPanEvent.bind(null,"Down"),onPanLeft:onPanEvent.bind(null,"Left"),onPanRight:onPanEvent.bind(null,"Right"),onMouseDown:onMouseEvent.bind(null,"Down"),onMouseUp:onMouseEvent.bind(null,"Up"),onMouseMove:onMouseEvent.bind(null,"Move"),onTouchStart:onTouchEvent.bind(null,"Start"),onTouchMove:onTouchEvent.bind(null,"Move"),onTouchEnd:onTouchEvent.bind(null,"End"),onTouchCancel:onTouchEvent.bind(null,"Cancel"),content:function(e,t){var n=void 0===arguments[2]?null:arguments[2];fcalc(t,function(t){checkDOMControl(e);var r=toNode(t);r?(checkDOMControl(e),e.innerHTML="",e.appendChild(r)):e.innerHTML="",n&&n()})},appendChild:function(e,t){checkDOMControl(e);var n=toNode(t);n&&(checkDOMControl(e),e.appendChild(n))},contentX:function(e,t){var n=void 0===arguments[2]?null:arguments[2];fcalcX(t,function(t){checkDOMControl(e);var r=toNode(t);r?(checkDOMControl(e),e.innerHTML="",e.appendChild(r)):e.innerHTML="",n&&n()})},display:function(e,t){fcalc(t,function(t){e.style.display=t?"default":"none"})},displayX:function(e,t){fcalcX(t,function(t){e.style.display=t?"default":"none"})},"class":function(e,t,n){fcalc(n,function(n){n?Array.isArray(t)?(e.classList.add(t[0]),e.classList.remove(t[1])):e.classList.add(t):Array.isArray(t)?(e.classList.remove(t[0]),e.classList.add(t[1])):e.classList.remove(t)})},classX:function(e,t,n){fcalcX(n,function(n){n?Array.isArray(t)?(e.classList.add(t[0]),e.classList.remove(t[1])):e.classList.add(t):Array.isArray(t)?(e.classList.remove(t[0]),e.classList.add(t[1])):e.classList.remove(t)})},updateClass:function(e,t){var n="";fcalc(t,function(t){t!=n&&(n&&e.classList.remove(n),t&&e.classList.add(t),n=t)})},updateClassX:function(e,t){var n="";fcalcX(t,function(t){t!=n&&(n&&e.classList.remove(n),t&&e.classList.add(t),n=t)})},watch:function(e){var t=!0;ra(!1,regeneratorRuntime.mark(function n(){var r;return regeneratorRuntime.wrap(function(n){for(;;)switch(n.prev=n.next){case 0:if(!t){n.next=4;break}t=!1,n.next=6;break;case 4:return n.next=6,co.requestAnimationFrame;case 6:if(r=e(),!(r&&r.next&&r["throw"])){n.next=10;break}return n.next=10,r;case 10:case"end":return n.stop()}},n,this)}))},watchX:function(e){var t=!0;ra(!0,regeneratorRuntime.mark(function n(){var r;return regeneratorRuntime.wrap(function(n){for(;;)switch(n.prev=n.next){case 0:if(!t){n.next=4;break}t=!1,n.next=6;break;case 4:return n.next=6,co.requestAnimationFrame;case 6:if(r=e(),!(r&&r.next&&r["throw"])){n.next=10;break}return n.next=10,r;case 10:case"end":return n.stop()}},n,this)}))},jsx:{createElement:function(e,t){for(var n=arguments.length,r=Array(n>2?n-2:0),a=2;n>a;a++)r[a-2]=arguments[a];if("function"==typeof e)return e(t||0,appendContent(r));var o=void 0,i=document.createElement(e);switch(lodash.forEach(t,function(e,t){if("class"==t)fcalc(e,function(e){return i.className=toAttrString(e)});else if("style"==t)fcalc(e,function(e){"string"==typeof e?i.setAttribute("style",e):lodash.forEach(e,function(e,t){return fcalc(e,function(e){return i.style[t]=e})})});else if("oncreate"==t)o=e;else if(t.match(/^on/)){var n=Object.keys(CS),r=n.map(function(e){return e.toLowerCase()}).indexOf(t);r>=0?CS[n[r]](i,e):i.addEventListener(t.slice("on".length),e)}else fcalc(e,function(e){return i.setAttribute(t,toAttrString(e))})}),r.length){case 0:break;case 1:CS.content(i,r[0]);break;default:i.appendChild(appendContent(r))}return"function"==typeof o&&o.call(i),i}}},updateInputValue=function(){var e=this;setTimeout(function(){return e._raValue.assign(e.value)})},raValue={get:function(){var e=this;return this._raValue||ra.detach(function(){e._raValue=ra(),e._raValue.assign(e.value),e.addEventListener("change",updateInputValue),e.addEventListener("keypress",updateInputValue),e.addEventListener("keydown",updateInputValue),e.addEventListener("keyup",updateInputValue)}),this._raValue.valueOf()},set:function(e){this.value!=e&&(this.value=e,this._raValue&&this._raValue.assign(this.value))}},_arr=[HTMLInputElement,HTMLTextAreaElement],_i=0;_i<_arr.length;_i++){var C=_arr[_i];Object.defineProperty(C.prototype,"raValue",raValue)}
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
"use strict";module.exports=function(e){var t=e.appid,a=e.IconTemplates,n=require("app")(t),i=n.app,r=n.local;i.pageStarting=!0,window._app=i,window._local=r;require("httpClient");navigator.standalone||ra(function(){if(r.activeDeviceId&&r.activeDeviceId.valueOf()){var e="TITLE_"+r.activeDeviceId,t="ICON_"+r.activeDeviceId;screenTitle.setAttribute("content",e),r.activeDeviceId&&"main"!=r.activeDeviceId?history.replaceState(null,e,"?appicon="+t):history.replaceState(null,e,"?")}});var l=React.createElement("div",{"class":"application"}),c=l.className.split(/\s+/);CS.watch(function(){return l.className=c.concat([i.pageStarting?"pageStarting":"pageRunning",i.initialLoading?"JSONloading":"JSONloaded",i.initialized?"alreadyRun":"firstRun",i.connectedToServer?"appConnected":"appDisconnected",i.templates?"templatesLoaded":"templatesLoading",i.dialog?"dialog"+i.dialog:"",i.dialog?"dialogIsPresent":"dialogIsAbsent","app_labels_"+!!r.labels,"app_editing_"+!!i.editing]).join(" ")}),i.icons=a.reduce(function(e,t){return e[t.dataset.name]=t,e},Object.create(null));var o=i.load(require("ui/MainScreen")),u=i.load(require("ui/StartupScreen")),d=function(){return React.createElement("div",{"class":"loadingScreen"})};CS.content(l,[React.createElement(o,null),React.createElement(u,null),React.createElement(d,null)]);var s=i.load(require("ui/Button")),v={ServiceDialog:function(){return i.load(require("ui/ServiceDialog"))},ContextMenu:function(){return i.load(require("ui/ContextMenu"))},AddMenu:function(){return i.load(require("ui/AddMenu"))},SearchItems:function(){return i.load(require("ui/SearchItems"))},AskNewName:function(){return i.load(require("ui/AskNewName"))},AskToLinkDevice:function(){return i.load(require("ui/AskToLinkDevice"))},AskIfDeviceHasBeenLinked:function(){return React.createElement("div",null,React.createElement("p",null,"Устройство было успешно привязано?"),React.createElement(s,{onclick:"StopDeviceNotification"},"да"),React.createElement(s,{onclick:"AskToLinkDevice"},"нет"))},StopDeviceNotification:function(){return React.createElement("div",null,React.createElement("p",null,"Пожалуйста,",React.createElement("br",null),"переведите устройство в рабочий режим"),React.createElement(s,null,"закрыть"))},ErrorNoCarrier:function(){return React.createElement("div",{"class":"errorDialog"},React.createElement("p",null,"Ошибка"),React.createElement("p",null,"Произошла ошибка при попытке связаться с модемом"),React.createElement(s,null,"закрыть"))},StateWait:function(){return React.createElement("div",null,React.createElement("p",null,"Подождите..."))},AskToReset:function(){return React.createElement("div",null,React.createElement("p",null,"Память контроллера будет очищена,",React.createElement("br",null),"но память устройств очищаться не будет."),React.createElement(s,{onclick:i.reset},"Очистить",React.createElement("br",null),"память"))}};return ra(function(){var e=i.dialog;if(e){if(!Object.prototype.hasOwnProperty.call(v,e))return alert('Error: Could not find dialog named\n"'+e+'"'),void ra.detach(function(){return i.dialog=""});var t=v[e];if(t){v[e]=null;var a=t();a.classList.add(e),a.classList.add("modalDialog"),ra(Object.defineProperties({},{isActive:{get:function(){return e==i.dialog},configurable:!0,enumerable:!0},updateClass:{get:function(){var e=void 0;if(this.isActive){e="dialogshow",a.classList.add("dialogShown"),a.classList.remove("dialogHidden");var t=a.querySelector("*[ autofocus ]");t&&i.focus(t)}else{e="dialoghide",a.classList.remove("dialogShown"),a.classList.add("dialogHidden");var n=!0,r=!1,l=void 0;try{for(var c,o=a.querySelectorAll("*:focus")[Symbol.iterator]();!(n=(c=o.next()).done);n=!0){var u=c.value;u.blur()}}catch(d){r=!0,l=d}finally{try{!n&&o["return"]&&o["return"]()}finally{if(r)throw l}}a.blur()}a.dispatchEvent(new CustomEvent(e,{detail:null}))},configurable:!0,enumerable:!0}})),l.appendChild(a)}}}),setTimeout(function(){return i.pageStarting=!1},1),l};
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
"use strict";function _defineProperty(e,n,i){return Object.defineProperty(e,n,{value:i,enumerable:!0,configurable:!0,writable:!0})}var lodash=require("lodash"),htmlutils=require("htmlutils");module.exports=function(e,n){return function(i){function t(e){LOG(""+(t.c=t.c||0,++t.c)+" "+e.yellow)}function a(){O.isDimmering=!1,O.isMoving&&O.changes&&setTimeout(co.func(regeneratorRuntime.mark(function e(){var n,i;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:if(n=O.changes,O.changes=null,O.isMoving=!1,n){e.next=5;break}return e.abrupt("return");case 5:if(e.prev=5,i=lu.get(n,"before",g,"content",m,"index"),i!=O.newIndex){e.next=9;break}return e.abrupt("return");case 9:return e.next=11,n.save();case 11:return e.prev=11,n.close(),e.finish(11);case 14:case"end":return e.stop()}},e,this,[[5,,11,14]])})))}function r(){for(var e=h.parentNode,n=void 0;n=e.getBoundingClientRect(),!n.width||!n.height;)e=e.parentNode;return n}function o(e){var n=r();return{x:(e.x-n.left)/n.width*100,y:(e.y-n.top)/n.height*100}}function s(e){var n=e.changedPointers[Object.keys(e.changedPointers)[0]];return o({x:n.screenX,y:n.screenY})}function c(e){var n=e.getBoundingClientRect();return o({x:n.left,y:n.top})}function u(n){var i=O.isDimmering;if(O.isDimmering=O.dimmering&&!n.isFinal,O.dimmering&&(i||O.isDimmering)){if(!O.dimmChanges){O.dimmChanges=e.localDevices.createRecord();var t=d&&d.get("state");O.dimmChanges.assign({initialDimmeringState:t})}var a=-n.deltaY/(2*h.getBoundingClientRect().height/3),r=Math.min(1,Math.max(0,O.dimmChanges.get("initialDimmeringState")+a));(0==r||1==r)&&O.dimmChanges.assign({initialDimmeringState:r-a}),O.dimmChanges.update(_defineProperty({},m,{state:r}))}}function l(n){if(O.isMoving){var i=s(n),t={x:i.x+O.dx,y:i.y+O.dy};O.x=t.x,O.y=t.y,t={x:Math.min(e.pageWidth-1,Math.max(0,Math.round(t.x/(100/e.pageWidth)))),y:Math.min(e.pageHeight-1,Math.max(0,Math.round(t.y/(100/e.pageHeight))))},O.newIndex=t.x+t.y*e.pageWidth,O.moved=!0}}var g=i.placeId,m=i.iconId,d=i.iconDescr,f=i.index,h=void 0,p=void 0,v=void 0,y=void 0,C=void 0,b=void 0,S=void 0,x=void 0,D=void 0,w=void 0,M=h=React.createElement("div",{"class":"icon"},p=React.createElement("div",{"class":"iconControl"},v=React.createElement("div",{"class":"image"},y=React.createElement("img",{"class":"error wait",src:"/images/wait.svg",style:"visibility: hidden;"}),C=React.createElement("img",{"class":"error off",src:"/images/room.svg"}),b=React.createElement("img",{"class":"error on",src:"/images/room_on.svg"}),S=React.createElement("img",{"class":"error absent",src:"/images/room_absent.svg"}),x=React.createElement("div",{"class":"svg"})),D=React.createElement("span",{"class":"iconLabel"}),React.createElement("span",{"class":"iconPercentage"},function(){return O.present&&O.dimmering&&""+Math.round(100*d.get("state"))+"%"})),w=React.createElement("div",{"class":"deleteSign"})),O=ra(Object.defineProperties({iconData:null,iconCommand:function(n,i){return co.gocall(regeneratorRuntime.mark(function t(){var a;return regeneratorRuntime.wrap(function(t){for(;;)switch(t.prev=t.next){case 0:return a=this.dimmChanges,a&&(this.dimmChanges=null),this.isDimmering=!1,t.prev=3,t.next=6,e.iconCommand(d,m,n,i);case 6:return t.prev=6,a&&a.close(),t.finish(6);case 9:case"end":return t.stop()}},t,this,[[3,,6,9]])}),this)},isDimmering:!1,dimmChanges:null,readyToSaveDimmering:function(){return!this.isDimmering&&!!this.dimmChanges},saveDimmering:function(){this.readyToSaveDimmering()&&d&&O.iconCommand("Set",d.get("state"))},isMoving:!1,moved:!1,newIndex:null,x:null,y:null,dx:null,dy:null,changes:null,oldMoving:!1,oldDimmering:!1,state:0,onning:!1,offing:!1,"final":!1,errorneous:!1,setOpacity:function(e,n){null==n?delete e.style.opacity:e.style.opacity=n}},{iconName:{get:function(){return d&&d.valueOf()&&d.valueOf().icon||null},configurable:!0,enumerable:!0},iconTemplate:{get:function(){return this.iconName&&e.icons&&Object.prototype.hasOwnProperty.call(e.icons,this.iconName)&&e.icons[this.iconName]||null},configurable:!0,enumerable:!0},dimmering:{get:function(){var e=null==d?null:d.valueOf(),n=null==e?null:null==e.dimmering?null:!!e.dimmering;return null!=n?n:null!=e&&"place"===e.type?!1:!0},configurable:!0,enumerable:!0},image_on:{get:function(){var e=d&&d.valueOf(),n=""||e&&e.image_on||e&&e.image;return n&&"/images/"+n},configurable:!0,enumerable:!0},update_image_on:{get:function(){O.image_on&&(b.src=O.image_on)},configurable:!0,enumerable:!0},image_off:{get:function(){var e=d&&d.valueOf(),n=""||e&&e.image_off||e&&e.image;return n&&"/images/"+n},configurable:!0,enumerable:!0},update_image_off:{get:function(){O.image_off&&(C.src=O.image_off)},configurable:!0,enumerable:!0},onDimmering:{get:function(){this.readyToSaveDimmering()&&setTimeout(this.saveDimmering)},configurable:!0,enumerable:!0},checkAppMoving:{get:function(){var n=!!this.isMoving,i=!!this.oldMoving;this.oldMoving=n,n!=i&&(n?++e.moving:--e.moving)},configurable:!0,enumerable:!0},checkAppDimmering:{get:function(){var n=!!this.isDimmering,i=!!this.oldDimmering;this.oldDimmering=n,n!=i&&(n?++e.dimmering:--e.dimmering)},configurable:!0,enumerable:!0},updateChanges:{get:function(){var n=this;e.editing&&this.isMoving&&this.changes?!function(){var e=null,i=lu.get(n,"changes","before",g,"content");if(i&&i[m]){var t=lodash.keys(i).filter(function(e){return e!=m}).sort(function(e,n){return i[e].index-i[n].index}).map(function(e){return i[e].index});e=_defineProperty({},g,{content:_defineProperty({},m,{index:0==t.length?0:n.newIndex<=0?t[0]-1:n.newIndex>=t.length?t[t.length-1]+1:(t[n.newIndex-1]+t[n.newIndex])/2})})}n.changes.assign(e)}():(this.changes&&(this.changes.close(),this.changes=null),this.moved=!1)},configurable:!0,enumerable:!0},present:{get:function(){return!(!d.get("content")&&!d.get("group"))},configurable:!0,enumerable:!0},updateState:{get:function(){var e=d&&d.valueOf();if(!e)return 0;if(e.newstate_timestamp&&(!e.state_timestamp||e.newstate_timestamp>e.state_timestamp)){var n=e.newstate>=e.state;this.onning=n,this.offing=!n,this["final"]=!1,this.state=e.newstate}else this.onning=!1,this.offing=!1,this["final"]=!0,this.state=e.state;this.errorneous=!!e.errorneous},configurable:!0,enumerable:!0},updateWait:{get:function(){y.style.visibility=this["final"]?"hidden":null},configurable:!0,enumerable:!0},updateOpacity:{get:function(){this.iconTemplate?(b.style.visibility="hidden",C.style.visibility="hidden",S.style.visibility="hidden"):this.present?(this.setOpacity(S,0),this.dimmering?(this.setOpacity(b,this.state),this.setOpacity(C,.333*(1-this.state))):(this.setOpacity(b,+!!this.state),this.setOpacity(C,+!this.state))):(this.setOpacity(b,0),this.setOpacity(C,0),this.setOpacity(S,.7))},configurable:!0,enumerable:!0}}));CS.content(x,function(){return O.iconData=O.iconTemplate&&htmlutils.importComponent(O.iconTemplate)||null}),ra(function(){var e=O.state,n=O.iconData;n&&n.setDeviceState&&n.setDeviceState(e)}),CS.updateClassX(x,function(){return"state"+(O.present?(Math.round(100*O.state)+1e3).toString().slice(1):"Absent")}),CS.updateClassX(x,function(){return!O.isDimmering&&"smoothing"}),![].slice.call(h.getElementsByTagName("img")).forEach(function(n){return lodash.assign(n,e.imgProps)}),CS.updateClassX(h,function(){return O.onning&&"onning"}),CS.updateClassX(h,function(){return O.offing&&"offing"}),CS.updateClassX(h,function(){return O["final"]&&"final"}),CS.updateClassX(h,function(){return O.errorneous&&"errorneous"}),CS.updateClassX(h,function(){return O.dimmering.valueOf()?"dimmering":"switching"}),CS.updateClassX(h,m),CS.updateClassX(h,function(){return"icon_moving_"+!!O.isMoving}),CS.updateClassX(h,function(){return"icon_moved_"+(!!O.isMoving&&!!O.moved)}),CS.watchX(function(){var n=void 0;if(O.isMoving)n={x:O.x,y:O.y};else{var i=lu.valueOf(f),t=e.pageHeight||1,a=e.pageWidth||1,r=a*t,o=i%r,s=(i-o)/r,c=o%a,u=(o-c)/a;c+=a*s,n={x:100*c/a,y:100*u/t}}var l=function(){h.style.left=""+n.x+"%",h.style.top=""+n.y+"%"};e.editing?setTimeout(l):l()}),CS.contentX(D,function(){return d.get(n.language)||d.get("ru")||d.get("en")});var _=function(){return e.deleteItem(g,m)};return CS.onTouchStart(w,_),CS.onTap(w,_),CS.onPress(w,_),CS.onTouchStart(p,function(){t("\nTouchStart")}),CS.onTouchEnd(p,function(){t("TouchEnd"),a()}),CS.onTouchCancel(p,function(){t("TouchCancel"),a()}),CS.onMouseUp(p,function(){t("MouseUp"),a()}),CS.onTap(p,function(){t("Tap"),!e.editing&&O.iconCommand("Short")}),CS.onPress(p,function(n){if(t("Press"),e.editing){var i=s(n),a=c(h);O.isMoving=!0,O.moved=!1,O.dx=a.x-i.x,O.dy=a.y-i.y,O.x=a.x,O.y=a.y,O.newIndex=f.valueOf(),O.changes=e.localDevices.createRecord()}else O.iconCommand("Long")}),CS.onSwipeUp(p,function(){t("SwipeUp"),!e.editing&&O.iconCommand("Up")}),CS.onSwipeDown(p,function(){t("SwipeDown"),!e.editing&&O.iconCommand("Down")}),CS.onPanUp(p,function(n){t("PanUp "+JSON.stringify(n.isFinal)),e.editing?l(n):u(n)}),CS.onPanDown(p,function(n){t("PanDown "+JSON.stringify(n.isFinal)),e.editing?l(n):u(n)}),CS.onPanLeft(p,function(n){!e.dimmering&&(O.isMoving?l(n):e.pan(n))}),CS.onPanRight(p,function(n){!e.dimmering&&(O.isMoving?l(n):e.pan(n))}),CS.onTouchEnd(p,function(n){e.pan({deltaX:0,isFinal:!0})}),CS.onTouchCancel(p,function(n){e.pan({deltaX:0,isFinal:!0})}),M}};
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
"use strict";var htmlutils=require("htmlutils"),UID=require("uid");module.exports=function(e,t){var n=e.load(require("ui/Place"));return function(){var a=UID();return React.createElement("div",null,React.createElement("style",{"class":"style"},function(){return"\n				."+a+" .icon {\n					width: "+100/e.pageWidth+"%;\n					height: "+100/e.pageHeight+"%;\n				}\n			"}),React.createElement("div",{"class":"top"},React.createElement("span",{"class":"top_self"},React.createElement(htmlutils.Centered,null,function(){return e.caption}))),React.createElement("div",{"class":function(){return"menu "+a+" "+e.activeDeviceId},onpanleft:function(t){return!e.moving&&!e.dimmering&&e.pan(t)},onpanright:function(t){return!e.moving&&!e.dimmering&&e.pan(t)},ontouchend:function(){return e.pan({deltaX:0,isFinal:!0})},ontouchcancel:function(){return e.pan({deltaX:0,isFinal:!0})},oncreate:function(){e.menuElement=this}},React.createElement("span",{oncreate:function(){var a=this,c=Object.create(null);ra(function(){var i=e.activeDeviceId;i&&!c[i]&&(e.placesShifts.defineProperty(i),t.placesPages.defineProperty(i),c[i]=!0,a.appendChild(React.createElement(n,{placeId:i,placeDescr:ra(function(){return e.getDevice(i)})})))})}})),React.createElement("div",{"class":"bottom"},React.createElement("div",{"class":"help",onpress:function(){return e.dialog="ServiceDialog"}}),React.createElement("div",{"class":"logo",onpress:function(){return e.dialog="ContextMenu"},ontap:function(){e.editing=!1,e.dialog="",e.go(e.main)}}),React.createElement("div",{"class":"back",ontouch:function(){e.editing?e.editing=!1:e.dialog?e.dialog="":e.back()}})))}};
