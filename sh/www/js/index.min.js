...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
"use strict";module.exports=function(e){var t=e.appid,n=e.IconTemplates,a=require("app")(t),r=a.app,l=a.local;r.pageStarting=!0,window._app=r,window._local=l,window._devdb=require("devdb");require("httpClient");navigator.standalone||ra(function(){if(l.activeDeviceId&&l.activeDeviceId.valueOf()){var e="TITLE_"+l.activeDeviceId,t="ICON_"+l.activeDeviceId;screenTitle.setAttribute("content",e),l.activeDeviceId&&"main"!=l.activeDeviceId?history.replaceState(null,e,"?appicon="+t):history.replaceState(null,e,"?")}});var i=r.load(require("ui/MainScreen")),c=r.load(require("ui/StartupScreen")),o=function(){return React.createElement("div",{"class":"loadingScreen"})},u=React.createElement("div",{"class":function(){return"\n		application\n		"+(r.pageStarting?"pageStarting":"pageRunning")+"\n		"+(r.initialLoading?"JSONloading":"JSONloaded")+"\n		"+(r.initialized?"alreadyRun":"firstRun")+"\n		"+(r.connectedToServer?"appConnected":"appDisconnected")+"\n		\n		"+(r.templates?"templatesLoaded":"templatesLoading")+"\n		"+(r.dialog&&"dialog"+r.dialog)+"\n		"+(r.dialog?"dialogIsPresent":"dialogIsAbsent")+"\n		app_labels_"+!!l.labels+"\n		app_editing_"+!!r.editing+"\n	"}},React.createElement(i,null),React.createElement(c,null),React.createElement(o,null));r.icons=n.reduce(function(e,t){return e[t.dataset.name]=t,e},Object.create(null));var d=r.load(require("ui/Button")),s=function(e,t){var n=e.onclick;return React.createElement("p",{onclick:function(){var e=r.error;r.dialog="",r.error=null,n&&n(e)}},t)},v={ServiceDialog:function(){return r.load(require("ui/ServiceDialog"))},ContextMenu:function(){return r.load(require("ui/ContextMenu"))},AddMenu:function(){return r.load(require("ui/AddMenu"))},SearchItems:function(){return r.load(require("ui/SearchItems"))},AskNewName:function(){return r.load(require("ui/AskNewName"))},AskToLinkDevice:function(){return r.load(require("ui/AskToLinkDevice"))},AskIfDeviceHasBeenLinked:function(){return React.createElement("div",null,React.createElement("p",null,"Устройство было успешно привязано?"),React.createElement(d,{onclick:"StopDeviceNotification"},"да"),React.createElement(d,{onclick:"AskToLinkDevice"},"нет"))},StopDeviceNotification:function(){return React.createElement("div",null,React.createElement("p",null,"Пожалуйста,",React.createElement("br",null),"переведите устройство в рабочий режим."),React.createElement(d,null,"Закрыть"))},ErrorNoCarrier:function(){return React.createElement("div",{"class":"errorDialog"},React.createElement("p",null,"Ошибка"),React.createElement("p",null,"Произошла ошибка при попытке связаться с модемом."),React.createElement(d,null,"Закрыть"))},ErrorUnlinkingDevice:function(){return React.createElement("div",{"class":"errorDialog"},React.createElement("p",null,"Ошибка"),React.createElement("p",null,"Не удалось связаться с устройством и отвязать его."),React.createElement("p",null,"Что следует сделать?"),React.createElement("ul",null,React.createElement(s,{onclick:function(e){return r.purgeItem(e.data.deviceId)}},React.createElement("li",null,"Попытаться отвязать устройство ещё раз")),React.createElement(s,null,React.createElement("li",null,"Отменить удаление")),React.createElement(s,{onclick:function(e){return r.purgeItem(e.data.deviceId,!0)}},React.createElement("li",null,"Забыть информацию об устройстве"))))},StateWait:function(){return React.createElement("div",null,React.createElement("p",null,"Подождите..."))},AskToReset:function(){return React.createElement("div",null,React.createElement("p",null,"Память контроллера будет очищена,",React.createElement("br",null),"но память устройств очищаться не будет."),React.createElement(d,{onclick:r.reset},"Очистить",React.createElement("br",null),"память"))}};return ra(function(){var e=r.dialog;if(e){if(!Object.prototype.hasOwnProperty.call(v,e))return alert('Error: Could not find dialog named\n"'+e+'"'),void ra.detach(function(){return r.dialog=""});var t=v[e];if(t){v[e]=null;var n=t();n.classList.add(e),n.classList.add("modalDialog"),ra(Object.defineProperties({},{isActive:{get:function(){return e==r.dialog},configurable:!0,enumerable:!0},updateClass:{get:function(){var e=void 0;if(this.isActive){e="dialogshow",n.classList.add("dialogShown"),n.classList.remove("dialogHidden");var t=n.querySelector("*[ autofocus ]");t&&r.focus(t)}else{e="dialoghide",n.classList.remove("dialogShown"),n.classList.add("dialogHidden");var a=!0,l=!1,i=void 0;try{for(var c,o=n.querySelectorAll("*:focus")[Symbol.iterator]();!(a=(c=o.next()).done);a=!0){var u=c.value;u.blur()}}catch(d){l=!0,i=d}finally{try{!a&&o["return"]&&o["return"]()}finally{if(l)throw i}}n.blur()}n.dispatchEvent(new CustomEvent(e,{detail:null}))},configurable:!0,enumerable:!0}})),u.appendChild(n)}}}),setTimeout(function(){return r.pageStarting=!1},1),u};
