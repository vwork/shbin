...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
"use strict";function findFrozen(e,t){return find(e.array,function(e){return e[0]===t})}function leakStore(e){return e[LEAK]||hide(e,LEAK,{array:[],get:function(e){var t=findFrozen(this,e);return t?t[1]:void 0},has:function(e){return!!findFrozen(this,e)},set:function(e,t){var r=findFrozen(this,e);r?r[1]=t:this.array.push([e,t])},"delete":function(e){var t=findIndex(this.array,function(t){return t[0]===e});return~t&&this.array.splice(t,1),!!~t}})[LEAK]}var $=require("./$"),safe=require("./$.uid").safe,assert=require("./$.assert"),forOf=require("./$.for-of"),$has=$.has,isObject=$.isObject,hide=$.hide,isExtensible=Object.isExtensible||isObject,id=0,ID=safe("id"),WEAK=safe("weak"),LEAK=safe("leak"),method=require("./$.array-methods"),find=method(5),findIndex=method(6);module.exports={getConstructor:function(e,t,r,i){var s=e(function(e,n){$.set(assert.inst(e,s,t),ID,id++),void 0!=n&&forOf(n,r,e[i],e)});return require("./$.mix")(s.prototype,{"delete":function(e){return isObject(e)?isExtensible(e)?$has(e,WEAK)&&$has(e[WEAK],this[ID])&&delete e[WEAK][this[ID]]:leakStore(this)["delete"](e):!1},has:function(e){return isObject(e)?isExtensible(e)?$has(e,WEAK)&&$has(e[WEAK],this[ID]):leakStore(this).has(e):!1}}),s},def:function(e,t,r){return isExtensible(assert.obj(t))?($has(t,WEAK)||hide(t,WEAK,{}),t[WEAK][e[ID]]=r):leakStore(e).set(t,r),e},leakStore:leakStore,WEAK:WEAK,ID:ID};
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
"use strict";var $=require("./$"),$def=require("./$.def"),BUGGY=require("./$.iter").BUGGY,forOf=require("./$.for-of"),species=require("./$.species"),assertInstance=require("./$.assert").inst;module.exports=function(e,r,t,i,n,s){function o(e){var r=a[e];require("./$.redef")(a,e,"delete"==e?function(e){return r.call(this,0===e?0:e)}:"has"==e?function(e){return r.call(this,0===e?0:e)}:"get"==e?function(e){return r.call(this,0===e?0:e)}:"add"==e?function(e){return r.call(this,0===e?0:e),this}:function(e,t){return r.call(this,0===e?0:e,t),this})}var u=$.g[e],c=u,f=n?"set":"add",a=c&&c.prototype,d={};if($.isFunction(c)&&(s||!BUGGY&&a.forEach&&a.entries)){var l,h=new c,p=h[f](s?{}:-0,1);require("./$.iter-detect")(function(e){new c(e)})||(c=r(function(r,t){assertInstance(r,c,e);var i=new u;return void 0!=t&&forOf(t,n,i[f],i),i}),c.prototype=a,a.constructor=c),s||h.forEach(function(e,r){l=1/r===-(1/0)}),l&&(o("delete"),o("has"),n&&o("get")),(l||p!==h)&&o(f)}else c=i.getConstructor(r,e,n,f),require("./$.mix")(c.prototype,t);return require("./$.cof").set(c,e),d[e]=c,$def($def.G+$def.W+$def.F*(c!=u),d),species(c),species($.core[e]),s||i.setIter(c,e,n),c};
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
function $redef(t,r,e,n){if($.isFunction(e)){var i=t[r];$.hide(e,SRC,i?String(i):tpl.replace(/hasOwnProperty/,String(r))),"name"in e||(e.name=r)}t===$.g?t[r]=e:(n||delete t[r],$.hide(t,r,e))}var $=require("./$"),tpl=String({}.hasOwnProperty),SRC=require("./$.uid").safe("src"),_toString=Function.toString;$redef(Function.prototype,"toString",function(){return $.has(this,SRC)?this[SRC]:_toString.call(this)}),$.core.inspectSource=function(t){return _toString.call(t)},module.exports=$redef;
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
var $=require("./$"),SHARED="__core-js_shared__",store=$.g[SHARED]||$.hide($.g,SHARED,{})[SHARED];module.exports=function(e){return store[e]||(store[e]={})};
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
"use strict";function wrap(e){var t=AllSymbols[e]=$.set($create($Symbol.prototype),TAG,e);return DESC&&setter&&setSymbolDesc(ObjectProto,e,{configurable:!0,set:function(t){has(this,HIDDEN)&&has(this[HIDDEN],e)&&(this[HIDDEN][e]=!1),setSymbolDesc(this,e,desc(1,t))}}),t}function defineProperty(e,t,r){return r&&has(AllSymbols,t)?(r.enumerable?(has(e,HIDDEN)&&e[HIDDEN][t]&&(e[HIDDEN][t]=!1),r=$create(r,{enumerable:desc(0,!1)})):(has(e,HIDDEN)||setDesc(e,HIDDEN,desc(1,{})),e[HIDDEN][t]=!0),setSymbolDesc(e,t,r)):setDesc(e,t,r)}function defineProperties(e,t){assertObject(e);for(var r,s=enumKeys(t=toObject(t)),o=0,n=s.length;n>o;)defineProperty(e,r=s[o++],t[r]);return e}function create(e,t){return void 0===t?$create(e):defineProperties($create(e),t)}function propertyIsEnumerable(e){var t=_propertyIsEnumerable.call(this,e);return t||!has(this,e)||!has(AllSymbols,e)||has(this,HIDDEN)&&this[HIDDEN][e]?t:!0}function getOwnPropertyDescriptor(e,t){var r=getDesc(e=toObject(e),t);return!r||!has(AllSymbols,t)||has(e,HIDDEN)&&e[HIDDEN][t]||(r.enumerable=!0),r}function getOwnPropertyNames(e){for(var t,r=getNames(toObject(e)),s=[],o=0;r.length>o;)has(AllSymbols,t=r[o++])||t==HIDDEN||s.push(t);return s}function getOwnPropertySymbols(e){for(var t,r=getNames(toObject(e)),s=[],o=0;r.length>o;)has(AllSymbols,t=r[o++])&&s.push(AllSymbols[t]);return s}var $=require("./$"),setTag=require("./$.cof").set,uid=require("./$.uid"),shared=require("./$.shared"),$def=require("./$.def"),$redef=require("./$.redef"),keyOf=require("./$.keyof"),enumKeys=require("./$.enum-keys"),assertObject=require("./$.assert").obj,ObjectProto=Object.prototype,DESC=$.DESC,has=$.has,$create=$.create,getDesc=$.getDesc,setDesc=$.setDesc,desc=$.desc,$names=require("./$.get-names"),getNames=$names.get,toObject=$.toObject,$Symbol=$.g.Symbol,setter=!1,TAG=uid("tag"),HIDDEN=uid("hidden"),_propertyIsEnumerable={}.propertyIsEnumerable,SymbolRegistry=shared("symbol-registry"),AllSymbols=shared("symbols"),useNative=$.isFunction($Symbol),setSymbolDesc=DESC?function(){try{return $create(setDesc({},HIDDEN,{get:function(){return setDesc(this,HIDDEN,{value:!1})[HIDDEN]}}))[HIDDEN]||setDesc}catch(e){return function(e,t,r){var s=getDesc(ObjectProto,t);s&&delete ObjectProto[t],setDesc(e,t,r),s&&e!==ObjectProto&&setDesc(ObjectProto,t,s)}}}():setDesc;useNative||($Symbol=function(){if(this instanceof $Symbol)throw TypeError("Symbol is not a constructor");return wrap(uid(arguments[0]))},$redef($Symbol.prototype,"toString",function(){return this[TAG]}),$.create=create,$.setDesc=defineProperty,$.getDesc=getOwnPropertyDescriptor,$.setDescs=defineProperties,$.getNames=$names.get=getOwnPropertyNames,$.getSymbols=getOwnPropertySymbols,$.DESC&&$.FW&&$redef(ObjectProto,"propertyIsEnumerable",propertyIsEnumerable,!0));var symbolStatics={"for":function(e){return has(SymbolRegistry,e+="")?SymbolRegistry[e]:SymbolRegistry[e]=$Symbol(e)},keyFor:function(e){return keyOf(SymbolRegistry,e)},useSetter:function(){setter=!0},useSimple:function(){setter=!1}};$.each.call("hasInstance,isConcatSpreadable,iterator,match,replace,search,species,split,toPrimitive,toStringTag,unscopables".split(","),function(e){var t=require("./$.wks")(e);symbolStatics[e]=useNative?t:wrap(t)}),setter=!0,$def($def.G+$def.W,{Symbol:$Symbol}),$def($def.S,"Symbol",symbolStatics),$def($def.S+$def.F*!useNative,"Object",{create:create,defineProperty:defineProperty,defineProperties:defineProperties,getOwnPropertyDescriptor:getOwnPropertyDescriptor,getOwnPropertyNames:getOwnPropertyNames,getOwnPropertySymbols:getOwnPropertySymbols}),setTag($Symbol,"Symbol"),setTag(Math,"Math",!0),setTag($.g.JSON,"JSON",!0);
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
"use strict";var $=require("./$"),weak=require("./$.collection-weak"),leakStore=weak.leakStore,ID=weak.ID,WEAK=weak.WEAK,has=$.has,isObject=$.isObject,isExtensible=Object.isExtensible||isObject,tmp={},$WeakMap=require("./$.collection")("WeakMap",function(e){return function(){return e(this,arguments[0])}},{get:function(e){if(isObject(e)){if(!isExtensible(e))return leakStore(this).get(e);if(has(e,WEAK))return e[WEAK][this[ID]]}},set:function(e,t){return weak.def(this,e,t)}},weak,!0,!0);7!=(new $WeakMap).set((Object.freeze||Object)(tmp),7).get(tmp)&&$.each.call(["delete","has","get","set"],function(e){var t=$WeakMap.prototype,i=t[e];require("./$.redef")(t,e,function(t,r){if(isObject(t)&&!isExtensible(t)){var s=leakStore(this)[e](t,r);return"set"==e?this:s}return i.call(this,t,r)})});
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
module.exports=function(n,i){function e(n){var i=Math.floor(Math.random()*n);return i}function d(n){var i=!1;return u.filter(function(e){i=e===n}),i}function o(n,i){var o,u,t="";i=i||{},i.up="undefined"!=typeof i.up?i.up:!0,i.mid="undefined"!=typeof i.mid?i.mid:!0,i.down="undefined"!=typeof i.down?i.down:!0,i.size="undefined"!=typeof i.size?i.size:"maxi",n=n.split("");for(u in n)if(!d(u)){switch(t+=n[u],o={up:0,down:0,mid:0},i.size){case"mini":o.up=e(8),o.mid=e(2),o.down=e(8);break;case"maxi":o.up=e(16)+3,o.mid=e(4)+1,o.down=e(64)+3;break;default:o.up=e(8)+1,o.mid=e(6)/2,o.down=e(8)+1}var f=["up","mid","down"];for(var a in f)for(var p=f[a],m=0;m<=o[p];m++)i[p]&&(t+=r[p][e(r[p].length)])}return t}n=n||"   he is here   ";var r={up:["̍","̎","̄","̅","̿","̑","̆","̐","͒","͗","͑","̇","̈","̊","͂","̓","̈","͊","͋","͌","̃","̂","̌","͐","̀","́","̋","̏","̒","̓","̔","̽","̉","ͣ","ͤ","ͥ","ͦ","ͧ","ͨ","ͩ","ͪ","ͫ","ͬ","ͭ","ͮ","ͯ","̾","͛","͆","̚"],down:["̖","̗","̘","̙","̜","̝","̞","̟","̠","̤","̥","̦","̩","̪","̫","̬","̭","̮","̯","̰","̱","̲","̳","̹","̺","̻","̼","ͅ","͇","͈","͉","͍","͎","͓","͔","͕","͖","͙","͚","̣"],mid:["̕","̛","̀","́","͘","̡","̢","̧","̨","̴","̵","̶","͜","͝","͞","͟","͠","͢","̸","̷","͡"," ҉"]},u=[].concat(r.up,r.down,r.mid);return o(n,i)};
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
var colors=require("./colors");module.exports=function(){function r(r){var t=["__defineGetter__","__defineSetter__","__lookupGetter__","__lookupSetter__","charAt","constructor","hasOwnProperty","isPrototypeOf","propertyIsEnumerable","toLocaleString","toString","valueOf","charCodeAt","indexOf","lastIndexof","length","localeCompare","match","replace","search","slice","split","substring","toLocaleLowerCase","toLocaleUpperCase","toLowerCase","toUpperCase","trim","trimLeft","trimRight"];Object.keys(r).forEach(function(e){-1!==t.indexOf(e)?console.log("warn: ".red+("String.prototype"+e).magenta+" is probably something you don't want to override. Ignoring style name"):"string"==typeof r[e]?(colors[e]=colors[r[e]],o(e,function(){return colors[r[e]](this)})):o(e,function(){for(var o=this,t=0;t<r[e].length;t++)o=exports[r[e][t]](o);return o})})}var o=function(r,o){String.prototype.__defineGetter__(r,o)};o("strip",function(){return colors.strip(this)}),o("stripColors",function(){return colors.strip(this)}),o("trap",function(){return colors.trap(this)}),o("zalgo",function(){return colors.zalgo(this)}),o("zebra",function(){return colors.zebra(this)}),o("rainbow",function(){return colors.rainbow(this)}),o("random",function(){return colors.random(this)}),o("america",function(){return colors.america(this)});var t=Object.keys(colors.styles);t.forEach(function(r){o(r,function(){return colors.stylize(this,r)})}),colors.setTheme=function(o){if("string"==typeof o)try{return colors.themes[o]=require(o),r(colors.themes[o]),colors.themes[o]}catch(t){return console.log(t),t}else r(o)}};
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
var colors=require("./colors");module.exports=colors,require("./extendStringPrototype")();
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
"use strict";function getCost(t,e,o,n){var r="object"==typeof t?t[e]:t;return"function"==typeof r?r.call(t,o,n):r}module.exports=function(t,e){for(var o=void 0===arguments[2]?1:arguments[2],n=[],r=0;r<=t.length;++r){n[r]=3>r?[]:n[r-3];for(var s=0;s<=e.length;++s)n[r][s]=0==r&&0==s?0:0==r?n[r][s-1]+getCost(o,"insert",e[s-1]):0==s?n[r-1][s]+getCost(o,"delete",t[r-1]):Math.min(n[r-1][s]+getCost(o,"delete",t[r-1]),n[r][s-1]+getCost(o,"insert",e[s-1]),n[r-1][s-1]+(t[r-1]==e[s-1]?0:getCost(o,"replace",t[r-1],e[s-1])),r>1&&s>1&&t[r-1]==e[s-2]&&t[r-2]==e[s-1]?n[r-2][s-2]+getCost(o,"transpose",t[r-2],t[r-1]):1/0)}return n[t.length][e.length]};
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
"use strict";var ra=require("ra");module.exports=function(e){var a=void 0===arguments[1]?null:arguments[1],t=ra.clean(a).setConst("reset",function(){localStorage.removeItem(e),t.assign(a)}).setName("localStorage."+e),r=localStorage.getItem(e);return null!=r&&t.assign(JSON.parse(r)),ra.clean(function(){t.valueOf()!=a&&localStorage.setItem(e,JSON.stringify(t))}),t};
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
"use strict";function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(e.__proto__=t)}var _createClass=function(){function e(e,t){for(var r=0;r<t.length;r++){var n=t[r];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(t,r,n){return r&&e(t.prototype,r),n&&e(t,n),t}}(),_get=function(e,t,r){for(var n=!0;n;){var o=e,i=t,u=r;s=a=l=void 0,n=!1;var s=Object.getOwnPropertyDescriptor(o,i);if(void 0!==s){if("value"in s)return s.value;var l=s.get;return void 0===l?void 0:l.call(u)}var a=Object.getPrototypeOf(o);if(null===a)return void 0;e=a,t=i,r=u,n=!0}},WebSocketToJSON=function(e){function t(e){var r=this;_classCallCheck(this,t),_get(Object.getPrototypeOf(t.prototype),"constructor",this).call(this),this._ws=e,this.pipeFrom(e),e.onmessage=function(e){var t=void 0;try{t=JSON.parse(String(e.data))}catch(n){return r.doerror(n)}r.domessage(t)}}return _inherits(t,e),_createClass(t,[{key:"unwise",value:function(){var e=this._ws;return this._ws=null,e.onopen=null,e.onclose=null,e.onerror=null,e.onmessage=null,e}},{key:"_send",value:function(e){this._ws.send(JSON.stringify(e))}},{key:"_close",value:function(){this._ws.onclose=null,this._ws.close()}}]),t}(require("WebQueue"));module.exports=function(e){return new WebSocketToJSON(e)};
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
"use strict";function _defineProperty(e,t,n){return Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0})}function _toConsumableArray(e){if(Array.isArray(e)){for(var t=0,n=Array(e.length);t<e.length;t++)n[t]=e[t];return n}return Array.from(e)}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(e.__proto__=t)}function wsClient(e,t){var n=new PersistentWebSocket;return ra(function(){return n.url=e.localModem&&e.localModem+t}),n.active=ra.on(n,["pause","resume"],function(){return n.connected}),n}function wsJSONclient(e,t){function n(e,t){delete a[e],t()}var r=JSONlocal(t,{uid:null}),i=wsClient(e,t),o=function(){return i.send({what:"init",id:r.uid})},a={},s=function(e,t){throw new Error("wsJSONclient: "+e+": "+JSON.stringify(t))};lu.on(i,{resume:o,message:function(e){switch(e.what){case"error":s("error from server",e);case"saved":var t=a[e.messageId];return delete a[e.messageId],void(t&&t());case"data":return void(e.partial&&e.previous!=r.uid?o():Object.prototype.hasOwnProperty.call(e,"data")&&r.assign(lu.applyDiff(r.valueOf(),e.data,e.partial)));default:s("unknown message from server",e)}},error:function(){e.onCredentials()}});var c=function(e,t){return new Promise(function(r,o){var s=UID();a[s]=r,i.send({what:"save",data:e?t:Object.assign({__partial__:!1},t||{}),messageId:s}),setTimeout(n,savePlacesTimeout,s,o)})};return{data:r.getReadOnly(),active:i.active,send:function(e){return c(!1,e)},update:function(e){return c(!0,e)},"delete":function(){i.close()}}}var _createClass=function(){function e(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(t,n,r){return n&&e(t.prototype,n),r&&e(t,r),t}}(),_get=function(e,t,n){for(var r=!0;r;){var i=e,o=t,a=n;s=u=c=void 0,r=!1;var s=Object.getOwnPropertyDescriptor(i,o);if(void 0!==s){if("value"in s)return s.value;var c=s.get;return void 0===c?void 0:c.call(a)}var u=Object.getPrototypeOf(i);if(null===u)return void 0;e=u,t=o,n=a,r=!0}},JSONlocal=require("JSONlocal"),lu=require("localUtils"),ra=require("ra"),lodash=require("lodash"),UID=require("uid"),httpClient=require("httpClient"),EventEmitter=require("events").EventEmitter||require("events"),WebSocketToJSON=require("WebSocketToJSON"),PingPongJSON=require("PingPongJSON"),devdb=require("devdb"),WebSocketRetry=1e3,savePlacesTimeout=3e3,PersistentWebSocket=function(e){function t(e){_classCallCheck(this,t),_get(Object.getPrototypeOf(t.prototype),"constructor",this).call(this),this.connected=!1,this.closed=!1,this._ws=null,this._sheduledCreating=null,this._first=!0,this._lastClose=-(1/0),this.url=e,this.user=void 0,this.key=void 0}return _inherits(t,e),_createClass(t,[{key:"_setConnected",value:function(e){e=!!e,this.connected!=e&&(this.connected=e,this.emit("changed",e))}},{key:"_clearHandle",value:function(){this._ws&&(this._ws.onclose=null,this._ws.close(),this._ws=null,this._setConnected(!1)),this._sheduledCreating&&(clearTimeout(this._sheduledCreating),this._sheduledCreating=null)}},{key:"_ensureHandle",value:function(){this._ws||this._createHandle()}},{key:"_createHandle",value:function(){var e=this;this._clearHandle(),this._url&&(this._ws=PingPongJSON(WebSocketToJSON(new WebSocket(this._url))),this._ws.onclose=function(){if(e._ws=null,e._setConnected(!1),e.emit("pause"),!e.closed){var t=e._lastClose;e._lastClose=Date.now(),e._sheduledCreating=setTimeout(function(){e._createHandle()},Math.max(0,WebSocketRetry-(e._lastClose-t)))}},this._ws.onerror=function(t){e.emit("error",t)},this._ws.onopen=function(){e._setConnected(!0),e._first&&(e._first=!1,e.emit("open")),e.emit("resume")},this._ws.onmessage=function(t){e.emit("message",t)})}},{key:"reinit",value:function(){this._ws&&this._ws.close()}},{key:"send",value:function(e){if(this._ensureHandle(),!this._ws||!this.connected||this.closed)throw new Error("socket is not open");this._ws.send(e)}},{key:"delete",value:function(){this.close()}},{key:"close",value:function(){this.closed=!0,this._clearHandle(),this.emit("close")}},{key:"ask",value:function(e){return co.gocall(regeneratorRuntime.mark(function t(){var n,r;return regeneratorRuntime.wrap(function(t){for(;;)switch(t.prev=t.next){case 0:return n=UID(),this.send({id:n,question:e}),t.next=4,this.get(n);case 4:if(r=t.sent,!r.error){t.next=7;break}throw new Error(r.error);case 7:return t.abrupt("return",r.answer);case 8:case"end":return t.stop()}},t,this)}),this)}},{key:"get",value:function(e,t){return co.gocall(regeneratorRuntime.mark(function n(){var r,i,o;return regeneratorRuntime.wrap(function(n){for(;;)switch(n.prev=n.next){case 0:return"string"==typeof e||"number"==typeof e?!function(){var t=e;e=function(e){return e.id==t}}():"function"!=typeof e&&!function(){var t=e;e=function(e){return lodash.every(t,function(t,n){return e[n]==t})}}(),n.next=3,co.receive(this,{close:!0,message:e,timeout:t});case 3:if(r=n.sent,i=r.event,o=r.data,"message"!=i){n.next=8;break}return n.abrupt("return",o);case 8:throw new Error("timeout");case 9:case"end":return n.stop()}},n,this)}),this)}},{key:"url",get:function(){return this._url},set:function(e){this._url=e,this._createHandle()}}]),t}(EventEmitter);module.exports=function(e){var t={activeDeviceId:"",language:"ru",iconSize:40,labels:!0,placesPages:{}},n=JSONlocal(e,t),r=ra.clean(Object.defineProperties({getMessage:function(e){var t=n.language||"ru";return[t,"ru","en","by"].filter(function(t){return Object.prototype.hasOwnProperty.call(e,t)}).map(function(t){return e[t]})[0]},pageWidth:2,pageHeight:3,pageStarting:!1,dialog:"",editing:!1,moving:0,history:[],menuElement:null,loggedin:!1,onCredentials:function(){this.loggedin=!1},go:function(e,t){var r=this;if(e){for(var i=this.history,o=n.activeDeviceId,a=void 0;i.length&&(a=i[i.length-1],a==e||a==o||t&&t.indexOf(a)>=0);)i.pop();o!=e&&i.push(o),t&&i.push.apply(i,_toConsumableArray(t.filter(function(e){return e!=r.main}).reverse())),n.activeDeviceId=e,this.dialog=""}},back:function(){for(;this.history.length;){var e=this.history.pop();if(this.getDevice(e))return n.activeDeviceId=e}n.activeDeviceId=this.main},windowSize:require("windowSize").getReadOnly(),placesShifts:{},login:function(e,t){},getDevice:function(e){return this.devices.content&&this.devices.content[lu.valueOf(e)]},linkingPlaceId:null,setDatabase:function(e){this.serverDevices.send(e)},reset:function(){n.reset(),this.setDatabase({uid:UID()}),this.dialog="",this.editing=!1,this.history.length=0},setTemplate:function(e){function t(e,t){return Object.keys(e).forEach(function(n){return"image"!=n&&"content"!=n&&"type"!=n&&(t[n]=e[n])}),t}function n(e,i){return e.content||"place"==e.type?!function(){var o={};r.content[i]=t(e,{type:"place",content:o});var a=0;e.content&&e.content.forEach(function(e){return o[n(e,UID())]={index:a++}})}():r.content[i]=t(e,{type:"single"}),i}console.log(e);var r={uid:UID(),content:{}};r.main=n(e,UID()),this.setDatabase(r)},message:function(e){var t=this.messages&&this.messages[e];return null==t&&(t=e),t},notification:function(e){},saveDevice:function(e,t){var n=lu.makeDiff(this.getDevice(e),t);return null==n?Promise.resolve():this.serverDevices.update({content:_defineProperty({},e,n)})},newIndex:function(e){return Object.keys(this.getDevice(e).content||{}).length+1},linkItem:function(e,t,n){return co.gocall(regeneratorRuntime.mark(function r(){var i,o,a,s,c;return regeneratorRuntime.wrap(function(r){for(;;)switch(r.prev=r.next){case 0:if(e!=t){r.next=2;break}throw new Error("cannot link place to itself");case 2:if(i=this.getDevice(e),o=this.getDevice(t),"group"!=i.type){r.next=9;break}if(i.group){r.next=7;break}throw new Error("internal error: no GROUP number found");case 7:if(o.group){r.next=9;break}throw new Error("cannot add unlinked device to a group");case 9:if(a=this.localDevices.createRecord(),r.prev=10,s={content:_defineProperty({},e,{content:_defineProperty({},t,{index:this.newIndex(e)})})},c=n?lu.mergeDiffs(n,s):s,a.assign(c),"group"!=i.type){r.next=18;break}return r.next=18,this.command(t,"AppendTo",i.group);case 18:return r.next=20,a.save();case 20:return r.prev=20,a.close(),r.finish(20);case 23:case"end":return r.stop()}},r,this,[[10,,20,23]])}),this)},linkToFavourites:function(e){return this.linkItem(this.main,e)},linkActiveToFavourites:function(e){return this.linkToFavourites(this.activeDeviceId)},addItem:function(e,t){var n,r=void 0===arguments[2]?UID():arguments[2],i=void 0===arguments[3]?null:arguments[3];return this.serverDevices.update({content:(n={},_defineProperty(n,e,{content:_defineProperty({},r,{index:null!=i?i:this.newIndex(e)})}),_defineProperty(n,r,t),n)})},addPlace:function(e){return this.addItem(e,{type:"place",ru:"Помещение",en:"Room"})},addDevice:function(e){return this.addItem(e,{type:"single",ru:"Устройство",en:"Device"})},addGroup:function(e,t){return co.gocall(regeneratorRuntime.mark(function n(){return regeneratorRuntime.wrap(function(n){for(;;)switch(n.prev=n.next){case 0:return t||(t=UID()),n.next=3,this.addItem(e,{type:"group",ru:"Группа",en:"Group"},t);case 3:return n.next=5,this.command(t,"Reserve");case 5:return n.abrupt("return",t);case 6:case"end":return n.stop()}},n,this)}),this)},deleteItem:function(e,t){return co.gocall(regeneratorRuntime.mark(function n(){var r,i;return regeneratorRuntime.wrap(function(n){for(;;)switch(n.prev=n.next){case 0:if(r=this.getDevice(e),i=this.localDevices.createRecord(),n.prev=2,i.assign({content:_defineProperty({},e,{content:_defineProperty({},t,null)})}),"group"!=r.type||!r.group){n.next=7;break}return n.next=7,this.command(t,"RemoveFrom",r.group);case 7:return n.next=9,i.save();case 9:return n.prev=9,i.close(),n.finish(9);case 12:case"end":return n.stop()}},n,this,[[2,,9,12]])}),this)},insertInto:function(e,t,n){return this.linkItem(e,t,{content:_defineProperty({},n,{content:_defineProperty({},t,null)})})},errors:null,"throw":function(e,t,n){if(!e)throw new Error("an error has to have its own dialog");this.errors=(this.errors||[]).concat([{dialog:e,data:t,retry:n}])},clearError:function(){var e=this;ra.detach(function(){e.error&&(e.dialog="",e.errors=e.errors&&e.errors.slice(1))})},error:null,purgeItem:function(e,t){return co.gocall(regeneratorRuntime.mark(function n(){var r,i,o;return regeneratorRuntime.wrap(function(n){for(;;)switch(n.prev=n.next){case 0:if(r=this.getDevice(e),i=this.localDevices.createRecord(),n.prev=2,i.assign(devdb.Clear(this.devices,e)),o=void 0,r&&null!=r.group&&("group"==r.type?o="Clear":"single"==r.type&&(o="Unlink")),!o){n.next=11;break}return n.next=9,this.command(e,o);case 9:n.next=13;break;case 11:return n.next=13,i.save();case 13:if(n.prev=13,!t){n.next=17;break}return n.next=17,i.save();case 17:return i.close(),(lu.valueOf(this.serverDevices.data)||1)[e]&&this["throw"]("ErrorUnlinkingDevice",{deviceId:e}),n.finish(13);case 20:case"end":return n.stop()}},n,this,[[2,,13,20]])}),this)},renameItem:function(e,n){var r=lodash.reduce(this.getDevice(e),function(e,t,n){return 2==n.length&&(e[n]=null),e},{});return r[t.language||"ru"]=n,this.serverDevices.update({content:_defineProperty({},e,r)})},command:function(e,t,n){return this.commands.ask({device:e,command:t,data:n})},iconCommand:function(e,t,n,r){return e=lu.valueOf(e),("place"==e.type?"Short"==n:"Long"==n)?this.go(t):"place"==e.type||e.group?(("Short"==n||"Long"==n)&&(e&&e.state?(n="Set",r=0):(n="Set",r=1)),this.command(t,n,r)):(this.dialog="AskToLinkDevice",this.linkingPlaceId=t,Promise.resolve())},focus:function(e){setTimeout(function(){return e.focus()},400)},searchAction:null,searchFilter:null,icons:null,modules:new WeakMap,load:function(e){var t=this.modules.get(e);return null==t&&(t=e(r,n),this.modules.set(e,t)),t},hover:null,"debugger":function(){}},{modemLocations:{get:function(){return httpClient.get("/modem_locations")},configurable:!0,enumerable:!0},localModem:{get:function(){return this.modemLocations?this.modemLocations[0].url.replace(/^http(?=s?\:\/\/)/,"ws"):""},configurable:!0,enumerable:!0},doLogin:{get:function(){return regeneratorRuntime.mark(function e(){var t;return regeneratorRuntime.wrap(function(e){for(var n=this;;)switch(e.prev=e.next){case 0:if(this.loggedin||!this.modemLocations){e.next=23;break}return t=document.createElement("script"),t.src=""+this.modemLocations[0].url+"/login?"+UID(),document.body.appendChild(t),e.prev=4,e.next=7,t;case 7:e.next=16;break;case 9:return e.prev=9,e.t0=e["catch"](4),LOG("error while trying to login: "+(e.t0&&e.t0.message&&e.t0)),console.error(e.t0),e.next=15,co.sleep(300);case 15:return e.abrupt("continue",0);case 16:return e.prev=16,document.body.removeChild(t),e.finish(16);case 19:LOG("logged in"),ra.detach(function(){return n.loggedin=!0}),e.next=0;break;case 23:case"end":return e.stop()}},e,this,[[4,9,16,19]])}).call(this)},configurable:!0,enumerable:!0},serverDevices:{get:function(){return wsJSONclient(this,"/database")},configurable:!0,enumerable:!0},localDevices:{get:function(){var e=this;return ra.db(this.serverDevices.data,function(t){return e.serverDevices.update(t)})},configurable:!0,enumerable:!0},devices:{get:function(){return this.localDevices.valueOf()||{}},configurable:!0,enumerable:!0},commands:{get:function(){return wsClient(this,"/commands")},configurable:!0,enumerable:!0},connectedToServer:{get:function(){return!0&&this.serverDevices.active.valueOf()&&this.commands.active.valueOf()},configurable:!0,enumerable:!0},main:{get:function(){return this.devices.main},configurable:!0,enumerable:!0},activeDeviceId:{get:function(){return n.activeDeviceId||this.main},configurable:!0,enumerable:!0},activeDevice:{get:function(){return this.getDevice(this.activeDeviceId)},configurable:!0,enumerable:!0},activeContentIds:{get:function(){var e=this.activeDevice;return ra.Array(lodash.keys(e&&e.content).sort(function(t,n){return e.content[t].index-e.content[n].index}))},configurable:!0,enumerable:!0},activeContent:{get:function(){return ra.Array(this.activeContentIds.map(this.getDevice))},configurable:!0,enumerable:!0},clearLinkingPlaceId:{get:function(){"AskToLinkDevice"!=this.dialog&&"AskIfDeviceHasBeenLinked"!=this.dialog&&(this.linkingPlaceId=null)},configurable:!0,enumerable:!0},checkIfTimeToGoBack:{get:function(){this.getDevice(this.activeDeviceId)||this.back()},configurable:!0,enumerable:!0},caption:{get:function(){return this.getMessage(this.getDevice(this.activeDeviceId))||this.message("favorites")},configurable:!0,enumerable:!0},deviceType:{get:function(){var e=this.getDevice(this.activeDeviceId);return e||(e=this.getDevice(this.main)),e&&e.type||"place"},configurable:!0,enumerable:!0},deviceIds:{get:function(){return ra.Array(lodash.keys(this.devices.content).sort())},configurable:!0,enumerable:!0},initialLoading:{get:function(){return!this.devices.uid},configurable:!0,enumerable:!0},initialized:{get:function(){return!this.initialLoading&&!!this.devices.main},configurable:!0,enumerable:!0},templates:{get:function(){return regeneratorRuntime.mark(function e(){return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return e.prev=0,e.next=3,httpClient.get("/templates");case 3:return e.abrupt("return",e.sent);case 6:return e.prev=6,e.t0=e["catch"](0),e.abrupt("return",e.t0);case 9:case"end":return e.stop()}},e,this,[[0,6]])}).call(this)},configurable:!0,enumerable:!0},allMessages:{get:function(){return regeneratorRuntime.mark(function e(){return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return e.next=2,httpClient.get("/messages");case 2:return e.abrupt("return",e.sent);case 3:case"end":return e.stop()}},e,this)}).call(this)},configurable:!0,enumerable:!0},messages:{get:function(){var e=this.allMessages;if(null!=e){var t={},r=n.language||"ru";return lodash.forOwn(e,function(e,n){return t[n]=Object.prototype.hasOwnProperty.call(e,r)?e[r]:n}),t}},configurable:!0,enumerable:!0},checkError:{get:function(){var e=this;this.dialog||(this.errors&&this.errors.length?ra.detach(function(){var t=e.errors[0];e.errors=e.errors&&e.errors.slice(1),e.dialog=t.dialog,e.error=t}):this.error=null)},configurable:!0,enumerable:!0},checkSearchDialog:{get:function(){"SearchItems"!=this.dialog&&(this.searchAction=null,this.searchFilter=null)},configurable:!0,enumerable:!0}})).setName("app");return{app:r,local:n}};
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
"use strict";function onTimer(){timer=null,processQueue()}function ensureTimer(){timer||processing||installTimer()}function nextTick(e){queue.push(e),ensureTimer()}function processQueue(){if(!processing&&queue.length){var e=0;processing=!0;try{for(;MAX_TICKS>e&&e<queue.length;)queue[e++]()}finally{processing=!1,queue.splice(0,e),queue.length&&ensureTimer()}}}function getProxy(e){function n(){var n=e.handleEvent?e.handleEvent.apply(e,arguments):e.apply(this,arguments);return processQueue(),n}var t=void 0;return null!=(t=e[secret])?t:(assignProperty(n,secret,n),assignProperty(e,secret,n))}function hookEventListener(e){e.addEventListener&&!function(){var n=hookMethod(e,"addEventListener",function(e,t){return arguments[1]=getProxy(arguments[1]),n.apply(this,arguments)}),t=hookMethod(e,"removeEventListener",function(e,n){return arguments[1][secret]&&(arguments[1]=arguments[1][secret]),t.apply(this,arguments)})}()}function hookMethod(e,n,t){var r=e[n];return r&&(assignProperty(t,"toString",function(){return r.toString()}),e[n]=t),r}function assignProperty(e,n,t){return Object.defineProperty?Object.defineProperty(e,n,{value:t}):e[n]=t,t}var MAX_TICKS=1e5,setTimeout=window.setTimeout;process.nextTick=nextTick;var queue=[],timer=null,processing=!1,secret="process-tick-"+Math.random(),installTimer=function(){timer=setTimeout(onTimer,1)};window.postMessage&&window.addEventListener&&!function(){window.addEventListener("message",function(e){var n=e.source;n!=window&&null!=n||e.data!=secret||(e.stopPropagation(),onTimer())});var e=window.postMessage;installTimer=function(){e(secret,"*"),timer=!0}}(),!["setTimeout","setInterval","requestAnimationFrame"].forEach(function(e){var n=hookMethod(window,e,function(e,t){return"function"==typeof arguments[0]&&(arguments[0]=getProxy(arguments[0])),n.apply(this,arguments)})}),![window,document].forEach(hookEventListener);
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
"use strict";function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function _inherits(t,e){if("function"!=typeof e&&null!==e)throw new TypeError("Super expression must either be null or a function, not "+typeof e);t.prototype=Object.create(e&&e.prototype,{constructor:{value:t,enumerable:!1,writable:!0,configurable:!0}}),e&&(t.__proto__=e)}function iteratorFailed(t){return{done:!0,iteratorFailed:!0,value:t}}function iteratorNext(t,e){try{return t.next(e)}catch(r){return iteratorFailed(r)}}function iteratorThrow(t,e){if(!t["throw"])return iteratorFailed(e);try{return t["throw"](e)}catch(r){return iteratorFailed(r)}}function iteratorReturn(t){if(t["return"])try{t["return"]()}catch(e){return iteratorFailed(e)}else if(t["throw"]){var r=new EKill,n=iteratorThrow(t,r);if(n.done&&n.iteratorFailed){if(n.value!=r)return n}else rethrow(new Error("thread has eaten EKill"))}return DONE}function iteratorCheck(t){if(t&&t.done&&t.iteratorFailed)throw t.value;return t}function killIterator(t){if(t){var e=iteratorReturn(t);e.done&&e.iteratorFailed&&rethrow(e.value)}}var _createClass=function(){function t(t,e){for(var r=0;r<e.length;r++){var n=e[r];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(t,n.key,n)}}return function(e,r,n){return r&&t(e.prototype,r),n&&t(e,n),e}}(),_get=function(t,e,r){for(var n=!0;n;){var i=t,o=e,a=r;s=l=u=void 0,n=!1;var s=Object.getOwnPropertyDescriptor(i,o);if(void 0!==s){if("value"in s)return s.value;var u=s.get;return void 0===u?void 0:u.call(a)}var l=Object.getPrototypeOf(i);if(null===l)return void 0;t=l,e=o,r=a,n=!0}},later=require("later"),EventEmitter=require("events").EventEmitter,co=module.exports=exports=new EventEmitter,threadCatcher=null;exports.cb=null,exports.global=null,exports.go=function(t){for(var e=arguments.length,r=Array(e>1?e-1:0),n=1;e>n;n++)r[n-1]=arguments[n];return"function"==typeof t&&(t=t.apply(null,r)),t.next||!function(){var e=t;t={next:function(){var t={value:e,done:!e};return e=null,t}}}(),new Thread(t)},exports.gocall=function(t,e){for(var r=arguments.length,n=Array(r>2?r-2:0),i=2;r>i;i++)n[i-2]=arguments[i];return new Thread(t.apply(e,n))},exports.func=function(t){return arguments.length>=2&&(t=Array.prototype.reduceRight.call(arguments,function(t,e){return e(t)})),function(){return new Thread(t.apply(this,arguments))}},exports.eventHandler=function(t){return function(){var e=new Thread(t.apply(this,arguments));return e.waitForInput(),e}},exports.cbfunc=function(t){return function(){for(var e=this,r=arguments.length,n=Array(r),i=0;r>i;i++)n[i]=arguments[i];return new Promise(function(r,i){return t.call.apply(t,[e].concat(n,[function(t,e){null!=t?i(t):r(e)}]))})}},exports.catchThreads=function(t,e){var r=threadCatcher;threadCatcher=e;try{return t()}finally{threadCatcher=r}},exports.receive=function(t,e){return new Promise(function(r,n){function i(){if(a){clearTimeout(s);for(var e in a)t.removeListener(e,a[e]);u.close(),a=null}}function o(t,e){i(),r({event:t,data:e})}var a=Object.create(null),s=void 0,u=co.defer(function(){i(),n()}),l=function(r){if(Object.prototype.hasOwnProperty.call(e,r)){var n=function(){var n=e[r];return null==n?{v:"continue"}:void("timeout"==r?s=setTimeout(function(){return o("timeout",null)},n):t.addListener(r,a[r]=function(t){("function"!=typeof n||n(t))&&o(r,t)}))}();if("object"==typeof n)return n.v}};for(var c in e){l(c)}})};var noopthen={then:function(){}};exports.wait=function(){return noopthen},exports.sleep=function(t){return{then:function(e){var r=setTimeout(e,t);return{kill:function(){clearTimout(r)}}}}},exports.tick=exports.sleep(1),exports.timeout=function(t){return{then:function(e,r){var n=setTimeout(r,t);return{kill:function(){clearTimout(n)}}}}},exports.promise=function(t){return Promise.all([co.go(regeneratorRuntime.mark(function e(){return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return e.next=2,t;case 2:case"end":return e.stop()}},e,this)}))])},exports.requestAnimationFrame={then:function(t){if("function"!=typeof cancelAnimationFrame)return exports.sleep(1).then(t);var e=function(){var e=requestAnimationFrame(t);return{v:{kill:function(){cancelAnimationFrame(e)}}}}();return"object"==typeof e?e.v:void 0}};var rethrow=function(t){return setTimeout(function(){throw t},1)},DONE={done:!0},EKill=function(t){function e(){var t=void 0===arguments[0]?"kill":arguments[0];_classCallCheck(this,e),_get(Object.getPrototypeOf(e.prototype),"constructor",this).call(this,t)}return _inherits(e,t),e}(Error);exports.EKill=EKill;var catchDefer=function(t){try{return t()}catch(e){return{next:function(){return iteratorFailed(e)}}}},IteratorProxy=function(){function t(e){return _classCallCheck(this,t),e instanceof t?e:(this._iterator=e,this._deferred=null,void(this._result=null))}return _createClass(t,[{key:"defer",value:function(t){var e=this;if("function"!=typeof t)throw new Error("type error: only functions can be deferred");return this._deferred||(this._deferred=[]),this._deferred.push(t),{close:function(){if(e._deferred)for(var r=e._deferred.length-1;r>=0;--r)if(e._deferred[r]==t)return void e._deferred.splice(r,1)}}}},{key:"save",value:function(t){this._result?t.iteratorFailed&&(this._result.iteratorFailed&&rethrow(this._result.value),this._result=t):this._result=t}},{key:"call",value:function(e,r){var n=t._iterator;t._iterator=this;try{t:for(;;){var i=e(this._iterator,r);if(!i.done)return i;if(this._iterator=null,!this._deferred)return i;for(this.save(i);this._deferred.length;){var o=catchDefer(this._deferred.pop());if(null!=o&&"function"==typeof o.next){this._iterator=o,r=void 0,e=iteratorNext;continue t}}return i=this._result,this._result=null,i}}finally{t._iterator=n}}},{key:"next",value:function(t){return iteratorCheck(this.call(iteratorNext,t))}},{key:"throw",value:function(t){return iteratorCheck(this.call(iteratorThrow,t))}},{key:"return",value:function(e){if(this._iterator){this.save({done:!0,value:e});var r=t._iterator;t._iterator=this;try{var n=iteratorReturn(this._iterator);if(this._iterator=null,!this.deferred)return void iteratorCheck(n);for(this.save(n);this._deferred.length;){var i=catchDefer(this._deferred.pop());if(null!=i&&"function"==typeof i.next){var o=iteratorNext(i);o.done||(o=iteratorReturn(i)),this.save(o)}}n=this._result,this._result=null,iteratorCheck(n)}finally{t._iterator=r}}}}]),t}();IteratorProxy._iterator=null,exports.defer=function(t){if(!IteratorProxy._iterator)throw new Error("defer: not in a co-thread");return IteratorProxy._iterator.defer(t)};var Thread=function(){function t(e){var r=this;if(_classCallCheck(this,t),this._attachedToStack=!0,this._iterator=new IteratorProxy(e),this._stopCount=0,this._stack=[],this.global=Object.create(null),this._currentPromise=null,this._running=!1,this._killing=null,this._cb=function(t,e){r._step&&(t?r._step.fail(t):r._step.next(e))},this.$name={toString:function(){return"<Thread>"}},this._newStep(),this._start=function(){r._start&&r._step&&r._step.next&&(r._stopCount>0?r._step.resume=r._start:(r._start=null,r._step.next()))},this._promise=new Promise(function(t,e){r._resolve=t,r._reject=e}),!this._resolve)throw new Error("assertion failure: wrong implementation of Promise");later.then(this._start),threadCatcher&&threadCatcher(this),exports.emit("start",this)}return _createClass(t,[{key:"linkName",value:function(t){var e=void 0===arguments[1]?":thread":arguments[1];return t.$name&&(t=t.$name),this.$name.toString=function(){return""+t+e},this}},{key:"waitForInput",value:function(){if(this._checkFinished(),this._stopCount>0)throw new Error("thread is paused");return this._start&&this._start(),this}},{key:"_attachPromise",value:function(t){return t.kill=this.kill.bind(this),t}},{key:"then",value:function(t,e){return this._attachedToStack=!1,this._attachPromise(this._promise.then(t,e))}},{key:"catch",value:function(t){return this._attachedToStack=!1,this._attachPromise(this._promise["catch"](t))}},{key:"isFinished",value:function(){return!this._step||this._killing}},{key:"isPaused",value:function(){return this._stopCount>0}},{key:"throw",value:function(t){if(this.global==exports.global)throw t;this._checkFinished(),this._newStep(),this._stopCount>0?this._step.resume=this._step.fail.bind(this._step,t):this._step.fail(t)}},{key:"attachToStack",value:function(){this._attachedToStack=!0}},{key:"kill",value:function(t){if(!this.isFinished()){if(this._reject(t),this._running)throw this._killing={reason:t},new EKill;var e=exports.current,r=exports.cb,n=exports.global;exports.cb=this._cb,exports.global=this.global,exports.current=this,killIterator(this._iterator);for(var i=this._stack,o=i.length-1;o>=0;--o)killIterator(i[o]);if(exports.cb=r,exports.global=n,exports.current=e,this._currentPromise)try{this._currentPromise.kill(t)}catch(a){rethrow(a)}this._done()}}},{key:"pause",value:function(){this._checkFinished(),++this._stopCount}},{key:"resume",value:function(){if(0==this._stopCount)throw new Error("thread not paused");0==--this._stopCount&&this._step&&this._step.resume&&(later.then(this._step.resume),this._step.resume=null)}},{key:"_tick",value:function(t,e,r){if(this["debugger"]||t["debugger"],this._running)throw new Error("FATAL: reentering thread tick");if(t===this._step){if(this._stopCount>0)return void(t.resume=this._tick.bind(this,t,e,r));for(;;){this._currentPromise=null,this._running=!0;var n=exports.current,i=exports.cb,o=exports.global;exports.cb=this._cb,exports.global=this.global,exports.current=this;var a=this._iterator.call(e,r);if(exports.cb=i,exports.global=o,exports.current=n,this._running=!1,this["debugger"]||t["debugger"],this._killing){var s=this._killing.reason;return this._killing=null,void this.kill(s)}if(a.done){if(this.isFinished())return;if(this._iterator=this._stack.pop()){e=a.iteratorFailed?iteratorThrow:iteratorNext,r=a.value;continue}var u=a.iteratorFailed?this._reject:this._resolve;this._done(),a.iteratorFailed&&this._attachedToStack&&rethrow(a.value),u(a.value)}else if(a.value)if(a.value.then){var l=a.value.then(t.next,t.fail);l&&l.kill&&(this._currentPromise=l)}else{if(a.value.next){this._stack.push(this._iterator),this._iterator=new IteratorProxy(a.value),e=iteratorNext,r=void 0;continue}if("onload"in a.value&&!a.value.onload&&"onerror"in a.value&&!a.value.onerror)a.value.onload=t.next,a.value.onerror=t.fail;else{if(!("onsuccess"in a.value&&!a.value.onload&&"onerror"in a.value)||a.value.onerror)throw new Error("thread type error");t.success_error||(t.success_error={onsuccess:function(e){t.next(e.target.result)},onerror:function(e){t.fail(e.target.error||e)}}),a.value.onsuccess=t.success_error.onsuccess,a.value.onerror=t.success_error.onerror}}else exports.tick.then(t.next);break}}}},{key:"_done",value:function(){this._step=null,this._iterator=null,this._stack=null,this._resolve=null,this._reject=null,this._currentPromise=null,this._killing=null}},{key:"_newStep",value:function(){var t=this._step={resume:null};t.next=this._tick.bind(this,t,iteratorNext),t.fail=this._tick.bind(this,t,iteratorThrow);var e=this.$name;t.next.$name={toString:function(){return e+":next"}},t.fail.$name={toString:function(){return e+":fail"}}}},{key:"_onPromise",value:function(t,e){this._resolve=t,this._reject=e,this.resume()}},{key:"_checkFinished",value:function(){if(this.isFinished())throw new Error("thread is already finished")}}]),t}();exports.Thread=Thread,!function(){var t={enumerable:!1};Object.keys(Thread.prototype).forEach(function(e){return e.match(/^_/)&&Object.defineProperty(Thread.prototype,e,t)});var e=new Thread({next:function(){return{value:{then:function(){}}}}}).waitForInput();exports.current=null,exports.global=e.global,exports.cb=null}();
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
"use strict";function toNode(e,t){e:for(;;){if(e=e&&"function"==typeof e.valueOf?e.valueOf():e,Array.isArray(e)){if(0==e.length)return null;if(1==e.length){e=e[0];continue e}t||(t=document.createDocumentFragment()),e.forEach(function(e){return toNode(e,t)}),e=t}else"string"==typeof e&&(e=document.createTextNode(e)),t&&(t.appendChild(e),e=t);return e}}function fcalc(e,t){"function"!=typeof e?t(e):!function(){var n=!0;ra(!1,regeneratorRuntime.mark(function r(){var a;return regeneratorRuntime.wrap(function(r){for(;;)switch(r.prev=r.next){case 0:if(!n){r.next=4;break}n=!1,r.next=6;break;case 4:return r.next=6,co.requestAnimationFrame;case 6:if(a=e(),!(a&&a.next&&a["throw"])){r.next=11;break}return r.next=10,a;case 10:a=r.sent;case 11:t(a);case 12:case"end":return r.stop()}},r,this)}))}()}function checkDOMControl(e){for(var t=[e.ownerDocument&&e.ownerDocument.documentElement,document.documentElement,e.ownerDocument&&e.ownerDocument.body,document.body].filter(Boolean),n=e;n;){if(t.indexOf(n)>=0)return void ra.forceCalculations();n=n.parentNode}}function setContent(e,t){var n=void 0===arguments[2]?null:arguments[2];fcalc(t,function(t){checkDOMControl(e);var r=toNode(t);r?(checkDOMControl(e),e.innerHTML="",e.appendChild(r)):e.innerHTML="",n&&n()})}function toAttrString(e){return Array.isArray(e)?e.map(toAttrString).join(" "):e?""+e:""}function appendContent(e,t){t||(t=document.createDocumentFragment());var n=!0,r=!1,a=void 0;try{for(var o,u=e[Symbol.iterator]();!(n=(o=u.next()).done);n=!0){var i=o.value;if("function"==typeof i){var c=document.createElement("span");setContent(c,i),t.appendChild(c)}else if(i instanceof Node)t.appendChild(i);else if(null!=i&&"string"!=typeof i&&i[Symbol.iterator]){var l=!0,f=!1,s=void 0;try{for(var d,p=i[Symbol.iterator]();!(l=(d=p.next()).done);l=!0){var h=d.value;appendContent(h,t)}}catch(m){f=!0,s=m}finally{try{!l&&p["return"]&&p["return"]()}finally{if(f)throw s}}}else t.appendChild(document.createTextNode(i))}}catch(m){r=!0,a=m}finally{try{!n&&u["return"]&&u["return"]()}finally{if(r)throw a}}return t}var co=require("co"),ra=require("ra"),lodash=require("lodash"),GeneratorFunctionPrototype=Object.getPrototypeOf(regeneratorRuntime.mark(function e(){return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:case"end":return e.stop()}},e,this)}));module.exports={createElement:function(e,t){function n(e){null!=e&&(lodash.forEach(e,function(e,t){if("_"==t);else if("class"==t)c.push(e);else if("style"==t)fcalc(e,function(e){"string"==typeof e?i.setAttribute("style",e):lodash.forEach(e,function(e,t){return fcalc(e,function(e){return i.style[t]=e})})});else if("oncreate"==t)u=e;else if(t.match(/^on/)){if(null!=e){"function"==typeof e&&(e=[e]);var n=!0,r=!1,a=void 0;try{for(var o,l=e[Symbol.iterator]();!(n=(o=l.next()).done);n=!0){var f=o.value;Object.getPrototypeOf(f)==GeneratorFunctionPrototype&&(f=co.eventHandler(f)),i.addEventListener(t.slice("on".length),f)}}catch(s){r=!0,a=s}finally{try{!n&&l["return"]&&l["return"]()}finally{if(r)throw a}}}}else fcalc(e,function(e){e=toAttrString(e),i.getAttribute(t)!=e&&i.setAttribute(t,e)})}),Object.prototype.hasOwnProperty.call(e,"_")&&n(e._))}for(var r=arguments.length,a=Array(r>2?r-2:0),o=2;r>o;o++)a[o-2]=arguments[o];if("function"==typeof e)return e(t&&t._?Object.assign({},t,t._,{_:null}):t||0,appendContent(a));var u=void 0,i=document.createElement(e),c=[];switch(n(t),c.length&&!function(){var e=c.map(function(){return null});c.forEach(function(t,n){return fcalc(t,function(t){e[n]=t;var r=toAttrString(e).replace(/(^|\s|\r|\n)(null|undefined|false|0|\-0|NaN)(?=$|\s|\r|\n)/g,"");i.className!=r&&(i.className=r)})})}(),a.length){case 0:break;case 1:setContent(i,a[0]);break;default:i.appendChild(appendContent(a))}return"function"==typeof u&&u.call(i,{type:"create",target:i,srcElement:i,currentTarget:i}),i}};for(var updateInputValue=function(){var e=this;setTimeout(function(){return e._raValue.assign(e.value)})},raValue={get:function(){var e=this;return this._raValue||ra.detach(function(){e._raValue=ra(),e._raValue.assign(e.value),e.addEventListener("change",updateInputValue),e.addEventListener("keypress",updateInputValue),e.addEventListener("keydown",updateInputValue),e.addEventListener("keyup",updateInputValue)}),this._raValue.valueOf()},set:function(e){this.value!=e&&(this.value=e,this._raValue&&this._raValue.assign(this.value))}},_arr=[HTMLInputElement,HTMLTextAreaElement],_i=0;_i<_arr.length;_i++){var C=_arr[_i];Object.defineProperty(C.prototype,"raValue",raValue)}
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
"use strict";function _defineProperty(n,t,e){return Object.defineProperty(n,t,{value:e,enumerable:!0,configurable:!0,writable:!0})}var lodash=require("lodash"),UID=require("uid"),lu=require("localUtils");exports.Clear=exports.Unlink=function(n,t){return lodash.reduce(n.content,function(n,e,o){return e&&(o==t?n.content[o]=null:e.content&&e.content[t]&&(n.content[o]={content:_defineProperty({},t,null)})),n},{content:{}})},exports.Set=function(n,t,e){var o=n.content[t];if(o&&o.group){var r={content:_defineProperty({},t,e)};return"group"==o.type&&(r=lodash.reduce(o.content,function(n,t,o){return t&&(n.content[o]=e),n},r)),r}},exports.findFreeGroup=function(n){for(var t=[],e=1;1022>=e;++e)t[e]=e;return lodash.forEach(n.content,function(n){return n&&Number.isFinite(n.group)&&(t[n.group]=!1)}),t=t.filter(Boolean),t.length?t[Math.floor(Math.random()*t.length)%t.length]:null},exports.cleanDatabase=function(n){function t(n){u=lu.applyDiff(u,n)}function e(n,e){t(n.reduceRight(function(n,t){return _defineProperty({},t,n)},e))}function o(){for(var n=arguments.length,t=Array(n),o=0;n>o;o++)t[o]=arguments[o];e(t,t.pop())}function r(){for(var n=arguments.length,t=Array(n),o=0;n>o;o++)t[o]=arguments[o];e(t,null)}function c(n){i||!function(){var n=function(n){return n in i||!u.content.hasOwnProperty(n)||(i[n]=!0,t.push(n)),n};i=Object.create(null);var t=[];n(u.main);for(var e=0;e<t.length;++e){var o=u.content[t[e]];o&&o.content&&Object.keys(o.content).forEach(n)}}();var t=0;"group"==u.content[n].type&&(t+=2),n in i&&(t+=1)}var u=n||{};u.content?lodash.forEach(u,function(n,t){(null==n||"object"==typeof n)&&"content"!=t&&r(t)}):lodash.forEach(u,function(n,t){(null==n||"object"==typeof n)&&(r(t),o("content",t,n))}),lodash.forEach(u.content,function(n,t){if(null==n||"object"!=typeof n)return r("content",t);if("device"==n.type&&o("content",t,"type","single"),n.device==t)r("content",t,"device");else if(!(n.type||"").match(/^(place|group|single)$/))return r("content",t);null==n.group||Number.isFinite(n.group)&&"place"!=n.type||r("content",t,"group")}),u&&"string"!=typeof u.main&&!function(){var n=UID(),t=0;lodash.forEach(u.content,function(e,r){return o("content",n,"content",r,++t)}),u.content&&u.content[n]&&o("main",n)}();var i=void 0,a=Object.create(null);return lodash.forEach(u.content,function(n,t){n&&null!=n.group&&(a[n.group]?c(a[n.group])<c(t)?(r("content",a[n.group]),a[n.group]=t):r("content",t):a[n.group]=t)}),lodash.forEach(u.content,function(n,t){if(n&&null!=n.content){if("object"!=typeof n.content)return r("content",t,"content");lodash.forEach(n.content,function(n,e){u.content[e]&&"object"==typeof u.content[e]||r("content",t,"content",e)}),n=u.content[t],lodash.keys(n.content).sort(function(t,e){return(n.content[t].index||0)-(n.content[e].index||0)}).forEach(function(e,r){n.content[e].index!=r&&o("content",t,"content",e,"index",r)})}}),lu.makeDiff(n,u)};
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
"use strict";function _toConsumableArray(e){if(Array.isArray(e)){for(var t=0,a=Array(e.length);t<e.length;t++)a[t]=e[t];return a}return Array.from(e)}function squareDistance(e,t){return(e.pageX-t.pageX)*(e.pageX-t.pageX)+(e.pageY-t.pageY)*(e.pageY-t.pageY)}function getX(e){return e.pageX}function getY(e){return e.pageY}function increasing(e,t,a){return 0==t||e>=a[t-1]}function decreasing(e,t,a){return 0==t||e<=a[t-1]}var co=require("co"),sparsequeue=require("sparsequeue"),TRACE=void 0,SWIPE_TIMEOUT=400,PRESS_TIMEOUT=500,PRESS_MOVE_OUT=2*(96/25.4);document.addEventListener("touch",co.eventHandler(regeneratorRuntime.mark(function e(t){var a,n,r,u,i,p,o,c,s,l,g,m,f,E,T,d,h,y,v,X,Y,S,M,A,R,_;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:E=function q(){clearTimeout(f),f=setTimeout(function(){l(),g("stop"),q()},PRESS_TIMEOUT)},g=function(e,t,a,n){var r=s(e,t,a,n);p&&(o&&o.length?(o[0].queue.push(r),o.forEach(function(e,t){return t>0&&(e.dirty=!0)}),p.dirty=!0):p.queue.push(r))},l=function(e){p||(p={queue:new sparsequeue},s("pan",e,r,{next:p.queue,lock:function(){o||(o=[]);var e={queue:new sparsequeue};return o.push(e),e.queue},unlock:function(e){o=o.filter(function(t){return t!=e});var t=o[0]||p;t.dirty&&(t.dirty=!1,g("pan","unlocked"))}},""))},s=function(e,n,i,p,o){TRACE&&TRACE(e,a),null==o&&(o=n),p||(p={}),p.direction=n,p.pressed=u,p.type=e,p.start=t,p.original=i||t;var s=new CustomEvent(e+(o||""),{bubbles:!0,cancelable:!0,detail:p});return s.pageX=r.pageX,s.pageY=r.pageY,s.clientX=r.clientX,s.clientY=r.clientY,s.screenX=r.screenX,s.screenY=r.screenY,s.deltaX=r.pageX-t.pageX,s.deltaY=r.pageY-t.pageY,s.lastDeltaX=r.pageX-c.pageX,s.lastDeltaY=r.pageY-c.pageY,c=r,s.preventDefault=function(){return t.preventDefault()},t.target.dispatchEvent(s),s},a=void 0,n=[t],r=t,u=null,i=!1,p=null,o=null,c=t,co.defer(function(){o&&o.forEach(function(e){return e.queue.close()}),p&&p.queue.close()}),m=void 0,f=void 0,co.defer(function(){clearTimeout(m),clearTimeout(f)}),m=setTimeout(function(){u=!0,s("press")},PRESS_TIMEOUT),E(),TRACE&&TRACE("enter",{x:t.pageX,y:t.pageY,t:t.timeStamp}),T=t,d=void 0;case 21:return e.next=23,t.detail.next;case 23:if(!(d=e.sent)){e.next=31;break}TRACE&&((a||(a=[])).push({x:d.pageX,y:d.pageY,t:d.timeStamp-t.timeStamp}),TRACE("next",a)),r.timeStamp-t.timeStamp>SWIPE_TIMEOUT&&(n=null),h=squareDistance(d,T)>PRESS_MOVE_OUT*PRESS_MOVE_OUT,h&&(T=d,E()),(h||!n||n.length>1)&&(null==u&&(u=!1,clearTimeout(m)),y=d.pageX-r.pageX,v=d.pageY-r.pageY,(y||v)&&(X=Math.abs(y),Y=Math.abs(v),S=r,n&&n.push(r),r=d,M="",X>=Y&&y>0?M="right":X>=Y&&0>y?M="left":Y>X&&v>0?M="down":Y>X&&0>v&&(M="up"),l(M),g("pan",M,r)));case 29:e.next=21;break;case 31:clearTimeout(m),r.timeStamp-t.timeStamp<SWIPE_TIMEOUT&&n&&n.length>2&&(n.shift(),A=n.map(getX),R=n.map(getY),_={x:Math.max.apply(Math,_toConsumableArray(A))-Math.min.apply(Math,_toConsumableArray(A)),y:Math.max.apply(Math,_toConsumableArray(R))-Math.min.apply(Math,_toConsumableArray(R))},M="",_.x>_.y&&A.every(increasing)?M="right":_.x>_.y&&A.every(decreasing)?M="left":_.x<_.y&&R.every(increasing)?M="down":_.x<_.y&&R.every(decreasing)&&(M="up"),M&&(i=!0,g("swipe",M,r))),u||i||p||g("tap"),TRACE&&TRACE("done",a);case 35:case"end":return e.stop()}},e,this)})));
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
"use strict";var style=document.createElement("div").style;!("transform"in style)&&"webkitTransform"in style&&Object.defineProperty(CSSStyleDeclaration.prototype,"transform",{get:function(){return this.webkitTransform},set:function(t){this.webkitTransform=t}}),NodeList.prototype[Symbol.iterator]||(NodeList.prototype[Symbol.iterator]=regeneratorRuntime.mark(function t(){var e,r;return regeneratorRuntime.wrap(function(t){for(;;)switch(t.prev=t.next){case 0:e=0,r=this.length;case 1:if(!(r>e)){t.next=7;break}return t.next=4,this.item(e);case 4:++e,t.next=1;break;case 7:case"end":return t.stop()}},t,this)}));
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
"use strict";exports.preventDefault=function(e){return e&&e.preventDefault&&e.preventDefault()},exports.Submit=function(e){e&&e.preventDefault();for(var t=this;t&&!(t instanceof HTMLFormElement);)t=t.parentNode;return t&&t.dispatchEvent(new CustomEvent("submit",null)),!1};var centered="\n	width: 100%;\n	height: 100%;\n	vertical-align: middle;\n	text-align: center;\n";exports.Centered=function(e,t){return React.createElement("table",{style:centered},React.createElement("tr",{style:centered},React.createElement("td",{style:centered},t)))},exports.isEmptyNode=function(e){return e instanceof Comment||e instanceof ProcessingInstruction||e instanceof Text&&!e.nodeValue.trim()},exports.importTemplate=function(e){return document.importNode(e.content,!0)},exports.importElement=function(e){var t=exports.importTemplate(e);if(!t)return null;for(;t.lastChild&&exports.isEmptyNode(t.lastChild);)t.removeChild(t.lastChild);for(;t.firstChild&&exports.isEmptyNode(t.firstChild);)t.removeChild(t.firstChild);if(!t.firstChild)return null;if(1==t.childNodes.length)return t.childNodes.item(0);var n=document.createElement("span");return n.appendChild(t),n},exports.importComponent=function(e){var t=exports.importElement(e);if(t){var n=t.getElementsByClassName("init")[0];if(n&&"init"==n.type){var r=new Function("component",[].slice.call(n.childNodes).map(function(e){return e.data||""}).join(""));r(t)}}return t},exports.tickCache=function(e){var t=void 0,n=!1,r=function(){t=null,n=!1};return function(){return n||(t=e.apply(this,arguments),n=!0,setImmediate(r)),t}},exports.createEvent=function(e,t,n){var r=new CustomEvent(e,{detail:t,bubbles:!0,cancelable:!0});return n&&(r.pageX=n.pageX,r.pageY=n.pageY,r.clientX=n.clientX,r.clientY=n.clientY,r.screenX=n.screenX,r.screenY=n.screenY),r},exports.sendEvent=function(e,t,n){return n.target.dispatchEvent(exports.createEvent(e,t,n))};
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
"use strict";var httpClient={get:function(t,e){return httpClient.xhr({method:"GET",url:t,encoding:e})},post:function(t,e,n){return httpClient.xhr({method:"POST",url:t,data:e,encoding:n})},xhr:function t(e){var n=e.method,r=e.url,o=e.encoding,u=e.data,t=new XMLHttpRequest;"binary"==o?t.responseType="arraybuffer":t.responseType="text";var a=new Promise(function(e,o){var u=function(t){"string"==typeof t&&(t=new Error(t),t.method=n,t.url=r),global._ALERT&&global._ALERT("try "+t+r),o(t)};t.ontimeout=function(){return u(new Error("TIMEOUT "+r))},t.onerror=function(t){return u(t||"ERROR")},t.onreadystatechange=function(){t.readyState==t.DONE&&0==t.status&&t.ontimeout()},t.onload=function(){if(t.status>=200&&t.status<=299)return e(null==t.response?null:t.response);if(401==t.status){var n=require("url").parse(r);n.host&&!function(){n=""+n.protocol+"//"+n.host+"/dummy."+Math.random()+".js";var t=document.createElement("script");t.src=n,document.body.appendChild(t),setTimeout(function(){return document.body.removeChild(t)},1e3)}()}u(""+t.status+" "+t.statusText)}});switch(o){case"immutable":a=a.then(function(t){return Immutable.fromJS(JSON.parse(t))});break;case"binary":a=a.then(function(t){return new Uint8Array(t)});break;case"text":break;default:a=a.then(function(e){var n=o;if(!n){var r=t.getResponseHeader("content-type")||"";r.match(/^application\/json/)&&(n="json")}switch(n){case"json":return JSON.parse(e)}return e})}return t.open(n||"GET",r),t.withCredentials=!0,t.send(u),t.then=a.then.bind(a),t["catch"]=a["catch"].bind(a),t},url:function(t,e){return e&&Object.keys(e).forEach(function(n,r){return t=t+(r>0?"&":"?")+encodeURIComponent(n)+"="+encodeURIComponent(e[n])}),t}};module.exports=httpClient;
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
"use strict";if(Object.defineProperty(Object.prototype,"_LOG_",{value:function(){return console.log(this),this},configurable:!0}),"function"==typeof Symbol&&Symbol.iterator){var x=null;try{x=eval.call(null,"(function*(){}().constructor.prototype)")}catch(_){}x&&!x[Symbol.iterator]&&(x[Symbol.iterator]=function(){return this})}
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
"use strict";function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function rethrow(e){setTimeout(function(){throw e})}function safeEach(e,t){for(var n=0,r=e.length;r>n;++n)try{t(e.shift())}catch(s){rethrow(s)}}var _createClass=function(){function e(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(t,n,r){return n&&e(t.prototype,n),r&&e(t,r),t}}();module.exports=function(){function e(){_classCallCheck(this,e),this._cbs=[]}return _createClass(e,[{key:"then",value:function(e){this._closed?process.nextTick(function(){return e(void 0)}):this._cbs.push(e)}},{key:"isClosed",value:function(){return this._closed}},{key:"close",value:function(){this._closed=!0,safeEach(this._cbs,function(e){return e(void 0)})}},{key:"push",value:function(e){if(this._closed)throw new Error("queue is aready closed");safeEach(this._cbs,function(t){return t(e)})}},{key:"pushcb",value:function(e){if(this._closed)throw new Error("queue is aready closed");safeEach(this._cbs,function(t){return t(e())})}}]),e}();
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
"use strict";function pushEvent(e,n){e.points.push(n),e.preventDefault&&n.preventDefault&&n.preventDefault()}function stopEvents(e){e.points.close()}function startTrack(e,n){var t=new sparsequeue,a={cancelEvent:null,next:t},r={abandoned:!1,closed:!1,detail:a,points:t,preventDefault:!1};tracks[e]=r;var c=new CustomEvent("touch",{detail:a,bubbles:!0,cancelable:!0});c.pageX=n.pageX,c.pageY=n.pageY,c.clientX=n.clientX,c.clientY=n.clientY,c.screenX=n.screenX,c.screenY=n.screenY,c.preventDefault=function(){n.preventDefault(),r.preventDefault=!0},n.target.dispatchEvent(c),pushEvent(r,n)}function onExistingTrack(e){return function(n,t){var a=tracks[n];a&&(a.abandoned=!1,e(a,t))}}function forTouches(e,n){for(var t=0;t<e.changedTouches.length;++t){var a=e.changedTouches.item(t);n(a.identifier,{type:"touchmove",identifier:a.identifier,target:a.target,screenX:a.screenX,screenY:a.screenY,clientX:a.clientX,clientY:a.clientY,pageX:a.pageX,pageY:a.pageY,radiusX:a.radiusX,radiusY:a.radiusY,rotationAngle:a.rotationAngle,force:a.force,timeStamp:e.timeStamp,preventDefault:e.preventDefault.bind(e)})}for(var r=Object.create(null),t=0;t<e.touches.length;++t)r[e.touches.item(t).identifier]=!0;for(var c in tracks)c in r?tracks[c].abandoned=!1:removeTrack(c)}var sparsequeue=require("sparsequeue"),tracks=Object.create(null);setInterval(function(){for(var e in tracks){var n=tracks[e];n.abandoned||(n.abandoned=!0)}},7e3);var continueTrack=onExistingTrack(pushEvent),stopTrack=onExistingTrack(function(e,n){pushEvent(e,n),stopEvents(e)}),removeTrack=onExistingTrack(stopEvents),cancelTrack=onExistingTrack(function(e,n){e.detail.cancelEvent=n,stopEvents(e)}),container=document;container.addEventListener("mousedown",function(e){0==e.button?startTrack("mouse",e):1&e.buttons||removeTrack("mouse")}),container.addEventListener("mousemove",function(e){1&e.buttons?continueTrack("mouse",e):removeTrack("mouse")}),container.addEventListener("mouseup",function(e){0==e.button?stopTrack("mouse",e):1&e.buttons||removeTrack("mouse")}),container.addEventListener("touchstart",function(e){forTouches(e,startTrack)}),container.addEventListener("touchmove",function(e){forTouches(e,continueTrack)}),container.addEventListener("touchend",function(e){forTouches(e,stopTrack)}),container.addEventListener("touchcancel",function(e){forTouches(e,cancelTrack)});
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
"use strict";module.exports=function(e){var t=e.load(require("ui/Command"));return function(i){return React.createElement(t,{message:"commandAddExistingItem",onclick:function(){e.dialog="SearchItems",e.searchAction=function(t){e.linkItem(e.activeDeviceId,t),e.dialog=""},e.searchFilter=null,"group"==e.deviceType&&(e.searchFilter=function(t){var i=e.getDevice(t);return i&&"single"==i.type})},_:i})}};
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
"use strict";module.exports=function(e){var c=e.load(require("ui/Command")),t=e.load(require("ui/AddExistingItem"));return React.createElement("div",null,React.createElement(t,null),React.createElement(c,{message:"commandCreateNewGroup",onclick:function(){e.addGroup(e.activeDeviceId)}}),React.createElement(c,{message:"commandAddNewDevice",onclick:function(){return e.addDevice(e.activeDeviceId)}}),React.createElement(c,{message:"commandAddPlace",onclick:function(){e.addPlace(e.activeDeviceId)}}))};
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
"use strict";module.exports=function(e){var t=e.appid,n=e.IconTemplates,a=require("app")(t),l=a.app,c=a.local;l.pageStarting=!0,window._app=l,window._local=c,window._devdb=require("devdb"),navigator.standalone||ra(function(){if(c.activeDeviceId&&c.activeDeviceId.valueOf()){var e="TITLE_"+c.activeDeviceId,t="ICON_"+c.activeDeviceId;screenTitle.setAttribute("content",e),c.activeDeviceId&&"main"!=c.activeDeviceId?history.replaceState(null,e,"?appicon="+t):history.replaceState(null,e,"?")}});var r=l.load(require("ui/MainScreen")),i=l.load(require("ui/StartupScreen")),o=function(){return React.createElement("div",{"class":"loadingScreen"})},u=React.createElement("div",{"class":function(){return"\n		application\n		"+(l.pageStarting?"pageStarting":"pageRunning")+"\n		"+(l.initialLoading?"JSONloading":"JSONloaded")+"\n		"+(l.initialized?"alreadyRun":"firstRun")+"\n		"+(l.connectedToServer?"appConnected":"appDisconnected")+"\n		\n		"+(l.templates?"templatesLoaded":"templatesLoading")+"\n		"+(l.dialog&&"dialog"+l.dialog)+"\n		"+(l.dialog?"dialogIsPresent":"dialogIsAbsent")+"\n		app_labels_"+!!c.labels+"\n		app_editing_"+!!l.editing+"\n	"}},React.createElement(r,null),React.createElement(i,null),React.createElement(o,null));l.icons=n.reduce(function(e,t){return e[t.dataset.name]=t,e},Object.create(null));var d=l.load(require("ui/Button")),s=function(e,t){return React.createElement("p",{ontouch:function(){var t=l.error;l.dialog="",l.error=null,e.onclick&&e.onclick(t)},_:Object.assign({},e,{onclick:null})},t)},m=function(e,t){return React.createElement("p",{ontouch:function(){l.dialog="",e.onclick&&e.onclick()},_:Object.assign({},e,{onclick:null})},t)},p={ServiceDialog:function(){return l.load(require("ui/ServiceDialog"))},ContextMenu:function(){return l.load(require("ui/ContextMenu"))},AddMenu:function(){return l.load(require("ui/AddMenu"))},SearchItems:function(){return l.load(require("ui/SearchItems"))},AskNewName:function(){return l.load(require("ui/AskNewName"))},AskToLinkDevice:function(){return l.load(require("ui/AskToLinkDevice"))},AskIfDeviceHasBeenLinked:function(){return React.createElement("div",null,React.createElement("p",null,"Устройство было успешно привязано?"),React.createElement(d,{onclick:"StopDeviceNotification"},"да"),React.createElement(d,{onclick:"AskToLinkDevice"},"нет"))},StopDeviceNotification:function(){return React.createElement("div",null,React.createElement("p",null,"Пожалуйста,",React.createElement("br",null),"переведите устройство в рабочий режим."),React.createElement(d,null,"Закрыть"))},ErrorNoCarrier:function(){return React.createElement("div",{"class":"errorDialog"},React.createElement("p",null,"Ошибка"),React.createElement("p",null,"Произошла ошибка при попытке связаться с модемом."),React.createElement(d,null,"Закрыть"))},ErrorUnlinkingDevice:function(){return React.createElement("div",{"class":"errorDialog"},React.createElement("p",null,"Ошибка"),React.createElement("p",null,"Не удалось связаться с устройством и отвязать его."),React.createElement("p",null,"Что следует сделать?"),React.createElement("ul",null,React.createElement(s,{onclick:function(e){return l.purgeItem(e.data.deviceId)}},React.createElement("li",null,"Попытаться отвязать устройство ещё раз")),React.createElement(s,null,React.createElement("li",null,"Отменить удаление")),React.createElement(s,{onclick:function(e){return l.purgeItem(e.data.deviceId,!0)}},React.createElement("li",null,"Забыть информацию об устройстве"))))},DeleteDevice:function(){return React.createElement("div",null,React.createElement("p",null,{place:React.createElement("span",null,'Помещение (место) "',l.caption,'" будет удалено из программы.'),single:React.createElement("span",null,'Устройство "',l.caption,'" будет удалено из программы.'),group:React.createElement("span",null,'Группа "',l.caption,'" будет удалена из программы.')}[l.deviceType]),React.createElement("ul",null,React.createElement(m,{"class":"dangerousAction",onclick:function(){return l.purgeItem(l.activeDeviceId)}},React.createElement("li",null,"Удалить")),React.createElement(m,null,React.createElement("li",null,"Не удалять"))))},StateWait:function(){return React.createElement("div",null,React.createElement("p",null,"Подождите..."))},AskToReset:function(){return React.createElement("div",null,React.createElement("p",null,"Память контроллера будет очищена,",React.createElement("br",null),"но память устройств очищаться не будет."),React.createElement(d,{"class":"dangerousAction",onclick:l.reset},"Очистить",React.createElement("br",null),"память"))}};return ra(function(){var e=l.dialog;if(e){if(!Object.prototype.hasOwnProperty.call(p,e))return alert('Error: Could not find dialog named\n"'+e+'"'),void ra.detach(function(){return l.dialog=""});var t=p[e];if(t){p[e]=null;var n=t();n.classList.add(e),n.classList.add("modalDialog"),ra(Object.defineProperties({},{isActive:{get:function(){return e==l.dialog},configurable:!0,enumerable:!0},updateClass:{get:function(){var e=void 0;if(this.isActive){e="dialogshow",n.classList.add("dialogShown"),n.classList.remove("dialogHidden");var t=n.querySelector("*[ autofocus ]");t&&l.focus(t)}else{e="dialoghide",n.classList.remove("dialogShown"),n.classList.add("dialogHidden");var a=!0,c=!1,r=void 0;try{for(var i,o=n.querySelectorAll("*:focus")[Symbol.iterator]();!(a=(i=o.next()).done);a=!0){var u=i.value;u.blur()}}catch(d){c=!0,r=d}finally{try{!a&&o["return"]&&o["return"]()}finally{if(c)throw r}}n.blur()}n.dispatchEvent(new CustomEvent(e,{detail:null}))},configurable:!0,enumerable:!0}})),u.appendChild(n)}}}),setTimeout(function(){return l.pageStarting=!1},1),u};
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
"use strict";var htmlutils=require("htmlutils");module.exports=function(e){var t={};return React.createElement("div",{ondialogshow:function(){t.string.value=e.getMessage(e.getDevice(e.activeDeviceId)),t.string.setSelectionRange(0,t.string.value.length)}},React.createElement("p",null,"Название:"),React.createElement("form",{onsubmit:function(a){a&&a.preventDefault();var n=t.string.value.trim();e.dialog="",n&&e.renameItem(e.activeDeviceId,n)}},t.string=React.createElement("textarea",{name:"string",cols:"35",rows:"2",autofocus:"autofocus"}),React.createElement("p",null,React.createElement("a",{"class":"button",href:"javascript:void(0)",target:"_self",ontouch:htmlutils.Submit},"Закрыть"))))};
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
"use strict";module.exports=function(e){var t=e.load(require("ui/Button"));return React.createElement("div",null,React.createElement("p",null,"Пожалуйста,",React.createElement("br",null),"переведите устройство в режим",React.createElement("br",null),"программирования и нажмите"),React.createElement(t,{onclick:function(){var t=e.linkingPlaceId||e.activeDeviceId;e.dialog="StateWait",co.go(regeneratorRuntime.mark(function n(){return regeneratorRuntime.wrap(function(n){for(;;)switch(n.prev=n.next){case 0:return n.next=2,e.command(t,"Link");case 2:e.dialog="AskIfDeviceHasBeenLinked",e.linkingPlaceId=t;case 4:case"end":return n.stop()}},n,this)}))["catch"](function(t){console.log(t),e.dialog="ErrorNoCarrier"})}},"здесь"))};
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
"use strict";module.exports=function(t){return function(c,n){return React.createElement("a",{"class":"button",href:"javascript:void(0)",target:"_self",ontouch:function(n){n.preventDefault(),"string"==typeof c.onclick?t.dialog=c.onclick:(t.dialog="",c.onclick&&c.onclick())},_:Object.assign({},c,{onclick:null})},n)}};
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
"use strict";module.exports=function(e){return function(t){var n=t.onclick,r=t.url,a=t.visible,i=t.enabled,l=t.message,c=e.message(l),o=function(){return(r||n)&&(!i||i())};"string"==typeof a&&!function(){var t=a;a=function(){return e.deviceType==t}}();var s=function(){return"command "+l+" "+(o()?"enabled":"disabled")+" "+(null==a||a()?"itemVisible":"itemHidden")};return r&&!n?React.createElement("a",{"class":s,href:r,rel:"external",target:"_blank"},c):React.createElement("a",{"class":s,href:"javascript:void(0)",target:"_self",ontouch:function(t){t.preventDefault(),n&&o()&&("string"==typeof n?e.dialog=n:(e.dialog="",n()))}},c)}};
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
"use strict";module.exports=function(e,n){var i=e.load(require("ui/Command")),t=e.load(require("ui/AddExistingItem"));return React.createElement("div",null,React.createElement(i,{message:"commandSearchDevices",onclick:"SearchItems"}),React.createElement(i,{message:"commandToFavourites",visible:function(){return!e.editing&&e.activeDeviceId!=e.main},onclick:function(){e.linkActiveToFavourites(),e.notification("Добавлено в избранное")}}),React.createElement(i,{message:"commandLinkDevice",visible:"device",onclick:"AskToLinkDevice"}),React.createElement(i,{message:"commandAdd",visible:function(){return!e.editing&&"place"==e.deviceType},onclick:"AddMenu"}),React.createElement(t,{message:"commandAdd",visible:function(){return!e.editing&&"group"==e.deviceType}}),React.createElement(i,{message:"commandMoveIcons",visible:function(){return!e.editing&&"single"!=e.deviceType},onclick:function(){return e.editing=!0}}),React.createElement(i,{message:"commandRenameItem",visible:function(){return!e.editing},onclick:"AskNewName"}),React.createElement(i,{message:"commandPurgeItem",visible:function(){return!e.editing&&e.activeDeviceId!=e.main},onclick:function(){e.dialog="DeleteDevice"}}),React.createElement(i,{message:"commandShowLabels",visible:function(){return!n.labels&&e.activeDeviceId==e.main},onclick:function(){return n.labels=!0}}),React.createElement(i,{message:"commandHideLabels",visible:function(){return n.labels&&e.activeDeviceId==e.main},onclick:function(){return n.labels=!1}}),React.createElement(i,{message:"commandResetToFactorySettings",visible:function(){return e.activeDeviceId==e.main},enabled:function(){return"test.sh.neroelectronics.by"!=window.location.hostname},onclick:"AskToReset"}))};
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
"use strict";function _defineProperty(e,t,n){return Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0})}var lodash=require("lodash"),htmlutils=require("htmlutils");module.exports=function(e,t){return function(n){function i(e,t){return e.index-t.index}var r=n.placeId,a=n.iconId,o=n.iconDescr,c=n.position,u=void 0,s=void 0,l=void 0,d=void 0,f=void 0,g=!1,m=htmlutils.tickCache(function(){for(var e=u.parentNode,t=void 0;t=e.getBoundingClientRect(),!t.width||!t.height;)e=e.parentNode;return t}),p=function(e){var t=m();return{x:(e.x-t.left)/t.width*100,y:(e.y-t.top)/t.height*100}},h=function(e){return p({x:e.pageX,y:e.pageY})},v=function(e){var t=e.getBoundingClientRect();return p({x:t.left,y:t.top})},x=htmlutils.tickCache(function(){if(!g)return u.getBoundingClientRect().height;if(y.iconData){if(y.iconData.deviceImageGetHeight){var e=y.iconData.deviceImageGetHeight();if(e)return e}var t=y.iconData.getElementsByClassName("device_image_height")[0];if(null!=t&&t.getBoundingClientRect){var e=t.getBoundingClientRect().height;if(e)return e}for(var n=0;n<y.iconData.childNodes.length;++n){var e=y.iconData.childNodes.item(n);if(e.getBoundingClientRect&&(e=e.getBoundingClientRect().height))return e}}return f.getBoundingClientRect().height}),y=ra(Object.defineProperties({iconData:null,iconCommand:function(t,n){return e.iconCommand(o,a,t,n)},isDimmering:!1,moving:!1,moved:!1,x:null,y:null,state:0,onning:!1,offing:!1,"final":!0,errorneous:!1,setOpacity:function(e,t){null==t?delete e.style.opacity:e.style.opacity=t}},{iconName:{get:function(){return o&&o.valueOf()&&o.valueOf().icon||null},configurable:!0,enumerable:!0},iconTemplate:{get:function(){return this.iconName&&e.icons&&Object.prototype.hasOwnProperty.call(e.icons,this.iconName)&&e.icons[this.iconName]||null},configurable:!0,enumerable:!0},updateIconDataState:{get:function(){var e=this.iconData;e&&e.deviceSetState&&e.deviceSetState(this.state)},configurable:!0,enumerable:!0},dimmering:{get:function(){var e=null==o?null:o.valueOf(),t=null==e?null:null==e.dimmering?null:!!e.dimmering;return null!=t?t:null!=e&&"place"===e.type?!1:!0},configurable:!0,enumerable:!0},image_on:{get:function(){var e=o&&o.valueOf(),t=""||e&&e.image_on||e&&e.image;return t&&"/images/"+t},configurable:!0,enumerable:!0},update_image_on:{get:function(){y.image_on&&(l.src=y.image_on)},configurable:!0,enumerable:!0},image_off:{get:function(){var e=o&&o.valueOf(),t=""||e&&e.image_off||e&&e.image;return t&&"/images/"+t},configurable:!0,enumerable:!0},update_image_off:{get:function(){y.image_off&&(s.src=y.image_off)},configurable:!0,enumerable:!0},present:{get:function(){return!(!o.get("content")&&!o.get("group"))},configurable:!0,enumerable:!0},updateState:{get:function(){var e=o&&o.valueOf();if(!e)return 0;if(e.newstate_timestamp&&(!e.state_timestamp||e.newstate_timestamp>e.state_timestamp)){var t=e.newstate>=e.state;this.onning=t,this.offing=!t,this["final"]=!1,this.state=e.newstate}else this.onning=!1,this.offing=!1,this["final"]=!0,this.state=e.state;this.errorneous=!!e.errorneous},configurable:!0,enumerable:!0},updateOpacity:{get:function(){this.iconTemplate?(l.style.visibility="hidden",s.style.visibility="hidden",d.style.visibility="hidden"):this.present?(this.setOpacity(d,0),this.dimmering?(this.setOpacity(l,this.state),this.setOpacity(s,.333*(1-this.state))):(this.setOpacity(l,+!!this.state),this.setOpacity(s,+!this.state))):(this.setOpacity(l,0),this.setOpacity(s,0),this.setOpacity(d,.7))},configurable:!0,enumerable:!0}})),b=.1,k=.25,_=regeneratorRuntime.mark(function O(n,s){var l,d,f,g,m;return regeneratorRuntime.wrap(function(p){for(var x=this;;)switch(p.prev=p.next){case 0:return y.moving&&y.moving.kill("restarting by another finger"),l=e.localDevices.createRecord(),d=c.valueOf(),f=!1,g=ra(Object.defineProperties({savedId:null,cachedId:null,id:null,position:null,updateApp:function(t){this.savedId&&(e.hover=lu.applyDiff(e.hover,_defineProperty({},this.savedId,_defineProperty({},r,_defineProperty({},a,t)))))}},{updateCache:{get:function(){this.cachedId=this.id},configurable:!0,enumerable:!0},saveId:{get:function(){this.updateApp(null),this.savedId=this.cachedId,this.updateApp(!0)},configurable:!0,enumerable:!0}})),p.prev=5,p.delegateYield(regeneratorRuntime.mark(function _(){var c,m,p,R,w,O,D;return regeneratorRuntime.wrap(function(x){for(;;)switch(x.prev=x.next){case 0:c=co.current,ra(function(){return!f&&!e.editing&&c.kill()}),m=h(n),p=v(u),y.moving=co.current,y.moved=!1,R={x:p.x-m.x,y:p.y-m.y},y.x=p.x,y.y=p.y,w=function(n){var c=h(n),u={x:c.x+R.x,y:c.y+R.y};(y.x!=u.x||y.y!=u.y)&&(y.moved=!0),y.x=u.x,y.y=u.y;var s={x:e.pageWidth,y:e.pageHeight},f={x:100/s.x,y:100/s.y},m={x:Math.min(s.x-1,Math.max(0,Math.floor(c.x/f.x))),y:Math.min(s.y-1,Math.max(0,Math.floor(c.y/f.y)))},p={x:c.x/f.x-m.x,y:c.y/f.y-m.y},v=m.x+m.y*s.x+(t.placesPages[r]||0)*s.x*s.y,x=p.x>k&&p.x<1-k&&p.y>k&&p.y<1-k;if(x&&g.position==v||(g.id=null),g.position=v,"stop"!=n.type)return"continue";if(g.id=null,p>1-b&&f.x==s.x-1)return"continue";if(b>p&&f.x==s.x-1)return"continue";var _=lu.get(l,"summary","content",r,"content");if(!_||!_[a])return{v:{v:void 0}};var w=lodash.keys(_).map(function(e){return{key:e,index:_[e].index}}).sort(i),O=void 0;if(0>v){if(0>=d)return"continue";O=w[0].index-1}else if(v>w.length-1){if(d>=w.length-1)return"continue";O=w[w.length-1].index+1}else{if(d==v)return"continue";if(x){g.id=w[v].key;var D=o&&o.valueOf()&&o.valueOf().type,C=e.getDevice(g.id),I=C&&C.type;if("place"==I)return"continue";if("group"==I&&"single"==D)return"continue";g.id=null}if(p.x>.5){if(d==v+1)return"continue";if(m.x==s.x-1&&d>v)return"continue";O=v>=w.length-1?w[v].index+1:(w[v].index+w[v+1].index)/2}else{if(d==v-1)return"continue";if(0==m.x&&v>d)return"continue";O=0>=v?w[v].index-1:(w[v].index+w[v-1].index)/2}}var P=w.map(function(e){return e.key!=a?e:{key:e.key,index:O}}).sort(i).findIndex(function(e){return e.key==a});return d==P?"continue":(d=P,void l.assign({content:_defineProperty({},r,{content:_defineProperty({},a,{index:O})})}))},O=void 0;case 11:return x.next=13,s;case 13:if(!(O=x.sent)){x.next=23;break}D=w(O),x.t0=D,x.next="continue"===x.t0?18:19;break;case 18:return x.abrupt("continue",21);case 19:if("object"!=typeof D){x.next=21;break}return x.abrupt("return",D.v);case 21:x.next=11;break;case 23:if(f=!0,!g.id){x.next=29;break}l.close(),e.insertInto(g.id,a,r),x.next=32;break;case 29:return x.next=31,co.sleep();case 31:lu.when(l.save(),function(){return l.close()});case 32:case"end":return x.stop()}},_,x)})(),"t0",7);case 7:if(m=p.t0,"object"!=typeof m){p.next=10;break}return p.abrupt("return",m.v);case 10:return p.prev=10,g.id=null,f||(f=!0,l.close()),y.moving==co.current&&(y.moving=null,y.moved=!1),p.finish(10);case 15:case"end":return p.stop()}},O,this,[[5,,10,15]])}),R=regeneratorRuntime.mark(function D(t){var n,i,r,c,u;return regeneratorRuntime.wrap(function(s){for(;;)switch(s.prev=s.next){case 0:n=e.localDevices.createRecord(),s.prev=1,i=void 0,y.isDimmering=!0,r=o&&o.get("state"),c=void 0;case 6:return s.next=8,t;case 8:if(!(c=s.sent)){s.next=13;break}"swipe"==c.detail.type?i="up"==data.detail.direction?1:0:(u=-c.deltaY/(1*x()),i=Math.min(1,Math.max(0,r+u)),(0==i||1==i)&&(r=i-u)),n.update({content:_defineProperty({},a,{state:i})});case 11:s.next=6;break;case 13:null!=i&&y.iconCommand("Set",i);case 14:return s.prev=14,n.close(),y.isDimmering=!1,s.finish(14);case 18:case"end":return s.stop()}},D,this,[[1,,14,18]])}),w=function(e){return React.createElement("img",{"class":"error",onerror:function(){this.classList.add("error")},onload:function(){this.classList.remove("error")},_:e})};return React.createElement("div",{oncreate:function(e){return u=e.target},onmousedown:function(){return g=!0},onwheel:function(e){return console.log(e.deltaY,e.deltaMode,e)},"class":function(){return"\n			icon\n			"+(y.onning&&"onning")+"\n			"+(y.offing&&"offing")+"\n			"+(y["final"]&&"final")+"\n			"+(y.errorneous&&"errorneous")+"\n			"+(y.dimmering.valueOf()?"dimmering":"switching")+"\n			"+a+"\n			icon_moving_"+!!y.moving+"\n			icon_moved_"+(!!y.moving&&!!y.moved)+"\n			icon_destination_"+!(!e.hover||!e.hover[a])+"\n		"},style:regeneratorRuntime.mark(function C(){var t,n,i,r,a,o,u,s,l;return regeneratorRuntime.wrap(function(d){for(;;)switch(d.prev=d.next){case 0:if(!e.editing){d.next=3;break}return d.next=3,co.sleep();case 3:if(C.run){d.next=7;break}C.run=!0,d.next=9;break;case 7:return d.next=9,co.requestAnimationFrame;case 9:return t=void 0,y.moving?t={x:y.x,y:y.y}:(n=lu.valueOf(c),i=e.pageHeight||1,r=e.pageWidth||1,a=r*i,o=n%a,u=(n-o)/a,s=o%r,l=(o-s)/r,s+=r*u,t={x:100*s/r,y:100*l/i}),d.abrupt("return",{left:""+t.x+"%",top:""+t.y+"%"});case 12:case"end":return d.stop()}},C,this)})},React.createElement("div",{"class":"iconControl",ontouch:htmlutils.preventDefault,ontap:function(){return!e.editing&&y.iconCommand("Short")},onpress:function(){return!e.editing&&y.iconCommand("Long")},onpan:regeneratorRuntime.mark(function I(t){var n,i;return regeneratorRuntime.wrap(function(r){for(;;)switch(r.prev=r.next){case 0:if(!e.editing){r.next=20;break}n=t.detail.lock(),r.prev=2,i=void 0;case 4:return r.next=6,n;case 6:if(!(i=r.sent)){r.next=15;break}if(i.detail.pressed!==!1){r.next=9;break}return r.abrupt("return");case 9:if(null!=i.detail.pressed){r.next=11;break}return r.abrupt("continue",13);case 11:return r.delegateYield(_(i,n),"t0",12);case 12:return r.abrupt("break",15);case 13:r.next=4;break;case 15:return r.prev=15,t.detail.unlock(n),r.finish(15);case 18:r.next=23;break;case 20:if("up"!=t.detail.direction&&"down"!=t.detail.direction){r.next=23;break}return t.stopPropagation(),r.delegateYield(R(t.detail.next),"t1",23);case 23:case"end":return r.stop()}},I,this,[[2,,15,18]])})},React.createElement("div",{"class":"image",oncreate:function(e){return f=e.target}},React.createElement(w,{"class":"wait",src:"/images/wait.svg",style:{visibility:function(){return(void 0)["final"]?"hidden":null}}}),React.createElement(w,{"class":"off",src:"/images/room.svg",oncreate:function(e){return s=e.target}}),React.createElement(w,{"class":"on",src:"/images/room_on.svg",oncreate:function(e){return l=e.target}}),React.createElement(w,{"class":"absent",src:"/images/room_absent.svg",oncreate:function(e){return d=e.target}}),React.createElement("div",{"class":function(){return"\n					svg\n					state"+(y.present?(Math.round(100*y.state)+1e3).toString().slice(1):"Absent")+"\n					"+(y.isDimmering?"":"smoothing")+"\n				"}},function(){return y.iconData=y.iconTemplate&&htmlutils.importComponent(y.iconTemplate)||null})),React.createElement("span",{"class":"iconLabel"},function(){return o.get(t.language)||o.get("ru")||o.get("en")}),React.createElement("span",{"class":"iconPercentage"},function(){return y.present&&y.dimmering&&""+Math.round(100*y.state)+"%"})),React.createElement("div",{"class":"deleteSign",ontouchstart:function(){return e.deleteItem(r,a)},onmousedown:function(){return e.deleteItem(r,a)}}))}};
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
"use strict";var htmlutils=require("htmlutils"),UID=require("uid");module.exports=function(e,t){var n=e.load(require("ui/Place"));return function(){function a(n){var a,i,c,s,l,o,u,d,p,g;return regeneratorRuntime.wrap(function(r){for(;;)switch(r.prev=r.next){case 0:a=void 0,i=void 0,c=void 0,s=e.activeDeviceId,e.placesShifts.defineProperty(s),t.placesPages.defineProperty(s),r.prev=4,l=void 0;case 6:return r.next=8,n;case 8:if(!(l=r.sent)){r.next=25;break}if(l.lastDeltaX&&(a=l.lastDeltaX),o=l.deltaX,u=e.menuElement.getBoundingClientRect(),d=e.getDevice(s),d&&d.content){r.next=15;break}return r.abrupt("return");case 15:if(c=Math.ceil(Object.keys(d.content).length/(e.pageWidth*e.pageHeight)),0!=c){r.next=18;break}return r.abrupt("continue",23);case 18:i=t.placesPages[s]||0,p=-i*u.width,g=l.deltaX,(g>0&&0==i||0>g&&i==c-1)&&(g/=3),e.placesShifts[s]=g;case 23:r.next=6;break;case 25:a&&(a>0&&i>0?t.placesPages[s]=i-1:0>a&&c-1>i&&(t.placesPages[s]=i+1));case 26:return r.prev=26,e.placesShifts[s]=0,r.finish(26);case 29:case"end":return r.stop()}},r[0],this,[[4,,26,29]])}var r=[a].map(regeneratorRuntime.mark),i=UID();return React.createElement("div",null,React.createElement("style",{"class":"style"},function(){return"\n				."+i+" .icon {\n					width: "+100/e.pageWidth+"%;\n					height: "+100/e.pageHeight+"%;\n				}\n			"}),React.createElement("div",{"class":"top"},React.createElement("span",{"class":"top_self"},React.createElement(htmlutils.Centered,null,function(){return e.caption}))),React.createElement("div",{"class":function(){return"menu "+i+" "+e.activeDeviceId},onpan:regeneratorRuntime.mark(function c(e){return regeneratorRuntime.wrap(function(t){for(;;)switch(t.prev=t.next){case 0:if("left"!=e.detail.direction&&"right"!=e.detail.direction){t.next=3;break}return e.stopPropagation(),t.delegateYield(a(event.detail.next),"t0",3);case 3:case"end":return t.stop()}},c,this)}),oncreate:function(){var a=this;e.menuElement=this;var r=Object.create(null);ra(function(){var i=e.activeDeviceId;i&&!r[i]&&(e.placesShifts.defineProperty(i),t.placesPages.defineProperty(i),r[i]=!0,a.appendChild(React.createElement(n,{placeId:i,placeDescr:ra(function(){return e.getDevice(i)})})))})}}),React.createElement("div",{"class":"bottom"},React.createElement("div",{"class":"help",onpress:function(){return e.dialog="ServiceDialog"}}),React.createElement("div",{"class":"logo",onpress:function(){return e.dialog="ContextMenu"},ontap:function(t){return t.shiftKey||t.srcEvent&&t.srcEvent.shiftKey?e.dialog="ContextMenu":t.ctrlKey||t.srcEvent&&t.srcEvent.ctrlKey?e.dialog="SearchItems":(e.editing=!1,e.dialog="",void e.go(e.main))}}),React.createElement("div",{"class":"back",ontouch:function(){e.editing?e.editing=!1:e.dialog?e.dialog="":e.back()}})))}};
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
"use strict";var Application=require("ui/Application");module.exports=function(e){var t=e.IconTemplates;return React.createElement("span",null,React.createElement("style",null," ",".application { position: fixed !important; } } "," "),React.createElement(Application,{IconTemplates:t}))};
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
"use strict";module.exports=function(e,n){var t=e.load(require("ui/Icon"));return function(r){var a=r.placeId,c=r.placeDescr,i=ra(function(){var e=c.get("content");return ra.Array(lodash.keys(e).sort(function(n,t){return lu.compare(e[n].index,e[t].index)}))}),l=ra.map(i,function(n,r){return React.createElement(t,{placeId:a,iconId:n,position:r,iconDescr:ra(function(){return e.getDevice(n)})})});return React.createElement("div",null,React.createElement("style",null,"\n				."+a+" .place."+a+" {\n					display: initial;\n				}\n			"),React.createElement("div",{"class":"place "+a,style:{transform:function(){return"translateX( "+(-(n.placesPages[a]||0)*e.menuElement.getBoundingClientRect().width+e.placesShifts[a]||0)+"px )"}}},function(){return l}))}};
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
"use strict";function _toConsumableArray(e){if(Array.isArray(e)){for(var r=0,t=Array(e.length);r<e.length;r++)t[r]=e[r];return t}return Array.from(e)}function watch(e,r){var t=void 0;return function(){return null==t&&ra.detach(function(){t=ra(e),ra(function(){t.valueOf(),r()})}),t.valueOf()}}var DL=require("DamerauLevenshtein"),notAChar=function(e){return" ">=e||"-"==e},fuzzy=function(e,r){return DL(e.toUpperCase(),r.toUpperCase(),{replace:1/0,"delete":function(e){return notAChar(e)?.01:1/0},insert:function(e){return notAChar(e)?.01:1},transpose:1})};module.exports=function(e){var r=void 0,t={},n=function(e){var t=e.placeId;return React.createElement("div",{"class":"searchItem "+t,onscrolltap:function(){return r["goto"](t)}},React.createElement("span",{"class":"caption"},function(){return r.placeInfos[t].caption}),React.createElement("span",{"class":"places"},function(){return r.placeInfos[t].ptext}),React.createElement("span",{"class":"cmdDeleteFromProgram"}),React.createElement("span",{"class":"cmdAppend"}))};return r=ra(Object.defineProperties({"goto":function(t){if(t){var n=r.placeInfos[t];~(e.searchAction||e.go)(t,n&&n.places)}}},{deviceIds:{get:function(){return ra.Array(e.deviceIds.filter(function(r){return r!=e.main}))},configurable:!0,enumerable:!0},placeInfos:{get:function(){var r=Object.create(null),t=!0,n=!1,a=void 0;try{for(var c,o=this.deviceIds[Symbol.iterator]();!(t=(c=o.next()).done);t=!0){var l=c.value,i=e.getDevice(l);r[l]={info:i,caption:e.getMessage(i),places:[]}}}catch(u){n=!0,a=u}finally{try{!t&&o["return"]&&o["return"]()}finally{if(n)throw a}}var s=!0,f=!1,p=void 0;try{for(var m,d=function(){var e=m.value;lodash.forEach(r[e].info.content,function(t,n){return r[n]&&r[n].places.push(e)})},v=this.deviceIds[Symbol.iterator]();!(s=(m=v.next()).done);s=!0)d()}catch(u){f=!0,p=u}finally{try{!s&&v["return"]&&v["return"]()}finally{if(f)throw p}}var h=Object.create(null),y=!0,b=!1,g=void 0;try{for(var A,I=this.deviceIds[Symbol.iterator]();!(y=(A=I.next()).done);y=!0){var l=A.value,E=r[l],R=E.places.map(function(e){return r[e].caption}).join(", ");R&&(R="("+R+")"),h[l]={id:l,caption:E.caption||"<***>",places:E.places,ptext:R}}}catch(u){b=!0,g=u}finally{try{!y&&I["return"]&&I["return"]()}finally{if(b)throw g}}return ra.JSON(h)},configurable:!0,enumerable:!0},labels:{get:function(){return ra.keymap(r.live.deviceIds,function(e){return React.createElement(n,{placeId:e})})},configurable:!0,enumerable:!0},filtered:{get:function(){var n=t.mask.raValue,a=[],c=!0,o=!1,l=void 0;try{for(var i,u=this.deviceIds.filter(e.searchFilter||Boolean)[Symbol.iterator]();!(c=(i=u.next()).done);c=!0){var s=i.value,f=r.placeInfos[s],p=[];n&&(p.push(fuzzy(n,f.caption),fuzzy(n,f.caption+" "+f.ptext)),p.every(function(e){return Math.abs(e)==1/0}))||(p.push(f.caption.toUpperCase()),a.push({id:s,key:p}))}}catch(m){o=!0,l=m}finally{try{!c&&u["return"]&&u["return"]()}finally{if(o)throw l}}return ra.Array(a.sort(function(e,r){return lodash.zip(e.key,r.key).map(function(e){var r;return(r=lu).compare.apply(r,_toConsumableArray(e))}).reduce(function(e,r){return e||r})}).map(function(e){return e.id}))},configurable:!0,enumerable:!0},items:{get:function(){var e=this;return ra.Array(this.filtered.map(function(r){return e.labels.get(r)}))},configurable:!0,enumerable:!0}})),window._search=r,React.createElement("div",{ondialogshow:function(){t.scroller&&t.scroller.refresh(),t.mask.raValue=""}},React.createElement("form",{onsubmit:function(e){e&&e.preventDefault(),r["goto"](r.filtered[0])}},React.createElement("input",{name:"mask",type:"text",autofocus:"autofocus",oncreate:function(e){return t.mask=e.target}}),React.createElement("div",{"class":"scroll",oncreate:function(e){return t.scroll=e.target}},React.createElement("div",null,React.createElement("div",{"class":"items"},watch(function(){return r.items},function(){return setTimeout(function(){t.scroller?t.scroller.refresh():t.scroller=new(require("iscroll"))(t.scroll,{mouseWheel:!0,scrollbars:!0,tap:"scrolltap"})},100)})),React.createElement("div",{"class":"scrollAreaBottomFiller"})))))};
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
"use strict";var htmlutils=require("htmlutils");module.exports=function(t){var e=void 0;return React.createElement("div",{ondialogshow:function(){return e.value=JSON.stringify(t.getDevice(t.activeDeviceId),null,3)}},React.createElement("form",{onsubmit:function(a){a&&a.preventDefault();var i=e.value.trim()||null;try{i=i&&JSON.parse(i)}catch(o){return alert(o)}i&&t.saveDevice(t.activeDeviceId,i),t.dialog=""}},React.createElement("textarea",{name:"json",autofocus:"autofocus",oncreate:function(t){return e=t.target},style:{position:"absolute",left:0,right:0,top:"10mm",bottom:"15mm",fontSize:"50%"}}),React.createElement("a",{"class":"save",href:"javascript:void(0)",target:"_self",ontouch:htmlutils.Submit,style:{position:"absolute",display:"block",left:0,right:0,height:"10mm",bottom:"0"}},"Save")))};
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
"use strict";module.exports=function(e){return function(){return React.createElement("div",{"class":"startupScreen"},React.createElement("p",null,"Добро пожаловать в Ваш",React.createElement("br",null),"Умный Дом!"),React.createElement("div",{"class":"templates"},React.createElement("p",null,"Пожалуйста, выберите место, где используется этот пульт:"),React.createElement("ul",{"class":"houseTemplates"},function(){return(e.templates||[]).concat([{menu:"начать с чистого листа",ru:"Мой дом",en:"Home",type:"place"}]).map(function(t){return React.createElement("li",{"class":"houseTemplate",ontouch:function(){return e.setTemplate(t)}},t.menu||e.getMessage(t))})})),React.createElement("div",{"class":"loading"}))}};
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
"use strict";function checkBrowserFunctions(){var e=!0&&"undefined"!=typeof HTMLTemplateElement&&HTMLTemplateElement;return!!e}function preventDefault(e){if(!e.target||"external"!=e.target.getAttribute("rel")){for(var r=[HTMLInputElement,HTMLTextAreaElement,HTMLOptionElement,HTMLButtonElement],n=0;n<r.length;n++){var t=r[n];if(e.target instanceof t)return}e.preventDefault()}}function script(e){var r=document.createElement("script");return r.appendChild(document.createTextNode(e)),r}if(!checkBrowserFunctions())throw window.__UNSUPPORTED__(),new Error("unsupported");require("browser-nexttick"),require("platform"),require("htmlpolyfill"),require("track"),require("gesture"),global.lu=require("localUtils"),global.ra=require("ra"),global.co=require("co"),global.lodash=require("lodash"),require("colors");for(var _arr2=["touchstart","touchmove","touchend","touchcancel"],_i2=0;_i2<_arr2.length;_i2++){var type=_arr2[_i2];window.addEventListener(type,preventDefault)}global.LOG=function(e){console.log.apply(console,arguments),global._ALERT&&global._ALERT(e);var r=new XMLHttpRequest;return r.open("POST","/log?"+encodeURIComponent(e)),r.onerror=lodash.noop,r.send(),e},window.addEventListener("error",function e(r){if(!r.message.match(404)&&!e.processing){e.processing=!0;try{LOG(""+r.message.red+" at "+r.lineno+":"+r.colno+" in "+r.filename)}finally{e.processing=!1}}});var onerror=window.onerror;window.onerror=function(e,r,n,t,o){var a=void 0;if(o&&LOG("stack: "+o.stack),onerror)try{window.onerror=onerror,a=onerror.apply(this,arguments)}finally{onerror=window.onerror}return a},global.React=require("components"),co.go(regeneratorRuntime.mark(function r(){var e,n,t,o,a;return regeneratorRuntime.wrap(function(r){for(;;)switch(r.prev=r.next){case 0:return e=cacheUrlResource("./main.html"),r.next=3,e;case 3:for(e=r.sent,n=document.createDocumentFragment(),t=document.createElement("div"),t.innerHTML=e,t=t.children[0],o=[],a=0;a<t.childNodes.length;++a)o.push(t.childNodes[a]);o.forEach(function(e){return t.removeChild(e)}),o.forEach(function(e){e instanceof HTMLScriptElement&&(e=script(e.innerHTML)),n.appendChild(e)}),document.body.appendChild(n);case 13:case"end":return r.stop()}},r,this)}));
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
"use strict";function updateSize(){var i=window.innerWidth,e=window.innerHeight,t=(window.orientation||0)%360;0>t&&(t+=360),windowSize.width=i,windowSize.height=e,windowSize.ppmm=ppmm,windowSize.widthmm=i/ppmm,windowSize.heightmm=e/ppmm,windowSize.pixelRatio=window.devicePixelRatio||1,windowSize.orientation=t,windowSize.layout=e>=i?"vertical":"horizontal",windowSize.window=window.navigator.standalone?"app":"browser"}var ra=require("ra"),windowSize=ra.clean({width:1,height:1,ppmm:1,widthmm:1,heightmm:1,pixelRatio:1,orientation:0,layout:"vertical",window:"browser"}).setName("windowSize");window.addEventListener("resize",updateSize);var cm=document.createElement("div");cm.style.left="0",cm.style.top="0",cm.style.width="10cm",cm.style.height="10cm",cm.style.position="fixed",cm.style.zIndex="-9999",document.body.appendChild(cm);var ppmm=cm.clientWidth/100;document.body.removeChild(cm),updateSize(),module.exports=windowSize;
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
require("webpage"),require("ui/OneApp"),global.require=function e(r){global.require=null;try{return require.apply(this,arguments)}finally{global.require=e}};
