...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
!function(){!function(e){var t=global.performance||Date,r=0,n=t.now(),a=require,i=function(){r+=t.now()-n,require=a;try{return a.apply(this,arguments)}finally{require=i,n=t.now()}};require=i;try{e()}finally{require=a,r+=t.now()-n,r/=1e3,global.__require_stats__||(global.__require_stats__={}),global.__require_stats__["/home/vadzim/v/work/nerojs/src/app.js"]=r}}(function(){"use strict";function e(e,t){var r=new b;return a(function(){return r.url=e.localModem&&e.localModem+t}),r.active=a.on(r,["pause","resume"],function(){return r.connected}),r}function t(t,a){function i(e,t){delete l[e],t()}var c=r(a,{uid:null}),o=e(t,a),u=function(){return o.send({what:"init",id:c.uid})},l={},f=function(e,t){throw new Error("wsJSONclient: "+e+": "+JSON.stringify(t))};n.on(o,{resume:u,message:function(e){switch(e.what){case"error":f("error from server",e);case"saved":var t=l[e.messageId];return delete l[e.messageId],void(t&&t());case"data":return void(e.partial&&e.previous!=c.uid?u():e.hasOwnProperty("data")&&c.assign((e.partial?n.applyDiff:n.assignDiff)(c.valueOf(),e.data)));default:f("unknown message from server",e)}},error:function(){t.onCredentials()}});var h=function(e,t){return new Promise(function(r,n){var a=s();l[a]=r,o.send({what:"save",partial:e,data:t,messageId:a}),setTimeout(i,d,a,n)})};return{data:c.getReadOnly(),active:o.active,send:function(e){return h(!1,e)},update:function(e){return h(!0,e)},"delete":function(){o.close()}}}var r=require("JSONlocal"),n=require("localUtils"),a=require("ra"),i=require("lodash"),s=require("uid"),c=require("httpClient"),o=require("events").EventEmitter||require("events"),u=require("deviceActions"),l=(require("http-status"),require("WebSocketToJSON")),f=require("PingPongJSON"),h=1e3,d=3e3,b=function(e){$traceurRuntime.superConstructor(v).call(this),this.connected=!1,this.closed=!1,this._ws=null,this._sheduledCreating=null,this._first=!0,this._lastClose=-(1/0),this.url=e,this.user=void 0,this.key=void 0},v=b;$traceurRuntime.createClass(b,{get url(){return this._url},set url(e){this._url=e,this._createHandle()},_setConnected:function(e){e=!!e,this.connected!=e&&(this.connected=e,this.emit("changed",e))},_clearHandle:function(){this._ws&&(this._ws.onclose=null,this._ws.close(),this._ws=null,this._setConnected(!1)),this._sheduledCreating&&(clearTimeout(this._sheduledCreating),this._sheduledCreating=null)},_ensureHandle:function(){this._ws||this._createHandle()},_createHandle:function(){var e=this;this._clearHandle(),this._url&&(this._ws=f(l(new WebSocket(this._url))),this._ws.onclose=function(){if(e._ws=null,e._setConnected(!1),e.emit("pause"),!e.closed){var t=e._lastClose;e._lastClose=Date.now(),e._sheduledCreating=setTimeout(function(){e._createHandle()},Math.max(0,h-(e._lastClose-t)))}},this._ws.onerror=function(t){e.emit("error",t)},this._ws.onopen=function(){e._setConnected(!0),e._first&&(e._first=!1,e.emit("open")),e.emit("resume")},this._ws.onmessage=function(t){e.emit("message",t)})},reinit:function(){this._ws&&this._ws.close()},send:function(e){if(this._ensureHandle(),!this._ws||!this.connected||this.closed)throw new Error("socket is not open");this._ws.send(e)},"delete":function(){this.close()},close:function(){this.closed=!0,this._clearHandle(),this.emit("close")},ask:function(e){return co.gocall($traceurRuntime.initGeneratorFunction(function t(){var r,n;return $traceurRuntime.createGeneratorInstance(function(t){for(;;)switch(t.state){case 0:r=s(),this.send({id:r,question:e}),t.state=8;break;case 8:return t.state=2,this.get(r);case 2:n=t.sent,t.state=4;break;case 4:if(n.error)throw new Error(n.error);t.state=10;break;case 10:t.returnValue=n.answer,t.state=-2;break;default:return t.end()}},t,this)}),this)},get:function(e,t){return co.gocall($traceurRuntime.initGeneratorFunction(function r(){var n,a,s,c,o,u,l,f,h,d;return $traceurRuntime.createGeneratorInstance(function(r){for(;;)switch(r.state){case 0:"string"==typeof e||"number"==typeof e?(n=e,e=function(e){return e.id==n}):"function"!=typeof e&&(a=e,e=function(e){return i.every(a,function(t,r){return e[r]==t})}),r.state=13;break;case 13:u=co.receive,l=u.call(co,this,{close:!0,message:e,timeout:t}),r.state=6;break;case 6:return r.state=2,l;case 2:f=r.sent,r.state=4;break;case 4:s=f,h=s.event,c=h,d=s.data,o=d,r.state=8;break;case 8:r.state="message"==c?9:10;break;case 9:r.returnValue=o,r.state=-2;break;case 10:throw new Error("timeout");default:return r.end()}},r,this)}),this)}},{},o),module.exports=function(o){var l={activePlaceId:"",language:"ru",iconSize:40,labels:!0,placesPages:{}},f=r(o,l),h=a.clean({getMessage:function(e){var t=f.language||"ru";return[t,"ru","en","by"].filter(function(t){return e.hasOwnProperty(t)}).map(function(t){return e[t]})[0]},pageWidth:2,pageHeight:3,pageStarting:!1,dialog:"",editing:!1,moving:0,history:[],menuElement:null,loggedin:!1,onCredentials:function(){this.loggedin=!1},go:function(e){e&&f.activePlaceId!=e&&(this.history.push(f.activePlaceId),f.activePlaceId=e)},back:function(){for(;this.history.length;){var e=this.history.pop();if(this.getPlace(e))return f.activePlaceId=e}f.activePlaceId=this.main},windowSize:require("windowSize").getReadOnly(),placesShifts:{},get modemLocations(){return c.get("/modem_locations")},get localModem(){return this.modemLocations?this.modemLocations[0].url.replace(/^http(?=s?\:\/\/)/,"ws"):""},get doLogin(){return $traceurRuntime.initGeneratorFunction(function e(){var t,r,n;return $traceurRuntime.createGeneratorInstance(function(e){for(;;)switch(e.state){case 0:t=this,e.state=37;break;case 37:e.state=3;break;case 3:e.state=this.loggedin||!this.modemLocations?1:2;break;case 1:e.state=-2;break;case 2:r=document.createElement("script"),r.src=this.modemLocations[0].url+"/login?"+s(),document.body.appendChild(r),e.state=32;break;case 32:e.pushTry(20,21),e.state=23;break;case 23:e.state=9;break;case 9:return e.state=5,r;case 5:e.maybeThrow(),e.state=7;break;case 7:e.popTry(),e.state=21,e.finallyFallThrough=25;break;case 20:e.popTry(),e.maybeUncatchable(),n=e.storedException,e.state=16;break;case 16:console.error("error while trying to login",n),e.state=17;break;case 17:return e.state=11,co.sleep(300);case 11:e.maybeThrow(),e.state=13;break;case 13:e.state=21,e.finallyFallThrough=37;break;case 21:e.popTry(),e.state=30;break;case 30:document.body.removeChild(r),e.state=28;break;case 25:a.detach(function(){return t.loggedin=!0}),e.state=37;break;case 28:e.state=e.finallyFallThrough;break;default:return e.end()}},e,this)}).call(this)},login:function(){},get serverDevices(){return t(this,"/devices")},get localDevices(){var e=this;return a.db(this.serverDevices.data,function(t){return e.serverDevices.update(t)})},get devices(){return this.localDevices.valueOf()},get serverPlaces(){return t(this,"/places")},get localPlaces(){var e=this;return a.db(this.serverPlaces.data,function(t){return e.serverPlaces.update(t)})},get places(){return this.localPlaces.valueOf()},get commands(){return e(this,"/commands")},get connectedToServer(){return!0&&this.serverDevices.active.valueOf()&&this.serverPlaces.active.valueOf()&&this.commands.active.valueOf()},get main(){var e=this.places;return e&&n.valueOf(e.main)},getPlace:function(e){return this.places&&this.places[n.valueOf(e)]},getDevice:function(e){return this.devices&&this.devices[n.valueOf(e)]},get activePlaceId(){return f.activePlaceId||this.main},get activePlace(){return this.getPlace(this.activePlaceId)},get activeContentIds(){var e=this.activePlace;return a.Array(i.keys(e&&e.content).sort(function(t,r){return e.content[t].index-e.content[r].index}))},get activeContent(){return a.Array(this.activeContentIds.map(this.getPlace))},get activeDeviceId(){return this.activePlace.device},get checkIfTimeToGoBack(){this.getPlace(this.activePlaceId)||this.back()},get caption(){return this.getMessage(this.getPlace(this.activePlaceId))||this.message("favorites")},get placeType(){var e=this.getPlace(this.activePlaceId);return e||(e=this.getPlace(this.main)),"content"==e.type&&e.group?"group":"content"==e.type?"place":"device"},get deviceIds(){var e=n.valueOf(this.devices);return a.Array(i.keys(e).filter(function(t){var r=e[t];return r&&r.type}).sort())},getFreeGroup:function(){for(var e=i.reduce(n.valueOf(this.devices),function(e,t){return t.group&&(e[t.group]=!0),e},[]),t=2;1022>=t;++t)if(!e[t])return t;return null},get placeIds(){var e=n.valueOf(this.places);return a.Array(i.keys(e).filter(function(t){var r=e[t];return r&&r.type}).sort())},get initialLoading(){return!(this.places&&this.places.uid&&this.devices&&this.devices.uid)},get initialized(){return!this.initialLoading&&!!this.places&&!!this.places.main},setDatabase:function(e,t){this.serverDevices.send(e),this.serverPlaces.send(t)},reset:function(){f.reset(),this.setDatabase({uid:s()},{uid:s()}),this.dialog="",this.editing=!1,this.history.length=0},setTemplate:function(e){function t(e,t){return Object.keys(e).forEach(function(r){return"image"!=r&&"content"!=r&&"type"!=r&&(t[r]=e[r])}),t}function r(e,n){if(e.content){var i={};a[n]=t(e,{type:"content",content:i});var c=0;e.content.forEach(function(e){return i[r(e,s())]={index:c++}})}else a[n]=t(e,{type:"single"});return n}console.log(e);var n={uid:s()},a={uid:s()};a.main=r(e,s()),this.setDatabase(n,a)},get templates(){return $traceurRuntime.initGeneratorFunction(function e(){var t,r,n,a;return $traceurRuntime.createGeneratorInstance(function(e){for(;;)switch(e.state){case 0:e.pushTry(11,null),e.state=14;break;case 14:t=c.get,r=t.call(c,"/templates"),e.state=6;break;case 6:return e.state=2,r;case 2:n=e.sent,e.state=4;break;case 4:e.returnValue=n,e.state=-2;break;case 8:e.popTry(),e.state=-2;break;case 11:e.popTry(),e.maybeUncatchable(),a=e.storedException,e.state=9;break;case 9:e.returnValue=a,e.state=-2;break;default:return e.end()}},e,this)}).call(this)},get allMessages(){return $traceurRuntime.initGeneratorFunction(function e(){var t,r,n;return $traceurRuntime.createGeneratorInstance(function(e){for(;;)switch(e.state){case 0:t=c.get,r=t.call(c,"/messages"),e.state=6;break;case 6:return e.state=2,r;case 2:n=e.sent,e.state=4;break;case 4:e.returnValue=n,e.state=-2;break;default:return e.end()}},e,this)}).call(this)},get messages(){var e=this.allMessages;if(null!=e){var t={},r=f.language||"ru";return i.forOwn(e,function(e,n){return t[n]=e.hasOwnProperty(r)?e[r]:n}),t}},message:function(e){var t=this.messages&&this.messages[e];return null==t&&(t=e),t},notification:function(){},createDevice:function(e){var t=n.valueOf(this.getPlace(e));if(!t.device){var r=s();return co.go($traceurRuntime.initGeneratorFunction(function a(){var t,i,s;return $traceurRuntime.createGeneratorInstance(function(a){for(;;)switch(a.state){case 0:s=this,a.state=18;break;case 18:return a.state=2,this.serverDevices.update((t={},Object.defineProperty(t,r,{value:{model:"Nero II 8421",state:0,comfort_1:.8,comfort_2:.2},configurable:!0,enumerable:!0,writable:!0}),t));case 2:a.maybeThrow(),a.state=4;break;case 4:return a.state=6,n.waitFor(function(){return s.getDevice(r)});case 6:a.maybeThrow(),a.state=8;break;case 8:return a.state=10,this.serverPlaces.update((i={},Object.defineProperty(i,e,{value:{device:r},configurable:!0,enumerable:!0,writable:!0}),i));case 10:a.maybeThrow(),a.state=12;break;case 12:return a.state=14,n.waitFor(function(){return s.getPlace(e).device});case 14:a.maybeThrow(),a.state=-2;break;default:return a.end()}},a,this)}))}return n.promiseSucceeded},saveDevice:function(e,t){{var r;s()}return this.serverDevices.update((r={},Object.defineProperty(r,e,{value:n.makeDiff(this.getDevice(e),t),configurable:!0,enumerable:!0,writable:!0}),r))},savePlace:function(e,t){{var r;s()}return this.serverPlaces.update((r={},Object.defineProperty(r,e,{value:n.makeDiff(this.getPlace(e),t),configurable:!0,enumerable:!0,writable:!0}),r))},newIndex:function(e){return Object.keys(this.getPlace(e).content||[]).length+1},linkItem:function(e,t){var r,n;if(e==t)throw new Error("cannot link place to itself");return this.serverPlaces.update((n={},Object.defineProperty(n,e,{value:{content:(r={},Object.defineProperty(r,t,{value:{index:this.newIndex(e)},configurable:!0,enumerable:!0,writable:!0}),r)},configurable:!0,enumerable:!0,writable:!0}),n))},linkToFavourites:function(e){return this.linkItem(this.main,e)},linkActiveToFavourites:function(){return this.linkToFavourites(this.activePlaceId)},addItem:function(e,t){var r,n,a=s();return this.serverPlaces.update((n={},Object.defineProperty(n,e,{value:{content:(r={},Object.defineProperty(r,a,{value:{index:this.newIndex(e)},configurable:!0,enumerable:!0,writable:!0}),r)},configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(n,a,{value:t,configurable:!0,enumerable:!0,writable:!0}),n))},addPlace:function(e){return this.addItem(e,{type:"content",ru:"Помещение",en:"Room"})},addDevice:function(e){return this.addItem(e,{type:"single",ru:"Устройство",en:"Device"})},deleteItem:function(e,t){var r,n;return this.serverPlaces.update((n={},Object.defineProperty(n,e,{value:{content:(r={},Object.defineProperty(r,t,{value:null,configurable:!0,enumerable:!0,writable:!0}),r)},configurable:!0,enumerable:!0,writable:!0}),n))},purgeItem:function(e){var t,r;return Promise.all([this.serverPlaces.update(i.reduce(this.places,function(t,r,n){var a;return r&&r.content&&r.content[e]&&(t[n]={content:(a={},Object.defineProperty(a,e,{value:null,configurable:!0,enumerable:!0,writable:!0}),a)}),t},(t={},Object.defineProperty(t,e,{value:null,configurable:!0,enumerable:!0,writable:!0}),t))),this.serverDevices.update((r={},Object.defineProperty(r,this.getPlace(e).device,{value:null,configurable:!0,enumerable:!0,writable:!0}),r))])},renameItem:function(e,t){var r,n=i.reduce(this.getPlace(e),function(e,t,r){return 2==r.length&&(e[r]=null),e},{});return n[l.language||"ru"]=t,this.serverPlaces.update((r={},Object.defineProperty(r,e,{value:n,configurable:!0,enumerable:!0,writable:!0}),r))},command:function(e,t,r){u.getNewState(this.getDevice(e),t);return this.commands.ask({device:e,command:t,data:r})},iconCommand:function(e,t,r,a){return console.log(e,t,r),e=n.valueOf(e),("content"==e.type?"Short"==r:"Long"==r)?this.go(t):(("Short"==r||"Long"==r)&&(r="Comfort_1"),e.device?this.command(e.device,r,a):Promise.reject(new Error("device not configured")))},pan:function(e){var t=this.menuElement.getBoundingClientRect(),r=this.activePlaceId;this.placesShifts.defineProperty(r),f.placesPages.defineProperty(r);var n=this.getPlace(r);if(n&&n.content){var a=Math.ceil(Object.keys(n.content).length/(this.pageWidth*this.pageHeight));if(0!=a){{var i=f.placesPages[r]||0;-i*t.width}if(e.isFinal)e.deltaX>0&&i>0?f.placesPages[r]=i-1:e.deltaX<0&&a-1>i&&(f.placesPages[r]=i+1),this.placesShifts[r]=0;else{var s=e.deltaX;(s>0&&0==i||0>s&&i==a-1)&&(s/=3),this.placesShifts[r]=s}}}},get imgProps(){return{onerror:function(){this.classList.add("error")},onload:function(){this.classList.remove("error")}}}}).setName("app");return{app:h,local:f}}})}();
//# sourceMappingURL=out.js.map
