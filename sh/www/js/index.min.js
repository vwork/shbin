...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
!function(){!function(e){var t=global.performance||Date,n=0,r=t.now(),a=require,c=function(){n+=t.now()-r,require=a;try{return a.apply(this,arguments)}finally{require=c,r=t.now()}};require=c;try{e()}finally{require=a,n+=t.now()-r,n/=1e3,global.__require_stats__||(global.__require_stats__={}),global.__require_stats__["/home/vadzim/v/work/nerojs/src/app.js"]=n}}(function(){"use strict";function e(e,t){var n=new b;return a(function(){return n.url=e.localModem&&e.localModem+t}),n.active=a.on(n,["pause","resume"],function(){return n.connected}),n}function t(t,a){var c=n(a,{uid:null}),i=e(t,a),o=function(){return i.send({what:"init",id:c.uid})};return r.on(i,{resume:o,message:function(e){return e.error?console.log("wsJSONclient: error from server:",e.error):e.partial&&e.previous!=c.uid?o():void(e.hasOwnProperty("data")?c.assign((e.partial?r.applyDiff:r.assignDiff)(c.valueOf(),e.data)):console.log("unknown message from server",e))},error:function(){t.onCredentials()}}),{data:c.getReadOnly(),active:i.active,send:function(e){i.send({what:"save",partial:!1,data:e})},update:function(e){i.send({what:"save",partial:!0,data:e})},"delete":function(){i.close()}}}var n=require("JSONlocal"),r=require("localUtils"),a=require("ra"),c=require("lodash"),i=require("uid"),o=require("httpClient"),u=require("events").EventEmitter||require("events"),s=require("deviceActions"),l=(require("http-status"),require("WebSocketToJSON")),f=require("PingPongJSON"),d=1e3,b=function(e){this.connected=!1,this.closed=!1,this._ws=null,this._xhr=null,this._first=!0,this.url=e,this.user=void 0,this.key=void 0};$traceurRuntime.createClass(b,{get url(){return this._url},set url(e){this._url=e,this._createHandle()},_setConnected:function(e){e=!!e,this.connected!=e&&(this.connected=e,this.emit("changed",e))},_clearHandle:function(){this._ws&&(this._ws.onclose=null,this._ws.close(),this._ws=null,this._setConnected(!1)),this._xhr&&(this._xhr.onreadystatechange=null,this._xhr.abort(),this._xhr=null)},_createHandle:function(){var e=this;if(this._clearHandle(),this._url){var t=function(){return!e.closed&&setTimeout(function(){return e._createHandle()},d)};this._ws=f(l(new WebSocket(this._url))),this._ws.onclose=function(){e._ws=null,e._setConnected(!1),e.emit("pause"),t()},this._ws.onerror=function(t){e.emit("error",t)},this._ws.onopen=function(){e._setConnected(!0),e._first&&(e._first=!1,e.emit("open")),e.emit("resume")},this._ws.onmessage=function(t){e.emit("message",t)}}},reinit:function(){this._ws&&this._ws.close()},send:function(e){if(!this._ws||!this.connected||this.closed)throw new Error("socket is not open");this._ws.send(e)},"delete":function(){this.close()},close:function(){this.closed=!0,this._clearHandle(),this.emit("close")},ask:function(e){var t=i();return this.send({id:t,question:e}),this.get(e.id).then(function(e){if(e.error)throw new Error(e.error);return e.answer})},get:function(e,t){var n=this;if("string"==typeof e||"number"==typeof e){var a=e;e=function(e){return e.id==a}}else if("function"!=typeof e){var i=e;e=function(){return c.every(i,function(e,t){return msk[t]==e})}}return new Promise(function(a,c){var i,o;i=function(e){r.off(n,{close:i,message:o}),null!=e?a(e):c(new Error("timeout"))},o=function(t){e(t)&&i(t)},null!=t&&setTimeout(i,t),r.on(n,{close:i,message:o})})}},{},u),module.exports=function(u){var l={activePlace:"",language:"ru",iconSize:40,house:{main:null},devices:{uid:null},places:{uid:null,main:null}},f=n(u,l),d=function(e){var t=f.language||"ru";return[t,"ru","en"].filter(function(t){return e.hasOwnProperty(t)}).map(function(t){return e[t]})[0]},b=a.clean({pageWidth:2,pageHeight:3,pageStarting:!1,dialog:"",history:[],loggedin:!1,onCredentials:function(){b.loggedin=!1},go:function(e){e&&f.activePlace!=e&&(b.history.push(f.activePlace),f.activePlace=e)},back:function(){for(;b.history.length;){var e=b.history.pop();if(b.getPlace(e))return f.activePlace=e}f.activePlace=b.main},windowSize:{$:require("windowSize").getReadOnly(),width:null,height:null,ppmm:null,layout:null,window:null},get modemLocations(){return o.get("/modem_locations")},get localModem(){return b.modemLocations?b.modemLocations[0].url.replace(/^http(?=s?\:\/\/)/,"ws"):""},doLogin:a.Getter($traceurRuntime.initGeneratorFunction(function g(){var e,t;return $traceurRuntime.createGeneratorInstance(function(n){for(;;)switch(n.state){case 0:n.state=3;break;case 3:n.state=b.loggedin||!b.modemLocations?1:2;break;case 1:n.state=-2;break;case 2:e=document.createElement("script"),e.src=b.modemLocations[0].url+"/login?"+i(),document.body.appendChild(e),n.state=28;break;case 28:n.pushTry(16,17),n.state=19;break;case 19:return n.state=5,e;case 5:n.maybeThrow(),n.state=7;break;case 7:n.popTry(),n.state=17,n.finallyFallThrough=21;break;case 16:n.popTry(),n.maybeUncatchable(),t=n.storedException,n.state=14;break;case 14:console.log("error while trying to login",t),n.state=15;break;case 15:return n.state=9,co.sleep(300);case 9:n.maybeThrow(),n.state=17,n.finallyFallThrough=0;break;case 17:n.popTry(),n.state=26;break;case 26:document.body.removeChild(e),n.state=24;break;case 21:a.detach(function(){return b.loggedin=!0}),n.state=0;break;case 24:n.state=n.finallyFallThrough;break;default:return n.end()}},g,this)})),login:function(){},get devices(){return t(b,"/devices")},get places(){return t(b,"/places")},get commands(){return e(b,"/commands")},get connectedToServer(){return!0&&b.devices.active.valueOf()&&b.places.active.valueOf()&&b.commands.active.valueOf()},get main(){var e=r.valueOf(b.places.data);return e&&r.valueOf(e.main)},getPlace:function(e){return b.places.data.get(e)},getDevice:function(e){return b.devices.data.get(e)},get activePlace(){return f.activePlace||b.main},get activeDevice(){return b.getPlace(b.activePlace).device},get checkIfTimeToGoBack(){r.valueOf(b.places.data),b.getPlace(b.activePlace)||b.back()},get caption(){return d(b.getPlace(b.activePlace))||b.message("favorites")},get placeType(){var e=b.getPlace(b.activePlace);return e||(e=b.getPlace(b.main)),"content"==e.type&&e.group?"group":"content"==e.type?"place":"device"},deviceIds:a.Getter(function(){var e=r.valueOf(b.devices.data);return c.keys(e).filter(function(t){var n=e[t];return n&&n.type}).sort()},r.arrayEqual),getFreeGroup:function(){for(var e=c.reduce(r.valueOf(b.devices.data),function(e,t){return t.group&&(e[t.group]=!0),e},[]),t=2;1022>=t;++t)if(!e[t])return t;return null},placeIds:a.Getter(function(){var e=r.valueOf(b.places.data);return c.keys(e).filter(function(t){var n=e[t];return n&&n.type}).sort()},r.arrayEqual),get onDevices(){var e=r.valueOf(b.devices.data);e&&e.uid&&(f.devices=e)},get onPlaces(){var e=r.valueOf(b.places.data);e&&e.uid&&(f.places=e)},get initialLoading(){return!f.places.uid||!f.devices.uid},get initialized(){return!b.initialLoading&&!!r.valueOf(f.places.main)},setDatabase:function(e,t){f.devices=e,b.devices.send(e),f.places=t,b.places.send(t)},reset:function(){b.setDatabase({uid:i()},{uid:i()})},setTemplate:function(e){function t(e,r){if(e.content){var a={},c=0;e.content.forEach(function(e){return a[t(e,i())]={index:c++}}),e.content=a,e.type="place"}return n[r]=e,r}e=c.cloneDeep(e);var n={uid:i()},r=t(e,i()),a={uid:i(),main:r};b.setDatabase(n,a)},get templates(){return $traceurRuntime.initGeneratorFunction(function e(){var t,n,r,a;return $traceurRuntime.createGeneratorInstance(function(e){for(;;)switch(e.state){case 0:e.pushTry(11,null),e.state=14;break;case 14:t=o.get,n=t.call(o,"/templates"),e.state=6;break;case 6:return e.state=2,n;case 2:r=e.sent,e.state=4;break;case 4:e.returnValue=r,e.state=-2;break;case 8:e.popTry(),e.state=-2;break;case 11:e.popTry(),e.maybeUncatchable(),a=e.storedException,e.state=9;break;case 9:e.returnValue=a,e.state=-2;break;default:return e.end()}},e,this)}).call(this)},get allMessages(){return $traceurRuntime.initGeneratorFunction(function e(){var t,n,r;return $traceurRuntime.createGeneratorInstance(function(e){for(;;)switch(e.state){case 0:t=o.get,n=t.call(o,"/messages"),e.state=6;break;case 6:return e.state=2,n;case 2:r=e.sent,e.state=4;break;case 4:e.returnValue=r,e.state=-2;break;default:return e.end()}},e,this)}).call(this)},get messages(){var e=b.allMessages;if(null!=e){var t={},n=f.language||"ru";return c.forOwn(e,function(e,r){return t[r]=e.hasOwnProperty(n)?e[n]:r}),t}},message:function(e){var t=b.messages&&b.messages[e];return null==t&&(t=e),t},createDevice:function(e){var t=r.valueOf(b.getPlace(e));if(!t.device){var n=i();return co.go($traceurRuntime.initGeneratorFunction(function a(){var t,c;return $traceurRuntime.createGeneratorInstance(function(a){for(;;)switch(a.state){case 0:return a.state=2,b.devices.update((t={},Object.defineProperty(t,n,{value:{model:"Nero II 8421",state:0,comfort_1:.8,comfort_2:.2},configurable:!0,enumerable:!0,writable:!0}),t));case 2:a.maybeThrow(),a.state=4;break;case 4:return a.state=6,r.waitFor(function(){return b.getDevice(n)});case 6:a.maybeThrow(),a.state=8;break;case 8:return a.state=10,b.places.update((c={},Object.defineProperty(c,e,{value:{device:n},configurable:!0,enumerable:!0,writable:!0}),c));case 10:a.maybeThrow(),a.state=12;break;case 12:return a.state=14,r.waitFor(function(){return b.getPlace(e).device});case 14:a.maybeThrow(),a.state=-2;break;default:return a.end()}},a,this)}))}return r.promiseSucceeded},addItem:function(e,t){var n,r,a=i();return b.places.update((r={},Object.defineProperty(r,e,{value:{content:(n={},Object.defineProperty(n,a,{value:{index:Object.keys(b.getPlace(e).content||{}).length},configurable:!0,enumerable:!0,writable:!0}),n)},configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(r,a,{value:t,configurable:!0,enumerable:!0,writable:!0}),r))},addPlace:function(e){return b.addItem(e,{type:"content",ru:"Помещение",en:"Room"})},addDevice:function(e){return b.addItem(e,{type:"single",ru:"Устройство",en:"Device"})},purgeItem:function(e){var t;return b.places.update(c.reduce(r.valueOf(b.places.data),function(t,n,r){var a;return n&&n.content&&n.content[e]&&(t[r]={content:(a={},Object.defineProperty(a,e,{value:null,configurable:!0,enumerable:!0,writable:!0}),a)}),t},(t={},Object.defineProperty(t,e,{value:null,configurable:!0,enumerable:!0,writable:!0}),t)))},renameItem:function(e,t){var n,r=c.reduce(b.getPlace(e),function(e,t,n){return 2==n.length&&(e[n]=null),e},{});return r[l.language||"ru"]=t,b.places.update((n={},Object.defineProperty(n,e,{value:r,configurable:!0,enumerable:!0,writable:!0}),n))},command:function(e,t){s.getNewState(b.getDevice(e),t);return b.commands?b.commands.ask({device:e,command:t}):Promise.reject("commands interface is not ready")},iconCommand:function(e,t,n){return console.log(e,t,n),e=r.valueOf(e),("content"==e.type?"Short"==n:"Long"==n)?b.go(t):(("Short"==n||"Long"==n)&&(n="Comfort_1"),e.device?b.command(e.device,n):Promise.reject(new Error("device not configured")))},get imgProps(){return{onerror:function(){this.classList.add("error")},onload:function(){this.classList.remove("error")}}}}).setName("app");return{app:b,local:f}}})}();
//# sourceMappingURL=out.js.map
...
module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports={
	"Nero II 8713-50": {
		"buttons": "RollShutter"
	},
	"Intro II 8513-50": {
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
!function(){!function(t){var e=global.performance||Date,r=0,n=e.now(),i=require,a=function(){r+=e.now()-n,require=i;try{return i.apply(this,arguments)}finally{require=a,n=e.now()}};require=a;try{t()}finally{require=i,r+=e.now()-n,r/=1e3,global.__require_stats__||(global.__require_stats__={}),global.__require_stats__["/home/vadzim/v/work/nerojs/src/ra.js"]=r}}(function(){"use strict";function t(){}var e=require("later").push,r=require("co"),n=require("uid"),i=require("lodash"),a="ACTION_"+n(),l={};l.scheduled=!1,l.procs=[],l.index=0,l.maxIndex=32768,l.processing=!1,l.totalTime=0,l.maxTime=0,l.maxTime1=0,l.minTime=1/0,l.runCount=0,l.runAllCount=0,global.updates=l;var s=global.performance||global.Date;l.start=s.now(),l.log=function(){return console.log(":: "+l.totalTime/1e3+" / "+(s.now()-l.start)/1e3+" ("+l.maxTime/1e3+", "+l.maxTime1/1e3+", "+l.minTime/1e3+", "+P.maxCount+", "+l.runCount+", "+l.runAllCount+")")},l.checkSchedule=function(){!l.scheduled&&l.procs.length>0&&(l.scheduled=!0,e(l.tick))},l.tick=function(){l.scheduled=!1;var t,e=function(){try{return l.runAll(),0}catch(t){setTimeout(function(){throw t},1)}};t:for(var r=0;1e3>r;++r)switch(t=e(r)){case 0:break t}l.checkSchedule()},l.runAll=function(){var t=s.now(),e=t,n=l.runCount,i=l.processing;l.processing=!0;var o=r.global[a];null!=o&&(r.global[a]=null);try{for(;l.index<l.procs.length;){global.APP_TIMEOUT&&global.APP_TIMEOUT<Date.now&&alert("Application is running too long");var u=l.procs[l.index];++l.index,++l.runCount,l.index>=l.maxIndex&&3*l.index>l.procs.length&&(l.procs.splice(0,l.index),l.index=0),u();var c=s.now();l.maxTime1<c-e&&(l.maxTime1=c-e),e=c}l.index=l.procs.length=0}finally{if(null!=o&&(r.global[a]=o),l.processing=i,!i){var h=s.now()-t;l.totalTime+=h,l.maxTime<h&&(l.maxTime=h),n=l.runCount-n,n&&(++l.runAllCount,l.minTime>h&&(l.minTime=h))}}},l.later=function(t){l.procs.push(t),l.checkSchedule()},l.later.then=l.later;var o="undefined"==typeof Immutable?null:Immutable.Map(),u=function(t){return null==t||t==o?null:t},c=function(){return this},h=function(t){return t&&"object"==typeof t&&t.constructor==Object},f=function(t){return null==t||null==t.valueOf?t:t.valueOf()},_=function(t){throw new Error('access to an undeclared property "'+this.$name+"."+t+'"')},p=Object.create(null),v=Object.create(null),d=function(t){p[t]||(p[t]=!0,Object.defineProperty(v,t,{get:function(){_.call(this,t)},set:function(){_.call(this,t)}}))};t.prototype=v,global.APP_DEBUG&&(t.prototype=(global.__UsedScriptIdentifiers__+"").split(/[\s,]+/).reduce(function(t,e){var r;return Object.create(t,(r={},Object.defineProperty(r,e,{value:{get:function(){_.call(this,e)},set:function(){_.call(this,e)}},configurable:!0,enumerable:!0,writable:!0}),r))},t.prototype)),t.prototype=Object.create(t.prototype,{toString:{value:{}.toString},valueOf:{value:{}.valueOf},toLocaleString:{value:{}.toLocaleString},hasOwnProperty:{value:{}.hasOwnProperty},isPrototypeOf:{value:{}.isPrototypeOf},propertyIsEnumerable:{value:{}.propertyIsEnumerable},$name:{value:"<...>",writable:1}});var y=[];Object.freeze(y);var g=function(){$traceurRuntime.superConstructor(b).apply(this,arguments)},b=g;$traceurRuntime.createClass(g,{get props(){throw new Error("access to deprecated 'props' property detected")},get declaredProperties(){return this.live},get length(){var t=this.valueOf();return null==t?0:Object.keys(t).length},get:function(t){if(null!=t){var e=this.valueOf();if(null!=e&&e.hasOwnProperty(t))return e[t]}return null},map:function(t){var e=this.valueOf();return e&&i.mapValues(e,t)},keys:function(){var t=this.valueOf();return null==t?y:Object.keys(t)}},{},t);var m=function(t){$traceurRuntime.superConstructor(w).call(this),this._parent=t},w=m;$traceurRuntime.createClass(m,{getReadOnly:function(){return this},get live(){return this._parent.live},get $name(){return this._parent.$name},valueOf:function(){return this._parent.valueOf.apply(this._parent,arguments)},noTouch:function(){return this._parent.noTouch.apply(this._parent,arguments)},toString:function(){return this._parent.toString.apply(this._parent,arguments)},toJSON:function(){return this._parent.toJSON.apply(this._parent,arguments)},getName:function(){return this._parent.getName.apply(this._parent,arguments)}},{},g);var k=function(t,e){var r,n=e?function(){var n=t.apply(this,arguments);return Object.is(r,n)||e(r,n)||(r=n),r}:function(){return t.apply(this,arguments)};return n.isGetter=!0,n},O=function(t){function e(){return t.apply(this,arguments)}return e.typeDescriptor=!0,e},x=function(t,e,r){return new P(e,t,r).linkName(t,":getter")},S=function(t,e,r){return new P(function(){return e(t.valueOf())},null,r).linkName(t,":setter")},T=function(t){var e=this;$traceurRuntime.superConstructor(C).call(this),this._id=n(),this._value=null,this._error=null,this._isValueEqual=Object.is,this._initialized=!1,this._closed=!1,this._dirty=!1,this._live=null,this._liveArray=null,this._actionsArr=[],this._parent=null,this._onchange=[],this.$name={toString:function(){return e.getName()}},this._notifyWritten(),this._sticky=!!t},C=T;$traceurRuntime.createClass(T,{valueOf:function(){return this._read()},assign:function(t){return this._write(t,!1,null)},"throw":function(t){return this._write(null,!1,t)},touch:function(){this._fire()},noTouch:function(){if(this._dirty&&this._updateSelf(),this._error)throw this._error;return this._value},then:function(t){this._onchange.push(t)},close:function(){if(!this._closed){if(this._closed=!0,this._fire(),this._parent&&this._parent.close(),this._liveArray){var t=!0,e=!1,r=void 0;try{for(var n=void 0,i=this._liveArray[$traceurRuntime.toProperty(Symbol.iterator)]();!(t=(n=i.next()).done);t=!0){var a=n.value;a.close()}}catch(l){e=!0,r=l}finally{try{t||null==i.return||i.return()}finally{if(e)throw r}}this._liveArray=null}this._value=null,this._error=null,this._actionsArr=null,this._parent=null}},get live(){return this._live},getReadOnly:function(){return this._readOnly||(this._readOnly=new m(this))},toString:function(){for(var t,e=[],r=0;r<arguments.length;r++)e[r]=arguments[r];var n=this._read();return null!=n&&n.toString?(t=n).toString.apply(t,$traceurRuntime.spread(e)):""+n},toJSON:function(){for(var t,e=[],r=0;r<arguments.length;r++)e[r]=arguments[r];var n=this._read();return null!=n&&n.toJSON?(t=n).toJSON.apply(t,$traceurRuntime.spread(e)):n},setName:function(t){return this._name=t,this},getName:function(){for(var t=this._name||this._key,e=this._parent;e;)t=(e._name||e._key)+"."+t,e=e._parent;return t},defineProperty:function(t){if(this._live||(this._live={},this._liveArray=[]),t){d(t);var e=this._live[t];return this._live.hasOwnProperty(t)?e:(this._liveArray.push(e=this._live[t]=new C(this._sticky)),e._key=t,e._parent=this,e._level=(this._level||0)+1,Object.defineProperty(this,t,{enumerable:!0,configurable:!0,get:function(){return e._live?e:e._read()},set:function(t){return e._write(t,!1)}}),null!=this._value&&e._write(this._value[t],!0),e)}},init:function(t){this._init(t,!1,!1)},setConst:function(t,e){return Object.defineProperty(this,t,{enumerable:!0,get:function(){return e}}),this},setVar:function(t,e){return Object.defineProperty(this,t,{enumerable:!0,writable:!0,value:e}),this},_init:function(t,e,r,n){var i=this;if(!e&&i._initialized)throw new Error("already initialized");if(this._parent&&(this._parent._dirty=!0),i._initialized=!0,n&&(this._isValueEqual=n),t=u(t),null!=t){if("function"==typeof t&&t.typeDescriptor&&(t=t(i._key)),"function"==typeof t&&(r||t.isGetter))return void x(i,t,this._sticky);if(!h(t))return void(null==t||"object"!=typeof t||t.valueOf==Object.prototype.valueOf?i._value=t:i._init(function(){return f(t)},!0,!0));if(e)throw new Error("wrong parameters");i.defineProperty();var a,l=function(e){var r=Object.getOwnPropertyDescriptor(t,e);if(!r)return 0;var n=r.get,a=r.value;if(r.set)throw new Error("wrong parameters");n&&(a=0==n.length?n:function(){return n()}),"$"==e?i._init(a,!0,!!n):i.defineProperty(e)._init(a,!1,!!n)};t:for(var s in t)switch(a=l(s)){case 0:continue t}}},_read:function(){this._dirty&&this._updateSelf();var t=r.global[a];if(t&&(this._closed?t.close():t.onread(this)),this._error)throw this._error;return this._value},_write:function(t,e,n){if(null==n&&(n=null),this._initialized=!0,this._dirty=!1,t=u(t),this._closed){var i=r.global[a];i&&i.close()}else if(!this._isValueEqual(this._value,t)||this._error!=n){if(this._value=t,this._error=n,this._live){var l=!0,s=!1,o=void 0;try{for(var c=void 0,h=this._liveArray[$traceurRuntime.toProperty(Symbol.iterator)]();!(l=(c=h.next()).done);l=!0){var f=c.value;f._write(t&&t[f._key],!0)}}catch(_){s=!0,o=_}finally{try{l||null==h.return||h.return()}finally{if(s)throw o}}}if(this._fire(),!e)for(var p=this._parent;p&&!p._dirty;)p._dirty=!0,p._fire()}return e||this._notifyWritten(),t},_updateSelf:function(){var t=0,e={};for(var r in this._value)this._value.hasOwnProperty(r)&&(e[r]=this._value[r],++t);var n=!0,i=!1,a=void 0;try{for(var l=void 0,s=this._liveArray[$traceurRuntime.toProperty(Symbol.iterator)]();!(n=(l=s.next()).done);n=!0){var o=l.value;if(o._dirty&&o._updateSelf(),o._error)return this._error=o._error,this._value=null,void(this._dirty=!1);var u=o._value;null==u?e.hasOwnProperty(o._key)&&(delete e[o._key],--t):(e[o._key]=u,t=1/0)}}catch(c){i=!0,a=c}finally{try{n||null==s.return||s.return()}finally{if(i)throw a}}0==t&&(e=null),this._value=e,this._dirty=!1},debug:function(t){this._actionsArr.push({action:{_fire:t}})},"debugger":function(){this.debug(function(){})},_fire:function(){var t;if(t=this._actionsArr,t.length){for(var e=0;e<t.length;e++){var r=t[e];r.action&&r.action._fire(),r.pushedC=!1}t.length=0}if(t=this._onchange,t.length){for(var n=0;n<t.length;n++)l.later(t[n]);t.length=0}},_notifyWritten:function(){var t=r.global[a];t&&t.onwritten(this)}},{},g);var j=function(t){return setTimeout(function(){throw t},1)},P=function(t,e,i){var l=this;this._id=n(),this._fun=t,this._dest=e,this._cellSet={},this._cellSetSize=0,this._cellArr=[],this.$name={toString:function(){return"<Action>"}},this._thread=r.gocall(this._loop,this).linkName(this).waitForInput(),this._runCount=0;var s;(s=r.global[a])&&s._children&&s._children.push(this),this._children=null,this._threads=null,this._onthread=null,this._generatorProxy=null,this._generator=null,i&&(this._children=[],this._threads=[],this._onthread=function(t){return l._threads.push(t)})},A=P;$traceurRuntime.createClass(P,{linkName:function(t){var e=void 0!==arguments[1]?arguments[1]:":action";return t.$name&&(t=t.$name),this.$name.toString=function(){return""+t+e},this},_initGeneratorProxy:function(){var t,e,n=this,i=function(){return n._generator.next(e)},a=function(){return n._generator.throw(e)};this._generatorProxy=(t={},Object.defineProperty(t,Symbol.iterator,{value:c,configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(t,"next",{value:function(t){e=t;try{return r.catchThreads(i,n._onthread)}finally{e=null}},configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(t,"throw",{value:function(t){e=t;try{return r.catchThreads(a,n._onthread)}finally{e=null}},configurable:!0,enumerable:!0,writable:!0}),t)},_loop:$traceurRuntime.initGeneratorFunction(function E(){var t,e,n,i,s,o,u,c,h;return $traceurRuntime.createGeneratorInstance(function(f){for(;;)switch(f.state){case 0:t=this,f.state=99;break;case 99:return f.state=2,l.later;case 2:f.maybeThrow(),f.state=4;break;case 4:e={then:function(e){t._onchange=e}},r.global[a]=this,n=!1,f.state=101;break;case 101:f.pushTry(90,null),f.state=93;break;case 93:f.state=n?69:65;break;case 65:f.state=this.isClosed()?7:64;break;case 64:this._begin(),n=!0,i=void 0,f.state=67;break;case 67:f.state=this._children?38:60;break;case 38:i=r.catchThreads(this._fun,this._onthread),f.state=39;break;case 39:f.state=i&&i.next&&i.throw?30:36;break;case 30:this._generatorProxy||this._initGeneratorProxy(),this._generator=i,f.state=31;break;case 31:f.pushTry(null,23),f.state=25;break;case 25:s=f.wrapYieldStar(this._generatorProxy[Symbol.iterator]()),f.sent=void 0,f.action="next",f.state=19;break;case 19:o=s[f.action](f.sentIgnoreThrow),f.state=16;break;case 16:f.state=o.done?10:9;break;case 10:f.sent=o.value,f.state=17;break;case 9:return f.state=19,o.value;case 17:i=f.sentIgnoreThrow,f.state=23,f.finallyFallThrough=21;break;case 23:f.popTry(),f.state=29;break;case 29:this._generator=null,f.state=27;break;case 36:f.state=i&&i.then?32:21;break;case 32:return f.state=33,i;case 33:i=f.sent,f.state=21;break;case 60:i=this._fun(),f.state=61;break;case 61:f.state=i&&i.next&&i.throw?50:58;break;case 50:u=f.wrapYieldStar(i[Symbol.iterator]()),f.sent=void 0,f.action="next",f.state=51;break;case 51:c=u[f.action](f.sentIgnoreThrow),f.state=48;break;case 48:f.state=c.done?42:41;break;case 42:f.sent=c.value,f.state=49;break;case 41:return f.state=51,c.value;case 49:i=f.sentIgnoreThrow,f.state=21;break;case 58:f.state=i&&i.then?54:21;break;case 54:return f.state=55,i;case 55:i=f.sent,f.state=21;break;case 21:this._dest&&this._dest.assign(i),f.state=69;break;case 69:n=!1,f.state=83;break;case 83:f.state=this.isClosed()?7:80;break;case 80:switch(this._end()){default:f.state=93;break;case!1:f.state=7;break;case!0:f.state=73}break;case 74:f.maybeThrow(),f.state=93;break;case 73:return f.state=74,e;case 84:f.popTry(),f.state=101;break;case 90:f.popTry(),f.maybeUncatchable(),h=f.storedException,f.state=89;break;case 89:f.state=h instanceof r.EKill?7:87;break;case 87:n?this._dest.throw(h):j(h),f.state=101;break;case 7:r.global[a]=null,this._finalize(),f.state=-2;break;case 27:f.state=f.finallyFallThrough;break;default:return f.end()}},E,this)}),isClosed:function(){return!this._cellSet},close:function(){var t=this._thread;this._fire(),this._finalize(),t&&t.kill()},_closeChildren:function(){var t;if(t=this._children){for(var e=0,r=t.length;r>e;++e)t[e].close();t.length=0}if(t=this._threads){for(var n=0,i=t.length;i>n;++n)t[n].kill();t.length=0}},_finalize:function(){this._unsubscribe(),this._cellSet=null,this._cellArr=null,this._fun=null,this._dest=null,this._thread=null},_begin:function(){this._unsubscribe(),++this._runCount,A.maxCount<this._runCount&&(A.maxCount=this._runCount)},_unsubscribe:function(){this._onchange=null;var t=this._cellArr;if(t){for(var e=0;e<t.length;++e){var r=t[e];r.cell=null,r.value=null,r.action=null,r.read=!1,r.written=!1,r.pushedA=!1}this._cellSetSize>32&&t.length<this._cellSetSize/4&&(this._cellSet={}),t.length=0}this._closeChildren()},_end:function(){for(var t=!1,e=this._cellArr,r=0;r<e.length;++r){var n=e[r];if(n.written)n.action=null;else{if(n.pushedC||(n.cell._actionsArr.push(n),n.pushedC=!0),!Object.is(n.value,n.cell._value)||!Object.is(n.error,n.cell._error))return null;n.action=this,t=!0}n.value=null,n.cell=null}return t},_linkCell:function(t){var e=this._cellSet[t._id];return null==e&&(e=this._cellSet[t._id]={cell:null,value:null,error:null,action:null,read:!1,written:!1,pushedA:!1,pushedC:!1},++this._cellSetSize),e.pushedA||(this._cellArr.push(e),e.cell=t,e.pushedA=!0),e},onread:function(t){var e=this._linkCell(t);e.read=!0,e.value=t._value,e.error=t._error},onwritten:function(t){this._linkCell(t).written=!0},_fire:function(){this._onchange&&l.later(this._onchange),this._unsubscribe()}},{}),P.maxCount=0;var $=function(t,e,r,n){var i=!0,a=!1,l=void 0;try{for(var s=void 0,o=e[$traceurRuntime.toProperty(Symbol.iterator)]();!(i=(s=o.next()).done);i=!0){var u=s.value;if(null!=u&&"function"!=typeof u)throw new Error("wrong parameters")}}catch(c){a=!0,l=c}finally{try{i||null==o.return||o.return()}finally{if(a)throw l}}var h=new T(r);void 0!==t&&h._init(t,!1,!0,n);var f=!0,_=!1,p=void 0;try{for(var v=void 0,d=e[$traceurRuntime.toProperty(Symbol.iterator)]();!(f=(v=d.next()).done);f=!0){var y=v.value;y&&(y.length?S:x)(h,y,r)}}catch(g){_=!0,p=g}finally{try{f||null==d.return||d.return()}finally{if(_)throw p}}return h},R=function(){{var t,e,r,n,i=0;arguments.length-1}return"string"==typeof arguments[i]&&(t=arguments[i++]),"boolean"==typeof arguments[i]&&(r=arguments[i++]),e=arguments[i++],"function"==typeof arguments[i]&&(n=arguments[i++]),$(e,[],r,n)};exports=module.exports=R,exports.ra=R,exports.clean=function(t){for(var e=[],r=1;r<arguments.length;r++)e[r-1]=arguments[r];return $(t,e,!1)},exports.detach=function(t){var e;if(!(e=r.global[a]))return t();r.global[a]=null;try{return t()}finally{r.global[a]=e}},exports.on=function(t,e,r){var n=R(),i=function(t){return n.assign(r(t))};if("string"==e)t.on(e,i);else{var a=!0,l=!1,s=void 0;try{for(var o=void 0,u=e[$traceurRuntime.toProperty(Symbol.iterator)]();!(a=(o=u.next()).done);a=!0){var c=o.value;t.on(c,i)}}catch(h){l=!0,s=h}finally{try{a||null==u.return||u.return()}finally{if(l)throw s}}}return i(),n},exports.Cell=T,exports.ImmutableInterface=g,exports.AbstractGuard=t,exports.Getter=k,exports.Type=O,exports.importFrom=function(t){return O(function(e){return k(function(){return t.live[e].valueOf()})})},exports.forceCalculations=function(){return l.runAll()},exports.map=function(t,e,r){throw new Error("message")},exports.slice=function(t,e,r){throw new Error("message")}})}();
//# sourceMappingURL=out.js.map
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
!function(){!function(e){var r=global.performance||Date,t=0,n=r.now(),o=require,a=function(){t+=r.now()-n,require=o;try{return o.apply(this,arguments)}finally{require=a,n=r.now()}};require=a;try{e()}finally{require=o,t+=r.now()-n,t/=1e3,global.__require_stats__||(global.__require_stats__={}),global.__require_stats__["/home/vadzim/v/work/nerojs/src/webpage.js"]=t}}(function(){"use strict";function e(e){e.target&&"external"==e.target.getAttribute("rel")||e.preventDefault()}function r(e){var r=document.createElement("script");return r.appendChild(document.createTextNode(e)),r}{var t=global.performance||global.Date;t.now()}require("browser-nexttick"),require("platform"),global.lu=require("localUtils"),global.ra=require("ra"),global.co=require("co"),global.lodash=require("lodash"),require("colors");require("uid"),require("httpClient");document.body.addEventListener("touchstart",e),document.body.addEventListener("touchmove",e),document.body.addEventListener("touchend",e),document.body.addEventListener("touchcancel",e),global.LOG=function(e){console.log.apply(console,arguments),global._ALERT&&global._ALERT(e);var r=new XMLHttpRequest;return r.open("POST","/log?"+encodeURIComponent(e)),r.onerror=lodash.noop,r.send(),e},window.addEventListener("error",function o(e){if(!e.message.match(404)&&!o.processing){o.processing=!0;try{LOG(e.message.red+" at "+e.lineno+":"+e.colno+" in "+e.filename)}finally{o.processing=!1}}});var n=window.onerror;window.onerror=function(e,r,t,o,a){var i;return a&&LOG("stack: "+a.stack),n&&(i=n.apply(this,arguments)),i},global.CS=lu.new(require("components"),global.CS),co.go($traceurRuntime.initGeneratorFunction(function a(){var e,t,n,o,i;return $traceurRuntime.createGeneratorInstance(function(a){for(;;)switch(a.state){case 0:e=cacheUrlResource("./main.html"),a.state=6;break;case 6:return a.state=2,e;case 2:e=a.sent,a.state=4;break;case 4:for(t=document.createDocumentFragment(),n=document.createElement("div"),n.innerHTML=e,n=n.children[0],o=[],i=0;i<n.childNodes.length;++i)o.push(n.childNodes[i]);o.forEach(function(e){return n.removeChild(e)}),o.forEach(function(e){e instanceof HTMLScriptElement&&(e=r(e.innerHTML)),t.appendChild(e)}),document.body.appendChild(t),a.state=-2;break;default:return a.end()}},a,this)})),window.addEventListener("message",function(e){e&&e.data&&"urlResourceUpdated"==e.data.what&&window.setTimeout(function(){return window.location.reload()},1e3)},!1)})}();
//# sourceMappingURL=out.js.map
