...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
!function(){!function(e){var t=global.performance||Date,n=0,r=t.now(),i=require,a=function(){n+=t.now()-r,require=i;try{return i.apply(this,arguments)}finally{require=a,r=t.now()}};require=a;try{e()}finally{require=i,n+=t.now()-r,n/=1e3,global.__require_stats__||(global.__require_stats__={}),global.__require_stats__["/home/vadzim/v/work/nerojs/src/app.js"]=n}}(function(){"use strict";function e(e,t){var n=new v;return i(function(){return n.url=e.localModem&&e.localModem+t}),n.active=i.on(n,["pause","resume"],function(){return n.connected}),n}function t(t,i){function a(e,t){delete l[e],t()}var c=n(i,{uid:null}),o=e(t,i),u=function(){return o.send({what:"init",id:c.uid})},l={},h=function(e,t){throw new Error("wsJSONclient: "+e+": "+JSON.stringify(t))};r.on(o,{resume:u,message:function(e){switch(e.what){case"error":h("error from server",e);case"saved":var t=l[e.messageId];return delete l[e.messageId],void(t&&t());case"data":return void(e.partial&&e.previous!=c.uid?u():e.hasOwnProperty("data")&&c.assign((e.partial?r.applyDiff:r.assignDiff)(c.valueOf(),e.data)));default:h("unknown message from server",e)}},error:function(){t.onCredentials()}});var d=function(e,t){return new Promise(function(n,r){var i=s();l[i]=n,o.send({what:"save",partial:e,data:t,messageId:i}),setTimeout(a,f,i,r)})};return{data:c.getReadOnly(),active:o.active,send:function(e){return d(!1,e)},update:function(e){return d(!0,e)},"delete":function(){o.close()}}}var n=require("JSONlocal"),r=require("localUtils"),i=require("ra"),a=require("lodash"),s=require("uid"),c=require("httpClient"),o=require("events").EventEmitter||require("events"),u=require("deviceActions"),l=(require("http-status"),require("WebSocketToJSON")),h=require("PingPongJSON"),d=1e3,f=3e3,v=function(e){function t(e){$traceurRuntime.superConstructor(t).call(this),this.connected=!1,this.closed=!1,this._ws=null,this._sheduledCreating=null,this._first=!0,this._lastClose=-(1/0),this.url=e,this.user=void 0,this.key=void 0}return $traceurRuntime.createClass(t,{get url(){return this._url},set url(e){this._url=e,this._createHandle()},_setConnected:function(e){e=!!e,this.connected!=e&&(this.connected=e,this.emit("changed",e))},_clearHandle:function(){this._ws&&(this._ws.onclose=null,this._ws.close(),this._ws=null,this._setConnected(!1)),this._sheduledCreating&&(clearTimeout(this._sheduledCreating),this._sheduledCreating=null)},_ensureHandle:function(){this._ws||this._createHandle()},_createHandle:function(){var e=this;this._clearHandle(),this._url&&(this._ws=h(l(new WebSocket(this._url))),this._ws.onclose=function(){if(e._ws=null,e._setConnected(!1),e.emit("pause"),!e.closed){var t=e._lastClose;e._lastClose=Date.now(),e._sheduledCreating=setTimeout(function(){e._createHandle()},Math.max(0,d-(e._lastClose-t)))}},this._ws.onerror=function(t){e.emit("error",t)},this._ws.onopen=function(){e._setConnected(!0),e._first&&(e._first=!1,e.emit("open")),e.emit("resume")},this._ws.onmessage=function(t){e.emit("message",t)})},reinit:function(){this._ws&&this._ws.close()},send:function(e){if(this._ensureHandle(),!this._ws||!this.connected||this.closed)throw new Error("socket is not open");this._ws.send(e)},"delete":function(){this.close()},close:function(){this.closed=!0,this._clearHandle(),this.emit("close")},ask:function(e){return co.gocall($traceurRuntime.initGeneratorFunction(function t(){var n,r;return $traceurRuntime.createGeneratorInstance(function(t){for(;;)switch(t.state){case 0:n=s(),this.send({id:n,question:e}),t.state=8;break;case 8:return t.state=2,this.get(n);case 2:r=t.sent,t.state=4;break;case 4:if(r.error)throw new Error(r.error);t.state=10;break;case 10:t.returnValue=r.answer,t.state=-2;break;default:return t.end()}},t,this)}),this)},get:function(e,t){return co.gocall($traceurRuntime.initGeneratorFunction(function n(){var r,i,s,c,o,u,l,h,d,f;return $traceurRuntime.createGeneratorInstance(function(n){for(;;)switch(n.state){case 0:"string"==typeof e||"number"==typeof e?(r=e,e=function(e){return e.id==r}):"function"!=typeof e&&(i=e,e=function(e){return a.every(i,function(t,n){return e[n]==t})}),n.state=13;break;case 13:u=co.receive,l=u.call(co,this,{close:!0,message:e,timeout:t}),n.state=6;break;case 6:return n.state=2,l;case 2:h=n.sent,n.state=4;break;case 4:s=h,d=s.event,c=d,f=s.data,o=f,n.state=8;break;case 8:n.state="message"==c?9:10;break;case 9:n.returnValue=o,n.state=-2;break;case 10:throw new Error("timeout");default:return n.end()}},n,this)}),this)}},{},e)}(o);module.exports=function(o){var l={activeDeviceId:"",language:"ru",iconSize:40,labels:!0,placesPages:{}},h=n(o,l),d=i.clean({getMessage:function(e){var t=h.language||"ru";return[t,"ru","en","by"].filter(function(t){return e.hasOwnProperty(t)}).map(function(t){return e[t]})[0]},pageWidth:2,pageHeight:3,pageStarting:!1,dialog:"",editing:!1,moving:0,dimmering:0,history:[],menuElement:null,loggedin:!1,onCredentials:function(){this.loggedin=!1},go:function(e,t){var n,r=this;if(e){for(var i,a=this.history,s=h.activeDeviceId;a.length&&(i=a[a.length-1],i==e||i==s||t&&t.indexOf(i)>=0);)a.pop();s!=e&&a.push(s),t&&(n=a).push.apply(n,$traceurRuntime.spread(t.filter(function(e){return e!=r.main}).reverse())),h.activeDeviceId=e,this.dialog=""}},back:function(){for(;this.history.length;){var e=this.history.pop();if(this.getDevice(e))return h.activeDeviceId=e}h.activeDeviceId=this.main},windowSize:require("windowSize").getReadOnly(),placesShifts:{},get modemLocations(){return c.get("/modem_locations")},get localModem(){return this.modemLocations?this.modemLocations[0].url.replace(/^http(?=s?\:\/\/)/,"ws"):""},get doLogin(){return $traceurRuntime.initGeneratorFunction(function e(){var t,n,r;return $traceurRuntime.createGeneratorInstance(function(e){for(;;)switch(e.state){case 0:t=this,e.state=33;break;case 33:e.state=3;break;case 3:e.state=this.loggedin||!this.modemLocations?1:2;break;case 1:e.state=-2;break;case 2:n=document.createElement("script"),n.src=this.modemLocations[0].url+"/login?"+s(),document.body.appendChild(n),e.state=28;break;case 28:e.pushTry(16,17),e.state=19;break;case 19:return e.state=5,n;case 5:e.maybeThrow(),e.state=7;break;case 7:e.popTry(),e.state=17,e.finallyFallThrough=21;break;case 16:e.popTry(),e.maybeUncatchable(),r=e.storedException,e.state=14;break;case 14:LOG("error while trying to login: "+(r&&r.message&&r)),console.error(r),e.state=15;break;case 15:return e.state=9,co.sleep(300);case 9:e.maybeThrow(),e.state=17,e.finallyFallThrough=33;break;case 17:e.popTry(),e.state=26;break;case 26:document.body.removeChild(n),e.state=24;break;case 21:LOG("logged in"),i.detach(function(){return t.loggedin=!0}),e.state=33;break;case 24:e.state=e.finallyFallThrough;break;default:return e.end()}},e,this)}).call(this)},login:function(){},get serverDevices(){return t(this,"/database")},get localDevices(){var e=this;return i.db(this.serverDevices.data,function(t){return e.serverDevices.update(t)})},get devices(){return this.localDevices.valueOf()},get commands(){return e(this,"/commands")},get connectedToServer(){return!0&&this.serverDevices.active.valueOf()&&this.commands.active.valueOf()},get main(){var e=this.devices;return e&&r.valueOf(e.main)},getDevice:function(e){return this.devices&&this.devices[r.valueOf(e)]},get activeDeviceId(){return h.activeDeviceId||this.main},get activeDevice(){return this.getDevice(this.activeDeviceId)},get activeContentIds(){var e=this.activeDevice;return i.Array(a.keys(e&&e.content).sort(function(t,n){return e.content[t].index-e.content[n].index}))},get activeContent(){return i.Array(this.activeContentIds.map(this.getDevice))},linkingPlaceId:null,get clearLinkingPlaceId(){"AskToLinkDevice"!=this.dialog&&"AskIfDeviceHasBeenLinked"!=this.dialog&&(this.linkingPlaceId=null)},get checkIfTimeToGoBack(){this.getDevice(this.activeDeviceId)||this.back()},get caption(){return this.getMessage(this.getDevice(this.activeDeviceId))||this.message("favorites")},get deviceType(){var e=this.getDevice(this.activeDeviceId);return e||(e=this.getDevice(this.main)),e.type},get deviceIds(){var e=r.valueOf(this.devices);return i.Array(a.keys(e).filter(function(t){var n=e[t];return n&&n.type}).sort())},getFreeGroup:function(){for(var e=a.reduce(r.valueOf(this.devices),function(e,t){return t.group&&(e[t.group]=!0),e},[]),t=2;1022>=t;++t)if(!e[t])return t;return null},get initialLoading(){return!this.devices||!this.devices.uid},get initialized(){return!this.initialLoading&&!!this.devices&&!!this.devices.main},setDatabase:function(e){this.serverDevices.send(e)},reset:function(){h.reset(),this.setDatabase({uid:s()},{uid:s()}),this.dialog="",this.editing=!1,this.history.length=0},setTemplate:function(e){function t(e,t){return Object.keys(e).forEach(function(n){return"image"!=n&&"content"!=n&&"type"!=n&&(t[n]=e[n])}),t}function n(e,i){if(e.content||"place"==e.type){var a={};r[i]=t(e,{type:"place",content:a});var c=0;e.content&&e.content.forEach(function(e){return a[n(e,s())]={index:c++}})}else r[i]=t(e,{type:"single"});return i}console.log(e);var r={uid:s()};r.main=n(e,s()),this.setDatabase(r)},get templates(){return $traceurRuntime.initGeneratorFunction(function e(){var t,n,r,i;return $traceurRuntime.createGeneratorInstance(function(e){for(;;)switch(e.state){case 0:e.pushTry(11,null),e.state=14;break;case 14:t=c.get,n=t.call(c,"/templates"),e.state=6;break;case 6:return e.state=2,n;case 2:r=e.sent,e.state=4;break;case 4:e.returnValue=r,e.state=-2;break;case 8:e.popTry(),e.state=-2;break;case 11:e.popTry(),e.maybeUncatchable(),i=e.storedException,e.state=9;break;case 9:e.returnValue=i,e.state=-2;break;default:return e.end()}},e,this)}).call(this)},get allMessages(){return $traceurRuntime.initGeneratorFunction(function e(){var t,n,r;return $traceurRuntime.createGeneratorInstance(function(e){for(;;)switch(e.state){case 0:t=c.get,n=t.call(c,"/messages"),e.state=6;break;case 6:return e.state=2,n;case 2:r=e.sent,e.state=4;break;case 4:e.returnValue=r,e.state=-2;break;default:return e.end()}},e,this)}).call(this)},get messages(){var e=this.allMessages;if(null!=e){var t={},n=h.language||"ru";return a.forOwn(e,function(e,r){return t[r]=e.hasOwnProperty(n)?e[n]:r}),t}},message:function(e){var t=this.messages&&this.messages[e];return null==t&&(t=e),t},notification:function(){},saveDevice:function(e,t){{var n;s()}return this.serverDevices.update((n={},Object.defineProperty(n,e,{value:r.makeDiff(this.getDevice(e),t),configurable:!0,enumerable:!0,writable:!0}),n))},newIndex:function(e){return Object.keys(this.getDevice(e).content||[]).length+1},linkItem:function(e,t){var n,r;if(e==t)throw new Error("cannot link place to itself");return this.serverDevices.update((r={},Object.defineProperty(r,e,{value:{content:(n={},Object.defineProperty(n,t,{value:{index:this.newIndex(e)},configurable:!0,enumerable:!0,writable:!0}),n)},configurable:!0,enumerable:!0,writable:!0}),r))},linkToFavourites:function(e){return this.linkItem(this.main,e)},linkActiveToFavourites:function(){return this.linkToFavourites(this.activeDeviceId)},addItem:function(e,t){var n,r,i=s();return this.serverDevices.update((r={},Object.defineProperty(r,e,{value:{content:(n={},Object.defineProperty(n,i,{value:{index:this.newIndex(e)},configurable:!0,enumerable:!0,writable:!0}),n)},configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(r,i,{value:t,configurable:!0,enumerable:!0,writable:!0}),r))},addPlace:function(e){return this.addItem(e,{type:"place",ru:"Помещение",en:"Room"})},addDevice:function(e){return this.addItem(e,{type:"device",ru:"Устройство",en:"Device"})},addGroup:function(e){return this.addItem(e,{type:"group",ru:"Группа",en:"Group"})},deleteItem:function(e,t){var n,r;return this.serverDevices.update((r={},Object.defineProperty(r,e,{value:{content:(n={},Object.defineProperty(n,t,{value:null,configurable:!0,enumerable:!0,writable:!0}),n)},configurable:!0,enumerable:!0,writable:!0}),r))},purgeItem:function(e){var t;return Promise.all([this.serverDevices.update(a.reduce(this.devices,function(t,n,r){var i;return n&&n.content&&n.content[e]&&(t[r]={content:(i={},Object.defineProperty(i,e,{value:null,configurable:!0,enumerable:!0,writable:!0}),i)}),t},(t={},Object.defineProperty(t,e,{value:null,configurable:!0,enumerable:!0,writable:!0}),t)))])},renameItem:function(e,t){var n,r=a.reduce(this.getDevice(e),function(e,t,n){return 2==n.length&&(e[n]=null),e},{});return r[l.language||"ru"]=t,this.serverDevices.update((n={},Object.defineProperty(n,e,{value:r,configurable:!0,enumerable:!0,writable:!0}),n))},command:function(e,t,n){u.getNewState(this.getDevice(e),t);return this.commands.ask({device:e,command:t,data:n})},iconCommand:function(e,t,n,i){return e=r.valueOf(e),("place"==e.type?"Short"==n:"Long"==n)?this.go(t):"place"==e.type||e.group?(("Short"==n||"Long"==n)&&(n=e&&e.state?"Down":"Up"),this.command(t,n,i)):(this.dialog="AskToLinkDevice",this.linkingPlaceId=t,Promise.resolve())},pan:function(e){var t=this.menuElement.getBoundingClientRect(),n=this.activeDeviceId;this.placesShifts.defineProperty(n),h.placesPages.defineProperty(n);var r=this.getDevice(n);if(r&&r.content){var i=Math.ceil(Object.keys(r.content).length/(this.pageWidth*this.pageHeight));if(0!=i){{var a=h.placesPages[n]||0;-a*t.width}if(e.isFinal)e.deltaX>0&&a>0?h.placesPages[n]=a-1:e.deltaX<0&&i-1>a&&(h.placesPages[n]=a+1),this.placesShifts[n]=0;else{var s=e.deltaX;(s>0&&0==a||0>s&&a==i-1)&&(s/=3),this.placesShifts[n]=s}}}},get imgProps(){return{onerror:function(){this.classList.add("error")},onload:function(){this.classList.remove("error")}}},focus:function(e){setTimeout(function(){return e.focus()},400)},searchAction:null,searchFilter:null,get checkSearchDialog(){"SearchItems"!=this.dialog&&(this.searchAction=null,this.searchFilter=null)},icons:null}).setName("app");return{app:d,local:h}}})}();
//# sourceMappingURL=out.js.map
