...
},{"_process":96,"buffer":91,"ra":137}],118:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
...
},{"JSONlocal":117,"PingPongJSON":119,"WebSocketToJSON":121,"_process":96,"buffer":91,"devdb":126,"deviceActions":127,"events":95,"http-status":114,"httpClient":132,"localUtils":135,"lodash":115,"ra":137,"uid":155,"windowSize":157}],123:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
"use strict";function onTimer(){timer=null,processQueue()}function ensureTimer(){timer||processing||installTimer()}function nextTick(e){queue.push(e),ensureTimer()}function processQueue(){if(!processing&&queue.length){var e=0;processing=!0;try{for(;MAX_TICKS>e&&e<queue.length;)queue[e++]()}finally{processing=!1,queue.splice(0,e),queue.length&&ensureTimer()}}}function getProxy(e){function t(){var t=e.handleEvent?e.handleEvent.apply(e,arguments):e.apply(this,arguments);return processQueue(),t}var n=void 0;return null!=(n=e[secret])?n:(assignProperty(t,secret,t),assignProperty(e,secret,t))}function hookEventListener(e){e.addEventListener&&!function(){var t=hookMethod(e,"addEventListener",function(e,n){return arguments[1]=getProxy(arguments[1]),t.apply(this,arguments)}),n=hookMethod(e,"removeEventListener",function(e,t){return arguments[1][secret]&&(arguments[1]=arguments[1][secret]),n.apply(this,arguments)})}()}function hookMethod(e,t,n){var r=e[t];return r&&(assignProperty(n,"toString",function(){return r.toString()}),e[t]=n),r}function assignProperty(e,t,n){return Object.defineProperty?Object.defineProperty(e,t,{value:n}):e[t]=n,n}var MAX_TICKS=1e3,setTimeout=window.setTimeout,setInterval=window.setInterval;process.nextTick=nextTick;var queue=[],timer=null,processing=!1,secret="process-tick-"+Math.random(),installTimer=function(){timer=setTimeout(onTimer,1)};window.postMessage&&window.addEventListener&&!function(){window.addEventListener("message",function(e){var t=e.source;t!=window&&null!=t||e.data!=secret||(e.stopPropagation(),onTimer())});var e=window.postMessage;installTimer=function(){e(secret,"*"),timer=!0}}(),!["setTimeout","setInterval","requestAnimationFrame"].forEach(function(e){var t=hookMethod(window,e,function(e,n){return"function"==typeof arguments[0]&&(arguments[0]=getProxy(arguments[0])),t.apply(this,arguments)})}),![window,document].forEach(hookEventListener);
...
},{"_process":96,"buffer":91,"events":95,"later":134}],125:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
"use strict";function _defineProperty(e,t,n){return Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0})}function toNode(e,t){e:for(;;){if(e=e&&"function"==typeof e.valueOf?e.valueOf():e,Array.isArray(e)){if(0==e.length)return null;if(1==e.length){e=e[0];continue e}t||(t=document.createDocumentFragment()),e.forEach(function(e){return toNode(e,t)}),e=t}else"string"==typeof e&&(e=document.createTextNode(e)),t&&(t.appendChild(e),e=t);return e}}function fcalc(e,t){"function"!=typeof e?t(e):!function(){var n=!0;ra(!1,regeneratorRuntime.mark(function r(){var a;return regeneratorRuntime.wrap(function(r){for(;;)switch(r.prev=r.next){case 0:if(!n){r.next=4;break}n=!1,r.next=6;break;case 4:return r.next=6,co.requestAnimationFrame;case 6:if(a=e(),!(a&&a.next&&a["throw"])){r.next=11;break}return r.next=10,a;case 10:a=r.sent;case 11:t(a);case 12:case"end":return r.stop()}},r,this)}))}()}function getControl(e){var t=e,n=-(1/0);if(e instanceof DocumentFragment)for(var r=0,a=e.childNodes.length;a>r;++r){var o=e.childNodes.item(r),i=void 0;if(i=o instanceof HTMLScriptElement?0:o instanceof HTMLTemplateElement?0:o instanceof Text?o.data?o.data.trim()?1/0:20:10:"NOSCRIPT"==o.tagName?0:1/0,i==1/0)return o;i>n&&(n=i,t=o)}return t}function ShortSwipeRecognizer(){Hammer.AttrRecognizer.apply(this,arguments)}function directionStr(e){return e==Hammer.DIRECTION_DOWN?"down":e==Hammer.DIRECTION_UP?"up":e==Hammer.DIRECTION_LEFT?"left":e==Hammer.DIRECTION_RIGHT?"right":""}function onMoveEvent(e,t,n,r){var a=getHammer(n),o=n["DIRECTION_"+e]|=Hammer["DIRECTION_"+t.toUpperCase()];a.get(""+e).set({direction:o}),a.on(""+e+t,r)}function onMouseEvent(e,t,n){(t=getControl(t))&&t.addEventListener("mouse"+e,n)}function onTouchEvent(e,t,n){(t=getControl(t))&&t.addEventListener("touch"+e,n)}function checkDOMControl(e){for(var t=[e.ownerDocument&&e.ownerDocument.documentElement,document.documentElement,e.ownerDocument&&e.ownerDocument.body,document.body].filter(Boolean),n=e;n;){if(t.indexOf(n)>=0)return void ra.forceCalculations();n=n.parentNode}}function setContent(e,t){var n=void 0===arguments[2]?null:arguments[2];fcalc(t,function(t){checkDOMControl(e);var r=toNode(t);r?(checkDOMControl(e),e.innerHTML="",e.appendChild(r)):e.innerHTML="",n&&n()})}function toAttrString(e){return Array.isArray(e)?e.map(toAttrString).join(" "):e?""+e:""}function appendContent(e,t){t||(t=document.createDocumentFragment());var n=!0,r=!1,a=void 0;try{for(var o,i=e[Symbol.iterator]();!(n=(o=i.next()).done);n=!0){var c=o.value;if("function"==typeof c){var u=document.createElement("span");setContent(u,c),t.appendChild(u)}else if(c instanceof Node)t.appendChild(c);else if(null!=c&&"string"!=typeof c&&c[Symbol.iterator]){var l=!0,s=!1,m=void 0;try{for(var f,d=c[Symbol.iterator]();!(l=(f=d.next()).done);l=!0){var p=f.value;appendContent(p,t)}}catch(h){s=!0,m=h}finally{try{!l&&d["return"]&&d["return"]()}finally{if(s)throw m}}}else t.appendChild(document.createTextNode(c))}}catch(h){r=!0,a=h}finally{try{!n&&i["return"]&&i["return"]()}finally{if(r)throw a}}return t}var co=require("co"),ra=require("ra"),lodash=require("lodash"),Hammer=require("hammerjs");Hammer.inherit(ShortSwipeRecognizer,Hammer.AttrRecognizer,{defaults:{event:"shortswipe",threshold:10,velocity:.1,direction:Hammer.DIRECTION_HORIZONTAL|Hammer.DIRECTION_VERTICAL,pointers:1,maxtime:300},getTouchAction:function(){return Hammer.Pan.prototype.getTouchAction.call(this)},attrTest:function(e){var t=this.options.direction,n=void 0;return t&(Hammer.DIRECTION_HORIZONTAL|Hammer.DIRECTION_VERTICAL)?n=e.maxVelocity:t&Hammer.DIRECTION_HORIZONTAL?n=e.maxVelocityX:t&Hammer.DIRECTION_VERTICAL&&(n=e.maxVelocityY),this._super.attrTest.call(this,e)&&e.deltaTime<=this.options.maxtime&&t&e.direction&&e.distance>this.options.threshold&&Math.abs(n)>this.options.velocity&&e.eventType&Hammer.INPUT_END},emit:function(e){var t=directionStr(e.direction);t&&this.manager.emit(this.options.event+t,e),this.manager.emit(this.options.event,e)}}),Hammer.defaults.preset=[[ShortSwipeRecognizer,{direction:Hammer.DIRECTION_HORIZONTAL}],[Hammer.Pan,{direction:Hammer.DIRECTION_HORIZONTAL},["shortswipe"]],[Hammer.Tap],[Hammer.Tap,{event:"doubletap",taps:2},["tap"]],[Hammer.Press]];var updateInput=function(e,t){var n=e.session;if(t.maxVelocity=n.maxVelocity=Math.max(Math.abs(n.maxVelocity||0),Math.abs(t.velocity)),t.maxVelocityX=n.maxVelocityX=Math.max(Math.abs(n.maxVelocityX||0),Math.abs(t.velocityX)),t.maxVelocityY=n.maxVelocityY=Math.max(Math.abs(n.maxVelocityY||0),Math.abs(t.velocityY)),n.inputCount=(n.inputCount||0)+1,!n.directions){var r;n.directions=(r={},_defineProperty(r,Hammer.DIRECTION_LEFT,0),_defineProperty(r,Hammer.DIRECTION_RIGHT,0),_defineProperty(r,Hammer.DIRECTION_HORIZONTAL,0),_defineProperty(r,Hammer.DIRECTION_UP,0),_defineProperty(r,Hammer.DIRECTION_DOWN,0),_defineProperty(r,Hammer.DIRECTION_VERTICAL,0),r),n.directionsCount=0}if(t.directions={},t.direction){++n.directionsCount;for(var a in n.directions)Object.prototype.hasOwnProperty.call(n.directions,a)&&a&t.direction&&++n.directions[a]}for(var a in n.directions)Object.prototype.hasOwnProperty.call(n.directions,a)&&(t.directions[a]=n.directions[a]/n.directionsCount)},getHammer=function(e){var t=e._hammer;return null==t&&(t=e._hammer=Hammer(e),t.on("hammer.input",function(e){return updateInput(t,e)})),t},onSwipeEvent=onMoveEvent.bind(null,"shortswipe"),onPanEvent=onMoveEvent.bind(null,"pan"),Events={},GeneratorFunctionPrototype=Object.getPrototypeOf(regeneratorRuntime.mark(function e(){return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:case"end":return e.stop()}},e,this)}));module.exports={createElement:function(e,t){function n(e){null!=e&&(lodash.forEach(e,function(e,t){if("_"==t);else if("class"==t)u.push(e);else if("style"==t)fcalc(e,function(e){"string"==typeof e?c.setAttribute("style",e):lodash.forEach(e,function(e,t){return fcalc(e,function(e){return c.style[t]=e})})});else if("oncreate"==t)i=e;else if(t.match(/^on/)){if(null!=e){"function"==typeof e&&(e=[e]);var n=!0,r=!1,a=void 0;try{for(var o,l=e[Symbol.iterator]();!(n=(o=l.next()).done);n=!0){var s=o.value;Object.getPrototypeOf(s)==GeneratorFunctionPrototype&&(s=co.eventHandler(s)),Object.prototype.hasOwnProperty.call(Events,t)?Events[t](c,s):c.addEventListener(t.slice("on".length),s)}}catch(m){r=!0,a=m}finally{try{!n&&l["return"]&&l["return"]()}finally{if(r)throw a}}}}else fcalc(e,function(e){e=toAttrString(e),c.getAttribute(t)!=e&&c.setAttribute(t,e)})}),Object.prototype.hasOwnProperty.call(e,"_")&&n(e._))}for(var r=arguments.length,a=Array(r>2?r-2:0),o=2;r>o;o++)a[o-2]=arguments[o];if("function"==typeof e)return e(t&&t._?Object.assign({},t,t._,{_:null}):t||0,appendContent(a));var i=void 0,c=document.createElement(e),u=[];switch(n(t),u.length&&!function(){var e=u.map(function(){return null});u.forEach(function(t,n){return fcalc(t,function(t){e[n]=t;var r=toAttrString(e).replace(/(^|\s|\r|\n)(null|undefined|false|0|\-0|NaN)(?=$|\s|\r|\n)/g,"");c.className!=r&&(c.className=r)})})}(),a.length){case 0:break;case 1:setContent(c,a[0]);break;default:c.appendChild(appendContent(a))}return"function"==typeof i&&i.call(c,{type:"create",target:c,srcElement:c,currentTarget:c}),c}};for(var updateInputValue=function(){var e=this;setTimeout(function(){return e._raValue.assign(e.value)})},raValue={get:function(){var e=this;return this._raValue||ra.detach(function(){e._raValue=ra(),e._raValue.assign(e.value),e.addEventListener("change",updateInputValue),e.addEventListener("keypress",updateInputValue),e.addEventListener("keydown",updateInputValue),e.addEventListener("keyup",updateInputValue)}),this._raValue.valueOf()},set:function(e){this.value!=e&&(this.value=e,this._raValue&&this._raValue.assign(this.value))}},_arr=[HTMLInputElement,HTMLTextAreaElement],_i=0;_i<_arr.length;_i++){var C=_arr[_i];Object.defineProperty(C.prototype,"raValue",raValue)}
...
},{"_process":96,"buffer":91,"co":124,"hammerjs":113,"lodash":115,"ra":137}],126:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
...
},{"_process":96,"buffer":91,"localUtils":135,"lodash":115,"uid":155}],127:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
"use strict";function _toConsumableArray(e){if(Array.isArray(e)){for(var a=0,t=Array(e.length);a<e.length;a++)t[a]=e[a];return t}return Array.from(e)}function squareDistance(e,a){return(e.pageX-a.pageX)*(e.pageX-a.pageX)+(e.pageY-a.pageY)*(e.pageY-a.pageY)}function getX(e){return e.pageX}function getY(e){return e.pageY}function increasing(e,a,t){return 0==a||e>=t[a-1]}function decreasing(e,a,t){return 0==a||e<=t[a-1]}var co=require("co"),TRACE=void 0,SWIPE_TIMEOUT=400,PRESS_TIMEOUT=500,PRESS_MOVE_OUT=2*(96/25.4);document.addEventListener("touch",co.eventHandler(regeneratorRuntime.mark(function e(a){var t,n,r,i,p,s,c,g,o,u,l,m,E,y,T,h,d;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:c=function(e,n){TRACE&&TRACE(e,t);var i=new CustomEvent(e,{bubbles:!0,cancelable:!0,detail:{start:a,original:n||a}});i.pageX=r.pageX,i.pageY=r.pageY,i.clientX=r.clientX,i.clientY=r.clientY,i.screenX=r.screenX,i.screenY=r.screenY,i.deltaX=r.pageX-a.pageX,i.deltaY=r.pageY-a.pageY,a.target.dispatchEvent(i)},t=void 0,n=[a],r=a,i=!1,p=!1,s=!1,g=setTimeout(function(){i=!0,c("press")},PRESS_TIMEOUT),co.defer(function(){return clearTimeout(g)}),TRACE&&TRACE("enter",{x:a.pageX,y:a.pageY,t:a.timeStamp}),o=void 0;case 11:return e.next=13,a.detail.next;case 13:if(!(o=e.sent)){e.next=18;break}TRACE&&((t||(t=[])).push({x:o.pageX,y:o.pageY,t:o.timeStamp-a.timeStamp}),TRACE("next",t)),(n.length>1||squareDistance(o,a)>PRESS_MOVE_OUT*PRESS_MOVE_OUT)&&(clearTimeout(g),u=o.pageX-r.pageX,l=o.pageY-r.pageY,(u||l)&&(m=Math.abs(u),E=Math.abs(l),y=r,n.push(r),r=o,p=!0,m>E&&u>0?c("panright",o):m>E&&0>u?c("panleft",o):E>m&&l>0?c("pandown",o):E>m&&0>l&&c("panup",o),c("pan",o)));case 16:e.next=11;break;case 18:clearTimeout(g),n.length>2&&r.timeStamp-a.timeStamp<SWIPE_TIMEOUT&&(s=!0,n.shift(),T=n.map(getX),h=n.map(getY),d={x:Math.max.apply(Math,_toConsumableArray(T))-Math.min.apply(Math,_toConsumableArray(T)),y:Math.max.apply(Math,_toConsumableArray(h))-Math.min.apply(Math,_toConsumableArray(h))},d.x>d.y&&T.every(increasing)?c("swiperight"):d.x>d.y&&T.every(decreasing)?c("swipeleft"):d.x<d.y&&h.every(increasing)?c("swipedown"):d.x<d.y&&h.every(decreasing)?c("swipeup"):s=!1),i||s||p||c("tap"),TRACE&&TRACE("done",t);case 22:case"end":return e.stop()}},e,this)})));
...
},{"_process":96,"buffer":91,"co":124}],130:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
...
},{"_process":96,"buffer":91,"localUtils":135,"lodash":115,"url":101}],133:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
...
},{"_process":96,"buffer":91}],134:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
...
},{"_process":96,"buffer":91,"co":124,"events":95,"lodash":115}],136:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
...
},{"_process":96,"buffer":91}],137:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
...
},{"LOG":118,"_process":96,"buffer":91,"co":124,"later":134,"lodash":115,"uid":155}],138:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
"use strict";function rethrow(e){setTimeout(function(){throw e})}function sendData(e,t){if(e.cbs.length){var n=e.cbs;e.cbs=[],n.forEach(function(e){try{e(t)}catch(n){rethrow(n)}})}}function pushEvent(e,t){if(e.closed)throw new Error("track is already closed");e.preventDefault&&t.preventDefault&&t.preventDefault(),sendData(e,t)}function stopEvents(e){e.closed=!0,sendData(e,null)}function startTrack(e,t){var n={cancelEvent:null,next:{then:function(e){c.closed?process.nextTick(function(){return e(null)}):c.cbs.push(e)}}},c={abandoned:!1,closed:!1,detail:n,cbs:[],preventDefault:!1};tracks[e]=c;var r=new CustomEvent("touch",{detail:n,bubbles:!0,cancelable:!0});r.pageX=t.pageX,r.pageY=t.pageY,r.clientX=t.clientX,r.clientY=t.clientY,r.screenX=t.screenX,r.screenY=t.screenY,r.preventDefault=function(){t.preventDefault(),c.preventDefault=!0},t.target.dispatchEvent(r),pushEvent(c,t)}function onExistingTrack(e){return function(t,n){var c=tracks[t];c&&(c.abandoned=!1,e(c,n))}}function forTouches(e,t){for(var n=0;n<e.changedTouches.length;++n){var c=e.changedTouches.item(n);t(c.identifier,{type:"touchmove",identifier:c.identifier,target:c.target,screenX:c.screenX,screenY:c.screenY,clientX:c.clientX,clientY:c.clientY,pageX:c.pageX,pageY:c.pageY,radiusX:c.radiusX,radiusY:c.radiusY,rotationAngle:c.rotationAngle,force:c.force,timeStamp:e.timeStamp,preventDefault:e.preventDefault.bind(e)})}for(var r=Object.create(null),n=0;n<e.touches.length;++n)r[e.touches.item(n).identifier]=!0;for(var a in tracks)a in r?tracks[a].abandoned=!1:removeTrack(a)}var htmlutils=require("htmlutils"),tracks=Object.create(null);setInterval(function(){for(var e in tracks){var t=tracks[e];t.abandoned||(t.abandoned=!0)}},7e3);var continueTrack=onExistingTrack(pushEvent),stopTrack=onExistingTrack(function(e,t){pushEvent(e,t),stopEvents(e)}),removeTrack=onExistingTrack(stopEvents),cancelTrack=onExistingTrack(function(e,t){e.detail.cancelEvent=t,stopEvents(e)}),container=document;container.addEventListener("mousedown",function(e){0==e.button?startTrack("mouse",e):1&e.buttons||removeTrack("mouse")}),container.addEventListener("mousemove",function(e){1&e.buttons?continueTrack("mouse",e):removeTrack("mouse")}),container.addEventListener("mouseup",function(e){0==e.button?stopTrack("mouse",e):1&e.buttons||removeTrack("mouse")}),container.addEventListener("touchstart",function(e){forTouches(e,startTrack)}),container.addEventListener("touchmove",function(e){forTouches(e,continueTrack)}),container.addEventListener("touchend",function(e){forTouches(e,stopTrack)}),container.addEventListener("touchcancel",function(e){forTouches(e,cancelTrack)});
...
},{"_process":96,"buffer":91,"htmlutils":131}],140:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
"use strict";module.exports=function(e){var t=e.load(require("ui/Command"));return function(n){return React.createElement(t,{message:"commandAddExistingItem",onclick:function(){e.dialog="SearchItems",e.searchAction=function(t){e.linkItem(e.activeDeviceId,t),e.dialog=""}},_:n})}};
...
},{"_process":96,"app":122,"buffer":91,"devdb":126,"httpClient":132,"localUtils":135,"ui/AddMenu":141,"ui/AskNewName":143,"ui/AskToLinkDevice":144,"ui/Button":145,"ui/ContextMenu":147,"ui/MainScreen":149,"ui/SearchItems":152,"ui/ServiceDialog":153,"ui/StartupScreen":154}],143:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
...
},{"_process":96,"buffer":91,"htmlutils":131}],144:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
"use strict";function _defineProperty(e,n,t){return Object.defineProperty(e,n,{value:t,enumerable:!0,configurable:!0,writable:!0})}var lodash=require("lodash"),htmlutils=require("htmlutils");module.exports=function(e,n){return function(t){var i=t.placeId,r=t.iconId,a=t.iconDescr,o=t.index,s=void 0,c=void 0,u=void 0,g=void 0,l=void 0,m=!1,d=function(){e.pan({deltaX:0,isFinal:!0}),D.isDimmering=!1,D.isMoving&&D.changes&&setTimeout(co.func(regeneratorRuntime.mark(function n(){var e,t;return regeneratorRuntime.wrap(function(n){for(;;)switch(n.prev=n.next){case 0:if(e=D.changes,D.changes=null,D.isMoving=!1,e){n.next=5;break}return n.abrupt("return");case 5:if(n.prev=5,t=lu.get(e,"before",i,"content",r,"index"),t!=D.newIndex){n.next=9;break}return n.abrupt("return");case 9:return n.next=11,e.save();case 11:return n.prev=11,e.close(),n.finish(11);case 14:case"end":return n.stop()}},n,this,[[5,,11,14]])})))},f=htmlutils.tickCache(function(){for(var e=s.parentNode,n=void 0;n=e.getBoundingClientRect(),!n.width||!n.height;)e=e.parentNode;return n}),h=function(e){var n=f();return{x:(e.x-n.left)/n.width*100,y:(e.y-n.top)/n.height*100}},v=function(e){return h({x:e.screenX,y:e.screenY})},p=function(e){var n=e.getBoundingClientRect();return h({x:n.left,y:n.top})},y=htmlutils.tickCache(function(){if(!m)return s.getBoundingClientRect().height;if(D.iconData){if(D.iconData.deviceImageGetHeight){var e=D.iconData.deviceImageGetHeight();if(e)return e}var n=D.iconData.getElementsByClassName("device_image_height")[0];if(null!=n&&n.getBoundingClientRect){var e=n.getBoundingClientRect().height;if(e)return e}for(var t=0;t<D.iconData.childNodes.length;++t){var e=D.iconData.childNodes.item(t);if(e.getBoundingClientRect&&(e=e.getBoundingClientRect().height))return e}}return l.getBoundingClientRect().height}),b=function(n){var t=D.isDimmering;if(D.isDimmering=D.dimmering&&!n.isFinal,D.dimmering&&(t||D.isDimmering)){if(!D.dimmChanges){D.dimmChanges=e.localDevices.createRecord();var i=a&&a.get("state");D.dimmChanges.assign({initialDimmeringState:i})}var o=-n.deltaY/(1*y()),s=Math.min(1,Math.max(0,D.dimmChanges.get("initialDimmeringState")+o));(0==s||1==s)&&D.dimmChanges.assign({initialDimmeringState:s-o}),D.dimmChanges.update({content:_defineProperty({},r,{state:s})})}},x=function(n){if(D.isMoving){var t=v(n),i={x:t.x+D.dx,y:t.y+D.dy};D.x=i.x,D.y=i.y,i={x:Math.min(e.pageWidth-1,Math.max(0,Math.round(i.x/(100/e.pageWidth)))),y:Math.min(e.pageHeight-1,Math.max(0,Math.round(i.y/(100/e.pageHeight))))},D.newIndex=i.x+i.y*e.pageWidth,D.moved=!0}},D=ra(Object.defineProperties({iconData:null,iconCommand:function(n,t){return co.gocall(regeneratorRuntime.mark(function i(){var o;return regeneratorRuntime.wrap(function(i){for(;;)switch(i.prev=i.next){case 0:return o=this.dimmChanges,o&&(this.dimmChanges=null),this.isDimmering=!1,i.prev=3,i.next=6,e.iconCommand(a,r,n,t);case 6:return i.prev=6,o&&o.close(),i.finish(6);case 9:case"end":return i.stop()}},i,this,[[3,,6,9]])}),this)},isDimmering:!1,dimmChanges:null,readyToSaveDimmering:function(){return!this.isDimmering&&!!this.dimmChanges},saveDimmering:function(){this.readyToSaveDimmering()&&a&&D.iconCommand("Set",a.get("state"))},isMoving:!1,moved:!1,newIndex:null,x:null,y:null,dx:null,dy:null,changes:null,oldMoving:!1,oldDimmering:!1,state:0,onning:!1,offing:!1,"final":!0,errorneous:!1,setOpacity:function(e,n){null==n?delete e.style.opacity:e.style.opacity=n}},{iconName:{get:function(){return a&&a.valueOf()&&a.valueOf().icon||null},configurable:!0,enumerable:!0},iconTemplate:{get:function(){return this.iconName&&e.icons&&Object.prototype.hasOwnProperty.call(e.icons,this.iconName)&&e.icons[this.iconName]||null},configurable:!0,enumerable:!0},updateIconDataState:{get:function(){var e=this.iconData;e&&e.deviceSetState&&e.deviceSetState(this.state)},configurable:!0,enumerable:!0},dimmering:{get:function(){var e=null==a?null:a.valueOf(),n=null==e?null:null==e.dimmering?null:!!e.dimmering;return null!=n?n:null!=e&&"place"===e.type?!1:!0},configurable:!0,enumerable:!0},image_on:{get:function(){var e=a&&a.valueOf(),n=""||e&&e.image_on||e&&e.image;return n&&"/images/"+n},configurable:!0,enumerable:!0},update_image_on:{get:function(){D.image_on&&(u.src=D.image_on)},configurable:!0,enumerable:!0},image_off:{get:function(){var e=a&&a.valueOf(),n=""||e&&e.image_off||e&&e.image;return n&&"/images/"+n},configurable:!0,enumerable:!0},update_image_off:{get:function(){D.image_off&&(c.src=D.image_off)},configurable:!0,enumerable:!0},onDimmering:{get:function(){this.readyToSaveDimmering()&&setTimeout(this.saveDimmering)},configurable:!0,enumerable:!0},checkAppMoving:{get:function(){var n=!!this.isMoving,t=!!this.oldMoving;this.oldMoving=n,n!=t&&(n?++e.moving:--e.moving)},configurable:!0,enumerable:!0},checkAppDimmering:{get:function(){var n=!!this.isDimmering,t=!!this.oldDimmering;this.oldDimmering=n,n!=t&&(n?++e.dimmering:--e.dimmering)},configurable:!0,enumerable:!0},updateChanges:{get:function(){var n=this;e.editing&&this.isMoving&&this.changes?!function(){var e=null,t=lu.get(n,"changes","before","content",i,"content");if(t&&t[r]){var a=lodash.keys(t).filter(function(e){return e!=r}).sort(function(e,n){return t[e].index-t[n].index}).map(function(e){return t[e].index});e={content:_defineProperty({},i,{content:_defineProperty({},r,{index:0==a.length?0:n.newIndex<=0?a[0]-1:n.newIndex>=a.length?a[a.length-1]+1:(a[n.newIndex-1]+a[n.newIndex])/2})})}}n.changes.assign(e)}():(this.changes&&(this.changes.close(),this.changes=null),this.moved=!1)},configurable:!0,enumerable:!0},present:{get:function(){return!(!a.get("content")&&!a.get("group"))},configurable:!0,enumerable:!0},updateState:{get:function(){var e=a&&a.valueOf();if(!e)return 0;if(e.newstate_timestamp&&(!e.state_timestamp||e.newstate_timestamp>e.state_timestamp)){var n=e.newstate>=e.state;this.onning=n,this.offing=!n,this["final"]=!1,this.state=e.newstate}else this.onning=!1,this.offing=!1,this["final"]=!0,this.state=e.state;this.errorneous=!!e.errorneous},configurable:!0,enumerable:!0},updateOpacity:{get:function(){this.iconTemplate?(u.style.visibility="hidden",c.style.visibility="hidden",g.style.visibility="hidden"):this.present?(this.setOpacity(g,0),this.dimmering?(this.setOpacity(u,this.state),this.setOpacity(c,.333*(1-this.state))):(this.setOpacity(u,+!!this.state),this.setOpacity(c,+!this.state))):(this.setOpacity(u,0),this.setOpacity(c,0),this.setOpacity(g,.7))},configurable:!0,enumerable:!0}})),w=function(e){return React.createElement("img",{"class":"error",onerror:function(){this.classList.add("error")},onload:function(){this.classList.remove("error")},_:e})};return React.createElement("div",{oncreate:function(e){return s=e.target},onmousedown:function(){return m=!0},onwheel:function(e){return console.log(e.deltaY,e.deltaMode,e)},"class":function(){return"\n			icon\n			"+(D.onning&&"onning")+"\n			"+(D.offing&&"offing")+"\n			"+(D["final"]&&"final")+"\n			"+(D.errorneous&&"errorneous")+"\n			"+(D.dimmering.valueOf()?"dimmering":"switching")+"\n			"+r+"\n			icon_moving_"+!!D.isMoving+"\n			icon_moved_"+(!!D.isMoving&&!!D.moved)+"\n		"},style:regeneratorRuntime.mark(function C(){var n,t,i,r,a,s,c,u,g;return regeneratorRuntime.wrap(function(l){for(;;)switch(l.prev=l.next){case 0:if(!e.editing){l.next=3;break}return l.next=3,co.sleep();case 3:if(C.run){l.next=7;break}C.run=!0,l.next=9;break;case 7:return l.next=9,co.requestAnimationFrame;case 9:return n=void 0,D.isMoving?n={x:D.x,y:D.y}:(t=lu.valueOf(o),i=e.pageHeight||1,r=e.pageWidth||1,a=r*i,s=t%a,c=(t-s)/a,u=s%r,g=(s-u)/r,u+=r*c,n={x:100*u/r,y:100*g/i}),l.abrupt("return",{left:""+n.x+"%",top:""+n.y+"%"});case 12:case"end":return l.stop()}},C,this)})},React.createElement("div",{"class":"iconControl",ontouch:htmlutils.preventDefault,ontouchend:d,ontouchcancel:d,onmouseup:d,ontap:function(){return!e.editing&&D.iconCommand("Short")},onswipeup:function(){return!e.editing&&D.iconCommand("Set",1)},onswipedown:function(){return!e.editing&&D.iconCommand("Set",0)},onpanup:function(n){return e.editing?x(n):b(n)},onpandown:function(n){return e.editing?x(n):b(n)},onpanleft:function(n){return!e.dimmering&&(D.isMoving?x(n):e.pan(n))},onpanright:function(n){return!e.dimmering&&(D.isMoving?x(n):e.pan(n))},onpress:function(n){if(e.editing){var t=v(n),i=p(s);D.isMoving=!0,D.moved=!1,D.dx=i.x-t.x,D.dy=i.y-t.y,D.x=i.x,D.y=i.y,D.newIndex=o.valueOf(),D.changes=e.localDevices.createRecord()}else D.iconCommand("Long")}},React.createElement("div",{"class":"image",oncreate:function(e){return l=e.target}},React.createElement(w,{"class":"wait",src:"/images/wait.svg",style:{visibility:function(){return(void 0)["final"]?"hidden":null}}}),React.createElement(w,{"class":"off",src:"/images/room.svg",oncreate:function(e){return c=e.target}}),React.createElement(w,{"class":"on",src:"/images/room_on.svg",oncreate:function(e){return u=e.target}}),React.createElement(w,{"class":"absent",src:"/images/room_absent.svg",oncreate:function(e){return g=e.target}}),React.createElement("div",{"class":function(){return"\n					svg\n					state"+(D.present?(Math.round(100*D.state)+1e3).toString().slice(1):"Absent")+"\n					"+(D.isDimmering?"":"smoothing")+"\n				"}},function(){return D.iconData=D.iconTemplate&&htmlutils.importComponent(D.iconTemplate)||null})),React.createElement("span",{"class":"iconLabel"},function(){return a.get(n.language)||a.get("ru")||a.get("en")}),React.createElement("span",{"class":"iconPercentage"},function(){return D.present&&D.dimmering&&""+Math.round(100*D.state)+"%"})),React.createElement("div",{"class":"deleteSign",ontouchstart:function(){return e.deleteItem(i,r)},onmousedown:function(){return e.deleteItem(i,r)}}))}};
...
},{"_process":96,"buffer":91,"htmlutils":131,"lodash":115}],149:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
"use strict";var htmlutils=require("htmlutils"),UID=require("uid");module.exports=function(e,t){var n=e.load(require("ui/Place"));return function(){var i=UID();return React.createElement("div",null,React.createElement("style",{"class":"style"},function(){return"\n				."+i+" .icon {\n					width: "+100/e.pageWidth+"%;\n					height: "+100/e.pageHeight+"%;\n				}\n			"}),React.createElement("div",{"class":"top"},React.createElement("span",{"class":"top_self"},React.createElement(htmlutils.Centered,null,function(){return e.caption}))),React.createElement("div",{"class":function(){return"menu "+i+" "+e.activeDeviceId},onpanleft:function(t){return!e.moving&&!e.dimmering&&e.pan(t)},onpanright:function(t){return!e.moving&&!e.dimmering&&e.pan(t)},ontouchend:function(){return e.pan({deltaX:0,isFinal:!0})},ontouchcancel:function(){return e.pan({deltaX:0,isFinal:!0})},oncreate:function(){var i=this;e.menuElement=this;var a=Object.create(null);ra(function(){var c=e.activeDeviceId;c&&!a[c]&&(e.placesShifts.defineProperty(c),t.placesPages.defineProperty(c),a[c]=!0,i.appendChild(React.createElement(n,{placeId:c,placeDescr:ra(function(){return e.getDevice(c)})})))})}}),React.createElement("div",{"class":"bottom"},React.createElement("div",{"class":"help",onpress:function(){return e.dialog="ServiceDialog"}}),React.createElement("div",{"class":"logo",onpress:function(){return e.dialog="ContextMenu"},ontap:function(t){return t.shiftKey||t.srcEvent&&t.srcEvent.shiftKey?e.dialog="ContextMenu":t.ctrlKey||t.srcEvent&&t.srcEvent.ctrlKey?e.dialog="SearchItems":(e.editing=!1,e.dialog="",void e.go(e.main))}}),React.createElement("div",{"class":"back",ontouch:function(){e.editing?e.editing=!1:e.dialog?e.dialog="":e.back()}})))}};
...
},{"_process":96,"buffer":91,"htmlutils":131,"ui/Place":151,"uid":155}],150:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
...
},{"DamerauLevenshtein":116,"_process":96,"buffer":91,"iscroll":133}],153:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
...
},{"_process":96,"buffer":91,"htmlutils":131}],154:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
...
},{"_process":96,"buffer":91,"ra":137}],158:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
