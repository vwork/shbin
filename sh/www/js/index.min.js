...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
!function(){!function(t){var e=global.performance||Date,r=0,n=e.now(),i=require,s=function(){r+=e.now()-n,require=i;try{return i.apply(this,arguments)}finally{require=s,n=e.now()}};require=s;try{t()}finally{require=i,r+=e.now()-n,r/=1e3,global.__require_stats__||(global.__require_stats__={}),global.__require_stats__["/home/vadzim/v/work/nerojs/src/co.js"]=r}}(function(){"use strict";function t(t){return{done:!0,iteratorFailed:!0,value:t}}function e(e,r){try{return e.next(r)}catch(n){return t(n)}}function r(e,r){if(!e.throw)return t(r);try{return e.throw(r)}catch(n){return t(n)}}function n(t){if(t&&t.throw){var e=(new h,r(t,new h));e.done&&e.iteratorFailed||a(new Error("thread ate EKill"))}}var i=require("later");module.exports=exports=new EventEmitter;var s=null;exports.currentThread=null,exports.global=null;exports.go=function(t){for(var e=[],r=1;r<arguments.length;r++)e[r-1]=arguments[r];if("function"==typeof t&&(t=t.apply(null,e)),!t.next){var n=t;t={next:function(){var t={value:n,done:!n};return n=null,t}}}return new c(t)},exports.gocall=function(t,e){for(var r=[],n=2;n<arguments.length;n++)r[n-2]=arguments[n];return new c(t.apply(e,r))},exports.func=function(t){return function(){return new c(t.apply(this,arguments))}};var o=function(t){return new Promise(function(e,r){return i.then(function(){return t(e,r)})})};exports.node=function(t){return function(){for(var e=[],r=0;r<arguments.length;r++)e[r]=arguments[r];var n=this;return o(function(r,i){e.push(function(t,e){return t?i(t):r(e)}),t.apply(n,e)})}},exports.cb=function(t){return function(){for(var e=[],r=0;r<arguments.length;r++)e[r]=arguments[r];var n=this;return o(function(r){e.push(r),t.apply(n,e)})}},exports.catchThreads=function(t,e){var r=s;s=e;try{return t()}finally{s=r}},exports.wait=function(t){return{then:t}},exports.sleep=function(t){return{then:function(e){var r=setTimeout(e,t);return{kill:function(){clearTimout(r)}}}}},exports.yield=exports.sleep(1),exports.requestAnimationFrame={then:function(t){if("function"==typeof cancelAnimationFrame){{requestAnimationFrame(t)}return{kill:function(){cancelAnimationFrame(timer)}}}return exports.sleep(1).then(t)}};var a=function(t){return setTimeout(function(){throw t},1)},u={enumerable:!1},h=function(){var t=void 0!==arguments[0]?arguments[0]:"kill";$traceurRuntime.superConstructor(l).call(this,t)},l=h;$traceurRuntime.createClass(h,{},{},Error),exports.EKill=h;var c=function(t){var e=this;if(this._attachedToStack=!0,this._iterator=t,this._stopCount=0,this._stack=[],this._global={},this._current=null,this.$name={toString:function(){return"<Thread>"}},this._newStep(),this._start=function(){e._start&&e._step&&e._step.next&&(e._stopCount>0?e._step.resume=e._start:(e._start=null,e._step.next()))},this._promise=new Promise(function(t,r){e._resolve=t,e._reject=r}),!this._resolve)throw new Error("assertion failure: wrong implementation of Promise");i.then(this._start),s&&s(this),exports.emit("start",this)};$traceurRuntime.createClass(c,{linkName:function(t){var e=void 0!==arguments[1]?arguments[1]:":thread";return t.$name&&(t=t.$name),this.$name.toString=function(){return""+t+e},this},waitForInput:function(){if(this._checkFinished(),this._stopCount>0)throw new Error("thread is paused");return this._start&&this._start(),this},_attachPromise:function(t){return t.kill=this.kill.bind(this),t},then:function(t,e){return this._attachedToStack=!1,this._attachPromise(this._promise.then(t,e))},"catch":function(t){return this._attachedToStack=!1,this._attachPromise(this._promise.catch(t))},isFinished:function(){return!this._step},isPaused:function(){return this._stopCount>0},"throw":function(t){if(this==exports.currentThread)throw t;this._checkFinished(),this._newStep(),this._stopCount>0?this._step.resume=this._step.fail.bind(this._step,t):this._step.fail(t)},attachToStack:function(){this._attachedToStack=!0},kill:function(t){var e=void 0!==arguments[1]?arguments[1]:!0;if(!this.isFinished()){if(this._reject(t),e){n(this._iterator);for(var r=this._stack,i=r.length-1;i>=0;--i)n(r[i])}if(this._current)try{this._current.kill(t,e)}catch(s){a(s)}if(this._done(),this==exports.currentThread)throw new h}},pause:function(){this._checkFinished(),++this._stopCount},resume:function(){if(0==this._stopCount)throw new Error("thread not paused");0==--this._stopCount&&this._step&&this._step.resume&&(i.then(this._step.resume),this._step.resume=null)},_tick:function(t,n,i){if(t===this._step){if(this._stopCount>0)return void(t.resume=this._tick.bind(this,t,n,i));for(;;){this._current=null;var s=exports.currentThread;exports.currentThread=this,global.currentThreadData=exports.global=this._global;var o=n(this._iterator,i);if(exports.currentThread=s,global.currentThreadData=exports.global=s&&s._global,o.done){if(this.isFinished())return;if(this._iterator=this._stack.pop()){n=o.iteratorFailed?r:e,i=o.value;continue}var u=o.iteratorFailed?this._reject:this._resolve;this._done(),o.iteratorFailed&&this._attachedToStack&&a(o.value),u(o.value)}else if(o.value)if(o.value.then)o=o.value.then(t.next,t.fail),o&&o.kill&&(this._current=o);else{if(o.value.next){this._stack.push(this._iterator),this._iterator=o.value,n=e,i=void 0;continue}if(!("onload"in o.value&&!o.value.onload&&"onerror"in o.value)||o.value.onerror)throw new Error("thread type error");o.value.onload=t.next,o.value.onerror=t.fail}else exports.yield.then(t.next);break}}},_done:function(){this._step=null,this._iterator=null,this._stack=null,this._resolve=null,this._reject=null,this._current=null},_newStep:function(){var t=this._step={resume:null};t.next=this._tick.bind(this,t,e),t.fail=this._tick.bind(this,t,r);var n=this.$name;t.next.$name={toString:function(){return n+":next"}},t.fail.$name={toString:function(){return n+":fail"}}},_onPromise:function(t,e){this._resolve=t,this._reject=e,this.resume()},_checkFinished:function(){if(this.isFinished())throw new Error("thread is already finished")}},{}),exports.Thread=c,Object.keys(c.prototype).forEach(function(t){return t.match(/^_/)&&Object.defineProperty(c.prototype,t,u)}),exports.currentThread=new c({next:function(){return{value:{then:function(){}}}}}).waitForInput(),exports.global=exports.currentThread._global})}();
//# sourceMappingURL=out.js.map
