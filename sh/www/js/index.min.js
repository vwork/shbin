...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
!function(){!function(e){var t=global.performance||Date,n=0,r=t.now(),a=require,i=function(){n+=t.now()-r,require=a;try{return a.apply(this,arguments)}finally{require=i,r=t.now()}};require=i;try{e()}finally{require=a,n+=t.now()-r,n/=1e3,global.__require_stats__||(global.__require_stats__={}),global.__require_stats__["/home/vadzim/v/work/nerojs/src/app.js"]=n}}(function(){"use strict";function e(e,t){var n=new v;return a(function(){return n.url=e.localModem&&e.localModem+t}),n.active=a.on(n,["pause","resume"],function(){return n.connected}),n}function t(t,a){var i=n(a,{uid:null}),c=e(t,a),o=function(){return c.send({what:"init",id:i.uid})};return r.on(c,{resume:o,message:function(e){return e.error?console.log("wsJSONclient: error from server:",e.error):e.partial&&e.previous!=i.uid?o():void(e.hasOwnProperty("data")?i.assign((e.partial?r.applyDiff:r.assignDiff)(i.valueOf(),e.data)):console.log("unknown message from server",e))},error:function(){t.onCredentials()}}),{data:i.getReadOnly(),active:c.active,send:function(e){c.send({what:"save",partial:!1,data:e})},update:function(e){c.send({what:"save",partial:!0,data:e})},"delete":function(){c.close()}}}var n=require("JSONlocal"),r=require("localUtils"),a=require("ra"),i=require("lodash"),c=require("uid"),o=require("httpClient"),s=require("events").EventEmitter||require("events"),u=require("deviceActions"),l=(require("http-status"),require("WebSocketToJSON")),f=require("PingPongJSON"),d=1e3,v=function(e){$traceurRuntime.superConstructor(b).call(this),this.connected=!1,this.closed=!1,this._ws=null,this._sheduledCreating=null,this._first=!0,this._lastClose=-(1/0),this.url=e,this.user=void 0,this.key=void 0},b=v;$traceurRuntime.createClass(v,{get url(){return this._url},set url(e){this._url=e,this._createHandle()},_setConnected:function(e){e=!!e,this.connected!=e&&(this.connected=e,this.emit("changed",e))},_clearHandle:function(){this._ws&&(this._ws.onclose=null,this._ws.close(),this._ws=null,this._setConnected(!1)),this._sheduledCreating&&(clearTimeout(this._sheduledCreating),this._sheduledCreating=null)},_ensureHandle:function(){this._ws||this._createHandle()},_createHandle:function(){var e=this;this._clearHandle(),this._url&&(this._ws=f(l(new WebSocket(this._url))),this._ws.onclose=function(){if(e._ws=null,e._setConnected(!1),e.emit("pause"),!e.closed){var t=e._lastClose;e._lastClose=Date.now(),e._sheduledCreating=setTimeout(function(){e._createHandle()},Math.max(0,d-(e._lastClose-t)))}},this._ws.onerror=function(t){e.emit("error",t)},this._ws.onopen=function(){e._setConnected(!0),e._first&&(e._first=!1,e.emit("open")),e.emit("resume")},this._ws.onmessage=function(t){e.emit("message",t)})},reinit:function(){this._ws&&this._ws.close()},send:function(e){if(this._ensureHandle(),!this._ws||!this.connected||this.closed)throw new Error("socket is not open");this._ws.send(e)},"delete":function(){this.close()},close:function(){this.closed=!0,this._clearHandle(),this.emit("close")},ask:function(e){var t=c();return this.send({id:t,question:e}),this.get(e.id).then(function(e){if(e.error)throw new Error(e.error);return e.answer})},get:function(e,t){var n=this;if("string"==typeof e||"number"==typeof e){var a=e;e=function(e){return e.id==a}}else if("function"!=typeof e){var c=e;e=function(){return i.every(c,function(e,t){return msk[t]==e})}}return new Promise(function(a,i){var c,o;c=function(e){r.off(n,{close:c,message:o}),null!=e?a(e):i(new Error("timeout"))},o=function(t){e(t)&&c(t)},null!=t&&setTimeout(c,t),r.on(n,{close:c,message:o})})}},{},s),module.exports=function(s){var l=a({placesShifts:{}}).setName("session"),f={activePlace:"",language:"ru",iconSize:40,labels:!0,placesPages:{}},d=n(s,f),v=a.clean({getMessage:function(e){var t=d.language||"ru";return[t,"ru","en","by"].filter(function(t){return e.hasOwnProperty(t)}).map(function(t){return e[t]})[0]},pageWidth:2,pageHeight:3,pageStarting:!1,dialog:"",history:[],menuElement:null,loggedin:!1,onCredentials:function(){v.loggedin=!1},go:function(e){e&&d.activePlace!=e&&(v.history.push(d.activePlace),d.activePlace=e)},back:function(){for(;v.history.length;){var e=v.history.pop();if(v.getPlace(e))return d.activePlace=e}d.activePlace=v.main},windowSize:{$:require("windowSize").getReadOnly(),width:null,height:null,ppmm:null,layout:null,window:null},get modemLocations(){return o.get("/modem_locations")},get localModem(){return v.modemLocations?v.modemLocations[0].url.replace(/^http(?=s?\:\/\/)/,"ws"):""},doLogin:a.Getter($traceurRuntime.initGeneratorFunction(function b(){var e,t;return $traceurRuntime.createGeneratorInstance(function(n){for(;;)switch(n.state){case 0:n.state=3;break;case 3:n.state=v.loggedin||!v.modemLocations?1:2;break;case 1:n.state=-2;break;case 2:e=document.createElement("script"),e.src=v.modemLocations[0].url+"/login?"+c(),document.body.appendChild(e),n.state=28;break;case 28:n.pushTry(16,17),n.state=19;break;case 19:return n.state=5,e;case 5:n.maybeThrow(),n.state=7;break;case 7:n.popTry(),n.state=17,n.finallyFallThrough=21;break;case 16:n.popTry(),n.maybeUncatchable(),t=n.storedException,n.state=14;break;case 14:console.log("error while trying to login",t),n.state=15;break;case 15:return n.state=9,co.sleep(300);case 9:n.maybeThrow(),n.state=17,n.finallyFallThrough=0;break;case 17:n.popTry(),n.state=26;break;case 26:document.body.removeChild(e),n.state=24;break;case 21:a.detach(function(){return v.loggedin=!0}),n.state=0;break;case 24:n.state=n.finallyFallThrough;break;default:return n.end()}},b,this)})),login:function(){},get serverDevices(){return t(v,"/devices")},localDevices:null,get devices(){return r.applyDiff(r.valueOf(v.serverDevices.data),r.valueOf(v.localDevices))},get serverPlaces(){return t(v,"/places")},get places(){return r.valueOf(v.serverPlaces.data)},get commands(){return e(v,"/commands")},get connectedToServer(){return!0&&v.serverDevices.active.valueOf()&&v.serverPlaces.active.valueOf()&&v.commands.active.valueOf()},get main(){var e=v.places;return e&&r.valueOf(e.main)},getPlace:function(e){return v.places&&v.places[r.valueOf(e)]},getDevice:function(e){return v.devices&&v.devices[r.valueOf(e)]},get activePlace(){return d.activePlace||v.main},get activeDevice(){return v.getPlace(v.activePlace).device},get checkIfTimeToGoBack(){v.getPlace(v.activePlace)||v.back()},get caption(){return v.getMessage(v.getPlace(v.activePlace))||v.message("favorites")},get placeType(){var e=v.getPlace(v.activePlace);return e||(e=v.getPlace(v.main)),"content"==e.type&&e.group?"group":"content"==e.type?"place":"device"},deviceIds:a.Getter(function(){var e=r.valueOf(v.devices);return i.keys(e).filter(function(t){var n=e[t];return n&&n.type}).sort()},r.arrayEqual),getFreeGroup:function(){for(var e=i.reduce(r.valueOf(v.devices),function(e,t){return t.group&&(e[t.group]=!0),e},[]),t=2;1022>=t;++t)if(!e[t])return t;return null},placeIds:a.Getter(function(){var e=r.valueOf(v.places);return i.keys(e).filter(function(t){var n=e[t];return n&&n.type}).sort()},r.arrayEqual),get initialLoading(){return!(v.places&&v.places.uid&&v.devices&&v.devices.uid)},get initialized(){return!v.initialLoading&&!!v.places&&!!v.places.main},setDatabase:function(e,t){v.serverDevices.send(e),v.serverPlaces.send(t)},reset:function(){v.history.length=0,v.setDatabase({uid:c()},{uid:c()})},setTemplate:function(e){function t(e,t){return Object.keys(e).forEach(function(n){return"image"!=n&&"content"!=n&&"type"!=n&&(t[n]=e[n])}),t}function n(e,r){if(e.content){var i={};a[r]=t(e,{type:"content",content:i});var o=0;e.content.forEach(function(e){return i[n(e,c())]={index:o++}})}else a[r]=t(e,{type:"single"});return r}console.log(e);var r={uid:c()},a={uid:c()};a.main=n(e,c()),v.setDatabase(r,a)},get templates(){return $traceurRuntime.initGeneratorFunction(function e(){var t,n,r,a;return $traceurRuntime.createGeneratorInstance(function(e){for(;;)switch(e.state){case 0:e.pushTry(11,null),e.state=14;break;case 14:t=o.get,n=t.call(o,"/templates"),e.state=6;break;case 6:return e.state=2,n;case 2:r=e.sent,e.state=4;break;case 4:e.returnValue=r,e.state=-2;break;case 8:e.popTry(),e.state=-2;break;case 11:e.popTry(),e.maybeUncatchable(),a=e.storedException,e.state=9;break;case 9:e.returnValue=a,e.state=-2;break;default:return e.end()}},e,this)}).call(this)},get allMessages(){return $traceurRuntime.initGeneratorFunction(function e(){var t,n,r;return $traceurRuntime.createGeneratorInstance(function(e){for(;;)switch(e.state){case 0:t=o.get,n=t.call(o,"/messages"),e.state=6;break;case 6:return e.state=2,n;case 2:r=e.sent,e.state=4;break;case 4:e.returnValue=r,e.state=-2;break;default:return e.end()}},e,this)}).call(this)},get messages(){var e=v.allMessages;if(null!=e){var t={},n=d.language||"ru";return i.forOwn(e,function(e,r){return t[r]=e.hasOwnProperty(n)?e[n]:r}),t}},message:function(e){var t=v.messages&&v.messages[e];return null==t&&(t=e),t},notification:function(){},createDevice:function(e){var t=r.valueOf(v.getPlace(e));if(!t.device){var n=c();return co.go($traceurRuntime.initGeneratorFunction(function a(){var t,i;return $traceurRuntime.createGeneratorInstance(function(a){for(;;)switch(a.state){case 0:return a.state=2,v.serverDevices.update((t={},Object.defineProperty(t,n,{value:{model:"Nero II 8421",state:0,comfort_1:.8,comfort_2:.2},configurable:!0,enumerable:!0,writable:!0}),t));case 2:a.maybeThrow(),a.state=4;break;case 4:return a.state=6,r.waitFor(function(){return v.getDevice(n)});case 6:a.maybeThrow(),a.state=8;break;case 8:return a.state=10,v.serverPlaces.update((i={},Object.defineProperty(i,e,{value:{device:n},configurable:!0,enumerable:!0,writable:!0}),i));case 10:a.maybeThrow(),a.state=12;break;case 12:return a.state=14,r.waitFor(function(){return v.getPlace(e).device});case 14:a.maybeThrow(),a.state=-2;break;default:return a.end()}},a,this)}))}return r.promiseSucceeded},saveDevice:function(e,t){{var n;c()}return v.serverDevices.update((n={},Object.defineProperty(n,e,{value:r.makeDiff(v.getDevice(e),t),configurable:!0,enumerable:!0,writable:!0}),n))},savePlace:function(e,t){{var n;c()}return v.serverPlaces.update((n={},Object.defineProperty(n,e,{value:r.makeDiff(v.getPlace(e),t),configurable:!0,enumerable:!0,writable:!0}),n))},newIndex:function(e){return Object.keys(v.getPlace(e).content||[]).length+1},linkItem:function(e,t){var n,r;if(e==t)throw new Error("cannot link place to itself");return v.serverPlaces.update((r={},Object.defineProperty(r,e,{value:{content:(n={},Object.defineProperty(n,t,{value:{index:v.newIndex(e)},configurable:!0,enumerable:!0,writable:!0}),n)},configurable:!0,enumerable:!0,writable:!0}),r))},linkToFavourites:function(e){return v.linkItem(v.main,e)},linkActiveToFavourites:function(){return v.linkToFavourites(v.activePlace)},addItem:function(e,t){var n,r,a=c();return v.serverPlaces.update((r={},Object.defineProperty(r,e,{value:{content:(n={},Object.defineProperty(n,a,{value:{index:v.newIndex(e)},configurable:!0,enumerable:!0,writable:!0}),n)},configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(r,a,{value:t,configurable:!0,enumerable:!0,writable:!0}),r))},addPlace:function(e){return v.addItem(e,{type:"content",ru:"Помещение",en:"Room"})},addDevice:function(e){return v.addItem(e,{type:"single",ru:"Устройство",en:"Device"})},deleteItem:function(e,t){var n,r;return v.serverPlaces.update((r={},Object.defineProperty(r,e,{value:{content:(n={},Object.defineProperty(n,t,{value:null,configurable:!0,enumerable:!0,writable:!0}),n)},configurable:!0,enumerable:!0,writable:!0}),r))},purgeItem:function(e){var t,n;return Promise.all([v.serverPlaces.update(i.reduce(v.places,function(t,n,r){var a;return n&&n.content&&n.content[e]&&(t[r]={content:(a={},Object.defineProperty(a,e,{value:null,configurable:!0,enumerable:!0,writable:!0}),a)}),t},(t={},Object.defineProperty(t,e,{value:null,configurable:!0,enumerable:!0,writable:!0}),t))),v.serverDevices.update((n={},Object.defineProperty(n,v.getPlace(e).device,{value:null,configurable:!0,enumerable:!0,writable:!0}),n))])},renameItem:function(e,t){var n,r=i.reduce(v.getPlace(e),function(e,t,n){return 2==n.length&&(e[n]=null),e},{});return r[f.language||"ru"]=t,v.serverPlaces.update((n={},Object.defineProperty(n,e,{value:r,configurable:!0,enumerable:!0,writable:!0}),n))},command:function(e,t,n){u.getNewState(v.getDevice(e),t);return v.commands.ask({device:e,command:t,data:n})},iconCommand:function(e,t,n,a){function i(t){var n;v.localDevices=r.applyDiff(v.localDevices,(n={},Object.defineProperty(n,e.device,{value:{temp:s,state:t},configurable:!0,enumerable:!0,writable:!0}),n))}function o(){var t,n=v.localDevices;n&&(n=n[e.device],n&&n.temp==s&&(v.localDevices=r.applyDiff(v.localDevices,(t={},Object.defineProperty(t,e.device,{value:null,configurable:!0,enumerable:!0,writable:!0}),t))))}if(console.log(e,t,n),e=r.valueOf(e),"content"==e.type?"Short"==n:"Long"==n)return v.go(t);if(("Short"==n||"Long"==n)&&(n="Comfort_1"),!e.device)return Promise.reject(new Error("device not configured"));var s=c();if("Save"==n){var u=v.getDevice(e.device);if(!u||!u.temp)return;n="Set",a=u.state,s=u.temp}else if("Set"==n){if(LOG(("$$$$$$$$$$ "+n+JSON.stringify(a)).green),!a.isCancel){var l=v.serverDevices.data.get(e.device);if(LOG(("$$$$$$$$$$ "+!!l).green),!l)return;LOG(("$$$$$$$$$$ "+(l.state-a.delta)).green),i(Math.max(0,Math.min(1,l.state-a.delta)))}if(!a.isFinal||a.isCancel)return Promise.resolve();a=state}return r.when(v.command(e.device,n,a),o)},pan:function(e){var t=v.menuElement.getBoundingClientRect(),n=v.activePlace;l.placesShifts.defineProperty(n),d.placesPages.defineProperty(n);var r=v.getPlace(n);if(r&&r.content){var a=Math.ceil(Object.keys(r.content).length/(v.pageWidth*v.pageHeight));if(0!=a){{var i=d.placesPages[n]||0;-i*t.width}if(e.isFinal)e.deltaX>0&&i>0?d.placesPages[n]=i-1:e.deltaX<0&&a-1>i&&(d.placesPages[n]=i+1),l.placesShifts[n]=0;else{var c=e.deltaX;(c>0&&0==i||0>c&&i==a-1)&&(c/=3),l.placesShifts[n]=c}}}},get imgProps(){return{onerror:function(){this.classList.add("error")},onload:function(){this.classList.remove("error")}}}}).setName("app");return{app:v,local:d,session:l}}})}();
//# sourceMappingURL=out.js.map
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
!function(){!function(e){var t=global.performance||Date,n=0,a=t.now(),r=require,i=function(){n+=t.now()-a,require=r;try{return r.apply(this,arguments)}finally{require=i,a=t.now()}};require=i;try{e()}finally{require=r,n+=t.now()-a,n/=1e3,global.__require_stats__||(global.__require_stats__={}),global.__require_stats__["/home/vadzim/v/work/nerojs/src/components.js"]=n}}(function(){"use strict";function e(t,n){e:for(;;){if(Array.isArray(t)){if(0==t.length)return null;if(1==t.length){t=t[0];continue e}n||(n=document.createDocumentFragment()),t.forEach(function(t){return e(t,n)}),t=n}else"string"==typeof t&&(t=document.createTextNode(t)),n&&(n.appendChild(t),t=n);return t}}function t(e,t){if("function"!=typeof e)t(e);else{var n=!0;l(!1,$traceurRuntime.initGeneratorFunction(function a(){var r;return $traceurRuntime.createGeneratorInstance(function(a){for(;;)switch(a.state){case 0:a.state=n?5:1;break;case 5:n=!1,a.state=6;break;case 1:return a.state=2,u.requestAnimationFrame;case 2:a.maybeThrow(),a.state=6;break;case 6:r=e(),a.state=14;break;case 14:a.state=r&&r.next&&r["throw"]?8:11;break;case 8:return a.state=9,r;case 9:r=a.sent,a.state=11;break;case 11:t(r),a.state=-2;break;default:return a.end()}},a,this)}))}}function n(e,t){if("function"!=typeof e)t(e);else{var n=!0;l(!0,$traceurRuntime.initGeneratorFunction(function a(){var r;return $traceurRuntime.createGeneratorInstance(function(a){for(;;)switch(a.state){case 0:a.state=n?5:1;break;case 5:n=!1,a.state=6;break;case 1:return a.state=2,u.requestAnimationFrame;case 2:a.maybeThrow(),a.state=6;break;case 6:r=e(),a.state=14;break;case 14:a.state=r&&r.next&&r["throw"]?8:11;break;case 8:return a.state=9,r;case 9:r=a.sent,a.state=11;break;case 11:t(r),a.state=-2;break;default:return a.end()}},a,this)}))}}function a(e){var t=e,n=-(1/0);if(e instanceof DocumentFragment)for(var a=0,r=e.childNodes.length;r>a;++a){var i,o=e.childNodes.item(a);if(i=o instanceof HTMLScriptElement?0:o instanceof HTMLTemplateElement?0:o instanceof Text?o.data?o.data.trim()?1/0:20:10:"NOSCRIPT"==o.tagName?0:1/0,i==1/0)return o;i>n&&(n=i,t=o)}return t}function r(){d.AttrRecognizer.apply(this,arguments)}function i(e){return e==d.DIRECTION_DOWN?"down":e==d.DIRECTION_UP?"up":e==d.DIRECTION_LEFT?"left":e==d.DIRECTION_RIGHT?"right":""}function o(e,t,n,a){var r=m(n);e=e.toLowerCase();var i=n["DIRECTION_"+e]|=d["DIRECTION_"+t.toUpperCase()];r.get(""+e).set({direction:i}),r.on(""+e+t.toLowerCase(),a)}function s(e,t,n){(t=a(t))&&t.addEventListener("mouse"+e.toLowerCase(),n)}function c(e,t,n){(t=a(t))&&t.addEventListener("touch"+e.toLowerCase(),n)}{var u=require("co"),l=require("ra");require("lodash"),l.$}u.on("tick",function(e){global.$__TEMPLATE_INSTANCE__$=e.$__TEMPLATE_INSTANCE__$});var d=require("hammerjs");d.inherit(r,d.AttrRecognizer,{defaults:{event:"shortswipe",threshold:10,velocity:.1,direction:d.DIRECTION_HORIZONTAL|d.DIRECTION_VERTICAL,pointers:1,maxtime:300},getTouchAction:function(){return d.Pan.prototype.getTouchAction.call(this)},attrTest:function(e){var t,n=this.options.direction;return n&(d.DIRECTION_HORIZONTAL|d.DIRECTION_VERTICAL)?t=e.maxVelocity:n&d.DIRECTION_HORIZONTAL?t=e.maxVelocityX:n&d.DIRECTION_VERTICAL&&(t=e.maxVelocityY),this._super.attrTest.call(this,e)&&e.deltaTime<=this.options.maxtime&&n&e.direction&&e.distance>this.options.threshold&&Math.abs(t)>this.options.velocity&&e.eventType&d.INPUT_END},emit:function(e){var t=i(e.direction);t&&this.manager.emit(this.options.event+t,e),this.manager.emit(this.options.event,e)}}),d.defaults.preset=[[r,{direction:d.DIRECTION_HORIZONTAL}],[d.Pan,{direction:d.DIRECTION_HORIZONTAL},["shortswipe"]],[d.Tap],[d.Tap,{event:"doubletap",taps:2},["tap"]],[d.Press]];var f=function(e,t){var n,a=e.session;if(t.maxVelocity=a.maxVelocity=Math.max(Math.abs(a.maxVelocity||0),Math.abs(t.velocity)),t.maxVelocityX=a.maxVelocityX=Math.max(Math.abs(a.maxVelocityX||0),Math.abs(t.velocityX)),t.maxVelocityY=a.maxVelocityY=Math.max(Math.abs(a.maxVelocityY||0),Math.abs(t.velocityY)),a.inputCount=(a.inputCount||0)+1,a.directions||(a.directions=(n={},Object.defineProperty(n,d.DIRECTION_LEFT,{value:0,configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(n,d.DIRECTION_RIGHT,{value:0,configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(n,d.DIRECTION_HORIZONTAL,{value:0,configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(n,d.DIRECTION_UP,{value:0,configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(n,d.DIRECTION_DOWN,{value:0,configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(n,d.DIRECTION_VERTICAL,{value:0,configurable:!0,enumerable:!0,writable:!0}),n),a.directionsCount=0),t.directions={},t.direction){++a.directionsCount;for(var r in a.directions)a.directions.hasOwnProperty(r)&&r&t.direction&&++a.directions[r]}for(var i in a.directions)a.directions.hasOwnProperty(i)&&(t.directions[i]=a.directions[i]/a.directionsCount)},m=function(e){var t=e._hammer;return null==t&&(t=e._hammer=d(e),t.on("hammer.input",function(e){return f(t,e)})),t},b=o.bind(null,"shortswipe"),h=o.bind(null,"pan"),p=module.exports={onClick:function(e,t){(e=a(e))&&e.addEventListener("click",t)},onTouch:function(e,t){(e=a(e))&&(e.addEventListener("touchstart",t),e.addEventListener("mousedown",t))},onTap:function(e,t){m(e).on("tap",t)},onPress:function(e,t){m(e).on("press",t)},onSwipeUp:b.bind(null,"Up"),onSwipeDown:b.bind(null,"Down"),onSwipeLeft:b.bind(null,"Left"),onSwipeRight:b.bind(null,"Right"),onPanUp:h.bind(null,"Up"),onPanDown:h.bind(null,"Down"),onPanLeft:h.bind(null,"Left"),onPanRight:h.bind(null,"Right"),onMouseDown:s.bind(null,"Down"),onMouseUp:s.bind(null,"Up"),onMouseMove:s.bind(null,"Move"),onTouchStart:c.bind(null,"Start"),onTouchMove:c.bind(null,"Move"),onTouchEnd:c.bind(null,"End"),onTouchCancel:c.bind(null,"Cancel"),content:function(n,a){t(a,function(t){var a=e(t);a?(l.forceCalculations(),n.innerHTML="",n.appendChild(a)):n.innerHTML=""})},contentX:function(t,a){var r=void 0!==arguments[2]?arguments[2]:null;return a instanceof HTMLTemplateElement?void n(r,function(e){var n=p.importTemplate(a,e);if(1!=n.childNodes.length){var r=document.createElement("span");r.appendChild(n),n=r}t.innerHTML="",t.appendChild(n)}):void n(a,function(n){var a=e(n);a?(l.forceCalculations(),t.innerHTML="",t.appendChild(a)):t.innerHTML=""})},display:function(e,n){t(n,function(t){e.style.display=t?"default":"none"})},displayX:function(e,t){n(t,function(t){e.style.display=t?"default":"none"})},"class":function(e,n,a){t(a,function(t){t?Array.isArray(n)?(e.classList.add(n[0]),e.classList.remove(n[1])):e.classList.add(n):Array.isArray(n)?(e.classList.remove(n[0]),e.classList.add(n[1])):e.classList.remove(n)})},classX:function(e,t,a){n(a,function(n){n?Array.isArray(t)?(e.classList.add(t[0]),e.classList.remove(t[1])):e.classList.add(t):Array.isArray(t)?(e.classList.remove(t[0]),e.classList.add(t[1])):e.classList.remove(t)})},updateClass:function(e,n){var a="";t(n,function(t){t!=a&&(a&&e.classList.remove(a),t&&e.classList.add(t),a=t)})},updateClassX:function(e,t){var a="";n(t,function(t){t!=a&&(a&&e.classList.remove(a),t&&e.classList.add(t),a=t)})},watch:function(e){var t=!0;l(!1,$traceurRuntime.initGeneratorFunction(function n(){var a;return $traceurRuntime.createGeneratorInstance(function(n){for(;;)switch(n.state){case 0:n.state=t?5:1;break;case 5:t=!1,n.state=6;break;case 1:return n.state=2,u.requestAnimationFrame;case 2:n.maybeThrow(),n.state=6;break;case 6:a=e(),n.state=14;break;case 14:n.state=a&&a.next&&a["throw"]?8:-2;break;case 8:return n.state=9,a;case 9:n.maybeThrow(),n.state=-2;break;default:return n.end()}},n,this)}))},watchX:function(e){var t=!0;l(!0,$traceurRuntime.initGeneratorFunction(function n(){var a;return $traceurRuntime.createGeneratorInstance(function(n){for(;;)switch(n.state){case 0:n.state=t?5:1;break;case 5:t=!1,n.state=6;break;case 1:return n.state=2,u.requestAnimationFrame;case 2:n.maybeThrow(),n.state=6;break;case 6:a=e(),n.state=14;break;case 14:n.state=a&&a.next&&a["throw"]?8:-2;break;case 8:return n.state=9,a;case 9:n.maybeThrow(),n.state=-2;break;default:return n.end()}},n,this)}))},importTemplate:function(e,t){l.forceCalculations();var n=$__IMPORT_TEMPLATE__$(e,t);return l.forceCalculations(),n}}})}();
//# sourceMappingURL=out.js.map
...
module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports={
	"Nero II 8713-50": {
		"buttons": "RollShutter"
	},
	"Intro II 8513-50": {
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
!function(){!function(t){var e=global.performance||Date,r=0,n=e.now(),i=require,a=function(){r+=e.now()-n,require=i;try{return i.apply(this,arguments)}finally{require=a,n=e.now()}};require=a;try{t()}finally{require=i,r+=e.now()-n,r/=1e3,global.__require_stats__||(global.__require_stats__={}),global.__require_stats__["/home/vadzim/v/work/nerojs/src/ra.js"]=r}}(function(){"use strict";function t(){}var e=require("later").push,r=require("co"),n=require("uid"),i=require("lodash"),a=require("LOG").LOG,l="ACTION_"+n(),o={};o.scheduled=!1,o.procs=[],o.index=0,o.maxIndex=32768,o.processing=!1,o.totalTime=0,o.maxTime=0,o.maxTime1=0,o.minTime=1/0,o.runCount=0,o.runAllCount=0,global.updates=o;var s=global.performance||global.Date;o.start=s.now(),o.log=function(){return console.log(":: "+o.totalTime/1e3+" / "+(s.now()-o.start)/1e3+" ("+o.maxTime/1e3+", "+o.maxTime1/1e3+", "+o.minTime/1e3+", "+A.maxCount+", "+o.runCount+", "+o.runAllCount+")")},o.checkSchedule=function(){!o.scheduled&&o.procs.length>0&&(o.scheduled=!0,e(o.tick))},o.tick=function(){o.scheduled=!1;var t,e=function(){try{return o.runAll(),0}catch(t){setTimeout(function(){throw t},1)}};t:for(var r=0;1e3>r;++r)switch(t=e(r)){case 0:break t}o.checkSchedule()},o.runAll=function(){var t=s.now(),e=t,n=o.runCount,i=o.processing;o.processing=!0;var u=r.global[l];null!=u&&(r.global[l]=null);try{for(;o.index<o.procs.length;){global.APP_TIMEOUT&&global.APP_TIMEOUT<Date.now&&alert("Application is running too long");var c=o.procs[o.index];++o.index,++o.runCount,o.index>=o.maxIndex&&3*o.index>o.procs.length&&(o.procs.splice(0,o.index),o.index=0),c();var h=s.now();o.maxTime1<h-e&&(o.maxTime1=h-e),e=h}o.index=o.procs.length=0}finally{if(null!=u&&(r.global[l]=u),o.processing=i,!i){var f=s.now()-t;o.totalTime+=f,o.maxTime<f&&(o.maxTime=f),n=o.runCount-n,n&&(++o.runAllCount,o.minTime>f&&(o.minTime=f)),f>300&&a("updates have been run for "+f.toString().red+" ms")}}},o.later=function(t){o.procs.push(t),o.checkSchedule()},o.later.then=o.later;var u="undefined"==typeof Immutable?null:Immutable.Map(),c=function(t){return null==t||t==u?null:t},h=function(){return this},f=function(t){return t&&"object"==typeof t&&t.constructor==Object},_=function(t){return null==t||null==t.valueOf?t:t.valueOf()},v=function(t){throw new Error('access to an undeclared property "'+this.$name+"."+t+'"')},p=Object.create(null),d=Object.create(null),y=function(t){p[t]||(p[t]=!0,Object.defineProperty(d,t,{get:function(){v.call(this,t)},set:function(){v.call(this,t)}}))};t.prototype=d,global.APP_DEBUG&&(t.prototype=(global.__UsedScriptIdentifiers__+"").split(/[\s,]+/).reduce(function(t,e){var r;return Object.create(t,(r={},Object.defineProperty(r,e,{value:{get:function(){v.call(this,e)},set:function(){v.call(this,e)}},configurable:!0,enumerable:!0,writable:!0}),r))},t.prototype)),t.prototype=Object.create(t.prototype,{toString:{value:{}.toString},valueOf:{value:{}.valueOf},toLocaleString:{value:{}.toLocaleString},hasOwnProperty:{value:{}.hasOwnProperty},isPrototypeOf:{value:{}.isPrototypeOf},propertyIsEnumerable:{value:{}.propertyIsEnumerable},$name:{value:"<...>",writable:1}});var g=[];Object.freeze(g);var b=function(){$traceurRuntime.superConstructor(m).apply(this,arguments)},m=b;$traceurRuntime.createClass(b,{get props(){throw new Error("access to deprecated 'props' property detected")},get declaredProperties(){return this.live},get length(){var t=this.valueOf();return null==t?0:Object.keys(t).length},get:function(t){if(null!=t){var e=this.valueOf();if(null!=e&&e.hasOwnProperty(t))return e[t]}return null},map:function(t){var e=this.valueOf();return e&&i.mapValues(e,t)},keys:function(){var t=this.valueOf();return null==t?g:Object.keys(t)}},{},t);var w=function(t){$traceurRuntime.superConstructor(k).call(this),this._parent=t},k=w;$traceurRuntime.createClass(w,{getReadOnly:function(){return this},get live(){return this._parent.live},get $name(){return this._parent.$name},valueOf:function(){return this._parent.valueOf.apply(this._parent,arguments)},noTouch:function(){return this._parent.noTouch.apply(this._parent,arguments)},toString:function(){return this._parent.toString.apply(this._parent,arguments)},toJSON:function(){return this._parent.toJSON.apply(this._parent,arguments)},getName:function(){return this._parent.getName.apply(this._parent,arguments)}},{},b);var O=function(t,e){var r,n=e?function(){var n=t.apply(this,arguments);return Object.is(r,n)||e(r,n)||(r=n),r}:function(){return t.apply(this,arguments)};return n.isGetter=!0,n},x=function(t){function e(){return t.apply(this,arguments)}return e.typeDescriptor=!0,e},S=function(t,e,r){return new A(e,t,r).linkName(t,":getter")},T=function(t,e,r){return new A(function(){return e(t.valueOf())},null,r).linkName(t,":setter")},C=function(t){var e;$traceurRuntime.superConstructor(P).call(this),this._id=n(),this._value=null,this._error=null,this._isValueEqual=Object.is,this._initialized=!1,this._frozen=!1,this._closed=!1,this._dirty=!1,this._live=null,this._liveArray=null,this._actionsArr=[],this._parent=null,this._onchange=[],this.$name={toString:(e=this,function(){return e.getName()})},this._notifyWritten(),this._sticky=!!t},P=C;$traceurRuntime.createClass(C,{valueOf:function(){return this._read()},assign:function(t){return this._write(t,!1,null)},"throw":function(t){return this._write(null,!1,t)},touch:function(){this._fire()},noTouch:function(){if(this._dirty&&this._updateSelf(),this._error)throw this._error;return this._value},then:function(t){this._onchange.push(t)},close:function(){if(!this._closed){if(this._closed=!0,this._fire(),this._parent&&this._parent.close(),this._liveArray){var t=!0,e=!1,r=void 0;try{for(var n=void 0,i=this._liveArray[$traceurRuntime.toProperty(Symbol.iterator)]();!(t=(n=i.next()).done);t=!0){var a=n.value;a.close()}}catch(l){e=!0,r=l}finally{try{t||null==i["return"]||i["return"]()}finally{if(e)throw r}}this._liveArray=null}this._value=null,this._error=null,this._actionsArr=null,this._parent=null}},freeze:function(){if(!this._closed&&!this._frozen&&(this._frozen=!0,this._fire(),this._parent&&this._parent.freeze(),this._liveArray)){var t=!0,e=!1,r=void 0;try{for(var n=void 0,i=this._liveArray[$traceurRuntime.toProperty(Symbol.iterator)]();!(t=(n=i.next()).done);t=!0){var a=n.value;a.freeze()}}catch(l){e=!0,r=l}finally{try{t||null==i["return"]||i["return"]()}finally{if(e)throw r}}}},get live(){return this._live},getReadOnly:function(){return this._readOnly||(this._readOnly=new w(this))},toString:function(){for(var t,e=[],r=0;r<arguments.length;r++)e[r]=arguments[r];var n=this._read();return null!=n&&n.toString?(t=n).toString.apply(t,$traceurRuntime.spread(e)):""+n},toJSON:function(){for(var t,e=[],r=0;r<arguments.length;r++)e[r]=arguments[r];var n=this._read();return null!=n&&n.toJSON?(t=n).toJSON.apply(t,$traceurRuntime.spread(e)):n},setName:function(t){return this._name=t,this},getName:function(){for(var t=this._name||this._key,e=this._parent;e;)t=(e._name||e._key)+"."+t,e=e._parent;return t},defineProperty:function(t){if(this._live||(this._live={},this._liveArray=[]),t){y(t);var e=this._live[t];return this._live.hasOwnProperty(t)?e:(this._liveArray.push(e=this._live[t]=new P(this._sticky)),e._key=t,e._parent=this,e._level=(this._level||0)+1,Object.defineProperty(this,t,{enumerable:!0,configurable:!0,get:function(){return e._live?e:e._read()},set:function(t){return e._write(t,!1)}}),null!=this._value&&e._write(this._value[t],!0),e)}},init:function(t){this._init(t,!1,!1)},setConst:function(t,e){return Object.defineProperty(this,t,{enumerable:!0,get:function(){return e}}),this},setVar:function(t,e){return Object.defineProperty(this,t,{enumerable:!0,writable:!0,value:e}),this},_init:function(t,e,r,n){var i=this;if(!e&&i._initialized)throw new Error("already initialized");if(this._parent&&(this._parent._dirty=!0),i._initialized=!0,n&&(this._isValueEqual=n),t=c(t),null!=t){if("function"==typeof t&&t.typeDescriptor&&(t=t(i._key)),"function"==typeof t&&(r||t.isGetter))return void S(i,t,this._sticky);if(!f(t))return void(null==t||"object"!=typeof t||t.valueOf==Object.prototype.valueOf?i._value=t:i._init(function(){return _(t)},!0,!0));if(e)throw new Error("wrong parameters");i.defineProperty();var a,l=function(e){var r=Object.getOwnPropertyDescriptor(t,e);if(!r)return 0;var n=r.get,a=r.value;if(r.set)throw new Error("wrong parameters");n&&(a=0==n.length?n:function(){return n()}),"$"==e?i._init(a,!0,!!n):i.defineProperty(e)._init(a,!1,!!n)};t:for(var o in t)switch(a=l(o)){case 0:continue t}}},_read:function(){this._dirty&&this._updateSelf();var t=r.global[l];if(t&&(this._closed?t.close():this._frozen||t.onread(this)),this._error)throw this._error;return this._value},_write:function(t,e,n){if(null==n&&(n=null),this._frozen)throw new Error("Try to change a frozen value");if(this._initialized=!0,this._dirty=!1,t=c(t),this._closed){var i=r.global[l];i&&i.close()}else if(!this._isValueEqual(this._value,t)||this._error!=n){if(this._value=t,this._error=n,this._live){var a=!0,o=!1,s=void 0;try{for(var u=void 0,h=this._liveArray[$traceurRuntime.toProperty(Symbol.iterator)]();!(a=(u=h.next()).done);a=!0){var f=u.value;f._write(t&&t[f._key],!0)}}catch(_){o=!0,s=_}finally{try{a||null==h["return"]||h["return"]()}finally{if(o)throw s}}}if(this._fire(),!e)for(var v=this._parent;v&&!v._dirty;)v._dirty=!0,v._fire()}return e||this._notifyWritten(),t},_updateSelf:function(){var t=0,e={};for(var r in this._value)this._value.hasOwnProperty(r)&&(e[r]=this._value[r],++t);var n=!0,i=!1,a=void 0;try{for(var l=void 0,o=this._liveArray[$traceurRuntime.toProperty(Symbol.iterator)]();!(n=(l=o.next()).done);n=!0){var s=l.value;if(s._dirty&&s._updateSelf(),s._error)return this._error=s._error,this._value=null,void(this._dirty=!1);var u=s._value;null==u?e.hasOwnProperty(s._key)&&(delete e[s._key],--t):(e[s._key]=u,t=1/0)}}catch(c){i=!0,a=c}finally{try{n||null==o["return"]||o["return"]()}finally{if(i)throw a}}0==t&&(e=null),this._value=e,this._dirty=!1},debug:function(t){this._actionsArr.push({action:{_fire:t}})},"debugger":function(){this.debug(function(){})},_fire:function(){var t;if(t=this._actionsArr,t.length){for(var e=0;e<t.length;e++){var r=t[e];r.action&&r.action._fire(),r.pushedC=!1}t.length=0}if(t=this._onchange,t.length){for(var n=0;n<t.length;n++)o.later(t[n]);t.length=0}},_notifyWritten:function(){var t=r.global[l];t&&t.onwritten(this)}},{},b);var j=function(t){return setTimeout(function(){throw t},1)},A=function(t,e,i){var a=this;this._id=n(),this._fun=t,this._dest=e,this._cellSet={},this._cellSetSize=0,this._cellArr=[],this.$name={toString:function(){return"<Action>"}},this._thread=r.gocall(this._loop,this).linkName(this).waitForInput(),this._runCount=0;var o;(o=r.global[l])&&o._children&&o._children.push(this),this._children=null,this._threads=null,this._onthread=null,this._generatorProxy=null,this._generator=null,i&&(this._children=[],this._threads=[],this._onthread=function(t){return a._threads.push(t)})},$=A;$traceurRuntime.createClass(A,{linkName:function(t){var e=void 0!==arguments[1]?arguments[1]:":action";return t.$name&&(t=t.$name),this.$name.toString=function(){return""+t+e},this},_initGeneratorProxy:function(){var t,e,n=this,i=function(){return n._generator.next(e)},a=function(){return n._generator["throw"](e)};this._generatorProxy=(t={},Object.defineProperty(t,Symbol.iterator,{value:h,configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(t,"next",{value:function(t){e=t;try{return r.catchThreads(i,n._onthread)}finally{e=null}},configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(t,"throw",{value:function(t){e=t;try{return r.catchThreads(a,n._onthread)}finally{e=null}},configurable:!0,enumerable:!0,writable:!0}),t)},_loop:$traceurRuntime.initGeneratorFunction(function E(){var t,e,n,i,a,s,u,c,h;return $traceurRuntime.createGeneratorInstance(function(f){for(;;)switch(f.state){case 0:t=this,f.state=99;break;case 99:return f.state=2,o.later;case 2:f.maybeThrow(),f.state=4;break;case 4:e={then:function(e){t._onchange=e}},r.global[l]=this,n=!1,f.state=101;break;case 101:f.pushTry(90,null),f.state=93;break;case 93:f.state=n?69:65;break;case 65:f.state=this.isClosed()?7:64;break;case 64:this._begin(),n=!0,i=void 0,f.state=67;break;case 67:f.state=this._children?38:60;break;case 38:i=r.catchThreads(this._fun,this._onthread),f.state=39;break;case 39:f.state=i&&i.next&&i["throw"]?30:36;break;case 30:this._generatorProxy||this._initGeneratorProxy(),this._generator=i,f.state=31;break;case 31:f.pushTry(null,23),f.state=25;break;case 25:a=f.wrapYieldStar(this._generatorProxy[Symbol.iterator]()),f.sent=void 0,f.action="next",f.state=19;break;case 19:s=a[f.action](f.sentIgnoreThrow),f.state=16;break;case 16:f.state=s.done?10:9;break;case 10:f.sent=s.value,f.state=17;break;case 9:return f.state=19,s.value;case 17:i=f.sentIgnoreThrow,f.state=23,f.finallyFallThrough=21;break;case 23:f.popTry(),f.state=29;break;case 29:this._generator=null,f.state=27;break;case 36:f.state=i&&i.then?32:21;break;case 32:return f.state=33,i;case 33:i=f.sent,f.state=21;break;case 60:i=this._fun(),f.state=61;break;case 61:f.state=i&&i.next&&i["throw"]?50:58;break;case 50:u=f.wrapYieldStar(i[Symbol.iterator]()),f.sent=void 0,f.action="next",f.state=51;break;case 51:c=u[f.action](f.sentIgnoreThrow),f.state=48;break;case 48:f.state=c.done?42:41;break;case 42:f.sent=c.value,f.state=49;break;case 41:return f.state=51,c.value;case 49:i=f.sentIgnoreThrow,f.state=21;break;case 58:f.state=i&&i.then?54:21;break;case 54:return f.state=55,i;case 55:i=f.sent,f.state=21;break;case 21:this._dest&&this._dest.assign(i),f.state=69;break;case 69:n=!1,f.state=83;break;case 83:f.state=this.isClosed()?7:80;break;case 80:switch(this._end()){default:f.state=93;break;case!1:f.state=7;break;case!0:f.state=73}break;case 74:f.maybeThrow(),f.state=93;break;case 73:return f.state=74,e;case 84:f.popTry(),f.state=101;break;case 90:f.popTry(),f.maybeUncatchable(),h=f.storedException,f.state=89;break;case 89:f.state=h instanceof r.EKill?7:87;break;case 87:n?this._dest["throw"](h):j(h),f.state=101;break;case 7:r.global[l]=null,this._finalize(),f.state=-2;break;case 27:f.state=f.finallyFallThrough;break;default:return f.end()}},E,this)}),isClosed:function(){return!this._cellSet},close:function(){var t=this._thread;this._fire(),this._finalize(),t&&t.kill()},_closeChildren:function(){var t;if(t=this._children){for(var e=0,r=t.length;r>e;++e)t[e].close();t.length=0}if(t=this._threads){for(var n=0,i=t.length;i>n;++n)t[n].kill();t.length=0}},_finalize:function(){this._unsubscribe(),this._cellSet=null,this._cellArr=null,this._fun=null,this._dest=null,this._thread=null},_begin:function(){this._unsubscribe(),++this._runCount,$.maxCount<this._runCount&&($.maxCount=this._runCount)},_unsubscribe:function(){this._onchange=null;var t=this._cellArr;if(t){for(var e=0;e<t.length;++e){var r=t[e];r.cell=null,r.value=null,r.action=null,r.read=!1,r.written=!1,r.pushedA=!1}this._cellSetSize>32&&t.length<this._cellSetSize/4&&(this._cellSet={},this._cellSetSize=0),t.length=0}this._closeChildren()},_end:function(){for(var t=!1,e=this._cellArr,r=0;r<e.length;++r){var n=e[r];if(n.written)n.action=null;else{if(n.pushedC||(n.cell._actionsArr.push(n),n.pushedC=!0),!Object.is(n.value,n.cell._value)||!Object.is(n.error,n.cell._error))return null;n.action=this,t=!0}n.value=null,n.cell=null}return t},_linkCell:function(t){var e=this._cellSet[t._id];return null==e&&(e=this._cellSet[t._id]={cell:null,value:null,error:null,action:null,read:!1,written:!1,pushedA:!1,pushedC:!1},++this._cellSetSize),e.pushedA||(this._cellArr.push(e),e.cell=t,e.pushedA=!0),e},onread:function(t){var e=this._linkCell(t);e.read=!0,e.value=t._value,e.error=t._error},onwritten:function(t){this._linkCell(t).written=!0},_fire:function(){this._onchange&&o.later(this._onchange),this._unsubscribe()}},{}),A.maxCount=0;var z=function(t,e,r,n){var i=!0,a=!1,l=void 0;try{for(var o=void 0,s=e[$traceurRuntime.toProperty(Symbol.iterator)]();!(i=(o=s.next()).done);i=!0){var u=o.value;if(null!=u&&"function"!=typeof u)throw new Error("wrong parameters")}}catch(c){a=!0,l=c}finally{try{i||null==s["return"]||s["return"]()}finally{if(a)throw l}}var h=new C(r);void 0!==t&&h._init(t,!1,!0,n);var f=!0,_=!1,v=void 0;try{for(var p=void 0,d=e[$traceurRuntime.toProperty(Symbol.iterator)]();!(f=(p=d.next()).done);f=!0){var y=p.value;y&&(y.length?T:S)(h,y,r)}}catch(g){_=!0,v=g}finally{try{f||null==d["return"]||d["return"]()}finally{if(_)throw v}}return h},R=function(){{var t,e,r,n,i=0;arguments.length-1}return"string"==typeof arguments[i]&&(t=arguments[i++]),"boolean"==typeof arguments[i]&&(r=arguments[i++]),e=arguments[i++],"function"==typeof arguments[i]&&(n=arguments[i++]),z(e,[],r,n)};exports=module.exports=R,exports.ra=R,exports.clean=function(t){for(var e=[],r=1;r<arguments.length;r++)e[r-1]=arguments[r];return z(t,e,!1)},exports.detach=function(t){var e;if(!(e=r.global[l]))return t();r.global[l]=null;try{return t()}finally{r.global[l]=e}},exports.on=function(t,e,r){var n=R(),i=function(t){return n.assign(r(t))};if("string"==e)t.on(e,i);else{var a=!0,l=!1,o=void 0;try{for(var s=void 0,u=e[$traceurRuntime.toProperty(Symbol.iterator)]();!(a=(s=u.next()).done);a=!0){var c=s.value;t.on(c,i)}}catch(h){l=!0,o=h}finally{try{a||null==u["return"]||u["return"]()}finally{if(l)throw o}}}return i(),n},exports.Cell=C,exports.ImmutableInterface=b,exports.AbstractGuard=t,exports.Getter=O,exports.Type=x,exports.importFrom=function(t){return x(function(e){return O(function(){return t.live[e].valueOf()})})},exports.forceCalculations=function(){return o.runAll()},exports.map=function(t,e,r){throw new Error("message")},exports.slice=function(t,e,r){throw new Error("message")}})}();
//# sourceMappingURL=out.js.map
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
!function(){!function(e){var t=global.performance||Date,r=0,n=t.now(),a=require,o=function(){r+=t.now()-n,require=a;try{return a.apply(this,arguments)}finally{require=o,n=t.now()}};require=o;try{e()}finally{require=a,r+=t.now()-n,r/=1e3,global.__require_stats__||(global.__require_stats__={}),global.__require_stats__["/home/vadzim/v/work/nerojs/src/webpage.js"]=r}}(function(){"use strict";function e(e){e.target&&"external"==e.target.getAttribute("rel")||e.preventDefault()}function t(e,t){return}function r(e){return e.x}function n(e){return e.y}function a(e,t,r){return 0==t||r[t].x>=r[t-1].x}function o(e,t,r){return 0==t||r[t].x<=r[t-1].x}function i(e){var t,i,u,s,l,d,m;return $traceurRuntime.createGeneratorInstance(function(c){for(;;)switch(c.state){case 0:t=[e],i={x:0,y:0,min:{x:e.x,y:e.y},max:{x:e.x,y:e.y}},LOG(1+JSON.stringify(e)),s="",l=!1,c.state=14;break;case 14:return c.state=2,null;case 2:m=c.sent,c.state=4;break;case 4:u=m,c.state=6;break;case 6:c.state=m?10:12;break;case 10:t.push(u),i.min.x>u.x&&(i.min.x=u.x),i.min.y>u.y&&(i.min.y=u.y),i.max.x<u.x&&(i.max.x=u.x),i.max.y<u.y&&(i.max.y=u.y),i.x=i.max.x-i.min.x,i.y=i.max.y-i.min.y,d=Math.max(i.x,i.y),l=!1,u.time-e.time<w&&d>L&&(l=d>q,i.x>i.y&&t.map(r).every(a)?s="right":i.x>i.y&&t.map(r).every(o)?s="left":i.x<i.y&&t.map(n).every(a)?s="down":i.x<i.y&&t.map(n).every(o)?s="up":(s="",l=!1)),LOG(2+JSON.stringify(u)),LOG("."+{"false":"","true":"swipe"}[l]+"."+s+"."+u.time+"."+e.time+"."+(u.time-e.time)+"."+w),c.state=11;break;case 11:c.state=u.last?12:14;break;case 12:LOG(3),c.state=-2;break;default:return c.end()}},c,this)}function u(e){var t=document.createElement("script");return t.appendChild(document.createTextNode(e)),t}{var c=$traceurRuntime.initGeneratorFunction(i),s=global.performance||global.Date;s.now()}require("browser-nexttick"),require("platform"),global.lu=require("localUtils"),global.ra=require("ra"),global.co=require("co"),global.lodash=require("lodash"),require("colors");var l=(require("uid"),require("httpClient"),!0),d=!1,m=void 0;try{for(var f=function(){var r=y.value;document.body.addEventListener(r,e),document.body.addEventListener(r,function(e){return t(r,e)})},y=void 0,h=["touchstart","touchmove","touchend","touchcancel"][$traceurRuntime.toProperty(Symbol.iterator)]();!(l=(y=h.next()).done);l=!0)f()}catch(v){d=!0,m=v}finally{try{l||null==h["return"]||h["return"]()}finally{if(d)throw m}}var p={mousedown:"touchstart",mousemove:"touchmove",mouseup:"touchend"},g=function(e){var r=p[e];document.body.addEventListener(e,function(e){return t(r,{changedTouches:{identifier:"mouse",target:e.target,screenX:e.screenX,screenY:e.screenY}})})};for(var x in p)g(x);var b=Object.create(null);setInterval(function(){var e=!0,t=!1,r=void 0;try{for(var n=void 0,a=Object.keys(b)[$traceurRuntime.toProperty(Symbol.iterator)]();!(e=(n=a.next()).done);e=!0){var o=n.value,i=b[o];i.abandoned?(i.handler["return"]&&i.handler["return"](),delete b[o]):i.abandoned=!0}}catch(u){t=!0,r=u}finally{try{e||null==a["return"]||a["return"]()}finally{if(t)throw r}}},1e4);var w=350,q=96/2.54*.5,L=96/2.54*.15;global.LOG=function(e){console.log.apply(console,arguments),global._ALERT&&global._ALERT(e);var t=new XMLHttpRequest;return t.open("POST","/log?"+encodeURIComponent(e)),t.onerror=lodash.noop,t.send(),e},window.addEventListener("error",function k(e){if(!e.message.match(404)&&!k.processing){k.processing=!0;try{LOG(e.message.red+" at "+e.lineno+":"+e.colno+" in "+e.filename)}finally{k.processing=!1}}});var _=window.onerror;window.onerror=function(e,t,r,n,a){var o;return a&&LOG("stack: "+a.stack),_&&(o=_.apply(this,arguments)),o},global.CS=lu["new"](require("components"),global.CS),co.go($traceurRuntime.initGeneratorFunction(function E(){var e,t,r,n,a;return $traceurRuntime.createGeneratorInstance(function(o){for(;;)switch(o.state){case 0:e=cacheUrlResource("./main.html"),o.state=6;break;case 6:return o.state=2,e;case 2:e=o.sent,o.state=4;break;case 4:for(t=document.createDocumentFragment(),r=document.createElement("div"),r.innerHTML=e,r=r.children[0],n=[],a=0;a<r.childNodes.length;++a)n.push(r.childNodes[a]);n.forEach(function(e){return r.removeChild(e)}),n.forEach(function(e){e instanceof HTMLScriptElement&&(e=u(e.innerHTML)),t.appendChild(e)}),document.body.appendChild(t),o.state=-2;break;default:return o.end()}},E,this)})),window.addEventListener("message",function(e){e&&e.data&&"urlResourceUpdated"==e.data.what&&window.setTimeout(function(){return window.location.reload()},1e3)},!1)})}();
//# sourceMappingURL=out.js.map
