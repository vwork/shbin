window.__UsedScriptIdentifiers__+=',$__TEMPLATE_INSTANCE__$,$name,$traceurRuntime,APP_DEBUG,APP_TIMEOUT,AbstractGuard,Array,AttrRecognizer,Boolean,Buffer,CS,Cell,DIRECTION_DOWN,DIRECTION_HORIZONTAL,DIRECTION_LEFT,DIRECTION_NONE,DIRECTION_RIGHT,DIRECTION_UP,DIRECTION_VERTICAL,DOMAIN,DONE,Date,EKill,EventEmitter,FRAGMENT,Function,GState,GenericType,Getter,INPUT_END,INSPECT_MAX_BYTES,ImmutableInterface,LN2,LOG,MSPointerEvent,Map,Math,ModuleStore,MutationObserver,Number,Object,PATH,PI,PORT,Pan,Press,Promise,QUERY_DATA,Reflect,RegExp,SCHEME,Set,SlowBuffer,String,Symbol,System,TERM,TYPED_ARRAY_SUPPORT,Tap,Thread,Type,TypeError,UID,USER_INFO,VERSION,WeakMap,WebKitMutationObserver,WinRTError,abs,action,actions,activePlace,add,addEventListener,addListener,after,all,allMessages,allow,amd,america,angle,any,appendChild,apply,applyDiff,applyDiffImm,argumentTypes,argv,array,arrayEqual,arrayIterationKind_,arrayIteratorNextIndex_,assign,assignDiff,asyncWrap,at,atan2,attrTest,base64js,basename,bind,bindAll,bindKey,binding,blue,body,browser,buffer,bundleStore,button,byteLength,cache,call,callback,canEmit,canRecognizeWith,canonicalizeUrl,cast,catch,catchThreads,cb,ceil,cell,center,chain,changedPointers,changedTouches,charAt,charCodeAt,chdir,checkIterable,checkObjectCoercible,checkSchedule,childNodes,classList,clean,clear,clearTimeout,clientWidth,clientX,clientY,clone,cloneDeep,close,closeRe,co,code,collect,colno,command,common,compact,compare,compose,compute,concat,constant,constructor,contains,content,copy,count,countBy,create,createCallback,createClass,createDocumentFragment,createElement,createEvent,createGeneratorInstance,createIteratorResultObject,createPrivateName,createStringIterator,createTextNode,criteria,cssProps,curRecognizer,currentThread,currentThreadData,curry,cwd,data,debounce,debug,default,defaultMaxListeners,defaultSuperCall,defaultView,defaults,defer,defineProperties,defineProperty,delay,delete,deletedCount_,delimiter,deltaTime,deltaX,deltaY,destroy,detach,detect,device,devicePixelRatio,devices,difference,direction,directionTest,directions,directionsCount,dirname,dispatchEvent,display,distance,do,domEvents,domHandler,done,down,drop,each,eachRight,element,elements,emit,enable,enabled,encoding,end,entries,entries_,env,equals,err,errback,error,escape,evEl,evTarget,evWin,evaluate,event,eventType,every,exec,execute,exports,extend,extname,fail,failTimeout,filename,fill,filter,finally,finallyFallThrough,find,findIndex,findKey,findLast,findLastIndex,findLastKey,findWhere,first,firstInput,firstMultiple,flatten,floor,flush,foldl,foldr,foo,forEach,forEachRight,forIn,forInRight,forOwn,forOwnRight,forceCalculations,freeze,fromByteArray,fromCharCode,fromJS,func,funcDecomp,funcNames,functions,genericType,gesture,get,getAttribute,getItem,getModuleImpl,getName,getOwnHashObject,getOwnPropertyDescriptor,getOwnPropertyNames,getOwnPropertySymbols,getPrototypeOf,getReadOnly,getResponseHeader,getTime,getTouchAction,getUncoatedModule,global,go,gocall,gray,grey,groupBy,handleException,handler,handlers,has,hasOwnProperty,hasRequireFailures,hash,head,height,heightmm,history,href,httpClient,id,identifier,identity,importFrom,importTemplate,imports,include,index,indexBy,indexOf,info,inherit,init,initEvent,initGeneratorFunction,initial,initialLoading,inject,innerHTML,innerHeight,innerWidth,input,inputClass,inputCount,inputTarget,inspect,interpolate,intersection,interval,inverse,invert,invoke,is,isAbsolute,isArguments,isArray,isBoolean,isBuffer,isCallable,isClosed,isConstructor,isDate,isElement,isEmpty,isEncoding,isEqual,isExtensible,isFinal,isFinished,isFinite,isFirst,isFunction,isGetter,isLiteral,isNaN,isNull,isNumber,isObject,isPlainObject,isPrivateName,isPrototypeOf,isRegExp,isString,isTTY,isUndefined,item,iterator,iteratorFailed,iteratorObject_,join,joinData,js,key,keys,kill,language,last,lastIndex,lastIndexOf,lastInterval,later,layout,leading,left,length,lineno,linkName,listener,listenerCount,listeners,live,loadedBy,location,lodash,log,lu,magenta,main,makeDiff,makeDiffImm,manager,map,mapValues,map_,maps,match,max,maxCount,maxIndex,maxTicks,maxTime,maxTime1,maxVelocity,maxVelocityX,maxVelocityY,maxWait,maxtime,maybeAddConsts,maybeAddFunctions,maybeAddIterator,maybeThrow,memoize,merge,message,messages,method,methods,mid,min,minTime,mixin,mouse,name,navigator,new,newListener,next,nextTick,noConflict,noTouch,node,nodeType,noop,normalize,now,number,object,objectIndex_,observe,off,offsetDelta,offsetDirection,omit,on,onReject_,onResolve_,once,onerror,onload,onmessage,onread,onreadystatechange,ontimeout,onwritten,open,options,orientation,ownerDocument,pCenter,pTime,pX,pY,pairs,parent,parentNode,parentWindow,parse,parseInt,partial,partialRight,performance,pick,pixelRatio,places,platform,pluck,pointerEvents,pointerId,pointerType,pointers,polyfillAll,poolSize,pop,popTry,port1,port2,posThreshold,position,post,postMessage,pow,ppmm,preset,pressed,prevDelta,prevInput,preventDefault,preventDefaults,preventExtensions,preventSrc,prevented,primitiveIndex_,process,processing,procs,promise,promiseFalse,promiseNull,promiseOne,promiseTrue,promiseZero,property,propertyIsEnumerable,prototype,pull,push,pushTry,pushedA,pushedC,ra,rainbow,random,range,raw,read,readDoubleBE,readDoubleLE,readFloatBE,readFloatLE,readInt16BE,readInt16LE,readInt32BE,readInt32LE,readInt8,readStream,readUInt16BE,readUInt16LE,readUInt32BE,readUInt32LE,readUInt8,readyState,receive,recognize,recognizeWith,recognizers,red,reduce,reduceRight,register,registerModule,registerPolyfill,reject,relative,remove,removeAllListeners,removeChild,removeDotSegments,removeEventListener,removeItem,removeListener,renderComponentToString,replace,requestAnimationFrame,require,requireFail,requireFailure,reset,resolve,resolveUrl,response,responseType,rest,result,resume,rethrow,returnValue,rotation,round,runAll,runAllCount,runCount,runInContext,sample,scale,scheduled,seal,second,select,self,send,sent,sentIgnoreThrow,sent_,sep,session,set,setAttribute,setConst,setDatabase,setImmediate,setInterval,setItem,setMaxListeners,setName,setTheme,setTimeout,setupGlobals,shift,shuffle,simultaneous,size,sleep,slice,some,sort,sortBy,sortedIndex,source,sourceURL,splice,split,spread,sqrt,srcEvent,stack,standalone,start,started,state,status,statusText,status_,stdout,stop,stopPropagation,stopped,store,storedException,str,string,stringIndex_,stringify,strip,stripCause,stripColors,stripError,stripStack,style,styles,stylize,subarray,substr,superCall,superConstructor,superGet,superSet,support,supportsColor,tagName,tail,take,tap,tapCount,taps,target,targetIds,template,templateSettings,test,testingPrefix_,themes,then,threshold,throttle,throw,tick,time,timeStamp,times,title,toArray,toArrayBuffer,toByteArray,toInteger,toJSON,toLength,toLocaleString,toLowerCase,toObject,toProperty,toString,toUint32,toUpperCase,top,totalTime,touch,touchAction,touches,trace,traceur,trailing,transform,trap,trim,try,tryEmit,tryStack_,type,typeDescriptor,uid,undefined,unescape,union,uniq,unique,uniqueId,unshift,unwise,unzip,up,update,updates,url,userAgent,value,valueOf,value_,values,variable,velocity,velocityX,velocityY,wait,waitForInput,warn,warned,where,which,white,width,widthmm,window,withMutations,without,wrap,write,writeDoubleBE,writeDoubleLE,writeFloatBE,writeFloatLE,writeHead,writeInt16BE,writeInt16LE,writeInt32BE,writeInt32LE,writeInt8,writeUInt16BE,writeUInt16LE,writeUInt32BE,writeUInt32LE,writeUInt8,written,xhr,xor,yield,zIndex,zalgo,zebra,zip,zipObject';(function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({"/home/vadzim/v/work/nerojs/node_modules/browserify/node_modules/buffer/index.js":[function(require,module,exports){
...
},{"_process":"/home/vadzim/v/work/nerojs/node_modules/browserify/node_modules/process/browser.js","buffer":"/home/vadzim/v/work/nerojs/node_modules/browserify/node_modules/buffer/index.js"}],"/home/vadzim/v/work/nerojs/node_modules/colors/lib/colors.js":[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
!function(){!function(e){var t=global.performance||Date,a=0,r=t.now(),n=require,i=function(){a+=t.now()-r,require=n;try{return n.apply(this,arguments)}finally{require=i,r=t.now()}};require=i;try{e()}finally{require=n,a+=t.now()-r,a/=1e3,global.__require_stats__||(global.__require_stats__={}),global.__require_stats__["/home/vadzim/v/work/nerojs/src/JSONclient.js"]=a}}(function(){"use strict";function e(e){var t=ra.clean();return co.go($traceurRuntime.initGeneratorFunction(function a(){var r,n;return $traceurRuntime.createGeneratorInstance(function(a){for(;;)switch(a.state){case 0:r="",a.state=9;break;case 9:return a.state=2,e.receive(r);case 2:n=a.sent,a.state=4;break;case 4:n=(n.partial?lu.applyDiff:lu.assignDiff)(t.valueOf(),n.data),r=n.uid,t.assign(n),a.state=9;break;default:return a.end()}},a,this)})),{data:t.getReadOnly(),send:function(t){e.send({partial:!1,data:t})},update:function(t){e.send({partial:!0,data:t})}}}module.exports=e})}();
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
!function(){!function(e){var r=global.performance||Date,t=0,a=r.now(),n=require,o=function(){t+=r.now()-a,require=n;try{return n.apply(this,arguments)}finally{require=o,a=r.now()}};require=o;try{e()}finally{require=n,t+=r.now()-a,t/=1e3,global.__require_stats__||(global.__require_stats__={}),global.__require_stats__["/home/vadzim/v/work/nerojs/src/JSONlocal.js"]=t}}(function(){"use strict";module.exports=function(e){var r=void 0!==arguments[1]?arguments[1]:null,t=ra.clean(r).setConst("reset",function(){localStorage.removeItem(e),t.assign(r)}).setName("localStorage."+e),a=localStorage.getItem(e);return null!=a&&t.assign(JSON.parse(a)),ra.clean(function(){t.valueOf()!=r&&localStorage.setItem(e,JSON.stringify(t))}),t}})}();
//# sourceMappingURL=out.js.map
...
},{"_process":"/home/vadzim/v/work/nerojs/node_modules/browserify/node_modules/process/browser.js","buffer":"/home/vadzim/v/work/nerojs/node_modules/browserify/node_modules/buffer/index.js"}],"/home/vadzim/v/work/nerojs/src/app.js":[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
!function(){!function(e){var t=global.performance||Date,n=0,a=t.now(),r=require,u=function(){n+=t.now()-a,require=r;try{return r.apply(this,arguments)}finally{require=u,a=t.now()}};require=u;try{e()}finally{require=r,n+=t.now()-a,n/=1e3,global.__require_stats__||(global.__require_stats__={}),global.__require_stats__["/home/vadzim/v/work/nerojs/src/app.js"]=n}}(function(){"use strict";module.exports=function(e){function t(e){return{receive:function(t){return lu.try(httpClient.post.bind(null,httpClient.url(e,{id:t})))},send:function(t){return httpClient.post(e,JSON.stringify(t))}}}var n=require("JSONclient"),a={activePlace:"",language:"ru",iconSize:40,house:{main:null},devices:{uid:null},places:{uid:null,main:null}},r=require("JSONlocal")(e,a),u=ra.clean({pageWidth:2,pageHeight:3,pageStarting:!1,isContextMenu:!1,history:[],go:function(e){r.activePlace!=e&&(u.history.push(r.activePlace),r.activePlace=e)},back:function(){u.history.length&&(r.activePlace=u.history.pop())},windowSize:{$:require("windowSize").getReadOnly(),width:null,height:null,ppmm:null,layout:null,window:null},get devices(){return n(t("/devices"))},get places(){return n(t("/rooms"))},get main(){var e=lu.valueOf(u.places.data);return e&&lu.valueOf(e.main)},get activePlace(){return r.activePlace||u.main},deviceIds:ra.Getter(function(){var e=lu.valueOf(u.devices.data);return lodash.keys(e).filter(function(t){var n=e[t];return n&&n.type}).sort()},lu.arrayEqual),placeIds:ra.Getter(function(){var e=lu.valueOf(u.places.data);return lodash.keys(e).filter(function(t){var n=e[t];return n&&n.type}).sort()},lu.arrayEqual),get onDevices(){var e=lu.valueOf(u.devices.data);e&&e.uid&&(r.devices=e)},get onPlaces(){var e=lu.valueOf(u.places.data);e&&e.uid&&(r.places=e)},get initialLoading(){return!r.places.uid||!r.devices.uid},get initialized(){return!u.initialLoading&&!!lu.valueOf(r.places.main)},setDatabase:function(e,t){r.devices=e,u.devices.send(e),r.places=t,u.places.send(t)},reset:function(){u.setDatabase({uid:UID()},{uid:UID()})},setTemplate:function(e){function t(e,a){if(e.content){var r={},u=0;e.content.forEach(function(e){return r[t(e,UID())]={index:u++}}),e.content=r,e.type="place"}return n[a]=e,a}e=lodash.cloneDeep(e);var n={uid:UID()},a=t(e,UID()),r={uid:UID(),main:a};u.setDatabase(n,r)},get templates(){return $traceurRuntime.initGeneratorFunction(function e(){var t,n,a,r;return $traceurRuntime.createGeneratorInstance(function(e){for(;;)switch(e.state){case 0:e.pushTry(11,null),e.state=14;break;case 14:t=httpClient.get,n=t.call(httpClient,"/templates"),e.state=6;break;case 6:return e.state=2,n;case 2:a=e.sent,e.state=4;break;case 4:e.returnValue=a,e.state=-2;break;case 8:e.popTry(),e.state=-2;break;case 11:e.popTry(),r=e.storedException,e.state=9;break;case 9:e.returnValue=r,e.state=-2;break;default:return e.end()}},e,this)}).call(this)},get allMessages(){return $traceurRuntime.initGeneratorFunction(function e(){var t,n,a;return $traceurRuntime.createGeneratorInstance(function(e){for(;;)switch(e.state){case 0:t=httpClient.get,n=t.call(httpClient,"/messages"),e.state=6;break;case 6:return e.state=2,n;case 2:a=e.sent,e.state=4;break;case 4:e.returnValue=a,e.state=-2;break;default:return e.end()}},e,this)}).call(this)},get messages(){var e=u.allMessages;if(null!=e){var t={},n=r.language||"ru";return lodash.forOwn(e,function(e,a){return t[a]=e.hasOwnProperty(n)?e[n]:a}),t}},message:function(e){var t=u.messages&&u.messages[e];return null==t&&(t=e),t},command:function(e,t){httpClient.post("/command?cmd="+t+"&id="+e)},iconCommand:function(e,t,n){return e=lu.valueOf(e),(e.content?"Short"==n:"Long"==n)?u.go(t):(("Short"==n||"Long"==n)&&(n="Comfort_1"),!!e.device&&u.command(e.device,n))},get imgProps(){return{onerror:function(){this.classList.add("error")},onload:function(){this.classList.remove("error")}}}}).setName("app");return{app:u,local:r}}})}();
//# sourceMappingURL=out.js.map
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
!function(){!function(t){var e=global.performance||Date,r=0,n=e.now(),i=require,o=function(){r+=e.now()-n,require=i;try{return i.apply(this,arguments)}finally{require=o,n=e.now()}};require=o;try{t()}finally{require=i,r+=e.now()-n,r/=1e3,global.__require_stats__||(global.__require_stats__={}),global.__require_stats__["/home/vadzim/v/work/nerojs/src/co.js"]=r}}(function(){"use strict";function t(t){return{done:!0,iteratorFailed:!0,value:t}}function e(e,r){try{return e.next(r)}catch(n){return t(n)}}function r(e,r){if(!e.throw)return t(r);try{return e.throw(r)}catch(n){return t(n)}}function n(t){if(t&&t.throw){var e=(new h,r(t,new h));e.done&&e.iteratorFailed||a(new Error("thread ate EKill"))}}var i=require("later");module.exports=exports=new EventEmitter;var o=null;exports.currentThread=null,exports.global=null;exports.go=function(t){for(var e=[],r=1;r<arguments.length;r++)e[r-1]=arguments[r];if("function"==typeof t&&(t=t.apply(null,e)),!t.next){var n=t;t={next:function(){var t={value:n,done:!n};return n=null,t}}}return new _(t)},exports.gocall=function(t,e){for(var r=[],n=2;n<arguments.length;n++)r[n-2]=arguments[n];return new _(t.apply(e,r))},exports.func=function(t){return function(){return new _(t.apply(this,arguments))}};var s=function(t){return new Promise(function(e,r){return i.then(function(){return t(e,r)})})};exports.node=function(t){return function(){for(var e=[],r=0;r<arguments.length;r++)e[r]=arguments[r];var n=this;return s(function(r,i){e.push(function(t,e){return t?i(t):r(e)}),t.apply(n,e)})}},exports.cb=function(t){return function(){for(var e=[],r=0;r<arguments.length;r++)e[r]=arguments[r];var n=this;return s(function(r){e.push(r),t.apply(n,e)})}},exports.catchThreads=function(t,e){var r=o;o=e;try{return t()}finally{o=r}},exports.wait=function(t){return{then:t}},exports.sleep=function(t){return{then:function(e){var r=setTimeout(e,t);return{kill:function(){clearTimout(r)}}}}},exports.yield=exports.sleep(1),exports.requestAnimationFrame={then:function(t){if("function"==typeof cancelAnimationFrame){{requestAnimationFrame(t)}return{kill:function(){cancelAnimationFrame(timer)}}}return exports.sleep(1).then(t)}};var a=function(t){return setTimeout(function(){throw t},1)},u={enumerable:!1},h=function(){var t=void 0!==arguments[0]?arguments[0]:"kill";$traceurRuntime.superConstructor(l).call(this,t)},l=h;$traceurRuntime.createClass(h,{},{},Error),exports.EKill=h;var c=function(t){return t instanceof f?t:(this._iterator=t,void(this._deferred=null))},f=c;$traceurRuntime.createClass(c,{defer:function(t){if("function"!=typeof t)throw new Error("type error: only functions can be deferred");this._deferred||(this._deferred=[]),this._deferred.push(t)},unwise:function(){var t=null,e=!1,r=this._deferred;for(this._deferred=null;r.length>1;)try{r.pop()()}catch(n){e&&a(t),e=!0,t=n}if(e){var i=!1;try{r.pop()(),i=!0}finally{if(i)throw t;return a(t)}}else r.pop()()},"do":function(t,e){var r=f._iterator;f._iterator=this;var n=null;try{n=t.call(this._iterator,e)}finally{try{n&&!n.done||!this._deferred||(f._iterator=null,this.unwise())}finally{f._iterator=r}}return n},next:function(t){return this.do(this._iterator.next,t)},"throw":function(t){return this.do(this._iterator.throw,t)}},{}),c._iterator=null,exports.defer=function(t){if(!c._iterator)throw new Error("defer: not in a co-thread");c._iterator.defer(t)};var _=function(t){var e=this;if(this._attachedToStack=!0,this._iterator=new c(t),this._stopCount=0,this._stack=[],this._global={},this._current=null,this.$name={toString:function(){return"<Thread>"}},this._newStep(),this._start=function(){e._start&&e._step&&e._step.next&&(e._stopCount>0?e._step.resume=e._start:(e._start=null,e._step.next()))},this._promise=new Promise(function(t,r){e._resolve=t,e._reject=r}),!this._resolve)throw new Error("assertion failure: wrong implementation of Promise");i.then(this._start),o&&o(this),exports.emit("start",this)};$traceurRuntime.createClass(_,{linkName:function(t){var e=void 0!==arguments[1]?arguments[1]:":thread";return t.$name&&(t=t.$name),this.$name.toString=function(){return""+t+e},this},waitForInput:function(){if(this._checkFinished(),this._stopCount>0)throw new Error("thread is paused");return this._start&&this._start(),this},_attachPromise:function(t){return t.kill=this.kill.bind(this),t},then:function(t,e){return this._attachedToStack=!1,this._attachPromise(this._promise.then(t,e))},"catch":function(t){return this._attachedToStack=!1,this._attachPromise(this._promise.catch(t))},isFinished:function(){return!this._step},isPaused:function(){return this._stopCount>0},"throw":function(t){if(this==exports.currentThread)throw t;this._checkFinished(),this._newStep(),this._stopCount>0?this._step.resume=this._step.fail.bind(this._step,t):this._step.fail(t)},attachToStack:function(){this._attachedToStack=!0},kill:function(t){var e=void 0!==arguments[1]?arguments[1]:!0;if(!this.isFinished()){if(this._reject(t),e){n(this._iterator);for(var r=this._stack,i=r.length-1;i>=0;--i)n(r[i])}if(this._current)try{this._current.kill(t,e)}catch(o){a(o)}if(this._done(),this==exports.currentThread)throw new h}},pause:function(){this._checkFinished(),++this._stopCount},resume:function(){if(0==this._stopCount)throw new Error("thread not paused");0==--this._stopCount&&this._step&&this._step.resume&&(i.then(this._step.resume),this._step.resume=null)},_tick:function(t,n,i){if(t===this._step){if(this._stopCount>0)return void(t.resume=this._tick.bind(this,t,n,i));for(;;){this._current=null;var o=exports.currentThread;exports.currentThread=this,global.currentThreadData=exports.global=this._global;var s=n(this._iterator,i);if(exports.currentThread=o,global.currentThreadData=exports.global=o&&o._global,s.done){if(this.isFinished())return;if(this._iterator=this._stack.pop()){n=s.iteratorFailed?r:e,i=s.value;continue}var u=s.iteratorFailed?this._reject:this._resolve;this._done(),s.iteratorFailed&&this._attachedToStack&&a(s.value),u(s.value)}else if(s.value)if(s.value.then)s=s.value.then(t.next,t.fail),s&&s.kill&&(this._current=s);else{if(s.value.next){this._stack.push(this._iterator),this._iterator=new c(s.value),n=e,i=void 0;continue}if(!("onload"in s.value&&!s.value.onload&&"onerror"in s.value)||s.value.onerror)throw new Error("thread type error");s.value.onload=t.next,s.value.onerror=t.fail}else exports.yield.then(t.next);break}}},_done:function(){this._step=null,this._iterator=null,this._stack=null,this._resolve=null,this._reject=null,this._current=null},_newStep:function(){var t=this._step={resume:null};t.next=this._tick.bind(this,t,e),t.fail=this._tick.bind(this,t,r);var n=this.$name;t.next.$name={toString:function(){return n+":next"}},t.fail.$name={toString:function(){return n+":fail"}}},_onPromise:function(t,e){this._resolve=t,this._reject=e,this.resume()},_checkFinished:function(){if(this.isFinished())throw new Error("thread is already finished")}},{}),exports.Thread=_,Object.keys(_.prototype).forEach(function(t){return t.match(/^_/)&&Object.defineProperty(_.prototype,t,u)}),exports.currentThread=new _({next:function(){return{value:{then:function(){}}}}}).waitForInput(),exports.global=exports.currentThread._global})}();
//# sourceMappingURL=out.js.map
...
},{"_process":"/home/vadzim/v/work/nerojs/node_modules/browserify/node_modules/process/browser.js","buffer":"/home/vadzim/v/work/nerojs/node_modules/browserify/node_modules/buffer/index.js","later":"/home/vadzim/v/work/nerojs/src/later.js"}],"/home/vadzim/v/work/nerojs/src/components.js":[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
!function(){!function(e){var n=global.performance||Date,t=0,r=n.now(),o=require,a=function(){t+=n.now()-r,require=o;try{return o.apply(this,arguments)}finally{require=a,r=n.now()}};require=a;try{e()}finally{require=o,t+=n.now()-r,t/=1e3,global.__require_stats__||(global.__require_stats__={}),global.__require_stats__["/home/vadzim/v/work/nerojs/src/httpClient.js"]=t}}(function(){"use strict";var e={get:function(n,t){return e.xhr({method:"GET",url:n,encoding:t})},post:function(n,t,r){return e.xhr({method:"POST",url:n,data:t,encoding:r})},xhr:function(e){var n=e,t=n.method,r=n.url,o=n.encoding,a=n.data,u=new XMLHttpRequest;u.responseType="binary"==o?"arraybuffer":"text";var i=new Promise(function(e,n){var t=function(e){"string"==typeof e&&(e=new Error(e)),global._ALERT&&global._ALERT("try "+e+r),n(e)};u.ontimeout=function(){return t("TIMEOUT")},u.onerror=function(e){return t(e||"ERROR")},u.onreadystatechange=function(){u.readyState==u.DONE&&0==u.status&&u.ontimeout()},u.onload=function(){u.status>=200&&u.status<=299?e(null==u.response?null:u.response):t(u.status+" "+u.statusText)}});switch(o){case"immutable":i=i.then(function(e){return Immutable.fromJS(JSON.parse(e))});break;case"binary":i=i.then(function(e){return new Uint8Array(e)});break;case"text":break;default:i=i.then(function(e){var n=o;if(!n){var t=u.getResponseHeader("content-type")||"";t.match(/^application\/json/)&&(n="json")}switch(n){case"json":return JSON.parse(e)}return e})}return u.open(t||"GET",r),u.send(a),u.then=i.then.bind(i),u.catch=i.catch.bind(i),u},url:function(e,n){return n&&Object.keys(n).forEach(function(t,r){return e=e+(r>0?"&":"?")+encodeURIComponent(t)+"="+encodeURIComponent(n[t])}),e}};module.exports=e})}();
//# sourceMappingURL=out.js.map
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
!function(){!function(n){var r=global.performance||Date,t=0,e=r.now(),o=require,u=function(){t+=r.now()-e,require=o;try{return o.apply(this,arguments)}finally{require=u,e=r.now()}};require=u;try{n()}finally{require=o,t+=r.now()-e,t/=1e3,global.__require_stats__||(global.__require_stats__={}),global.__require_stats__["/home/vadzim/v/work/nerojs/src/platform.js"]=t}}(function(){"use strict";if(Object.defineProperty(Object.prototype,"_LOG_",{value:function(){return console.log(this),this},configurable:!0}),require("colors"),global.EventEmitter=require("events").EventEmitter,"function"==typeof Symbol&&Symbol.iterator){var n=null;try{n=eval.call(null,"(function*(){}().constructor.prototype)")}catch(r){}n&&!n[Symbol.iterator]&&(n[Symbol.iterator]=function(){return this})}global.lodash=require("lodash"),global.UID=require("uid"),global.co=require("co"),global.ra=require("ra"),global.lu=require("localUtils"),global.httpClient=require("httpClient"),global.window&&(global.Promise=function(){var n=function r(n){var t=[],e=[],o=function(n,r){t.push(n),e.push(r)},u=function(n){t&&(o=function(r){return process.nextTick(function(){return r(n)})},t.forEach(function(n){return o(n,null)}),t=null,e=null)},i=function(n){t&&(o=function(r,t){return process.nextTick(function(){return t(n)})},e.forEach(function(n){return o(null,n)}),t=null,e=null)};this.then=function(n,t){return new r(function(r,e){var u=function(n,t){return n?function(t){try{r(n(t))}catch(o){e(o)}}:t};o(u(n,r),u(t,e))})};try{n(u,i)}catch(l){i(l)}};return $traceurRuntime.createClass(n,{"catch":function(n){return this.then(null,n)}},{resolve:function(r){return new n(function(n){return n(r)})},reject:function(r){return new n(function(n,t){return t(r)})},all:function(r){for(var t,e=[],o=r[$traceurRuntime.toProperty(Symbol.iterator)]();!(t=o.next()).done;){var u=t.value;e.push(u)}return new n(function(n,r){var t=e.length+1,o=function(){return!--t&&e&&n(e)},u=function(t){e=null,n=null,r(t)};e.forEach(function(n,r){return n.then(function(n){e&&(e[r]=n),o()},u)}),o()})},race:function(r){return new n(function(n,t){for(var e,o=r[$traceurRuntime.toProperty(Symbol.iterator)]();!(e=o.next()).done;){var u=e.value;u.then(n,t)}})}})}())})}();
//# sourceMappingURL=out.js.map
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
!function(){!function(e){var n=global.performance||Date,r=0,t=n.now(),o=require,a=function(){r+=n.now()-t,require=o;try{return o.apply(this,arguments)}finally{require=a,t=n.now()}};require=a;try{e()}finally{require=o,r+=n.now()-t,r/=1e3,global.__require_stats__||(global.__require_stats__={}),global.__require_stats__["/home/vadzim/v/work/nerojs/src/webpage.js"]=r}}(function(){"use strict";function e(e){e.target&&"external"==e.target.getAttribute("rel")||e.preventDefault()}{var n=global.performance||global.Date;n.now()}require("browser-nexttick"),require("platform"),document.body.addEventListener("touchstart",e),document.body.addEventListener("touchmove",e),document.body.addEventListener("touchend",e),document.body.addEventListener("touchcancel",e),global.LOG=function(e){console.log.apply(console,arguments),global._ALERT&&global._ALERT(e);var n=new XMLHttpRequest;return n.open("POST","/log?"+encodeURIComponent(e)),n.send(),e},window.addEventListener("error",function t(e){if(!e.message.match(404)&&!t.processing){t.processing=!0;try{LOG(e.message.red+" at "+e.lineno+":"+e.colno+" in "+e.filename)}finally{t.processing=!1}}});var r=window.onerror;window.onerror=function(e,n,t,o,a){var l;return a&&LOG("stack: "+a.stack),r&&(l=r.apply(this,arguments)),l},global.CS=lu.new(require("components"),global.CS)})}();
//# sourceMappingURL=out.js.map
...
},{"_process":"/home/vadzim/v/work/nerojs/node_modules/browserify/node_modules/process/browser.js","browser-nexttick":"/home/vadzim/v/work/nerojs/src/browser-nexttick.js","buffer":"/home/vadzim/v/work/nerojs/node_modules/browserify/node_modules/buffer/index.js","components":"/home/vadzim/v/work/nerojs/src/components.js","platform":"/home/vadzim/v/work/nerojs/src/platform.js"}],"/home/vadzim/v/work/nerojs/src/windowSize.js":[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
!function(){!function(e){var i=global.performance||Date,t=0,n=i.now(),o=require,r=function(){t+=i.now()-n,require=o;try{return o.apply(this,arguments)}finally{require=r,n=i.now()}};require=r;try{e()}finally{require=o,t+=i.now()-n,t/=1e3,global.__require_stats__||(global.__require_stats__={}),global.__require_stats__["/home/vadzim/v/work/nerojs/src/windowSize.js"]=t}}(function(){"use strict";function e(){var e=window.innerWidth,t=window.innerHeight,o=(window.orientation||0)%360;0>o&&(o+=360),i.width=e,i.height=t,i.ppmm=n,i.widthmm=e/n,i.heightmm=t/n,i.pixelRatio=window.devicePixelRatio||1,i.orientation=o,i.layout=t>=e?"vertical":"horizontal",i.window=window.navigator.standalone?"app":"browser"}var i=ra.clean({width:1,height:1,ppmm:1,widthmm:1,heightmm:1,pixelRatio:1,orientation:0,layout:"vertical",window:"browser"}).setName("windowSize");window.addEventListener("resize",e);var t=document.createElement("div");t.style.left="0",t.style.top="0",t.style.width="10cm",t.style.height="10cm",t.style.position="fixed",t.style.zIndex="-9999",document.body.appendChild(t);var n=t.clientWidth/100;document.body.removeChild(t),e(),module.exports=i})}();
//# sourceMappingURL=out.js.map
...
},{"_process":"/home/vadzim/v/work/nerojs/node_modules/browserify/node_modules/process/browser.js","buffer":"/home/vadzim/v/work/nerojs/node_modules/browserify/node_modules/buffer/index.js"}],"/home/vadzim/v/work/nerojs/tmp/index.js":[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
require("app"),require("webpage"),global.require=function e(){global.require=null;try{return require.apply(this,arguments)}finally{global.require=e}};
