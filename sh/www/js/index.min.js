...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
!function(){!function(e){var t=global.performance||Date,r=0,n=t.now(),a=require,i=function(){r+=t.now()-n,require=a;try{return a.apply(this,arguments)}finally{require=i,n=t.now()}};require=i;try{e()}finally{require=a,r+=t.now()-n,r/=1e3,global.__require_stats__||(global.__require_stats__={}),global.__require_stats__["/home/vadzim/v/work/nerojs/src/app.js"]=r}}(function(){"use strict";function e(e,t){var r=new f;return a(function(){return r.url=e.localModem&&e.localModem+t}),r.active=a.on(r,["pause","resume"],function(){return r.connected}),r}function t(t,a){var i=r(a,{uid:null}),c=e(t,a);return n.on(c,{resume:function(){c.send({what:"init",id:i.uid})},message:function(e){i.assign((e.partial?n.applyDiff:n.assignDiff)(i.valueOf(),e.data))},error:function(){t.onCredentials()}}),{data:i.getReadOnly(),active:c.active,send:function(e){c.send({what:"save",partial:!1,data:e})},update:function(e){c.send({what:"save",partial:!0,data:e})},"delete":function(){c.close()}}}var r=require("JSONlocal"),n=require("localUtils"),a=require("ra"),i=require("lodash"),c=require("uid"),u=require("httpClient"),o=require("events").EventEmitter||require("events"),l=require("deviceActions"),s=(require("http-status"),1e3),f=function(e){this.connected=!1,this.closed=!1,this._ws=null,this._xhr=null,this._first=!0,this.url=e,this.user=void 0,this.key=void 0};$traceurRuntime.createClass(f,{get url(){return this._url},set url(e){this._url=e,this._createHandle()},_setConnected:function(e){e=!!e,this.connected!=e&&(this.connected=e,this.emit("changed",e))},_clearHandle:function(){this._ws&&(this._ws.onclose=null,this._ws.close(),this._ws=null,this._setConnected(!1)),this._xhr&&(this._xhr.onreadystatechange=null,this._xhr.abort(),this._xhr=null)},_createHandle:function(){var e=this;if(this._clearHandle(),this._url){var t=function(){return!e.closed&&setTimeout(function(){return e._createHandle()},s)};this._ws=new WebSocket(this._url),this._ws.onclose=function(){e._ws=null,e._setConnected(!1),e.emit("pause"),t()},this._ws.onerror=function(t){e.emit("error",t)},this._ws.onopen=function(){e._setConnected(!0),e._first&&(e._first=!1,e.emit("open")),e.emit("resume")},this._ws.onmessage=function(t){var r=t.data;if(!/^pong/.test(r)){if(/^ping/.test(r))return e._ws.send(r.replace("i","o"));try{r=JSON.parse(r)}catch(n){return e.emit("error",n)}e.emit("message",r)}}}},send:function(e){if(!this._ws||!this.connected||this.closed)throw new Error("socket is not open");this._ws.send(JSON.stringify(e))},"delete":function(){this.close()},close:function(){this.closed=!0,this._clearHandle(),this.emit("close")},ask:function(e){var t=c();return this.send({id:t,question:e}),this.get(e.id).then(function(e){if(e.error)throw new Error(e.error);return e.answer})},get:function(e,t){var r=this;if("string"==typeof e||"number"==typeof e){var a=e;e=function(e){return e.id==a}}else if("function"!=typeof e){var c=e;e=function(){return i.every(c,function(e,t){return msk[t]==e})}}return new Promise(function(a,i){var c,u;c=function(e){n.off(r,{close:c,message:u}),null!=e?a(e):i(new Error("timeout"))},u=function(t){e(t)&&c(t)},null!=t&&setTimeout(c,t),n.on(r,{close:c,message:u})})}},{},o),module.exports=function(o){var s,f={activePlace:"",language:"ru",iconSize:40,house:{main:null},devices:{uid:null},places:{uid:null,main:null}},b=r(o,f),d=function(e){var t=b.language||"ru";return[t,"ru","en"].filter(function(t){return e.hasOwnProperty(t)}).map(function(t){return e[t]})[0]},m=a.clean((s={},Object.defineProperty(s,"pageWidth",{value:2,configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(s,"pageHeight",{value:3,configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(s,"pageStarting",{value:!1,configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(s,"dialog",{value:"",configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(s,"history",{value:[],configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(s,"loggedin",{value:!1,configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(s,"onCredentials",{value:function(){m.loggedin=!1},configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(s,"go",{value:function(e){e&&b.activePlace!=e&&(m.history.push(b.activePlace),b.activePlace=e)},configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(s,"back",{value:function(){for(;m.history.length;){var e=m.history.pop();if(m.getPlace(e))return b.activePlace=e}b.activePlace=m.main},configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(s,"windowSize",{value:{$:require("windowSize").getReadOnly(),width:null,height:null,ppmm:null,layout:null,window:null},configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(s,"modemLocations",{get:function(){return u.get("/modem_locations")},configurable:!0,enumerable:!0}),Object.defineProperty(s,"localModem",{get:function(){return m.modemLocations?m.modemLocations[0].url.replace(/^http(?=s?\:\/\/)/,"ws"):""},configurable:!0,enumerable:!0}),Object.defineProperty(s,"doLogin",{value:a.Getter($traceurRuntime.initGeneratorFunction(function g(){var e,t;return $traceurRuntime.createGeneratorInstance(function(r){for(;;)switch(r.state){case 0:r.state=3;break;case 3:r.state=m.loggedin||!m.modemLocations?1:2;break;case 1:r.state=-2;break;case 2:e=document.createElement("script"),e.src=m.modemLocations[0].url+"/login?"+c(),document.body.appendChild(e),r.state=28;break;case 28:r.pushTry(16,17),r.state=19;break;case 19:return r.state=5,e;case 5:r.maybeThrow(),r.state=7;break;case 7:r.popTry(),r.state=17,r.finallyFallThrough=21;break;case 16:r.popTry(),t=r.storedException,r.state=14;break;case 14:console.log("error while trying to login",t),r.state=15;break;case 15:return r.state=9,co.sleep(300);case 9:r.maybeThrow(),r.state=17,r.finallyFallThrough=0;break;case 17:r.popTry(),r.state=26;break;case 26:document.body.removeChild(e),r.state=24;break;case 21:a.detach(function(){return m.loggedin=!0}),r.state=0;break;case 24:r.state=r.finallyFallThrough;break;default:return r.end()}},g,this)})),configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(s,"login",{value:function(){},configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(s,"devices",{get:function(){return t(m,"/devices")},configurable:!0,enumerable:!0}),Object.defineProperty(s,"places",{get:function(){return t(m,"/places")},configurable:!0,enumerable:!0}),Object.defineProperty(s,"commands",{get:function(){return e(m,"/commands")},configurable:!0,enumerable:!0}),Object.defineProperty(s,"connectedToServer",{get:function(){return!0&&m.devices.active.valueOf()&&m.places.active.valueOf()&&m.commands.active.valueOf()},configurable:!0,enumerable:!0}),Object.defineProperty(s,"main",{get:function(){var e=n.valueOf(m.places.data);return e&&n.valueOf(e.main)},configurable:!0,enumerable:!0}),Object.defineProperty(s,"getPlace",{value:function(e){return m.places.data.get(e)},configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(s,"getDevice",{value:function(e){return m.devices.data.get(e)},configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(s,"activePlace",{get:function(){return b.activePlace||m.main},configurable:!0,enumerable:!0}),Object.defineProperty(s,"activeDevice",{get:function(){return m.getPlace(m.activePlace).device},configurable:!0,enumerable:!0}),Object.defineProperty(s,"checkIfTimeToGoBack",{get:function(){n.valueOf(m.places.data),m.getPlace(m.activePlace)||m.back()},configurable:!0,enumerable:!0}),Object.defineProperty(s,"caption",{get:function(){var e="";return m.activePlace!=m.main&&(e=d(m.getPlace(m.activePlace))),e||m.message("favorites")},configurable:!0,enumerable:!0}),Object.defineProperty(s,"placeType",{get:function(){var e=m.getPlace(m.activePlace);return e||(e=m.getPlace(m.main)),"content"==e.type&&e.group?"group":"content"==e.type?"place":"device"},configurable:!0,enumerable:!0}),Object.defineProperty(s,"deviceIds",{value:a.Getter(function(){var e=n.valueOf(m.devices.data);return i.keys(e).filter(function(t){var r=e[t];return r&&r.type}).sort()},n.arrayEqual),configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(s,"getFreeGroup",{value:function(){for(var e=i.reduce(n.valueOf(m.devices.data),function(e,t){return t.group&&(e[t.group]=!0),e},[]),t=2;1022>=t;++t)if(!e[t])return t;return null},configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(s,"placeIds",{value:a.Getter(function(){var e=n.valueOf(m.places.data);return i.keys(e).filter(function(t){var r=e[t];return r&&r.type}).sort()},n.arrayEqual),configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(s,"onDevices",{get:function(){var e=n.valueOf(m.devices.data);e&&e.uid&&(b.devices=e)},configurable:!0,enumerable:!0}),Object.defineProperty(s,"onPlaces",{get:function(){var e=n.valueOf(m.places.data);e&&e.uid&&(b.places=e)},configurable:!0,enumerable:!0}),Object.defineProperty(s,"initialLoading",{get:function(){return!b.places.uid||!b.devices.uid},configurable:!0,enumerable:!0}),Object.defineProperty(s,"initialized",{get:function(){return!m.initialLoading&&!!n.valueOf(b.places.main)},configurable:!0,enumerable:!0}),Object.defineProperty(s,"setDatabase",{value:function(e,t){b.devices=e,m.devices.send(e),b.places=t,m.places.send(t)},configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(s,"reset",{value:function(){m.setDatabase({uid:c()},{uid:c()})},configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(s,"setTemplate",{value:function(e){function t(e,n){if(e.content){var a={},i=0;e.content.forEach(function(e){return a[t(e,c())]={index:i++}}),e.content=a,e.type="place"}return r[n]=e,n}e=i.cloneDeep(e);var r={uid:c()},n=t(e,c()),a={uid:c(),main:n};m.setDatabase(r,a)},configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(s,"templates",{get:function(){return $traceurRuntime.initGeneratorFunction(function e(){var t,r,n,a;return $traceurRuntime.createGeneratorInstance(function(e){for(;;)switch(e.state){case 0:e.pushTry(11,null),e.state=14;break;case 14:t=u.get,r=t.call(u,"/templates"),e.state=6;break;case 6:return e.state=2,r;case 2:n=e.sent,e.state=4;break;case 4:e.returnValue=n,e.state=-2;break;case 8:e.popTry(),e.state=-2;break;case 11:e.popTry(),a=e.storedException,e.state=9;break;case 9:e.returnValue=a,e.state=-2;break;default:return e.end()}},e,this)}).call(this)},configurable:!0,enumerable:!0}),Object.defineProperty(s,"allMessages",{get:function(){return $traceurRuntime.initGeneratorFunction(function e(){var t,r,n;return $traceurRuntime.createGeneratorInstance(function(e){for(;;)switch(e.state){case 0:t=u.get,r=t.call(u,"/messages"),e.state=6;break;case 6:return e.state=2,r;case 2:n=e.sent,e.state=4;break;case 4:e.returnValue=n,e.state=-2;break;default:return e.end()}},e,this)}).call(this)},configurable:!0,enumerable:!0}),Object.defineProperty(s,"messages",{get:function(){var e=m.allMessages;if(null!=e){var t={},r=b.language||"ru";return i.forOwn(e,function(e,n){return t[n]=e.hasOwnProperty(r)?e[r]:n}),t}},configurable:!0,enumerable:!0}),Object.defineProperty(s,"message",{value:function(e){var t=m.messages&&m.messages[e];return null==t&&(t=e),t},configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(s,"createDevice",{value:function(e){var t=n.valueOf(m.getPlace(e));if(!t.device){var r=c();return co.go($traceurRuntime.initGeneratorFunction(function a(){var t,i;return $traceurRuntime.createGeneratorInstance(function(a){for(;;)switch(a.state){case 0:return a.state=2,m.devices.update((t={},Object.defineProperty(t,r,{value:{model:"Nero II 8421",state:0,comfort_1:.8,comfort_2:.2},configurable:!0,enumerable:!0,writable:!0}),t));case 2:a.maybeThrow(),a.state=4;break;case 4:return a.state=6,n.waitFor(function(){return m.getDevice(r)});case 6:a.maybeThrow(),a.state=8;break;case 8:return a.state=10,m.places.update((i={},Object.defineProperty(i,e,{value:{device:r},configurable:!0,enumerable:!0,writable:!0}),i));case 10:a.maybeThrow(),a.state=12;break;case 12:return a.state=14,n.waitFor(function(){return m.getPlace(e).device});case 14:a.maybeThrow(),a.state=-2;break;default:return a.end()}},a,this)}))}return n.promiseSucceeded},configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(s,"addItem",{value:function(e,t){var r,n,a,i=c();return m.places.update((a={},Object.defineProperty(a,e,{value:(n={},Object.defineProperty(n,"content",{value:(r={},Object.defineProperty(r,i,{value:{index:Object.keys(m.getPlace(e).content||{}).length},configurable:!0,enumerable:!0,writable:!0}),r),configurable:!0,enumerable:!0,writable:!0}),n),configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(a,i,{value:t,configurable:!0,enumerable:!0,writable:!0}),a))},configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(s,"addPlace",{value:function(e){return m.addItem(e,{type:"content",ru:"Помещение",en:"Room"})},configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(s,"addDevice",{value:function(e){return m.addItem(e,{type:"single",ru:"Устройство",en:"Device"})},configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(s,"purgeItem",{value:function(e){var t;return m.places.update(i.reduce(n.valueOf(m.places.data),function(t,r,n){var a,i;return r&&r.content&&r.content[e]&&(t[n]=(i={},Object.defineProperty(i,"content",{value:(a={},Object.defineProperty(a,e,{value:null,configurable:!0,enumerable:!0,writable:!0}),a),configurable:!0,enumerable:!0,writable:!0}),i)),t},(t={},Object.defineProperty(t,e,{value:null,configurable:!0,enumerable:!0,writable:!0}),t)))},configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(s,"renameItem",{value:function(e,t){var r,n=i.reduce(m.getPlace(e),function(e,t,r){return 2==r.length&&(e[r]=null),e},{});return n[f.language||"ru"]=t,m.places.update((r={},Object.defineProperty(r,e,{value:n,configurable:!0,enumerable:!0,writable:!0}),r))},configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(s,"command",{value:function(e,t){l.getNewState(m.devices[e],t);return m.commands?m.commands.ask({device:e,command:t}):Promise.reject("commands interface is not ready")},configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(s,"iconCommand",{value:function(e,t,r){return console.log(e,t,r),e=n.valueOf(e),("content"==e.type?"Short"==r:"Long"==r)?m.go(t):(("Short"==r||"Long"==r)&&(r="Comfort_1"),e.device?m.command(e.device,r):Promise.reject(new Error("device not configured")))},configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(s,"imgProps",{get:function(){return{onerror:function(){this.classList.add("error")},onload:function(){this.classList.remove("error")}}},configurable:!0,enumerable:!0}),s)).setName("app");return{app:m,local:b}}})}();
//# sourceMappingURL=out.js.map
...
module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports=module.exports={
	"Nero II 8713-50": {
		"buttons": "RollShutter"
	},
	"Intro II 8513-50": {
