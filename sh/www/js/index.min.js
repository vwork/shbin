...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
!function(){!function(t){var e=global.performance||Date,n=0,i=e.now(),s=require,r=function(){n+=e.now()-i,require=s;try{return s.apply(this,arguments)}finally{require=r,i=e.now()}};require=r;try{t()}finally{require=s,n+=e.now()-i,n/=1e3,global.__require_stats__||(global.__require_stats__={}),global.__require_stats__["/home/vadzim/v/work/nerojs/src/PingPongJSON.js"]=n}}(function(){"use strict";var t=require("lodash"),e=function(t){var e;$traceurRuntime.superConstructor(n).call(this),this._q=t,this.pipeFrom(t),t.onmessage=(e=this,function(t){return e._message(t)})},n=e;$traceurRuntime.createClass(e,{unwise:function(){var t=this._q;return this._q=null,t.onopen=null,t.onclose=null,t.onerror=null,t.onmessage=null,t.unwise?t.unwise():t},_message:function(t){"ping"==t.what?this._q.send({what:"pong",pong:t.ping}):this.domessage(t)},_send:function(t){this._q.send(t)},_close:function(){this._q.onclose=null,this._q.close()}},{},require("WebQueue"));var i=function(t){var e,n,i,r,o=void 0!==arguments[1]?arguments[1]:{},u=void 0===(e=o.interval)?6e4:e,a=void 0===(n=o.timeout)?15e3:n,l=void 0===(i=o.maxpings)?1e3:i;$traceurRuntime.superConstructor(s).call(this,t),this._pings={},this._count=0,this._pinterval=u==1/0?null:setInterval((r=this,function(){return r.ping()}),u),this._timeout=a,this._maxpings=l},s=i;$traceurRuntime.createClass(i,{_message:function(t){"pong"==t.what?this._pings.hasOwnProperty(t.pong)&&(clearTimeout(this._pings[t.pong]),delete this._pings[t.pong],--this._count):$traceurRuntime.superGet(this,s.prototype,"_message").call(this,t)},_send:function(t){$traceurRuntime.superGet(this,s.prototype,"_send").call(this,t),this.ping()},_close:function(){clearInterval(this._pinterval),this._pinterval=null,t.forEach(this._pings,function(t){return clearTimeout(t)}),this._pings=null,$traceurRuntime.superGet(this,s.prototype,"_close").call(this)},ping:function(){var t=this;if(this._q){if(this._count>this._maxpings)return this._ontimeout();var e=""+Math.random();this._q.send({what:"ping",ping:e}),this._pings[e]=setTimeout(function(){console.log(e.red),t._ontimeout()},this._timeout),++this._count}},_ontimeout:function(){try{this.doerror(new Error("timeout"))}finally{this.close()}}},{},e),module.exports=function(t,e){return new i(t,e)},module.exports.silent=function(t){return new e(t)}})}();
//# sourceMappingURL=out.js.map
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
!function(){!function(e){var r=global.performance||Date,n=0,t=r.now(),s=require,o=function(){n+=r.now()-t,require=s;try{return s.apply(this,arguments)}finally{require=o,t=r.now()}};require=o;try{e()}finally{require=s,n+=r.now()-t,n/=1e3,global.__require_stats__||(global.__require_stats__={}),global.__require_stats__["/home/vadzim/v/work/nerojs/src/WebSocketToJSON.js"]=n}}(function(){"use strict";var e=function(e){var n;$traceurRuntime.superConstructor(r).call(this),this._ws=e,this.pipeFrom(e),e.onmessage=(n=this,function(e){var r;try{r=JSON.parse(String(e.data))}catch(t){return n.doerror(t)}n.domessage(r)})},r=e;$traceurRuntime.createClass(e,{unwise:function(){var e=this._ws;return this._ws=null,e.onopen=null,e.onclose=null,e.onerror=null,e.onmessage=null,e},_send:function(e){this._ws.send(JSON.stringify(e))},_close:function(){this._ws.onclose=null,this._ws.close()}},{},require("WebQueue")),module.exports=function(r){return new e(r)}})}();
//# sourceMappingURL=out.js.map
...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
!function(){!function(t){var e=global.performance||Date,r=0,n=e.now(),i=require,a=function(){r+=e.now()-n,require=i;try{return i.apply(this,arguments)}finally{require=a,n=e.now()}};require=a;try{t()}finally{require=i,r+=e.now()-n,r/=1e3,global.__require_stats__||(global.__require_stats__={}),global.__require_stats__["/home/vadzim/v/work/nerojs/src/ra.js"]=r}}(function(){"use strict";function t(){}function e(t,e,r){return Object.is(t,e)||e&&"function"==typeof e.isEqualTo&&e.isEqualTo(t)||t&&"function"==typeof t.isEqualTo&&t.isEqualTo(e)||"function"==typeof r&&r(t,e)}function r(t){return this==t||Array.isArray(t)&&this.length==t.length&&this.every(function(r,n){return e(r,t[n])})}function n(t){return this==t||JSON.stringify(this)==JSON.stringify(t)}function i(){var t=V();return t.assign(t),V(function(){var e=t.valueOf();V.detach(function(){return t.assign(e)})}),t}function a(t){return a.Keys||(a.Keys="undefined"!=typeof WeakMap?new WeakMap:function(){var t="_to_key_"+o();return{set:function(e,r){Object.defineProperty(e,t,{enumerable:!1,configurable:!0,writable:!1,value:r})},get:function(e){return e[t]},has:function(e){return e.hasOwnProperty(t)}}}()),!t||"object"!=typeof t&&"function"!=typeof t?typeof t+t:(a.Keys.has(t)||a.Keys.set(t,o()),a.Keys.get(t))}var u=require("later").push,s=require("co"),o=require("uid"),l=require("lodash"),c=require("LOG").LOG,h="_RA_ACTION_"+o(),f="_RA_VALUE_"+o(),_={};_.scheduled=!1,_.procs=[],_.index=0,_.maxIndex=32768,_.processing=!1,_.totalTime=0,_.maxTime=0,_.maxTime1=0,_.minTime=1/0,_.runCount=0,_.runAllCount=0,global.updates=_;var v=global.performance||global.Date;_.start=v.now(),_.log=function(){return console.log(":: "+_.totalTime/1e3+" / "+(v.now()-_.start)/1e3+" ("+_.maxTime/1e3+", "+_.maxTime1/1e3+", "+_.minTime/1e3+", "+G.maxCount+", "+_.runCount+", "+_.runAllCount+")")},_.checkSchedule=function(){!_.scheduled&&_.procs.length>0&&(_.scheduled=!0,u(_.tick))},_.tick=function(){_.scheduled=!1;var t,e=function(){try{return _.runAll(),0}catch(t){setTimeout(function(){throw t},1)}};t:for(var r=0;1e3>r;++r)switch(t=e(r)){case 0:break t}_.checkSchedule()},_.runAll=function(){var t=v.now(),e=t,r=_.runCount,n=_.processing;_.processing=!0;var i=s.global[h];null!=i&&(s.global[h]=null);try{for(;_.index<_.procs.length;){global.APP_TIMEOUT&&global.APP_TIMEOUT<Date.now&&alert("Application is running too long");var a=_.procs[_.index];++_.index,++_.runCount,_.index>=_.maxIndex&&3*_.index>_.procs.length&&(_.procs.splice(0,_.index),_.index=0),a();var u=v.now();_.maxTime1<u-e&&(_.maxTime1=u-e),e=u}_.index=_.procs.length=0}finally{if(null!=i&&(s.global[h]=i),_.processing=n,!n){var o=v.now()-t;_.totalTime+=o,_.maxTime<o&&(_.maxTime=o),r=_.runCount-r,r&&(++_.runAllCount,_.minTime>o&&(_.minTime=o)),o>300&&c("updates have been run for "+o.toString().red+" ms")}}},_.later=function(t){_.procs.push(t),_.checkSchedule()},_.later.then=_.later;var p="undefined"==typeof Immutable?null:Immutable.Map(),d=function(t){return null==t||t==p?null:t},y=function(){return this},g=function(t){return t&&"object"==typeof t&&t.constructor==Object},b=function(t){return null==t||null==t.valueOf?t:t.valueOf()},m=function(t){throw new Error('access to an undeclared property "'+this.$name+"."+t+'"')},w=Object.create(null),O=Object.create(null),k=function(t){w[t]||(w[t]=!0,Object.defineProperty(O,t,{get:function(){m.call(this,t)},set:function(){m.call(this,t)}}))};t.prototype=O,global.APP_DEBUG&&(t.prototype=(global.__UsedScriptIdentifiers__+"").split(/[\s,]+/).reduce(function(t,e){var r;return Object.create(t,(r={},Object.defineProperty(r,e,{value:{get:function(){m.call(this,e)},set:function(){m.call(this,e)}},configurable:!0,enumerable:!0,writable:!0}),r))},t.prototype)),t.prototype=Object.create(t.prototype,{toString:{value:{}.toString},valueOf:{value:{}.valueOf},toLocaleString:{value:{}.toLocaleString},hasOwnProperty:{value:{}.hasOwnProperty},isPrototypeOf:{value:{}.isPrototypeOf},propertyIsEnumerable:{value:{}.propertyIsEnumerable},$name:{value:"<...>",writable:1}});var x=[];Object.freeze(x);var S=function(){$traceurRuntime.superConstructor(T).apply(this,arguments)},T=S;$traceurRuntime.createClass(S,{get props(){throw new Error("access to deprecated 'props' property detected")},get declaredProperties(){return this.live},get length(){var t=this.valueOf();return null==t?0:Object.keys(t).length},get:function(t){if(null!=t){var e=this.valueOf();if(null!=e&&e.hasOwnProperty(t))return e[t]}return null},map:function(t){var e=this.valueOf();return e&&(Array.isArray(e)?l.map(e,t):l.mapValues(e,t))},keys:function(){var t=this.valueOf();return null==t?x:Object.keys(t)}},{},t);var j=function(t){$traceurRuntime.superConstructor(P).call(this),this._parent=t},P=j;$traceurRuntime.createClass(j,{getReadOnly:function(){return this},get live(){return this._parent.live},get $name(){return this._parent.$name},valueOf:function(){return this._parent.valueOf.apply(this._parent,arguments)},noTouch:function(){return this._parent.noTouch.apply(this._parent,arguments)},toString:function(){return this._parent.toString.apply(this._parent,arguments)},toJSON:function(){return this._parent.toJSON.apply(this._parent,arguments)},getName:function(){return this._parent.getName.apply(this._parent,arguments)}},{},S);var A=function(t,r){var n,i=r?function(){var i=t.apply(this,arguments);return e(n,i,r)||(n=i),n}:function(){return t.apply(this,arguments)};return i.isGetter=!0,i},C=function(t){function e(){return t.apply(this,arguments)}return e.typeDescriptor=!0,e},$=function(t,e,r){return new G(e,t,r).linkName(t,":getter")},E=function(t,e,r){return new G(function(){return e(t.valueOf())},null,r).linkName(t,":setter")},R=function(){},z=R;$traceurRuntime.createClass(R,{_defineThatProperty:function(t,e){Object.defineProperty(this,t,{configurable:!0,enumerable:!0,get:function(){return e[t]},set:function(r){e[t]=r}})}},{create:function(t,e){var r=null;return r=t?Object.create(t):new z,r.valueOf=function(){return e.valueOf()},r.toString=function(){return e.toString()},r.toJSON=function(){return e.toJSON()},r.assign=function(t){return e.assign(t)},r["throw"]=function(t){return e["throw"](t)},Object.defineProperty(r,"live",{get:function(){return e.live}}),r}});var q=function(t){var r;$traceurRuntime.superConstructor(N).call(this),this._id=o(),this._that=null,this._value=null,this._error=null,this._isValueEqual=e,this._initialized=!1,this._frozen=!1,this._closed=!1,this._dirty=!1,this._live=null,this._liveArray=null,this._actionsArr=[],this._parent=null,this._onchange=[],this.$name={toString:(r=this,function(){return r.getName()})},this._notifyWritten(),this._sticky=!!t},N=q;$traceurRuntime.createClass(q,{valueOf:function(){return this._read()},assign:function(t){return this._write(t,!1,null)},update:function(t){return this.assign(lu.applyDiff(this.noTouch(),t))},"throw":function(t){return this._write(null,!1,t)},touch:function(){this._fire()},noTouch:function(){if(this._dirty&&this._updateSelf(),this._error)throw this._error;return this._value},then:function(t){this._onchange.push(t)},close:function(){if(!this._closed){if(this._closed=!0,this._fire(),this._parent&&this._parent.close(),this._liveArray){var t=!0,e=!1,r=void 0;try{for(var n=void 0,i=this._liveArray[$traceurRuntime.toProperty(Symbol.iterator)]();!(t=(n=i.next()).done);t=!0){var a=n.value;a.close()}}catch(u){e=!0,r=u}finally{try{t||null==i["return"]||i["return"]()}finally{if(e)throw r}}this._liveArray=null}this._value=null,this._error=null,this._actionsArr=null,this._parent=null}},freeze:function(){if(!this._closed&&!this._frozen&&(this._frozen=!0,this._fire(),this._parent&&this._parent.freeze(),this._liveArray)){var t=!0,e=!1,r=void 0;try{for(var n=void 0,i=this._liveArray[$traceurRuntime.toProperty(Symbol.iterator)]();!(t=(n=i.next()).done);t=!0){var a=n.value;a.freeze()}}catch(u){e=!0,r=u}finally{try{t||null==i["return"]||i["return"]()}finally{if(e)throw r}}}},get live(){return this._live},getReadOnly:function(){return this._readOnly||(this._readOnly=new j(this))},toString:function(){for(var t,e=[],r=0;r<arguments.length;r++)e[r]=arguments[r];var n=this._read();return null!=n&&n.toString?(t=n).toString.apply(t,$traceurRuntime.spread(e)):""+n},toJSON:function(){for(var t,e=[],r=0;r<arguments.length;r++)e[r]=arguments[r];var n=this._read();return null!=n&&n.toJSON?(t=n).toJSON.apply(t,$traceurRuntime.spread(e)):n},"with":function(t){return t.call(this._getThat())},setName:function(t){return this._name=t,this},getName:function(){for(var t=this._name||this._key,e=this._parent;e;)t=(e._name||e._key)+"."+t,e=e._parent;return t},_getThat:function(){if(!this._that&&(this._that=R.create(this._parent&&this._parent._getThat(),this),this._live))for(var t in this._live)this._that._defineThatProperty(t,this);return this._that},defineProperty:function(t){void 0!==arguments[1]?arguments[1]:!1;if(this._live||(this._live=Object.create(null),this._liveArray=[]),t){k(t);var e=this._live[t];return e?e:(e=new N(this._sticky),this._live[t]=e,this._liveArray.push(e),e._key=t,e._parent=this,e._level=(this._level||0)+1,Object.defineProperty(this,t,{enumerable:!0,configurable:!0,get:function(){return e._live?e:e._read()},set:function(t){e._live&&(t=b(t)),e._write(t,!1)}}),this._that&&this._that._defineThatProperty(t,this),null!=this._value&&e._write(this._value[t],!0),e)}},init:function(t){this._init(t,!1,!1)},setConst:function(t,e){return Object.defineProperty(this,t,{enumerable:!0,get:function(){return e}}),this},setVar:function(t,e){return Object.defineProperty(this,t,{enumerable:!0,writable:!0,value:e}),this},_init:function(t,e,r,n){var i=this;if(!e&&i._initialized)throw new Error("already initialized");if(this._parent&&(this._parent._dirty=!0),i._initialized=!0,n&&(this._isValueEqual=n),t=d(t),"function"==typeof t&&t.typeDescriptor&&(t=t(i._key)),null!=t){if(t[f])return i._value=t;if("function"==typeof t)return void(r||t.isGetter?$(i,function(){return t.call(i._parent&&i._parent._getThat())},this._sticky):i._value=function(){return t.apply(i._parent&&i._parent._getThat(),arguments)});if(!g(t))return i._value=t;if(e)throw new Error("wrong parameters");i.defineProperty();for(var a in t){var u=Object.getOwnPropertyDescriptor(t,a);if(u){var s=u.get,o=u.value;if(u.set)throw new Error("wrong parameters");s&&(o=s),"$"==a?i._init(o,!0,!!s):i.defineProperty(a,!0)._init(o,!1,!!s)}}}},_read:function(){this._dirty&&this._updateSelf();var t=s.global[h];if(t&&(this._closed?t.close():this._frozen||t.onread(this)),this._error)throw this._error;return this._value},_write:function(t,e,r){if(null==r&&(r=null),this._frozen)throw new Error("Try to change a frozen value");if(this._initialized=!0,this._dirty=!1,t=d(t),this._closed){var n=s.global[h];n&&n.close()}else if(!this._isValueEqual(this._value,t)||this._error!=r){if(this._value=t,this._error=r,this._live){var i=!0,a=!1,u=void 0;try{for(var o=void 0,l=this._liveArray[$traceurRuntime.toProperty(Symbol.iterator)]();!(i=(o=l.next()).done);i=!0){var c=o.value;c._write(t&&t[c._key],!0)}}catch(f){a=!0,u=f}finally{try{i||null==l["return"]||l["return"]()}finally{if(a)throw u}}}if(this._fire(),!e)for(var _=this._parent;_&&!_._dirty;)_._dirty=!0,_._fire(),_=_._parent}return e||this._notifyWritten(),t},_updateSelf:function(){var t=0,e={};for(var r in this._value)this._value.hasOwnProperty(r)&&(e[r]=this._value[r],++t);var n=!0,i=!1,a=void 0;try{for(var u=void 0,s=this._liveArray[$traceurRuntime.toProperty(Symbol.iterator)]();!(n=(u=s.next()).done);n=!0){var o=u.value;if(o._dirty&&o._updateSelf(),o._error)return this._error=o._error,this._value=null,void(this._dirty=!1);var l=o._value;null==l?e.hasOwnProperty(o._key)&&(delete e[o._key],--t):(e[o._key]=l,t=1/0)}}catch(c){i=!0,a=c}finally{try{n||null==s["return"]||s["return"]()}finally{if(i)throw a}}0==t&&(e=null),this._value=e,this._dirty=!1},debug:function(t){this._actionsArr.push({action:{_fire:t}})},"debugger":function(){this.debug(function(){})},_fire:function(){var t;if(t=this._actionsArr,t.length){for(var e=0;e<t.length;e++){var r=t[e];r.action&&r.action._fire(),r.pushedC=!1}t.length=0}if(t=this._onchange,t.length){for(var n=0;n<t.length;n++)_.later(t[n]);t.length=0}},_notifyWritten:function(){var t=s.global[h];t&&t.onwritten(this)}},{},S);var I=function(t){return setTimeout(function(){throw t},1)},G=function(t,e,r){var n=this;this._id=o(),this._fun=t,this._dest=e,this._cellSet={},this._cellSetSize=0,this._cellArr=[],this.$name={toString:function(){return"<Action>"}},this._thread=s.gocall(this._loop,this).linkName(this).waitForInput(),this._runCount=0;var i;(i=s.global[h])&&i._children&&i._children.push(this),this._children=null,this._threads=null,this._onthread=null,this._generatorProxy=null,this._generator=null,r&&(this._children=[],this._threads=[],this._onthread=function(t){return n._threads.push(t)})},J=G;$traceurRuntime.createClass(G,{linkName:function(t){var e=void 0!==arguments[1]?arguments[1]:":action";return t.$name&&(t=t.$name),this.$name.toString=function(){return""+t+e},this},_initGeneratorProxy:function(){var t,e,r=this,n=function(){return r._generator.next(e)},i=function(){return r._generator["throw"](e)},a=function(){return r._generator["return"](e)};this._generatorProxy=(t={},Object.defineProperty(t,Symbol.iterator,{value:y,configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(t,"next",{value:function(t){e=t;try{return s.catchThreads(n,r._onthread)}finally{e=null}},configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(t,"throw",{value:function(t){e=t;try{return s.catchThreads(i,r._onthread)}finally{e=null}},configurable:!0,enumerable:!0,writable:!0}),Object.defineProperty(t,"return",{value:function(t){e=t;try{return s.catchThreads(a,r._onthread)}finally{e=null}},configurable:!0,enumerable:!0,writable:!0}),t)},_loop:$traceurRuntime.initGeneratorFunction(function M(){var t,e,r,n,i,a,u,o,l;return $traceurRuntime.createGeneratorInstance(function(c){for(;;)switch(c.state){case 0:t=this,c.state=96;break;case 96:return c.state=2,_.later;case 2:c.maybeThrow(),c.state=4;break;case 4:e={then:function(e){t._onchange=e}},s.global[h]=this,r=!1,c.state=98;break;case 98:c.pushTry(85,null),c.state=88;break;case 88:c.state=r?69:65;break;case 65:c.state=this.isClosed()?7:64;break;case 64:this._begin(),r=!0,n=void 0,c.state=67;break;case 67:c.state=this._children?38:60;break;case 38:n=s.catchThreads(this._fun,this._onthread),c.state=39;break;case 39:c.state=n&&n.next&&n["throw"]?30:36;break;case 30:this._generatorProxy||this._initGeneratorProxy(),this._generator=n,c.state=31;break;case 31:c.pushTry(null,23),c.state=25;break;case 25:i=c.wrapYieldStar(this._generatorProxy[Symbol.iterator]()),c.sent=void 0,c.action="next",c.state=19;break;case 19:a=i[c.action](c.sentIgnoreThrow),c.state=16;break;case 16:c.state=a.done?10:9;break;case 10:c.sent=a.value,c.state=17;break;case 9:return c.state=19,a.value;case 17:n=c.sentIgnoreThrow,c.state=23,c.finallyFallThrough=21;break;case 23:c.popTry(),c.state=29;break;case 29:this._generator=null,c.state=27;break;case 36:c.state=n&&n.then?32:21;break;case 32:return c.state=33,n;case 33:n=c.sent,c.state=21;break;case 60:n=this._fun(),c.state=61;break;case 61:c.state=n&&n.next&&n["throw"]?50:58;break;case 50:u=c.wrapYieldStar(n[Symbol.iterator]()),c.sent=void 0,c.action="next",c.state=51;break;case 51:o=u[c.action](c.sentIgnoreThrow),c.state=48;break;case 48:c.state=o.done?42:41;break;case 42:c.sent=o.value,c.state=49;break;case 41:return c.state=51,o.value;case 49:n=c.sentIgnoreThrow,c.state=21;break;case 58:c.state=n&&n.then?54:21;break;case 54:return c.state=55,n;case 55:n=c.sent,c.state=21;break;case 21:this._dest&&this._dest.assign(n),c.state=69;break;case 69:r=!1,c.state=83;break;case 83:c.state=this.isClosed()?7:80;break;case 80:switch(this._end()){default:c.state=88;break;case!1:c.state=7;break;case!0:c.state=73}break;case 74:c.maybeThrow(),c.state=88;break;case 73:return c.state=74,e;case 84:c.popTry(),c.state=98;break;case 85:c.popTry(),c.maybeUncatchable(),l=c.storedException,c.state=91;break;case 91:r?this._dest["throw"](l):I(l),c.state=98;break;case 7:s.global[h]=null,this._finalize(),c.state=-2;break;case 27:c.state=c.finallyFallThrough;break;default:return c.end()}},M,this)}),isClosed:function(){return!this._cellSet},close:function(){var t=this._thread;this._fire(),this._finalize(),t&&t.kill()},_closeChildren:function(){var t;if(t=this._children){for(var e=0,r=t.length;r>e;++e)t[e].close();t.length=0}if(t=this._threads){for(var n=0,i=t.length;i>n;++n)t[n].kill();t.length=0}},_finalize:function(){this._unsubscribe(),this._cellSet=null,this._cellArr=null,this._fun=null,this._dest=null,this._thread=null},_begin:function(){this._unsubscribe(),++this._runCount,J.maxCount<this._runCount&&(J.maxCount=this._runCount)},_unsubscribe:function(){this._onchange=null;var t=this._cellArr;if(t){for(var e=0;e<t.length;++e){var r=t[e];r.cell=null,r.value=null,r.action=null,r.read=!1,r.written=!1,r.pushedA=!1}this._cellSetSize>32&&t.length<this._cellSetSize/4&&(this._cellSet={},this._cellSetSize=0),t.length=0}this._closeChildren()},_end:function(){for(var t=!1,r=this._cellArr,n=0;n<r.length;++n){var i=r[n];if(i.written)i.action=null;else{if(i.pushedC||(i.cell._actionsArr.push(i),i.pushedC=!0),!e(i.value,i.cell._value)||i.error!=i.cell._error)return null;i.action=this,t=!0}i.value=null,i.cell=null}return t},_linkCell:function(t){var e=this._cellSet[t._id];return null==e&&(e=this._cellSet[t._id]={cell:null,value:null,error:null,action:null,read:!1,written:!1,pushedA:!1,pushedC:!1},++this._cellSetSize),e.pushedA||(this._cellArr.push(e),e.cell=t,e.pushedA=!0),e},onread:function(t){var e=this._linkCell(t);e.read=!0,e.value=t._value,e.error=t._error},onwritten:function(t){this._linkCell(t).written=!0},_fire:function(){this._onchange&&_.later(this._onchange),this._unsubscribe()}},{}),G.maxCount=0;var D=function(t,e,r,n){var i=!0,a=!1,u=void 0;try{for(var s=void 0,o=e[$traceurRuntime.toProperty(Symbol.iterator)]();!(i=(s=o.next()).done);i=!0){var l=s.value;if(null!=l&&"function"!=typeof l)throw new Error("wrong parameters")}}catch(c){a=!0,u=c}finally{try{i||null==o["return"]||o["return"]()}finally{if(a)throw u}}var h=new q(r);void 0!==t&&h._init(t,!1,!0,n);var f=!0,_=!1,v=void 0;try{for(var p=void 0,d=e[$traceurRuntime.toProperty(Symbol.iterator)]();!(f=(p=d.next()).done);f=!0){var y=p.value;y&&(y.length?E:$)(h,y,r)}}catch(g){_=!0,v=g}finally{try{f||null==d["return"]||d["return"]()}finally{if(_)throw v}}return h},V=function(){{var t,e,r,n,i=0;arguments.length-1}return"string"==typeof arguments[i]&&(t=arguments[i++]),"boolean"==typeof arguments[i]&&(r=arguments[i++]),e=arguments[i++],"function"==typeof arguments[i]&&(n=arguments[i++]),D(e,[],r,n)};exports=module.exports=V,exports.ra=V,exports.is=e,exports.Array=function(t){return t.isEqualTo=r,t},exports.JSON=function(t){return t.isEqualTo=n,t},exports.Value=function(t){return t&&t.defineProperty(f,{value:!0,configurable:!0,enumerable:!1,writable:!1}),t},exports.clean=function(t){for(var e=[],r=1;r<arguments.length;r++)e[r-1]=arguments[r];return D(t,e,!1)},exports.detach=function(t){var e;if(!(e=s.global[h]))return t();s.global[h]=null;try{return t()}finally{s.global[h]=e}},exports.detached=function(t){return function(){var e;if(!(e=s.global[h]))return t.apply(this,arguments);s.global[h]=null;try{return t.apply(this,arguments)}finally{s.global[h]=e}}},exports.on=function(t,e,r){var n=V(),i=function(t){return n.assign(r(t))};if("string"==e)t.on(e,i);else{var a=!0,u=!1,s=void 0;try{for(var o=void 0,l=e[$traceurRuntime.toProperty(Symbol.iterator)]();!(a=(o=l.next()).done);a=!0){var c=o.value;t.on(c,i)}}catch(h){u=!0,s=h}finally{try{a||null==l["return"]||l["return"]()}finally{if(u)throw s}}}return i(),n},exports.Cell=q,exports.ImmutableInterface=S,exports.AbstractGuard=t,exports.Getter=A,exports.Type=C,exports.importFrom=function(t){return C(function(e){return A(function(){return t.live[e].valueOf()})})},exports.forceCalculations=function(){return _.runAll()};var K=o(),U=function(t,e,r,n){this._previous=n,this._getter=t,this._save=e;var a=this._chunk=V();a.assign(r);var u=this._actual=i();u[K]=V(function(){return lu.applyDiff(t.valueOf(),a.valueOf())}),this._summary=V(function(){return u.valueOf()[K].valueOf()})},F=U;$traceurRuntime.createClass(U,{createNext:function(){var t=void 0!==arguments[0]?arguments[0]:null;return new F(this._summary,this._save,t,this._actual)},get before(){return this._getter.valueOf()},get summary(){return this._summary.valueOf()},get chunk(){return this._chunk.valueOf()},set chunk(t){this._chunk.assign(t)},valueOf:function(){return this.chunk},assign:function(t){this.chunk=t},save:function(){return this._save(this.chunk)},update:function(t){return this._chunk.update(t)},set:function(t,e){return this._chunk.set(t,e)},get:function(t){return this._chunk.get(t)},close:function(){this._chunk.assign(null),this._previous&&(this._actual.assign(this._previous),this._previous=null)}},{});var L=function(t,e){var r=this;this._head=V(),this._head.assign(new U(t,e)),this._value=V(function(){return r._head.valueOf().summary})};$traceurRuntime.createClass(L,{get data(){return this.valueOf()},valueOf:function(){return this._value.valueOf()},createRecord:function(){var t=(void 0!==arguments[0]?arguments[0]:null,this._head.valueOf().createNext());return this._head.assign(t),t}},{}),exports.db=function(t,e){return new L(t,e)},exports.makeKey=function(t,e){return V(function(){return t.get(e)})},exports.map=function(t,e){if(!(t instanceof q))throw new Error("ra.map: first argument must be a cell");var r=Object.create(null),n=V();return V.detach(function(){return V(function(){var i=t.valueOf();V.detach(function(){var t=[],u=0;l.forEach(r,function(t){return t.abandoned=!0}),i&&i.forEach(function(n){var i,s=a(n);(i=r[s])||(i=r[s]={value:n,index:V()}),i.abandoned=!1,i.index.assign(u++),i.proc||(i.proc=V(function(){return e(n,i.index)})),t.push(i.proc)}),l.keys(r).forEach(function(t){var e=r[t];e.abandoned&&(delete r[t],e.index.close(),e.proc.close())}),n.assign(V.Array(t))})})}),n},exports.keymap=function(t,e){var r=V.map(t,e);return V(function(){return l.zipObject(t.valueOf(),r.valueOf())})},exports.slice=function(t,e,r){throw new Error("message")}})}();
//# sourceMappingURL=out.js.map
